...
T = TypeVar("T", bound="PersonExternalIdsListPersonExternalIdsResponse")


@_attrs_define
class PersonExternalIdsListPersonExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_external_ids_list_person_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        person_external_ids_list_person_external_ids_response.additional_properties = d
        return person_external_ids_list_person_external_ids_response
