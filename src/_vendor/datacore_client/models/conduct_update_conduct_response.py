...
T = TypeVar("T", bound="ConductUpdateConductResponse")


@_attrs_define
class ConductUpdateConductResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conduct_update_conduct_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        conduct_update_conduct_response.additional_properties = d
        return conduct_update_conduct_response
