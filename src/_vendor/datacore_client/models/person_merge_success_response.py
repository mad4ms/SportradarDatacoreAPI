...
T = TypeVar("T", bound="PersonMergeSuccessResponse")


@_attrs_define
class PersonMergeSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_merge_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        person_merge_success_response.additional_properties = d
        return person_merge_success_response
