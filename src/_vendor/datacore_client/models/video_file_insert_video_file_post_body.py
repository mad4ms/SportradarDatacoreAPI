...
from ..models.video_file_insert_video_file_post_body_content import (
    VideoFileInsertVideoFilePostBodyContent,
)
from ..models.video_file_insert_video_file_post_body_feed_type import (
    VideoFileInsertVideoFilePostBodyFeedType,
)
from ..models.video_file_insert_video_file_post_body_format import (
    VideoFileInsertVideoFilePostBodyFormat,
)
from ..models.video_file_insert_video_file_post_body_origin_type_1 import (
    VideoFileInsertVideoFilePostBodyOriginType1,
)
from ..models.video_file_insert_video_file_post_body_origin_type_2_type_1 import (
    VideoFileInsertVideoFilePostBodyOriginType2Type1,
)
from ..models.video_file_insert_video_file_post_body_origin_type_3_type_1 import (
    VideoFileInsertVideoFilePostBodyOriginType3Type1,
)
from ..models.video_file_insert_video_file_post_body_resolution import (
    VideoFileInsertVideoFilePostBodyResolution,
)
from ..models.video_file_insert_video_file_post_body_status_type_1 import (
    VideoFileInsertVideoFilePostBodyStatusType1,
)
from ..models.video_file_insert_video_file_post_body_status_type_2_type_1 import (
    VideoFileInsertVideoFilePostBodyStatusType2Type1,
)
from ..models.video_file_insert_video_file_post_body_status_type_3_type_1 import (
    VideoFileInsertVideoFilePostBodyStatusType3Type1,
)
from ..models.video_file_insert_video_file_post_body_storage_provider_type_1 import (
    VideoFileInsertVideoFilePostBodyStorageProviderType1,
)
from ..models.video_file_insert_video_file_post_body_storage_provider_type_2_type_1 import (
    VideoFileInsertVideoFilePostBodyStorageProviderType2Type1,
)
from ..models.video_file_insert_video_file_post_body_storage_provider_type_3_type_1 import (
    VideoFileInsertVideoFilePostBodyStorageProviderType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="VideoFileInsertVideoFilePostBody")


@_attrs_define
class VideoFileInsertVideoFilePostBody:
    """
    Attributes:
        ...
        resolution (VideoFileInsertVideoFilePostBodyResolution): The resolution of the video input
            >- `1080` 1920 x 1080
            >- `288` 512 x 288
            >- `720` 1280 x 720
             Example: 720.
        feed_type (VideoFileInsertVideoFilePostBodyFeedType): Type of video input
            >- `ADDITIONAL_ANGLE` Additional angle
            >- `LOW_LATENCY` Low Latency
            >- `PRIMARY` Primary
             Example: PRIMARY.
        content (VideoFileInsertVideoFilePostBodyContent): Content of the stream
        ...
        origin (Union[None, Unset, VideoFileInsertVideoFilePostBodyOriginType1,
            VideoFileInsertVideoFilePostBodyOriginType2Type1, VideoFileInsertVideoFilePostBodyOriginType3Type1]): The origin
            of the video file
            >- None None
            >- `STREAM` Streamed
            >- `UPLOAD` Uploaded
            >- `VENUE` Recorded in venue
             Example: STREAM.
        format_ (Union[Unset, VideoFileInsertVideoFilePostBodyFormat]): The format of the video file
            >- `HLS` A HLS play list
            >- `MP4` One MP4 file
             Example: HLS.
        storage_provider (Union[None, Unset, VideoFileInsertVideoFilePostBodyStorageProviderType1,
            VideoFileInsertVideoFilePostBodyStorageProviderType2Type1,
            VideoFileInsertVideoFilePostBodyStorageProviderType3Type1]): Where the video file is stored?
            >- None None
            >- `5STREAM` 5stream
        ...
        status (Union[None, Unset, VideoFileInsertVideoFilePostBodyStatusType1,
            VideoFileInsertVideoFilePostBodyStatusType2Type1, VideoFileInsertVideoFilePostBodyStatusType3Type1]): What is
    ...
    locale: str
    fixture_id: UUID
    resolution: VideoFileInsertVideoFilePostBodyResolution
    feed_type: VideoFileInsertVideoFilePostBodyFeedType
    content: VideoFileInsertVideoFilePostBodyContent
    url: str
    ...
    format_: Union[Unset, VideoFileInsertVideoFilePostBodyFormat] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.origin, Unset):
            origin = UNSET
        elif isinstance(self.origin, VideoFileInsertVideoFilePostBodyOriginType1):
            origin = self.origin.value
        elif isinstance(self.origin, VideoFileInsertVideoFilePostBodyOriginType2Type1):
            origin = self.origin.value
        elif isinstance(self.origin, VideoFileInsertVideoFilePostBodyOriginType3Type1):
            origin = self.origin.value
        else:
            origin = self.origin
        ...
        if isinstance(self.storage_provider, Unset):
            ...
            self.storage_provider, VideoFileInsertVideoFilePostBodyStorageProviderType1
        ):
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, VideoFileInsertVideoFilePostBodyStatusType1):
            status = self.status.value
        elif isinstance(self.status, VideoFileInsertVideoFilePostBodyStatusType2Type1):
            status = self.status.value
        elif isinstance(self.status, VideoFileInsertVideoFilePostBodyStatusType3Type1):
            status = self.status.value
        else:
            status = self.status
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resolution = VideoFileInsertVideoFilePostBodyResolution(d.pop("resolution"))

        feed_type = VideoFileInsertVideoFilePostBodyFeedType(d.pop("feedType"))

        content = VideoFileInsertVideoFilePostBodyContent(d.pop("content"))
        ...
        def _parse_origin(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                origin_type_1 = VideoFileInsertVideoFilePostBodyOriginType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                origin_type_2_type_1 = VideoFileInsertVideoFilePostBodyOriginType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                origin_type_3_type_1 = VideoFileInsertVideoFilePostBodyOriginType3Type1(
                    data
                )
        ...
        format_: Union[Unset, VideoFileInsertVideoFilePostBodyFormat]
        if isinstance(_format_, Unset):
            format_ = UNSET
        else:
            format_ = VideoFileInsertVideoFilePostBodyFormat(_format_)
        ...
        def _parse_storage_provider(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                storage_provider_type_1 = (
                    VideoFileInsertVideoFilePostBodyStorageProviderType1(data)
                )
            ...
            try:
                ...
                storage_provider_type_2_type_1 = (
                    VideoFileInsertVideoFilePostBodyStorageProviderType2Type1(data)
                )
            ...
            try:
                ...
                storage_provider_type_3_type_1 = (
                    VideoFileInsertVideoFilePostBodyStorageProviderType3Type1(data)
                )
        ...
        def _parse_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_1 = VideoFileInsertVideoFilePostBodyStatusType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_2_type_1 = VideoFileInsertVideoFilePostBodyStatusType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_3_type_1 = VideoFileInsertVideoFilePostBodyStatusType3Type1(
                    data
                )
        ...
        video_file_insert_video_file_post_body = cls(
            provider=provider,
            locale=locale,
        ...
        return video_file_insert_video_file_post_body
