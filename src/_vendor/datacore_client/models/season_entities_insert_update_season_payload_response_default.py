...
T = TypeVar("T", bound="SeasonEntitiesInsertUpdateSeasonPayloadResponseDefault")


@_attrs_define
class SeasonEntitiesInsertUpdateSeasonPayloadResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_entities_insert_update_season_payload_response_default = cls(
            meta=meta,
            error=error,
        )
