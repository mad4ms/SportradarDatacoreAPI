...
T = TypeVar("T", bound="SepInsertSeasonEntityPlacingsResponse")


@_attrs_define
class SepInsertSeasonEntityPlacingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sep_insert_season_entity_placings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        sep_insert_season_entity_placings_response.additional_properties = d
        return sep_insert_season_entity_placings_response
