...
T = TypeVar("T", bound="EntityGroupExternalIdsListEntityGroupExternalIdsResponse")


@_attrs_define
class EntityGroupExternalIdsListEntityGroupExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_external_ids_list_entity_group_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_group_external_ids_list_entity_group_external_ids_response.additional_properties = d
        return entity_group_external_ids_list_entity_group_external_ids_response
