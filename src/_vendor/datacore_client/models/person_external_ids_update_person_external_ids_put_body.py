...
T = TypeVar("T", bound="PersonExternalIdsUpdatePersonExternalIdsPutBody")


@_attrs_define
class PersonExternalIdsUpdatePersonExternalIdsPutBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_external_ids_update_person_external_ids_put_body = cls(
            person_id=person_id,
            source=source,
        ...
        return person_external_ids_update_person_external_ids_put_body
