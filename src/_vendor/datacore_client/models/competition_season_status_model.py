...
from ..models.competition_season_status_model_age_group_type_1 import (
...
from ..models.competition_season_status_model_event_type import (
...
if TYPE_CHECKING:
    ...
    from ..models.competition_season_status_model_league import (
        CompetitionSeasonStatusModelLeague,
    )
    from ..models.competition_season_status_model_organization import (
        CompetitionSeasonStatusModelOrganization,
    )
    from ..models.competition_season_status_model_social_media import (
...
class CompetitionSeasonStatusModel:
    ...
    event_type: Union[Unset, CompetitionSeasonStatusModelEventType] = (
        CompetitionSeasonStatusModelEventType.FIXTURE
    )
    ...
    historical_names: Union[
        None, Unset, list["CompetitionSeasonStatusModelCompetitionHistoricalName"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_organization, Unset):
            ...
            organization = CompetitionSeasonStatusModelOrganization.from_dict(
                _organization
            )
        ...
        def _parse_social(
            data: object,
        ) -> Union["CompetitionSeasonStatusModelSocialMedia", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(
                Union["CompetitionSeasonStatusModelSocialMedia", None, Unset], data
            )
        ...
        def _parse_historical_names(
            ...
            try:
                ...
                for historical_names_type_0_item_data in _historical_names_type_0:
                    historical_names_type_0_item = (
                        CompetitionSeasonStatusModelCompetitionHistoricalName.from_dict(
            ...
            return cast(
                Union[
                    None,
                    Unset,
                    list["CompetitionSeasonStatusModelCompetitionHistoricalName"],
                ],
                data,
            )
        ...
        def _parse_age_group(
            ...
            try:
                ...
                age_group_type_2_type_1 = (
                    CompetitionSeasonStatusModelAgeGroupType2Type1(data)
                )
            ...
            try:
                ...
                age_group_type_3_type_1 = (
                    CompetitionSeasonStatusModelAgeGroupType3Type1(data)
                )
