...
from ..models.fixture_profiles_update_match_profiles_put_body_match_profile_configuration_match_roles_item import (
    FixtureProfilesUpdateMatchProfilesPutBodyMatchProfileConfigurationMatchRolesItem,
)
from ..models.fixture_profiles_update_match_profiles_put_body_match_profile_configuration_type_of_cards_item import (
    FixtureProfilesUpdateMatchProfilesPutBodyMatchProfileConfigurationTypeOfCardsItem,
)
from ..types import UNSET, Unset

T = TypeVar(
    "T", bound="FixtureProfilesUpdateMatchProfilesPutBodyMatchProfileConfiguration"
)


@_attrs_define
class FixtureProfilesUpdateMatchProfilesPutBodyMatchProfileConfiguration:
    ...
    Attributes:
        ...
        type_of_cards (Union[Unset,
            list[FixtureProfilesUpdateMatchProfilesPutBodyMatchProfileConfigurationTypeOfCardsItem]]): The type of cards
        ...
        match_roles (Union[Unset,
            list[FixtureProfilesUpdateMatchProfilesPutBodyMatchProfileConfigurationMatchRolesItem]]): The official roles
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for type_of_cards_item_data in _type_of_cards or []:
            type_of_cards_item = FixtureProfilesUpdateMatchProfilesPutBodyMatchProfileConfigurationTypeOfCardsItem(
        ...
        for match_roles_item_data in _match_roles or []:
            match_roles_item = FixtureProfilesUpdateMatchProfilesPutBodyMatchProfileConfigurationMatchRolesItem(
        ...
        fixture_profiles_update_match_profiles_put_body_match_profile_configuration = (
            cls(
