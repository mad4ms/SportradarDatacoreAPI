...
T = TypeVar("T", bound="FesInsertUpdateMatchTeamStatisticsPostBodyStatistics")


@_attrs_define
class FesInsertUpdateMatchTeamStatisticsPostBodyStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fes_insert_update_match_team_statistics_post_body_statistics = cls(
            assists=assists,
        ...
        return fes_insert_update_match_team_statistics_post_body_statistics
