...
T = TypeVar("T", bound="ConductDeleteResponseDefault")


@_attrs_define
class ConductDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conduct_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        conduct_delete_response_default.additional_properties = d
        return conduct_delete_response_default
