...
T = TypeVar("T", bound="SebsListResponseDefault")


@_attrs_define
class SebsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sebs_list_response_default = cls(
            meta=meta,
            error=error,
        )

        sebs_list_response_default.additional_properties = d
        return sebs_list_response_default
