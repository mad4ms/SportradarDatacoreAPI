...
T = TypeVar("T", bound="RoleDeleteRolesResponse")


@_attrs_define
class RoleDeleteRolesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role_delete_roles_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        role_delete_roles_response.additional_properties = d
        return role_delete_roles_response
