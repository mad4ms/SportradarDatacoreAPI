...
T = TypeVar("T", bound="FixtureResetSuccessResponse")


@_attrs_define
class FixtureResetSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_reset_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_reset_success_response.additional_properties = d
        return fixture_reset_success_response
