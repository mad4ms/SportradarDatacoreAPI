...
T = TypeVar("T", bound="FixtureEntityStatisticsPeriodsResponse")


@_attrs_define
class FixtureEntityStatisticsPeriodsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_entity_statistics_periods_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_entity_statistics_periods_response.additional_properties = d
        return fixture_entity_statistics_periods_response
