...
from ..models.person_insert_person_post_body_gender import (
    PersonInsertPersonPostBodyGender,
)
from ..models.person_insert_person_post_body_status import (
    PersonInsertPersonPostBodyStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.person_insert_person_post_body_additional_names_type_0 import (
        PersonInsertPersonPostBodyAdditionalNamesType0,
    )
    from ..models.person_insert_person_post_body_person_additional_details import (
        PersonInsertPersonPostBodyPersonAdditionalDetails,
    )
    from ..models.person_insert_person_post_body_person_historical_name import (
        PersonInsertPersonPostBodyPersonHistoricalName,
    )
    from ..models.person_insert_person_post_body_social_media import (
        PersonInsertPersonPostBodySocialMedia,
    )


T = TypeVar("T", bound="PersonInsertPersonPostBody")


@_attrs_define
class PersonInsertPersonPostBody:
    """
    Attributes:
        status (PersonInsertPersonPostBodyStatus): Status
            >- `ACTIVE` Active
            >- `DECEASED` Deceased
            >- `INACTIVE` Inactive
            >- `PENDING` Pending
            >- `UNREGISTERED` UnRegistered
             Default: PersonInsertPersonPostBodyStatus.ACTIVE. Example: ACTIVE.
        gender (PersonInsertPersonPostBodyGender): The gender of the person
            >- `FEMALE` Female
            >- `MALE` Male
            >- `UNKNOWN` Unknown
             Example: MALE.
        ...
        additional_names (Union['PersonInsertPersonPostBodyAdditionalNamesType0', None, Unset]): Additional names for
            the person. They are broken down by language, so you can have a different set of names per language
        additional_details (Union['PersonInsertPersonPostBodyPersonAdditionalDetails', None, Unset]): Additional person
            detail fields
        social (Union['PersonInsertPersonPostBodySocialMedia', None, Unset]): Social Media contacts
        historical_names (Union[None, Unset, list['PersonInsertPersonPostBodyPersonHistoricalName']]): Array of person
            historical names
        representing (Union[None, Unset, str]): Who the person or team was representing Example: AUSTRALIA.
        external_id (Union[None, Unset, str]): The Id of the data as set by the provider of the data Example: A123.
    """

    gender: PersonInsertPersonPostBodyGender
    name_full_local: str
    status: PersonInsertPersonPostBodyStatus = PersonInsertPersonPostBodyStatus.ACTIVE
    ...
    additional_names: Union[
        "PersonInsertPersonPostBodyAdditionalNamesType0", None, Unset
    ] = UNSET
    additional_details: Union[
        "PersonInsertPersonPostBodyPersonAdditionalDetails", None, Unset
    ] = UNSET
    social: Union["PersonInsertPersonPostBodySocialMedia", None, Unset] = UNSET
    historical_names: Union[
        None, Unset, list["PersonInsertPersonPostBodyPersonHistoricalName"]
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.additional_names, Unset):
            ...
            self.additional_names, PersonInsertPersonPostBodyAdditionalNamesType0
        ):
        ...
        if isinstance(self.additional_details, Unset):
            ...
            self.additional_details, PersonInsertPersonPostBodyPersonAdditionalDetails
        ):
        ...
        if isinstance(self.social, Unset):
            social = UNSET
        elif isinstance(self.social, PersonInsertPersonPostBodySocialMedia):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        status = PersonInsertPersonPostBodyStatus(d.pop("status"))

        gender = PersonInsertPersonPostBodyGender(d.pop("gender"))
        ...
        def _parse_additional_names(
            data: object,
        ) -> Union["PersonInsertPersonPostBodyAdditionalNamesType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                additional_names_type_0 = (
                    PersonInsertPersonPostBodyAdditionalNamesType0.from_dict(data)
                )
        ...
        def _parse_additional_details(
            data: object,
        ) -> Union["PersonInsertPersonPostBodyPersonAdditionalDetails", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                additional_details_type_0 = (
                    PersonInsertPersonPostBodyPersonAdditionalDetails.from_dict(data)
                )
        ...
        def _parse_social(
            data: object,
        ) -> Union["PersonInsertPersonPostBodySocialMedia", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                social_type_0 = PersonInsertPersonPostBodySocialMedia.from_dict(data)

                return social_type_0
            except:  # noqa: E722
                pass
            return cast(
                Union["PersonInsertPersonPostBodySocialMedia", None, Unset], data
            )
        ...
        def _parse_historical_names(
            data: object,
        ) -> Union[None, Unset, list["PersonInsertPersonPostBodyPersonHistoricalName"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for historical_names_type_0_item_data in _historical_names_type_0:
                    historical_names_type_0_item = (
                        PersonInsertPersonPostBodyPersonHistoricalName.from_dict(
        ...
        person_insert_person_post_body = cls(
            status=status,
            gender=gender,
        ...
        return person_insert_person_post_body
