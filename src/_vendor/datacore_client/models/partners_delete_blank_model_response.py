...
if TYPE_CHECKING:
    from ..models.blank_model_model import BlankModelModel
...
T = TypeVar("T", bound="PartnersDeleteBlankModelResponse")


@_attrs_define
class PartnersDeleteBlankModelResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = BlankModelModel.from_dict(data_item_data)

            data.append(data_item)

        partners_delete_blank_model_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        partners_delete_blank_model_response.additional_properties = d
        return partners_delete_blank_model_response
