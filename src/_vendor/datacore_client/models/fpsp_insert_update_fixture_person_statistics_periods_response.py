...
T = TypeVar("T", bound="FpspInsertUpdateFixturePersonStatisticsPeriodsResponse")


@_attrs_define
class FpspInsertUpdateFixturePersonStatisticsPeriodsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fpsp_insert_update_fixture_person_statistics_periods_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fpsp_insert_update_fixture_person_statistics_periods_response.additional_properties = (
            d
        )
        return fpsp_insert_update_fixture_person_statistics_periods_response
