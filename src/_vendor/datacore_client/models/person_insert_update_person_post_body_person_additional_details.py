...
from ..models.person_insert_update_person_post_body_person_additional_details_dominant_foot import (
    PersonInsertUpdatePersonPostBodyPersonAdditionalDetailsDominantFoot,
)
from ..models.person_insert_update_person_post_body_person_additional_details_dominant_hand import (
    PersonInsertUpdatePersonPostBodyPersonAdditionalDetailsDominantHand,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PersonInsertUpdatePersonPostBodyPersonAdditionalDetails")


@_attrs_define
class PersonInsertUpdatePersonPostBodyPersonAdditionalDetails:
    ...
    Attributes:
        ...
        dominant_hand (Union[Unset, PersonInsertUpdatePersonPostBodyPersonAdditionalDetailsDominantHand]): Dominant hand
        dominant_foot (Union[Unset, PersonInsertUpdatePersonPostBodyPersonAdditionalDetailsDominantFoot]): Dominant foot
    ...
    dominant_hand: Union[
        Unset, PersonInsertUpdatePersonPostBodyPersonAdditionalDetailsDominantHand
    ] = UNSET
    dominant_foot: Union[
        Unset, PersonInsertUpdatePersonPostBodyPersonAdditionalDetailsDominantFoot
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_insert_update_person_post_body_person_additional_details = cls(
            height=height,
        ...
        return person_insert_update_person_post_body_person_additional_details
