...
if TYPE_CHECKING:
    from ..models.person_model_additional_names_type_0_additional_property import (
        PersonModelAdditionalNamesType0AdditionalProperty,
    )


T = TypeVar("T", bound="PersonModelAdditionalNamesType0")


@_attrs_define
class PersonModelAdditionalNamesType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        person_model_additional_names_type_0 = cls()
