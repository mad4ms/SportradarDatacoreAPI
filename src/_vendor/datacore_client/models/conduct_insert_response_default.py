...
T = TypeVar("T", bound="ConductInsertResponseDefault")


@_attrs_define
class ConductInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conduct_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        conduct_insert_response_default.additional_properties = d
        return conduct_insert_response_default
