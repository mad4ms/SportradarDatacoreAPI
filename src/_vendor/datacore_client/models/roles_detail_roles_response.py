...
T = TypeVar("T", bound="RolesDetailRolesResponse")


@_attrs_define
class RolesDetailRolesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roles_detail_roles_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        roles_detail_roles_response.additional_properties = d
        return roles_detail_roles_response
