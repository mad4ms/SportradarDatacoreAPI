...
T = TypeVar("T", bound="StandingDeleteResponseDefault")


@_attrs_define
class StandingDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        standing_delete_response_default.additional_properties = d
        return standing_delete_response_default
