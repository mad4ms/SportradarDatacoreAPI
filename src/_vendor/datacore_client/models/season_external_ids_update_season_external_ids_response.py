...
T = TypeVar("T", bound="SeasonExternalIdsUpdateSeasonExternalIdsResponse")


@_attrs_define
class SeasonExternalIdsUpdateSeasonExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_external_ids_update_season_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_external_ids_update_season_external_ids_response.additional_properties = (
            d
        )
        return season_external_ids_update_season_external_ids_response
