...
T = TypeVar("T", bound="ConferenceInsertResponseDefault")


@_attrs_define
class ConferenceInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        conference_insert_response_default.additional_properties = d
        return conference_insert_response_default
