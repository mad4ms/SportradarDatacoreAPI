...
T = TypeVar("T", bound="SeasonStageListResponseDefault")


@_attrs_define
class SeasonStageListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_stage_list_response_default = cls(
            meta=meta,
            error=error,
        )

        season_stage_list_response_default.additional_properties = d
        return season_stage_list_response_default
