...
T = TypeVar("T", bound="PersonModelPersonHistoricalName")


@_attrs_define
class PersonModelPersonHistoricalName:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_model_person_historical_name = cls(
        ...
        return person_model_person_historical_name
