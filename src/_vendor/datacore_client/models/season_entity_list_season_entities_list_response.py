...
T = TypeVar("T", bound="SeasonEntityListSeasonEntitiesListResponse")


@_attrs_define
class SeasonEntityListSeasonEntitiesListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_entity_list_season_entities_list_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_entity_list_season_entities_list_response.additional_properties = d
        return season_entity_list_season_entities_list_response
