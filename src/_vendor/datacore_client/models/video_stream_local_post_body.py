...
from ..models.video_stream_local_post_body_format import VideoStreamLocalPostBodyFormat
from ..types import UNSET, Unset

T = TypeVar("T", bound="VideoStreamLocalPostBody")


@_attrs_define
class VideoStreamLocalPostBody:
    """
    Attributes:
        ...
        format_ (Union[Unset, VideoStreamLocalPostBodyFormat]): The format of the video file
            >- `HLS` A HLS play list
            >- `MP4` One MP4 file
             Example: HLS.
    """
    ...
    format_: Union[Unset, VideoStreamLocalPostBodyFormat] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        format_: Union[Unset, VideoStreamLocalPostBodyFormat]
        if isinstance(_format_, Unset):
            format_ = UNSET
        else:
            format_ = VideoStreamLocalPostBodyFormat(_format_)

        video_stream_local_post_body = cls(
            url=url,
            url_id=url_id,
        ...
        return video_stream_local_post_body
