...
T = TypeVar("T", bound="FlsListResponseDefault")


@_attrs_define
class FlsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fls_list_response_default = cls(
            meta=meta,
            error=error,
        )

        fls_list_response_default.additional_properties = d
        return fls_list_response_default
