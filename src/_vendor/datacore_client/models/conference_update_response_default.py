...
T = TypeVar("T", bound="ConferenceUpdateResponseDefault")


@_attrs_define
class ConferenceUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_update_response_default = cls(
            meta=meta,
            error=error,
        )

        conference_update_response_default.additional_properties = d
        return conference_update_response_default
