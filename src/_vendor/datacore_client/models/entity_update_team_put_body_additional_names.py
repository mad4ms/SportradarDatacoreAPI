...
T = TypeVar("T", bound="EntityUpdateTeamPutBodyAdditionalNames")


@_attrs_define
class EntityUpdateTeamPutBodyAdditionalNames:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_update_team_put_body_additional_names = cls(
        ...
        entity_update_team_put_body_additional_names.additional_properties = d
        return entity_update_team_put_body_additional_names
