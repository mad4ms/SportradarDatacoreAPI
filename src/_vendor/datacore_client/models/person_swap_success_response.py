...
T = TypeVar("T", bound="PersonSwapSuccessResponse")


@_attrs_define
class PersonSwapSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_swap_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        person_swap_success_response.additional_properties = d
        return person_swap_success_response
