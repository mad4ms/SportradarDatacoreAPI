...
T = TypeVar(
    "T", bound="PersonInsertUpdatePersonPostBodyAdditionalNamesType0AdditionalProperty"
)


@_attrs_define
class PersonInsertUpdatePersonPostBodyAdditionalNamesType0AdditionalProperty:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_insert_update_person_post_body_additional_names_type_0_additional_property = cls(
            display=display,
        ...
        return person_insert_update_person_post_body_additional_names_type_0_additional_property
