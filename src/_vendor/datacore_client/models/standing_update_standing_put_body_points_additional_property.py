...
T = TypeVar("T", bound="StandingUpdateStandingPutBodyPointsAdditionalProperty")


@_attrs_define
class StandingUpdateStandingPutBodyPointsAdditionalProperty:
    """Type of points
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_update_standing_put_body_points_additional_property = cls(
        ...
        return standing_update_standing_put_body_points_additional_property
