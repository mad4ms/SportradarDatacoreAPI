...
from ..models.match_team_period_statistics_model_organization_resource_type import (
    MatchTeamPeriodStatisticsModelOrganizationResourceType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="MatchTeamPeriodStatisticsModelOrganization")


@_attrs_define
class MatchTeamPeriodStatisticsModelOrganization:
    """The organization that this match team period statistics belongs to
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        match_team_period_statistics_model_organization = cls(
            resource_type=resource_type,
            id=id,
        )

        match_team_period_statistics_model_organization.additional_properties = d
        return match_team_period_statistics_model_organization
