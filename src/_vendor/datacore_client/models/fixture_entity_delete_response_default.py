...
T = TypeVar("T", bound="FixtureEntityDeleteResponseDefault")


@_attrs_define
class FixtureEntityDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_entity_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_entity_delete_response_default.additional_properties = d
        return fixture_entity_delete_response_default
