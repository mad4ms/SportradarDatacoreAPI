...
T = TypeVar("T", bound="SeasonTeamBaseStatisticsModelStatistics")


@_attrs_define
class SeasonTeamBaseStatisticsModelStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_team_base_statistics_model_statistics = cls(
            assists=assists,
        ...
        return season_team_base_statistics_model_statistics
