...
T = TypeVar("T", bound="ImagesInsertOrganizationFromUrlImagesResponse")


@_attrs_define
class ImagesInsertOrganizationFromUrlImagesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = ImagesModel.from_dict(data_item_data)

            data.append(data_item)

        images_insert_organization_from_url_images_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        images_insert_organization_from_url_images_response.additional_properties = d
        return images_insert_organization_from_url_images_response
