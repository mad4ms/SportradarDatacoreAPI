...
T = TypeVar("T", bound="GameLogPersonResponse")


@_attrs_define
class GameLogPersonResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        game_log_person_response.additional_properties = d
        return game_log_person_response
