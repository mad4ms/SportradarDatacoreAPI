...
T = TypeVar("T", bound="FpspDeleteAllFixturePersonStatisticsPeriodsResponse")


@_attrs_define
class FpspDeleteAllFixturePersonStatisticsPeriodsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fpsp_delete_all_fixture_person_statistics_periods_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fpsp_delete_all_fixture_person_statistics_periods_response.additional_properties = (
            d
        )
        return fpsp_delete_all_fixture_person_statistics_periods_response
