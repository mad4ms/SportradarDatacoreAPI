...
T = TypeVar("T", bound="HeadToHeadListFixturesMulitpleCompetitionsResponseDefault")


@_attrs_define
class HeadToHeadListFixturesMulitpleCompetitionsResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        head_to_head_list_fixtures_mulitple_competitions_response_default = cls(
            meta=meta,
            error=error,
        )
