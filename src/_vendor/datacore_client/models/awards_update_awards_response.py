...
T = TypeVar("T", bound="AwardsUpdateAwardsResponse")


@_attrs_define
class AwardsUpdateAwardsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        awards_update_awards_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        awards_update_awards_response.additional_properties = d
        return awards_update_awards_response
