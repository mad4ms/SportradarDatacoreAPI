...
T = TypeVar("T", bound="EntityUpdateTeamPutBodyColors")


@_attrs_define
class EntityUpdateTeamPutBodyColors:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_update_team_put_body_colors = cls(
            primary=primary,
            secondary=secondary,
            tertiary=tertiary,
        )

        entity_update_team_put_body_colors.additional_properties = d
        return entity_update_team_put_body_colors
