...
if TYPE_CHECKING:
    ...
    from ..models.match_external_ids_model import MatchExternalIdsModel
    from ..models.response_links import ResponseLinks
    from ..models.response_meta_data import ResponseMetaData


T = TypeVar("T", bound="FixtureExternalIdsInsertUpdateFixtureExternalIdsResponse")


@_attrs_define
class FixtureExternalIdsInsertUpdateFixtureExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = MatchExternalIdsModel.from_dict(data_item_data)

            data.append(data_item)

        fixture_external_ids_insert_update_fixture_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_external_ids_insert_update_fixture_external_ids_response.additional_properties = (
            d
        )
        return fixture_external_ids_insert_update_fixture_external_ids_response
