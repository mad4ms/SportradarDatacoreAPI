...
T = TypeVar("T", bound="EntityListEntitiesResponse")


@_attrs_define
class EntityListEntitiesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_list_entities_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_list_entities_response.additional_properties = d
        return entity_list_entities_response
