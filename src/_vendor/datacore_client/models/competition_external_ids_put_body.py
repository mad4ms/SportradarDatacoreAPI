...
T = TypeVar("T", bound="CompetitionExternalIdsPutBody")


@_attrs_define
class CompetitionExternalIdsPutBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_external_ids_put_body = cls(
        ...
        return competition_external_ids_put_body
