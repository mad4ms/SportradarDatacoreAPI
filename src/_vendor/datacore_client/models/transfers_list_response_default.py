...
T = TypeVar("T", bound="TransfersListResponseDefault")


@_attrs_define
class TransfersListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfers_list_response_default = cls(
            meta=meta,
            error=error,
        )

        transfers_list_response_default.additional_properties = d
        return transfers_list_response_default
