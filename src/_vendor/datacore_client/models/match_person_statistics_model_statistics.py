...
T = TypeVar("T", bound="MatchPersonStatisticsModelStatistics")


@_attrs_define
class MatchPersonStatisticsModelStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        match_person_statistics_model_statistics = cls(
        ...
        return match_person_statistics_model_statistics
