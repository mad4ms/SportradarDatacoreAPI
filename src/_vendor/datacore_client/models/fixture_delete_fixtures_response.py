...
T = TypeVar("T", bound="FixtureDeleteFixturesResponse")


@_attrs_define
class FixtureDeleteFixturesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_delete_fixtures_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_delete_fixtures_response.additional_properties = d
        return fixture_delete_fixtures_response
