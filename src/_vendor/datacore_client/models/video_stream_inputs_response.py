...
T = TypeVar("T", bound="VideoStreamInputsResponse")


@_attrs_define
class VideoStreamInputsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        video_stream_inputs_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        video_stream_inputs_response.additional_properties = d
        return video_stream_inputs_response
