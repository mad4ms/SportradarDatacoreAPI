...
T = TypeVar("T", bound="FesInsertUpdateResponseDefault")


@_attrs_define
class FesInsertUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fes_insert_update_response_default = cls(
            meta=meta,
            error=error,
        )

        fes_insert_update_response_default.additional_properties = d
        return fes_insert_update_response_default
