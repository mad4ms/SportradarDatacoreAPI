...
T = TypeVar("T", bound="PersonInsertUpdatePersonPostBodySocialMedia")


@_attrs_define
class PersonInsertUpdatePersonPostBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_insert_update_person_post_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return person_insert_update_person_post_body_social_media
