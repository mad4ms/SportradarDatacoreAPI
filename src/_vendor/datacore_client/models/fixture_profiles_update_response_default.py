...
T = TypeVar("T", bound="FixtureProfilesUpdateResponseDefault")


@_attrs_define
class FixtureProfilesUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_profiles_update_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_profiles_update_response_default.additional_properties = d
        return fixture_profiles_update_response_default
