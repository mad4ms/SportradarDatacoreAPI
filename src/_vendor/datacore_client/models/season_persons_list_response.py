...
T = TypeVar("T", bound="SeasonPersonsListResponse")


@_attrs_define
class SeasonPersonsListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_persons_list_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_persons_list_response.additional_properties = d
        return season_persons_list_response
