...
T = TypeVar("T", bound="FpspListperiodliveResponseDefault")


@_attrs_define
class FpspListperiodliveResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fpsp_listperiodlive_response_default = cls(
            meta=meta,
            error=error,
        )

        fpsp_listperiodlive_response_default.additional_properties = d
        return fpsp_listperiodlive_response_default
