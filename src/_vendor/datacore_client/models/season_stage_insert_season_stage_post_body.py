...
T = TypeVar("T", bound="SeasonStageInsertSeasonStagePostBody")


@_attrs_define
class SeasonStageInsertSeasonStagePostBody:
    """
    Attributes:
        season_id (UUID): The unique identifier of the season Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        stage_code (str): A unique code for the stage. (Unique for season) Example: ST1.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_stage_insert_season_stage_post_body = cls(
            season_id=season_id,
        ...
        return season_stage_insert_season_stage_post_body
