...
T = TypeVar("T", bound="VenueListResponseDefault")


@_attrs_define
class VenueListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_list_response_default = cls(
            meta=meta,
            error=error,
        )

        venue_list_response_default.additional_properties = d
        return venue_list_response_default
