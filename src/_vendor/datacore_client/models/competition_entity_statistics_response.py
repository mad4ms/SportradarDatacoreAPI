...
T = TypeVar("T", bound="CompetitionEntityStatisticsResponse")


@_attrs_define
class CompetitionEntityStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_entity_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        competition_entity_statistics_response.additional_properties = d
        return competition_entity_statistics_response
