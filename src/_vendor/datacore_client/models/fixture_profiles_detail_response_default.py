...
T = TypeVar("T", bound="FixtureProfilesDetailResponseDefault")


@_attrs_define
class FixtureProfilesDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_profiles_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_profiles_detail_response_default.additional_properties = d
        return fixture_profiles_detail_response_default
