...
T = TypeVar("T", bound="EntitySwapResponseDefault")


@_attrs_define
class EntitySwapResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_swap_response_default = cls(
            meta=meta,
            error=error,
        )

        entity_swap_response_default.additional_properties = d
        return entity_swap_response_default
