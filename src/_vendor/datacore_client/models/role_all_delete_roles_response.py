...
T = TypeVar("T", bound="RoleAllDeleteRolesResponse")


@_attrs_define
class RoleAllDeleteRolesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role_all_delete_roles_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        role_all_delete_roles_response.additional_properties = d
        return role_all_delete_roles_response
