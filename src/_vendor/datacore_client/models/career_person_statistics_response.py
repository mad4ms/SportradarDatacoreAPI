...
T = TypeVar("T", bound="CareerPersonStatisticsResponse")


@_attrs_define
class CareerPersonStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        career_person_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        career_person_statistics_response.additional_properties = d
        return career_person_statistics_response
