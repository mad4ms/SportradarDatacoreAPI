...
T = TypeVar("T", bound="PartnersPostResponseDefault")


@_attrs_define
class PartnersPostResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        partners_post_response_default = cls(
            meta=meta,
            error=error,
        )

        partners_post_response_default.additional_properties = d
        return partners_post_response_default
