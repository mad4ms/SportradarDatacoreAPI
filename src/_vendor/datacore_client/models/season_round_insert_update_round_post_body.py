...
T = TypeVar("T", bound="SeasonRoundInsertUpdateRoundPostBody")


@_attrs_define
class SeasonRoundInsertUpdateRoundPostBody:
    """
    Attributes:
        season_id (UUID): The unique identifier of the season Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        round_code (str): A unique code for the round. (Unique for season) Example: RN1.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_round_insert_update_round_post_body = cls(
            season_id=season_id,
        ...
        return season_round_insert_update_round_post_body
