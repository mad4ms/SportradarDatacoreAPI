...
from ..models.person_additional_details_dominant_foot import PersonAdditionalDetailsDominantFoot
from ..models.person_additional_details_dominant_hand import PersonAdditionalDetailsDominantHand
from ..types import UNSET, Unset

T = TypeVar("T", bound="PersonAdditionalDetails")
...
class PersonAdditionalDetails:
    ...
    Attributes:
        ...
        dominant_hand (Union[Unset, PersonAdditionalDetailsDominantHand]): Dominant hand
        dominant_foot (Union[Unset, PersonAdditionalDetailsDominantFoot]): Dominant foot
    ...
    dominant_hand: Union[Unset, PersonAdditionalDetailsDominantHand] = UNSET
    dominant_foot: Union[Unset, PersonAdditionalDetailsDominantFoot] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dominant_hand: Union[Unset, PersonAdditionalDetailsDominantHand]
        if isinstance(_dominant_hand, Unset):
            dominant_hand = UNSET
        else:
            dominant_hand = PersonAdditionalDetailsDominantHand(_dominant_hand)

        _dominant_foot = d.pop("dominantFoot", UNSET)
        dominant_foot: Union[Unset, PersonAdditionalDetailsDominantFoot]
        if isinstance(_dominant_foot, Unset):
            dominant_foot = UNSET
        else:
            dominant_foot = PersonAdditionalDetailsDominantFoot(_dominant_foot)
        ...
        return person_additional_details
