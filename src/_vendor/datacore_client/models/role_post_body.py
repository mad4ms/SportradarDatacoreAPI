...
from ..models.role_post_body_role import RolePostBodyRole
from ..models.role_post_body_status import RolePostBodyStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="RolePostBody")
...
class RolePostBody:
    ...
    Attributes:
        ...
        person_id (Union[Unset, UUID]): The unique identifier of the person Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        status (Union[Unset, RolePostBodyStatus]): Status
            >- `ACTIVE` Active
            >- `INACTIVE` Inactive
            >- `PENDING` Pending
             Example: ACTIVE.
    ...
    status: Union[Unset, RolePostBodyStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        role = RolePostBodyRole(d.pop("role"))
        ...
        status: Union[Unset, RolePostBodyStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = RolePostBodyStatus(_status)
