...
if TYPE_CHECKING:
    ...
    from ..models.seasonteam_placings_model import SEASONTEAMPlacingsModel


T = TypeVar("T", bound="SepDeleteSeasonEntityPlacingsResponse")


@_attrs_define
class SepDeleteSeasonEntityPlacingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SEASONTEAMPlacingsModel.from_dict(data_item_data)

            data.append(data_item)

        sep_delete_season_entity_placings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        sep_delete_season_entity_placings_response.additional_properties = d
        return sep_delete_season_entity_placings_response
