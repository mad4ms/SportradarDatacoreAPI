...
T = TypeVar("T", bound="EntityInsertResponseDefault")


@_attrs_define
class EntityInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        entity_insert_response_default.additional_properties = d
        return entity_insert_response_default
