...
T = TypeVar("T", bound="FespInsertUpdateFixtureEntityStatisticsPeriodsResponse")


@_attrs_define
class FespInsertUpdateFixtureEntityStatisticsPeriodsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fesp_insert_update_fixture_entity_statistics_periods_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fesp_insert_update_fixture_entity_statistics_periods_response.additional_properties = (
            d
        )
        return fesp_insert_update_fixture_entity_statistics_periods_response
