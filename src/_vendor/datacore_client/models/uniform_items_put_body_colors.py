...
T = TypeVar("T", bound="UniformItemsPutBodyColors")


@_attrs_define
class UniformItemsPutBodyColors:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniform_items_put_body_colors = cls(
            lettering=lettering,
            primary=primary,
            secondary=secondary,
            tertiary=tertiary,
        ...
        uniform_items_put_body_colors.additional_properties = d
        return uniform_items_put_body_colors
