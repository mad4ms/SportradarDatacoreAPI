...
T = TypeVar("T", bound="SeasonSeriesListSeasonSeriesResponse")


@_attrs_define
class SeasonSeriesListSeasonSeriesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_series_list_season_series_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_series_list_season_series_response.additional_properties = d
        return season_series_list_season_series_response
