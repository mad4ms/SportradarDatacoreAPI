...
T = TypeVar("T", bound="FixtureProgressionsInsertFixtureProgressionPostBody")


@_attrs_define
class FixtureProgressionsInsertFixtureProgressionPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_progressions_insert_fixture_progression_post_body = cls(
        ...
        return fixture_progressions_insert_fixture_progression_post_body
