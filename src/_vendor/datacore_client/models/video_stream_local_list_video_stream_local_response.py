...
T = TypeVar("T", bound="VideoStreamLocalListVideoStreamLocalResponse")


@_attrs_define
class VideoStreamLocalListVideoStreamLocalResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        video_stream_local_list_video_stream_local_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        video_stream_local_list_video_stream_local_response.additional_properties = d
        return video_stream_local_list_video_stream_local_response
