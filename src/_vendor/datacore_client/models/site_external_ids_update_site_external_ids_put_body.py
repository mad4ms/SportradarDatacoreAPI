...
T = TypeVar("T", bound="SiteExternalIdsUpdateSiteExternalIdsPutBody")


@_attrs_define
class SiteExternalIdsUpdateSiteExternalIdsPutBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_external_ids_update_site_external_ids_put_body = cls(
            site_id=site_id,
            source=source,
        ...
        return site_external_ids_update_site_external_ids_put_body
