...
T = TypeVar("T", bound="ChangeLogListResponseDefault")


@_attrs_define
class ChangeLogListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        change_log_list_response_default = cls(
            meta=meta,
            error=error,
        )

        change_log_list_response_default.additional_properties = d
        return change_log_list_response_default
