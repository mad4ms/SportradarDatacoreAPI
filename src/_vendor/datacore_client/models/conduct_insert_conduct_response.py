...
T = TypeVar("T", bound="ConductInsertConductResponse")


@_attrs_define
class ConductInsertConductResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conduct_insert_conduct_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        conduct_insert_conduct_response.additional_properties = d
        return conduct_insert_conduct_response
