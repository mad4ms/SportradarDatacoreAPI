...
T = TypeVar("T", bound="FixtureTriggerEmrMergeSuccessResponse")


@_attrs_define
class FixtureTriggerEmrMergeSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_trigger_emr_merge_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_trigger_emr_merge_success_response.additional_properties = d
        return fixture_trigger_emr_merge_success_response
