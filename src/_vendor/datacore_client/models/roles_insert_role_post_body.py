...
from ..models.roles_insert_role_post_body_role import RolesInsertRolePostBodyRole
from ..models.roles_insert_role_post_body_status import RolesInsertRolePostBodyStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="RolesInsertRolePostBody")


@_attrs_define
class RolesInsertRolePostBody:
    """
    Attributes:
        role (RolesInsertRolePostBodyRole): Role
        ...
        person_id (Union[Unset, UUID]): The unique identifier of the person Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        status (Union[Unset, RolesInsertRolePostBodyStatus]): Status
            >- `ACTIVE` Active
            >- `INACTIVE` Inactive
            >- `PENDING` Pending
             Example: ACTIVE.
    ...
    role: RolesInsertRolePostBodyRole
    ...
    status: Union[Unset, RolesInsertRolePostBodyStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        role = RolesInsertRolePostBodyRole(d.pop("role"))
        ...
        status: Union[Unset, RolesInsertRolePostBodyStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = RolesInsertRolePostBodyStatus(_status)
        ...
        roles_insert_role_post_body = cls(
            role=role,
            role_id=role_id,
        ...
        return roles_insert_role_post_body
