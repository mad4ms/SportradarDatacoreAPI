...
T = TypeVar("T", bound="DivisionInsertDivisionsResponse")


@_attrs_define
class DivisionInsertDivisionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        division_insert_divisions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        division_insert_divisions_response.additional_properties = d
        return division_insert_divisions_response
