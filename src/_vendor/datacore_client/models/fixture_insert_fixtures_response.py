...
T = TypeVar("T", bound="FixtureInsertFixturesResponse")


@_attrs_define
class FixtureInsertFixturesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_insert_fixtures_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_insert_fixtures_response.additional_properties = d
        return fixture_insert_fixtures_response
