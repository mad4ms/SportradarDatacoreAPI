...
T = TypeVar("T", bound="SeasonSeriesResponse")


@_attrs_define
class SeasonSeriesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_series_response.additional_properties = d
        return season_series_response
