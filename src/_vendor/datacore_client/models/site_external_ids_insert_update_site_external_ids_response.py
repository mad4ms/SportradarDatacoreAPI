...
if TYPE_CHECKING:
    ...
    from ..models.site_external_ids_model import SiteExternalIdsModel


T = TypeVar("T", bound="SiteExternalIdsInsertUpdateSiteExternalIdsResponse")


@_attrs_define
class SiteExternalIdsInsertUpdateSiteExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SiteExternalIdsModel.from_dict(data_item_data)

            data.append(data_item)

        site_external_ids_insert_update_site_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        site_external_ids_insert_update_site_external_ids_response.additional_properties = (
            d
        )
        return site_external_ids_insert_update_site_external_ids_response
