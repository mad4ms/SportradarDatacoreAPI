...
T = TypeVar("T", bound="EntityDeleteResponseDefault")


@_attrs_define
class EntityDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        entity_delete_response_default.additional_properties = d
        return entity_delete_response_default
