...
T = TypeVar("T", bound="SeasonListSeasonsResponse")


@_attrs_define
class SeasonListSeasonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_list_seasons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_list_seasons_response.additional_properties = d
        return season_list_seasons_response
