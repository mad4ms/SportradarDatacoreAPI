...
T = TypeVar("T", bound="VenueDetailVenuesResponse")


@_attrs_define
class VenueDetailVenuesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_detail_venues_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        venue_detail_venues_response.additional_properties = d
        return venue_detail_venues_response
