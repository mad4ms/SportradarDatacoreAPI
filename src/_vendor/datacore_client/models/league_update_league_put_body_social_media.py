...
T = TypeVar("T", bound="LeagueUpdateLeaguePutBodySocialMedia")


@_attrs_define
class LeagueUpdateLeaguePutBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        league_update_league_put_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return league_update_league_put_body_social_media
