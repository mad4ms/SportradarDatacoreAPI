...
T = TypeVar("T", bound="FixturePbpExternalListLiveFixturePbpExternalResponse")


@_attrs_define
class FixturePbpExternalListLiveFixturePbpExternalResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_pbp_external_list_live_fixture_pbp_external_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_pbp_external_list_live_fixture_pbp_external_response.additional_properties = d
        return fixture_pbp_external_list_live_fixture_pbp_external_response
