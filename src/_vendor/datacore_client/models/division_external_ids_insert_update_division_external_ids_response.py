...
if TYPE_CHECKING:
    from ..models.division_external_ids_model import DivisionExternalIdsModel
...
T = TypeVar("T", bound="DivisionExternalIdsInsertUpdateDivisionExternalIdsResponse")


@_attrs_define
class DivisionExternalIdsInsertUpdateDivisionExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = DivisionExternalIdsModel.from_dict(data_item_data)

            data.append(data_item)

        division_external_ids_insert_update_division_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        division_external_ids_insert_update_division_external_ids_response.additional_properties = (
            d
        )
        return division_external_ids_insert_update_division_external_ids_response
