...
if TYPE_CHECKING:
    ...
    from ..models.league_external_ids_model import LeagueExternalIdsModel
    from ..models.response_links import ResponseLinks
    from ..models.response_meta_data import ResponseMetaData


T = TypeVar("T", bound="LeagueExternalIdsInsertUpdateLeagueExternalIdsResponse")


@_attrs_define
class LeagueExternalIdsInsertUpdateLeagueExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = LeagueExternalIdsModel.from_dict(data_item_data)

            data.append(data_item)

        league_external_ids_insert_update_league_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        league_external_ids_insert_update_league_external_ids_response.additional_properties = (
            d
        )
        return league_external_ids_insert_update_league_external_ids_response
