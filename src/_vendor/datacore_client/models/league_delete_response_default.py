...
T = TypeVar("T", bound="LeagueDeleteResponseDefault")


@_attrs_define
class LeagueDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        league_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        league_delete_response_default.additional_properties = d
        return league_delete_response_default
