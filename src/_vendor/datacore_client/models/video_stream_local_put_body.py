...
from ..models.video_stream_local_put_body_format import VideoStreamLocalPutBodyFormat
from ..types import UNSET, Unset

T = TypeVar("T", bound="VideoStreamLocalPutBody")


@_attrs_define
class VideoStreamLocalPutBody:
    """
    Attributes:
        ...
        format_ (Union[Unset, VideoStreamLocalPutBodyFormat]): The format of the video file
            >- `HLS` A HLS play list
            >- `MP4` One MP4 file
             Example: HLS.
    ...
    format_: Union[Unset, VideoStreamLocalPutBodyFormat] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        format_: Union[Unset, VideoStreamLocalPutBodyFormat]
        if isinstance(_format_, Unset):
            format_ = UNSET
        else:
            format_ = VideoStreamLocalPutBodyFormat(_format_)

        url = d.pop("url", UNSET)

        video_stream_local_put_body = cls(
        ...
        return video_stream_local_put_body
