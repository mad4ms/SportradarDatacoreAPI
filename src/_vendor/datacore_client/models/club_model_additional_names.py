...
T = TypeVar("T", bound="ClubModelAdditionalNames")


@_attrs_define
class ClubModelAdditionalNames:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        club_model_additional_names = cls(
        ...
        club_model_additional_names.additional_properties = d
        return club_model_additional_names
