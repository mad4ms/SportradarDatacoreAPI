...
from ..models.fixture_entities_insert_update_match_teams_post_body_result_status import (
    FixtureEntitiesInsertUpdateMatchTeamsPostBodyResultStatus,
)
from ..models.fixture_entities_insert_update_match_teams_post_body_roster_status import (
    FixtureEntitiesInsertUpdateMatchTeamsPostBodyRosterStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FixtureEntitiesInsertUpdateMatchTeamsPostBody")


@_attrs_define
class FixtureEntitiesInsertUpdateMatchTeamsPostBody:
    """
    Attributes:
        fixture_id (UUID): The unique identifier of the match Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        result_status (FixtureEntitiesInsertUpdateMatchTeamsPostBodyResultStatus): Result status
            >- `CONFIRMED` Confirmed
        ...
        include_in_representation (Union[Unset, bool]): Include this match in represented statistics? Default: True.
            Example: True.
        roster_status (Union[Unset, FixtureEntitiesInsertUpdateMatchTeamsPostBodyRosterStatus]): The status of the TEAM
            match teams
            >- `APPROVED` Approved
            >- `PENDING` Pending
            >- `REJECTED` Rejected
            >- `SUBMITTED` Submitted
            >- `UNKNOWN` Unknown
             Default: FixtureEntitiesInsertUpdateMatchTeamsPostBodyRosterStatus.UNKNOWN. Example: APPROVED.
    ...
    fixture_id: UUID
    result_status: FixtureEntitiesInsertUpdateMatchTeamsPostBodyResultStatus
    ...
    roster_status: Union[
        Unset, FixtureEntitiesInsertUpdateMatchTeamsPostBodyRosterStatus
    ] = FixtureEntitiesInsertUpdateMatchTeamsPostBodyRosterStatus.UNKNOWN
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_roster_status, Unset):
            ...
            roster_status = FixtureEntitiesInsertUpdateMatchTeamsPostBodyRosterStatus(
                _roster_status
            )
        ...
        fixture_entities_insert_update_match_teams_post_body = cls(
        ...
        return fixture_entities_insert_update_match_teams_post_body
