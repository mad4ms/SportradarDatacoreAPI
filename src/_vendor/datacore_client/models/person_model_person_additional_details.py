...
from ..models.person_model_person_additional_details_dominant_foot import (
    PersonModelPersonAdditionalDetailsDominantFoot,
)
from ..models.person_model_person_additional_details_dominant_hand import (
...
class PersonModelPersonAdditionalDetails:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_dominant_hand, Unset):
            ...
            dominant_hand = PersonModelPersonAdditionalDetailsDominantHand(
                _dominant_hand
            )
        ...
        if isinstance(_dominant_foot, Unset):
            ...
            dominant_foot = PersonModelPersonAdditionalDetailsDominantFoot(
                _dominant_foot
            )
