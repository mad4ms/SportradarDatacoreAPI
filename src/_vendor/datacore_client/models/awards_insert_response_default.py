...
T = TypeVar("T", bound="AwardsInsertResponseDefault")


@_attrs_define
class AwardsInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        awards_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        awards_insert_response_default.additional_properties = d
        return awards_insert_response_default
