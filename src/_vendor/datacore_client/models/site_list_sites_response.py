...
T = TypeVar("T", bound="SiteListSitesResponse")


@_attrs_define
class SiteListSitesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_list_sites_response.additional_properties = d
        return site_list_sites_response
