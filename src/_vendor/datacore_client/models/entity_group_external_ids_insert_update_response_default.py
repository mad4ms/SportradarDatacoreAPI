...
T = TypeVar("T", bound="EntityGroupExternalIdsInsertUpdateResponseDefault")


@_attrs_define
class EntityGroupExternalIdsInsertUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_external_ids_insert_update_response_default = cls(
            meta=meta,
            error=error,
        )
