...
class StandingConfigurationsModelStandingConfiguration:
    ...
    sorts: Union[
        Unset, list["StandingConfigurationsModelStandingConfigurationSorting"]
    ] = UNSET
    ...
    head_to_head_resolutions: Union[
        Unset,
        list["StandingConfigurationsModelStandingConfigurationHeadToHeadResolution"],
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for sorts_item_data in _sorts or []:
            sorts_item = (
                StandingConfigurationsModelStandingConfigurationSorting.from_dict(
                    sorts_item_data
                )
            )
        ...
        for head_to_head_identification_item_data in _head_to_head_identification or []:
            head_to_head_identification_item = StandingConfigurationsModelStandingConfigurationHeadToHeadIdentification.from_dict(
                head_to_head_identification_item_data
            )
        ...
        for head_to_head_identification_subsequent_item_data in (
            ...
            head_to_head_identification_subsequent_item = StandingConfigurationsModelStandingConfigurationHeadToHeadIdentificationForSubsequentChecks.from_dict(
                head_to_head_identification_subsequent_item_data
            )
        ...
        for head_to_head_resolutions_item_data in _head_to_head_resolutions or []:
            head_to_head_resolutions_item = StandingConfigurationsModelStandingConfigurationHeadToHeadResolution.from_dict(
        ...
        for head_to_head_resolutions_subsequent_item_data in (
            ...
            head_to_head_resolutions_subsequent_item = StandingConfigurationsModelStandingConfigurationHeadToHeadResolutionForExtraDepthH2Hs.from_dict(
                head_to_head_resolutions_subsequent_item_data
            )
