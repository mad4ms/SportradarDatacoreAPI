...
T = TypeVar("T", bound="SeasonUpdateSeasonPutBodySocialMedia")


@_attrs_define
class SeasonUpdateSeasonPutBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_update_season_put_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return season_update_season_put_body_social_media
