...
from ..models.uniform_items_insert_base_route_uniform_items_post_body_item_type import (
    UniformItemsInsertBaseRouteUniformItemsPostBodyItemType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.uniform_items_insert_base_route_uniform_items_post_body_colors import (
        UniformItemsInsertBaseRouteUniformItemsPostBodyColors,
    )


T = TypeVar("T", bound="UniformItemsInsertBaseRouteUniformItemsPostBody")


@_attrs_define
class UniformItemsInsertBaseRouteUniformItemsPostBody:
    """
    Attributes:
        uniform_id (UUID): The unique identifier of the uniform Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        item_type (UniformItemsInsertBaseRouteUniformItemsPostBodyItemType): The type of Uniform Item
            >- `BOTTOM` Bottom
        ...
        colors (Union[Unset, UniformItemsInsertBaseRouteUniformItemsPostBodyColors]):
    """

    uniform_id: UUID
    item_type: UniformItemsInsertBaseRouteUniformItemsPostBodyItemType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_colors, Unset):
            ...
            colors = UniformItemsInsertBaseRouteUniformItemsPostBodyColors.from_dict(
                _colors
            )

        uniform_items_insert_base_route_uniform_items_post_body = cls(
        ...
        return uniform_items_insert_base_route_uniform_items_post_body
