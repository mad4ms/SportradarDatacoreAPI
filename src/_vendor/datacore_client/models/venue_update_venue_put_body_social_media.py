...
T = TypeVar("T", bound="VenueUpdateVenuePutBodySocialMedia")


@_attrs_define
class VenueUpdateVenuePutBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_update_venue_put_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return venue_update_venue_put_body_social_media
