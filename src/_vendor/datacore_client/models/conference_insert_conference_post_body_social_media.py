...
T = TypeVar("T", bound="ConferenceInsertConferencePostBodySocialMedia")


@_attrs_define
class ConferenceInsertConferencePostBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_insert_conference_post_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return conference_insert_conference_post_body_social_media
