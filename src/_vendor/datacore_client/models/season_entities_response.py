...
T = TypeVar("T", bound="SeasonEntitiesResponse")


@_attrs_define
class SeasonEntitiesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_entities_response.additional_properties = d
        return season_entities_response
