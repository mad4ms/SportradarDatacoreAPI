...
T = TypeVar("T", bound="EntityExternalIdsUpdateTeamExternalIdsPutBody")


@_attrs_define
class EntityExternalIdsUpdateTeamExternalIdsPutBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_external_ids_update_team_external_ids_put_body = cls(
            entity_id=entity_id,
            source=source,
        ...
        return entity_external_ids_update_team_external_ids_put_body
