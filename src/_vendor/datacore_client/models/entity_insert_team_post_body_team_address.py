...
T = TypeVar("T", bound="EntityInsertTeamPostBodyTeamAddress")


@_attrs_define
class EntityInsertTeamPostBodyTeamAddress:
    """Street Address for the team
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_insert_team_post_body_team_address = cls(
            address1=address1,
            address2=address2,
            address3=address3,
            city=city,
        ...
        return entity_insert_team_post_body_team_address
