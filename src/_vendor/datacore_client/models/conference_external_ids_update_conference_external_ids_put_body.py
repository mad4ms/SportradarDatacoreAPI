...
T = TypeVar("T", bound="ConferenceExternalIdsUpdateConferenceExternalIdsPutBody")


@_attrs_define
class ConferenceExternalIdsUpdateConferenceExternalIdsPutBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_external_ids_update_conference_external_ids_put_body = cls(
        ...
        return conference_external_ids_update_conference_external_ids_put_body
