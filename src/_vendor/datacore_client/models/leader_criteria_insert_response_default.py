...
T = TypeVar("T", bound="LeaderCriteriaInsertResponseDefault")


@_attrs_define
class LeaderCriteriaInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        leader_criteria_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        leader_criteria_insert_response_default.additional_properties = d
        return leader_criteria_insert_response_default
