...
T = TypeVar("T", bound="FpspInsertUpdateMatchPersonStatisticsPeriodsPostBodyStatistics")


@_attrs_define
class FpspInsertUpdateMatchPersonStatisticsPeriodsPostBodyStatistics:
    """
    Attributes:
        ...
        minutes (Union[None, Unset, float, str]): Time in play (in ISO8601 Duration format); only available for
            goalkeepers
        minus (Union[None, Unset, int]): The number of goals conceded by the team while this player is on the field
        ...
        plus (Union[None, Unset, int]): The number of goals scored by the team while this player is on the field
        plus_minus (Union[Unset, int]): goals scored/conceded while this player is on the field
    ...
    minus: Union[None, Unset, int] = UNSET
    ...
    plus: Union[None, Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        minus: Union[None, Unset, int]
        if isinstance(self.minus, Unset):
            minus = UNSET
        else:
            minus = self.minus
        ...
        plus: Union[None, Unset, int]
        if isinstance(self.plus, Unset):
            plus = UNSET
        else:
            plus = self.plus
        ...
        if minus is not UNSET:
            field_dict["minus"] = minus
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_minus(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        minus = _parse_minus(d.pop("minus", UNSET))
        ...
        plus = _parse_plus(d.pop("plus", UNSET))
        ...
        fpsp_insert_update_match_person_statistics_periods_post_body_statistics = cls(
        ...
        return fpsp_insert_update_match_person_statistics_periods_post_body_statistics
