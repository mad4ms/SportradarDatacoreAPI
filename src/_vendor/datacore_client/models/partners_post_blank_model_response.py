...
T = TypeVar("T", bound="PartnersPostBlankModelResponse")


@_attrs_define
class PartnersPostBlankModelResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        partners_post_blank_model_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        partners_post_blank_model_response.additional_properties = d
        return partners_post_blank_model_response
