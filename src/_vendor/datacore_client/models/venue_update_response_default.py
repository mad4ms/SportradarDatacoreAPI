...
T = TypeVar("T", bound="VenueUpdateResponseDefault")


@_attrs_define
class VenueUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_update_response_default = cls(
            meta=meta,
            error=error,
        )

        venue_update_response_default.additional_properties = d
        return venue_update_response_default
