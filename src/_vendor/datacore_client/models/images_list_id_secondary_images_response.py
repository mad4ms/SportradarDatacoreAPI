...
T = TypeVar("T", bound="ImagesListIdSecondaryImagesResponse")


@_attrs_define
class ImagesListIdSecondaryImagesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_list_id_secondary_images_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        images_list_id_secondary_images_response.additional_properties = d
        return images_list_id_secondary_images_response
