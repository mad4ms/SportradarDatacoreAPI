...
T = TypeVar("T", bound="SeasonRoundUpdateResponseDefault")


@_attrs_define
class SeasonRoundUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_round_update_response_default = cls(
            meta=meta,
            error=error,
        )

        season_round_update_response_default.additional_properties = d
        return season_round_update_response_default
