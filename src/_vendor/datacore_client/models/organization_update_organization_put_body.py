...
from ..models.organization_update_organization_put_body_region_type import (
    OrganizationUpdateOrganizationPutBodyRegionType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="OrganizationUpdateOrganizationPutBody")


@_attrs_define
class OrganizationUpdateOrganizationPutBody:
    """
    Attributes:
        ...
        region_type (Union[Unset, OrganizationUpdateOrganizationPutBodyRegionType]): How geographically relevant is this
            organization
    ...
    region_type: Union[Unset, OrganizationUpdateOrganizationPutBodyRegionType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        region_type: Union[Unset, OrganizationUpdateOrganizationPutBodyRegionType]
        if isinstance(_region_type, Unset):
            region_type = UNSET
        else:
            region_type = OrganizationUpdateOrganizationPutBodyRegionType(_region_type)

        default_locale = d.pop("defaultLocale", UNSET)

        organization_update_organization_put_body = cls(
        ...
        return organization_update_organization_put_body
