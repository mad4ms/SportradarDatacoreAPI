...
from ..models.season_roster_post_body_position_type_1 import SeasonRosterPostBodyPositionType1
from ..models.season_roster_post_body_position_type_2_type_1 import SeasonRosterPostBodyPositionType2Type1
from ..models.season_roster_post_body_position_type_3_type_1 import SeasonRosterPostBodyPositionType3Type1
from ..models.season_roster_post_body_status import SeasonRosterPostBodyStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeasonRosterPostBody")


@_attrs_define
class SeasonRosterPostBody:
    """
    Attributes:
        status (SeasonRosterPostBodyStatus): Participation status
            >- `ACTIVE` Active
            >- `INJURED` Injured
        ...
        position (Union[None, SeasonRosterPostBodyPositionType1, SeasonRosterPostBodyPositionType2Type1,
            SeasonRosterPostBodyPositionType3Type1, Unset]): Playing position
            >- None None
            >- `CB` Center Backcourt
    ...
    status: SeasonRosterPostBodyStatus
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.position, Unset):
            position = UNSET
        elif isinstance(self.position, SeasonRosterPostBodyPositionType1):
            position = self.position.value
        elif isinstance(self.position, SeasonRosterPostBodyPositionType2Type1):
            position = self.position.value
        elif isinstance(self.position, SeasonRosterPostBodyPositionType3Type1):
            position = self.position.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        status = SeasonRosterPostBodyStatus(d.pop("status"))
        ...
        def _parse_position(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                position_type_1 = SeasonRosterPostBodyPositionType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                position_type_2_type_1 = SeasonRosterPostBodyPositionType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                position_type_3_type_1 = SeasonRosterPostBodyPositionType3Type1(data)
        ...
        return season_roster_post_body
