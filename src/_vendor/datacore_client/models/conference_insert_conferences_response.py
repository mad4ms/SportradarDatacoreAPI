...
T = TypeVar("T", bound="ConferenceInsertConferencesResponse")


@_attrs_define
class ConferenceInsertConferencesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_insert_conferences_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        conference_insert_conferences_response.additional_properties = d
        return conference_insert_conferences_response
