...
T = TypeVar("T", bound="StandingAdjustmentsDeleteStandingAdjustmentsResponse")


@_attrs_define
class StandingAdjustmentsDeleteStandingAdjustmentsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_adjustments_delete_standing_adjustments_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_adjustments_delete_standing_adjustments_response.additional_properties = (
            d
        )
        return standing_adjustments_delete_standing_adjustments_response
