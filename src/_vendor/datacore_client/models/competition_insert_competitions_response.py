...
T = TypeVar("T", bound="CompetitionInsertCompetitionsResponse")


@_attrs_define
class CompetitionInsertCompetitionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_insert_competitions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        competition_insert_competitions_response.additional_properties = d
        return competition_insert_competitions_response
