...
T = TypeVar("T", bound="SeasonDeleteResponseDefault")


@_attrs_define
class SeasonDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        season_delete_response_default.additional_properties = d
        return season_delete_response_default
