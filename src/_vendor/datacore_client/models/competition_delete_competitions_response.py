...
T = TypeVar("T", bound="CompetitionDeleteCompetitionsResponse")


@_attrs_define
class CompetitionDeleteCompetitionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_delete_competitions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        competition_delete_competitions_response.additional_properties = d
        return competition_delete_competitions_response
