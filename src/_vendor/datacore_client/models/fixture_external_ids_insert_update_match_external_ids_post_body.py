...
T = TypeVar("T", bound="FixtureExternalIdsInsertUpdateMatchExternalIdsPostBody")


@_attrs_define
class FixtureExternalIdsInsertUpdateMatchExternalIdsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_external_ids_insert_update_match_external_ids_post_body = cls(
            source=source,
        ...
        return fixture_external_ids_insert_update_match_external_ids_post_body
