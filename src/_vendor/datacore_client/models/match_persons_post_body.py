...
from ..models.match_persons_post_body_result_status import MatchPersonsPostBodyResultStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="MatchPersonsPostBody")


@_attrs_define
class MatchPersonsPostBody:
    """
    Attributes:
        ...
        result_status (MatchPersonsPostBodyResultStatus): Result status
            >- `CONFIRMED` Confirmed
    ...
    fixture_id: UUID
    person_id: UUID
    result_status: MatchPersonsPostBodyResultStatus
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        result_status = MatchPersonsPostBodyResultStatus(d.pop("resultStatus"))
        ...
        return match_persons_post_body
