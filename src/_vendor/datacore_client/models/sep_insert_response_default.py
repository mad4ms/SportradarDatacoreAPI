...
T = TypeVar("T", bound="SepInsertResponseDefault")


@_attrs_define
class SepInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sep_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        sep_insert_response_default.additional_properties = d
        return sep_insert_response_default
