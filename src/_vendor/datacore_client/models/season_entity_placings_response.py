...
T = TypeVar("T", bound="SeasonEntityPlacingsResponse")


@_attrs_define
class SeasonEntityPlacingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_entity_placings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_entity_placings_response.additional_properties = d
        return season_entity_placings_response
