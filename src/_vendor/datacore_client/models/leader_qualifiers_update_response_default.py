...
T = TypeVar("T", bound="LeaderQualifiersUpdateResponseDefault")


@_attrs_define
class LeaderQualifiersUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        leader_qualifiers_update_response_default = cls(
            meta=meta,
            error=error,
        )

        leader_qualifiers_update_response_default.additional_properties = d
        return leader_qualifiers_update_response_default
