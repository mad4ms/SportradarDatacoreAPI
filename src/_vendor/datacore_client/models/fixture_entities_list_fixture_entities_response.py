...
T = TypeVar("T", bound="FixtureEntitiesListFixtureEntitiesResponse")


@_attrs_define
class FixtureEntitiesListFixtureEntitiesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_entities_list_fixture_entities_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_entities_list_fixture_entities_response.additional_properties = d
        return fixture_entities_list_fixture_entities_response
