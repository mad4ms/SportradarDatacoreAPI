...
if TYPE_CHECKING:
    from ..models.award_model import AwardModel
...
T = TypeVar("T", bound="AwardsListNonFixturesAwardsResponse")


@_attrs_define
class AwardsListNonFixturesAwardsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = AwardModel.from_dict(data_item_data)

            data.append(data_item)

        awards_list_non_fixtures_awards_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        awards_list_non_fixtures_awards_response.additional_properties = d
        return awards_list_non_fixtures_awards_response
