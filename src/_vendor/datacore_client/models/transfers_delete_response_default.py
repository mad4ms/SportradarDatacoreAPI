...
T = TypeVar("T", bound="TransfersDeleteResponseDefault")


@_attrs_define
class TransfersDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfers_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        transfers_delete_response_default.additional_properties = d
        return transfers_delete_response_default
