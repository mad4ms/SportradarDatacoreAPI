...
T = TypeVar("T", bound="FixtureUpdateMatchPutBodySocialMedia")


@_attrs_define
class FixtureUpdateMatchPutBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_update_match_put_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return fixture_update_match_put_body_social_media
