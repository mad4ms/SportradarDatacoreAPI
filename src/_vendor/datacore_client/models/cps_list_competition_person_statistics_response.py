...
if TYPE_CHECKING:
    from ..models.competition_person_statistics_model import CompetitionPersonStatisticsModel
...
T = TypeVar("T", bound="CpsListCompetitionPersonStatisticsResponse")


@_attrs_define
class CpsListCompetitionPersonStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = CompetitionPersonStatisticsModel.from_dict(data_item_data)

            data.append(data_item)

        cps_list_competition_person_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        cps_list_competition_person_statistics_response.additional_properties = d
        return cps_list_competition_person_statistics_response
