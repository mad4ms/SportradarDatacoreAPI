...
T = TypeVar("T", bound="FixturePbpEventUpdateResponseDefault")


@_attrs_define
class FixturePbpEventUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_pbp_event_update_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_pbp_event_update_response_default.additional_properties = d
        return fixture_pbp_event_update_response_default
