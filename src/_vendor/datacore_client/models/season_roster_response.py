...
T = TypeVar("T", bound="SeasonRosterResponse")


@_attrs_define
class SeasonRosterResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_roster_response.additional_properties = d
        return season_roster_response
