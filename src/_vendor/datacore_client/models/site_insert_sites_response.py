...
T = TypeVar("T", bound="SiteInsertSitesResponse")


@_attrs_define
class SiteInsertSitesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_insert_sites_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        site_insert_sites_response.additional_properties = d
        return site_insert_sites_response
