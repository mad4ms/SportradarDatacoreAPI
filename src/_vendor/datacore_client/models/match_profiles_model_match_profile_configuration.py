...
from ..models.match_profiles_model_match_profile_configuration_match_roles_item import (
    MatchProfilesModelMatchProfileConfigurationMatchRolesItem,
)
from ..models.match_profiles_model_match_profile_configuration_type_of_cards_item import (
    MatchProfilesModelMatchProfileConfigurationTypeOfCardsItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="MatchProfilesModelMatchProfileConfiguration")


@_attrs_define
class MatchProfilesModelMatchProfileConfiguration:
    ...
    Attributes:
        ...
        type_of_cards (Union[Unset, list[MatchProfilesModelMatchProfileConfigurationTypeOfCardsItem]]): The type of
            cards allowed in this match.
        ...
        blue_card_seconds (Union[Unset, float]): The length (in seconds) a player leaves the field for when issued a
            blue card.
        match_roles (Union[Unset, list[MatchProfilesModelMatchProfileConfigurationMatchRolesItem]]): The official roles
    ...
    type_of_cards: Union[
        Unset, list[MatchProfilesModelMatchProfileConfigurationTypeOfCardsItem]
    ] = UNSET
    ...
    match_roles: Union[
        Unset, list[MatchProfilesModelMatchProfileConfigurationMatchRolesItem]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        match_profiles_model_match_profile_configuration = cls(
        ...
        return match_profiles_model_match_profile_configuration
