...
T = TypeVar("T", bound="SeasonVenueVideostreamEnableSuccessResponse")


@_attrs_define
class SeasonVenueVideostreamEnableSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_venue_videostream_enable_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_venue_videostream_enable_success_response.additional_properties = d
        return season_venue_videostream_enable_success_response
