...
T = TypeVar("T", bound="SeasonUpdateSeasonPutBodySeasonConfiguration")


@_attrs_define
class SeasonUpdateSeasonPutBodySeasonConfiguration:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_update_season_put_body_season_configuration = cls(
            period_break_duration=period_break_duration,
            half_time_duration=half_time_duration,
        )

        return season_update_season_put_body_season_configuration
