...
T = TypeVar("T", bound="EntityListByEntityGroupEntitiesResponse")


@_attrs_define
class EntityListByEntityGroupEntitiesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = TeamModel.from_dict(data_item_data)

            data.append(data_item)

        entity_list_by_entity_group_entities_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_list_by_entity_group_entities_response.additional_properties = d
        return entity_list_by_entity_group_entities_response
