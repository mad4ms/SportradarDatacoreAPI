...
T = TypeVar("T", bound="SiteDeleteSitesResponse")


@_attrs_define
class SiteDeleteSitesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SiteModel.from_dict(data_item_data)

            data.append(data_item)

        site_delete_sites_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        site_delete_sites_response.additional_properties = d
        return site_delete_sites_response
