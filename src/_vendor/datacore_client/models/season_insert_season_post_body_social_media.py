...
T = TypeVar("T", bound="SeasonInsertSeasonPostBodySocialMedia")


@_attrs_define
class SeasonInsertSeasonPostBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_insert_season_post_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return season_insert_season_post_body_social_media
