...
T = TypeVar("T", bound="FpsInsertUpdateMatchPersonStatisticsPostBodyStatistics")


@_attrs_define
class FpsInsertUpdateMatchPersonStatisticsPostBodyStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fps_insert_update_match_person_statistics_post_body_statistics = cls(
        ...
        return fps_insert_update_match_person_statistics_post_body_statistics
