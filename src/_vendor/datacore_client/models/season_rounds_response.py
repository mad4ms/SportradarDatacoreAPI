...
T = TypeVar("T", bound="SeasonRoundsResponse")


@_attrs_define
class SeasonRoundsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_rounds_response.additional_properties = d
        return season_rounds_response
