...
T = TypeVar("T", bound="FixturePersonsDetailResponseDefault")


@_attrs_define
class FixturePersonsDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_persons_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_persons_detail_response_default.additional_properties = d
        return fixture_persons_detail_response_default
