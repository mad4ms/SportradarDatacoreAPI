...
T = TypeVar("T", bound="FixtureEntitiesResponse")


@_attrs_define
class FixtureEntitiesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_entities_response.additional_properties = d
        return fixture_entities_response
