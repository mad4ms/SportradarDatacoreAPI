...
from ..models.fixture_update_match_put_body_match_competitor_result_status import (
    FixtureUpdateMatchPutBodyMatchCompetitorResultStatus,
)
from ..models.fixture_update_match_put_body_match_competitor_roster_status import (
    FixtureUpdateMatchPutBodyMatchCompetitorRosterStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FixtureUpdateMatchPutBodyMatchCompetitor")


@_attrs_define
class FixtureUpdateMatchPutBodyMatchCompetitor:
    """
    Attributes:
        ...
        result_status (Union[Unset, FixtureUpdateMatchPutBodyMatchCompetitorResultStatus]): Result status
        ...
        roster_status (Union[Unset, FixtureUpdateMatchPutBodyMatchCompetitorRosterStatus]): Roster status
    ...
    result_status: Union[
        Unset, FixtureUpdateMatchPutBodyMatchCompetitorResultStatus
    ] = UNSET
    ...
    roster_status: Union[
        Unset, FixtureUpdateMatchPutBodyMatchCompetitorRosterStatus
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_result_status, Unset):
            ...
            result_status = FixtureUpdateMatchPutBodyMatchCompetitorResultStatus(
                _result_status
            )
        ...
        if isinstance(_roster_status, Unset):
            ...
            roster_status = FixtureUpdateMatchPutBodyMatchCompetitorRosterStatus(
                _roster_status
            )
        ...
        fixture_update_match_put_body_match_competitor = cls(
            entity_id=entity_id,
        ...
        return fixture_update_match_put_body_match_competitor
