...
T = TypeVar("T", bound="SiteExternalIdsInsertResponseDefault")


@_attrs_define
class SiteExternalIdsInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_external_ids_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        site_external_ids_insert_response_default.additional_properties = d
        return site_external_ids_insert_response_default
