...
T = TypeVar("T", bound="ImagesUpdateResponseDefault")


@_attrs_define
class ImagesUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_update_response_default = cls(
            meta=meta,
            error=error,
        )

        images_update_response_default.additional_properties = d
        return images_update_response_default
