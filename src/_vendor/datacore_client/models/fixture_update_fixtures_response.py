...
T = TypeVar("T", bound="FixtureUpdateFixturesResponse")


@_attrs_define
class FixtureUpdateFixturesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_update_fixtures_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_update_fixtures_response.additional_properties = d
        return fixture_update_fixtures_response
