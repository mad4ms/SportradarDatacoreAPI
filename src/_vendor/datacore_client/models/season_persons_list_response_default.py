...
T = TypeVar("T", bound="SeasonPersonsListResponseDefault")


@_attrs_define
class SeasonPersonsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_persons_list_response_default = cls(
            meta=meta,
            error=error,
        )

        season_persons_list_response_default.additional_properties = d
        return season_persons_list_response_default
