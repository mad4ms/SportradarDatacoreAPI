...
T = TypeVar("T", bound="SeasonPoolsDeleteResponseDefault")


@_attrs_define
class SeasonPoolsDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_pools_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        season_pools_delete_response_default.additional_properties = d
        return season_pools_delete_response_default
