...
T = TypeVar("T", bound="FixturePbpDeleteResponseDefault")


@_attrs_define
class FixturePbpDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_pbp_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_pbp_delete_response_default.additional_properties = d
        return fixture_pbp_delete_response_default
