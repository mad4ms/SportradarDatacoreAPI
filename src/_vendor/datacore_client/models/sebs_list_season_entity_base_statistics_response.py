...
T = TypeVar("T", bound="SebsListSeasonEntityBaseStatisticsResponse")


@_attrs_define
class SebsListSeasonEntityBaseStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sebs_list_season_entity_base_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        sebs_list_season_entity_base_statistics_response.additional_properties = d
        return sebs_list_season_entity_base_statistics_response
