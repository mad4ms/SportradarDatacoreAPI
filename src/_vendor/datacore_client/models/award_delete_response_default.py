...
T = TypeVar("T", bound="AwardDeleteResponseDefault")


@_attrs_define
class AwardDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        award_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        award_delete_response_default.additional_properties = d
        return award_delete_response_default
