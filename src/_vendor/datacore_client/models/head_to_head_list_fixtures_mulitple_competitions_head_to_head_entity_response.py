...
T = TypeVar(
    "T", bound="HeadToHeadListFixturesMulitpleCompetitionsHeadToHeadEntityResponse"
)
...
class HeadToHeadListFixturesMulitpleCompetitionsHeadToHeadEntityResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        head_to_head_list_fixtures_mulitple_competitions_head_to_head_entity_response.additional_properties = (
            d
        )
