...
T = TypeVar("T", bound="FixtureInsertResponseDefault")


@_attrs_define
class FixtureInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_insert_response_default.additional_properties = d
        return fixture_insert_response_default
