...
T = TypeVar("T", bound="LeagueInsertLeaguesResponse")


@_attrs_define
class LeagueInsertLeaguesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = LeagueModel.from_dict(data_item_data)

            data.append(data_item)

        league_insert_leagues_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        league_insert_leagues_response.additional_properties = d
        return league_insert_leagues_response
