...
T = TypeVar("T", bound="SiteUpdateSitePutBodySiteAddress")


@_attrs_define
class SiteUpdateSitePutBodySiteAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_update_site_put_body_site_address = cls(
            address1=address1,
            address2=address2,
            address3=address3,
            city=city,
        ...
        return site_update_site_put_body_site_address
