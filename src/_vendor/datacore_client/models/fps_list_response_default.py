...
T = TypeVar("T", bound="FpsListResponseDefault")


@_attrs_define
class FpsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fps_list_response_default = cls(
            meta=meta,
            error=error,
        )

        fps_list_response_default.additional_properties = d
        return fps_list_response_default
