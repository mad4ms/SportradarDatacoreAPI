...
T = TypeVar("T", bound="EntityGroupExternalIdsResponse")


@_attrs_define
class EntityGroupExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_group_external_ids_response.additional_properties = d
        return entity_group_external_ids_response
