...
T = TypeVar("T", bound="VenueInsertVenuesResponse")


@_attrs_define
class VenueInsertVenuesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_insert_venues_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        venue_insert_venues_response.additional_properties = d
        return venue_insert_venues_response
