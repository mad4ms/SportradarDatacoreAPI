...
T = TypeVar("T", bound="SeasonSeriesDeleteResponseDefault")


@_attrs_define
class SeasonSeriesDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_series_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        season_series_delete_response_default.additional_properties = d
        return season_series_delete_response_default
