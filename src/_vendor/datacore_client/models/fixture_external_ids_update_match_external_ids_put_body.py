...
T = TypeVar("T", bound="FixtureExternalIdsUpdateMatchExternalIdsPutBody")


@_attrs_define
class FixtureExternalIdsUpdateMatchExternalIdsPutBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_external_ids_update_match_external_ids_put_body = cls(
        ...
        return fixture_external_ids_update_match_external_ids_put_body
