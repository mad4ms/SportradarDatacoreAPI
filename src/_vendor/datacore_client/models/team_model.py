...
if TYPE_CHECKING:
    ...
    from ..models.team_model_entity_additional_details import (
...
class TeamModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_contacts(
            data: object,
        ) -> Union["TeamModelContactDetails", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_details(
            data: object,
        ) -> Union["TeamModelEntityAdditionalDetails", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_historical_names(
            data: object,
        ) -> Union[None, Unset, list["TeamModelTeamHistoricalName"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for historical_names_type_0_item_data in _historical_names_type_0:
                    historical_names_type_0_item = (
                        TeamModelTeamHistoricalName.from_dict(
