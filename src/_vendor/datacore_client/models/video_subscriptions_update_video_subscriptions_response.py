...
if TYPE_CHECKING:
    ...
    from ..models.video_subscription_model import VideoSubscriptionModel


T = TypeVar("T", bound="VideoSubscriptionsUpdateVideoSubscriptionsResponse")


@_attrs_define
class VideoSubscriptionsUpdateVideoSubscriptionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = VideoSubscriptionModel.from_dict(data_item_data)

            data.append(data_item)

        video_subscriptions_update_video_subscriptions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        video_subscriptions_update_video_subscriptions_response.additional_properties = (
            d
        )
        return video_subscriptions_update_video_subscriptions_response
