...
T = TypeVar("T", bound="CompetitionInsertCompetitionPostBodySocialMedia")


@_attrs_define
class CompetitionInsertCompetitionPostBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_insert_competition_post_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return competition_insert_competition_post_body_social_media
