...
T = TypeVar("T", bound="OrggroupCompetitionListCompetitionsResponse")


@_attrs_define
class OrggroupCompetitionListCompetitionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orggroup_competition_list_competitions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        orggroup_competition_list_competitions_response.additional_properties = d
        return orggroup_competition_list_competitions_response
