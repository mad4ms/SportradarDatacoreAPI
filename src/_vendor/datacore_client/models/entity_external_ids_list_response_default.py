...
T = TypeVar("T", bound="EntityExternalIdsListResponseDefault")


@_attrs_define
class EntityExternalIdsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_external_ids_list_response_default = cls(
            meta=meta,
            error=error,
        )

        entity_external_ids_list_response_default.additional_properties = d
        return entity_external_ids_list_response_default
