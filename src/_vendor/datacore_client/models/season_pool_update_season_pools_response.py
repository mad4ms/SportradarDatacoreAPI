...
T = TypeVar("T", bound="SeasonPoolUpdateSeasonPoolsResponse")


@_attrs_define
class SeasonPoolUpdateSeasonPoolsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_pool_update_season_pools_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_pool_update_season_pools_response.additional_properties = d
        return season_pool_update_season_pools_response
