...
T = TypeVar("T", bound="FesListperiodBySeasonResponseDefault")


@_attrs_define
class FesListperiodBySeasonResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fes_listperiod_by_season_response_default = cls(
            meta=meta,
            error=error,
        )

        fes_listperiod_by_season_response_default.additional_properties = d
        return fes_listperiod_by_season_response_default
