...
T = TypeVar("T", bound="EntityInsertTeamPostBodyTeamHistoricalName")


@_attrs_define
class EntityInsertTeamPostBodyTeamHistoricalName:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_insert_team_post_body_team_historical_name = cls(
        ...
        return entity_insert_team_post_body_team_historical_name
