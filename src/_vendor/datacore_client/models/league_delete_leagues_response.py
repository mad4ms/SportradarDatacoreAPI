...
T = TypeVar("T", bound="LeagueDeleteLeaguesResponse")


@_attrs_define
class LeagueDeleteLeaguesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        league_delete_leagues_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        league_delete_leagues_response.additional_properties = d
        return league_delete_leagues_response
