...
from ..models.awards_insert_award_post_body_award import AwardsInsertAwardPostBodyAward
from ..types import UNSET, Unset

T = TypeVar("T", bound="AwardsInsertAwardPostBody")


@_attrs_define
class AwardsInsertAwardPostBody:
    """
    Attributes:
        person_id (UUID): The person that this award is for Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        award (AwardsInsertAwardPostBodyAward): Award
    ...
    person_id: UUID
    award: AwardsInsertAwardPostBodyAward
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        award = AwardsInsertAwardPostBodyAward(d.pop("award"))
        ...
        awards_insert_award_post_body = cls(
            person_id=person_id,
            award=award,
            award_id=award_id,
        ...
        return awards_insert_award_post_body
