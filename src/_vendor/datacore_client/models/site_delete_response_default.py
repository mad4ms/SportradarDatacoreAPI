...
T = TypeVar("T", bound="SiteDeleteResponseDefault")


@_attrs_define
class SiteDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        site_delete_response_default.additional_properties = d
        return site_delete_response_default
