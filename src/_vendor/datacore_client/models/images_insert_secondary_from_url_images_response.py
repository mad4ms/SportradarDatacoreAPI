...
T = TypeVar("T", bound="ImagesInsertSecondaryFromUrlImagesResponse")


@_attrs_define
class ImagesInsertSecondaryFromUrlImagesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_insert_secondary_from_url_images_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        images_insert_secondary_from_url_images_response.additional_properties = d
        return images_insert_secondary_from_url_images_response
