...
T = TypeVar("T", bound="EntityInsertEntitiesResponse")


@_attrs_define
class EntityInsertEntitiesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_insert_entities_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_insert_entities_response.additional_properties = d
        return entity_insert_entities_response
