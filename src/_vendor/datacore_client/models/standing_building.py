...
from ..models.standing_building_build_type import StandingBuildingBuildType
from ..models.standing_building_fixture_types_item import StandingBuildingFixtureTypesItem
from ..models.standing_building_grouping import StandingBuildingGrouping
from ..types import UNSET, Unset

T = TypeVar("T", bound="StandingBuilding")
...
class StandingBuilding:
    ...
    Attributes:
        build_type (StandingBuildingBuildType): Overall standing Type (ROUND not used on live Standings) Example:
            OVERALL.
        grouping (StandingBuildingGrouping): How to Group Example: NONE.
        fixture_types (list[StandingBuildingFixtureTypesItem]):
    ...
    build_type: StandingBuildingBuildType
    grouping: StandingBuildingGrouping
    fixture_types: list[StandingBuildingFixtureTypesItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        build_type = StandingBuildingBuildType(d.pop("buildType"))

        grouping = StandingBuildingGrouping(d.pop("grouping"))

        fixture_types = []
        _fixture_types = d.pop("fixtureTypes")
        for fixture_types_item_data in _fixture_types:
            fixture_types_item = StandingBuildingFixtureTypesItem(fixture_types_item_data)
