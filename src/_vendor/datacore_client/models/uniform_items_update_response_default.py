...
T = TypeVar("T", bound="UniformItemsUpdateResponseDefault")


@_attrs_define
class UniformItemsUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniform_items_update_response_default = cls(
            meta=meta,
            error=error,
        )

        uniform_items_update_response_default.additional_properties = d
        return uniform_items_update_response_default
