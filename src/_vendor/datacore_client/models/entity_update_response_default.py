...
T = TypeVar("T", bound="EntityUpdateResponseDefault")


@_attrs_define
class EntityUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_update_response_default = cls(
            meta=meta,
            error=error,
        )

        entity_update_response_default.additional_properties = d
        return entity_update_response_default
