...
T = TypeVar("T", bound="PersonUpdatePersonPutBodyPersonHistoricalName")


@_attrs_define
class PersonUpdatePersonPutBodyPersonHistoricalName:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_update_person_put_body_person_historical_name = cls(
        ...
        return person_update_person_put_body_person_historical_name
