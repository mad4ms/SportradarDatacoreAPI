...
T = TypeVar("T", bound="SeasonPersonBaseStatisticsModelStatistics")


@_attrs_define
class SeasonPersonBaseStatisticsModelStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_person_base_statistics_model_statistics = cls(
        ...
        return season_person_base_statistics_model_statistics
