...
T = TypeVar("T", bound="SppListSeasonPersonPlacingsResponse")


@_attrs_define
class SppListSeasonPersonPlacingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spp_list_season_person_placings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        spp_list_season_person_placings_response.additional_properties = d
        return spp_list_season_person_placings_response
