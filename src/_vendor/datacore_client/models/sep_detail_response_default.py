...
T = TypeVar("T", bound="SepDetailResponseDefault")


@_attrs_define
class SepDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sep_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        sep_detail_response_default.additional_properties = d
        return sep_detail_response_default
