...
T = TypeVar("T", bound="StandingProgressionsPostBody")


@_attrs_define
class StandingProgressionsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_progressions_post_body = cls(
            season_id=season_id,
        ...
        return standing_progressions_post_body
