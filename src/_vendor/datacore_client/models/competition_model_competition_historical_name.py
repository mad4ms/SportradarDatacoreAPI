...
T = TypeVar("T", bound="CompetitionModelCompetitionHistoricalName")


@_attrs_define
class CompetitionModelCompetitionHistoricalName:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_model_competition_historical_name = cls(
        ...
        return competition_model_competition_historical_name
