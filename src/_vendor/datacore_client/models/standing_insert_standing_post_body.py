...
from ..models.standing_insert_standing_post_body_fixture_type import (
    StandingInsertStandingPostBodyFixtureType,
)
from ..models.standing_insert_standing_post_body_grouping_base import (
    StandingInsertStandingPostBodyGroupingBase,
)
from ..models.standing_insert_standing_post_body_grouping_conference_division import (
    StandingInsertStandingPostBodyGroupingConferenceDivision,
)
from ..models.standing_insert_standing_post_body_grouping_stage_pool import (
    StandingInsertStandingPostBodyGroupingStagePool,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.standing_insert_standing_post_body_calculated import (
        StandingInsertStandingPostBodyCalculated,
    )
    from ..models.standing_insert_standing_post_body_points import (
        StandingInsertStandingPostBodyPoints,
    )


T = TypeVar("T", bound="StandingInsertStandingPostBody")


@_attrs_define
class StandingInsertStandingPostBody:
    """
    Attributes:
        ...
        grouping_base (StandingInsertStandingPostBodyGroupingBase): Base grouping of standings row
            >- `OVERALL` Overall
            >- `ROUND` Round
             Example: OVERALL.
        grouping_conference_division (StandingInsertStandingPostBodyGroupingConferenceDivision): Conference/Division
            grouping of standings row
            >- `CONFERENCE` Conference
            >- `DIVISION` Division
            >- `OVERALL` Overall
             Example: OVERALL.
        grouping_stage_pool (StandingInsertStandingPostBodyGroupingStagePool): Stage/Pool grouping of standings row
            >- `OVERALL` Overall
            >- `STAGE` Stage
        ...
        fixture_type (Union[Unset, StandingInsertStandingPostBodyFixtureType]): Type of match
            >- `ALL_STAR` All Star
        ...
        points (Union[Unset, StandingInsertStandingPostBodyPoints]): standings points fields
        calculated (Union[Unset, StandingInsertStandingPostBodyCalculated]): standings points fields
    ...
    entity_id: UUID
    live: bool
    grouping_base: StandingInsertStandingPostBodyGroupingBase
    grouping_conference_division: (
        StandingInsertStandingPostBodyGroupingConferenceDivision
    )
    grouping_stage_pool: StandingInsertStandingPostBodyGroupingStagePool
    ...
    fixture_type: Union[Unset, StandingInsertStandingPostBodyFixtureType] = UNSET
    secured_finals: Union[Unset, str] = UNSET
    points: Union[Unset, "StandingInsertStandingPostBodyPoints"] = UNSET
    calculated: Union[Unset, "StandingInsertStandingPostBodyCalculated"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grouping_conference_division = (
            StandingInsertStandingPostBodyGroupingConferenceDivision(
                d.pop("groupingConferenceDivision")
            )
        )

        grouping_stage_pool = StandingInsertStandingPostBodyGroupingStagePool(
            d.pop("groupingStagePool")
        )
        ...
        fixture_type: Union[Unset, StandingInsertStandingPostBodyFixtureType]
        if isinstance(_fixture_type, Unset):
            fixture_type = UNSET
        else:
            fixture_type = StandingInsertStandingPostBodyFixtureType(_fixture_type)

        secured_finals = d.pop("securedFinals", UNSET)

        _points = d.pop("points", UNSET)
        points: Union[Unset, StandingInsertStandingPostBodyPoints]
        if isinstance(_points, Unset):
            points = UNSET
        else:
            points = StandingInsertStandingPostBodyPoints.from_dict(_points)

        _calculated = d.pop("calculated", UNSET)
        calculated: Union[Unset, StandingInsertStandingPostBodyCalculated]
        if isinstance(_calculated, Unset):
            calculated = UNSET
        else:
            calculated = StandingInsertStandingPostBodyCalculated.from_dict(_calculated)
        ...
        standing_insert_standing_post_body = cls(
            season_id=season_id,
            entity_id=entity_id,
            live=live,
        ...
        return standing_insert_standing_post_body
