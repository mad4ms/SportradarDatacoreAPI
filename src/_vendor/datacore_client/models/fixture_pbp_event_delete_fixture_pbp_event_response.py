...
if TYPE_CHECKING:
    from ..models.fixture_pbp_event_model import FixturePBPEventModel
...
T = TypeVar("T", bound="FixturePbpEventDeleteFixturePbpEventResponse")


@_attrs_define
class FixturePbpEventDeleteFixturePbpEventResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = FixturePBPEventModel.from_dict(data_item_data)

            data.append(data_item)

        fixture_pbp_event_delete_fixture_pbp_event_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_pbp_event_delete_fixture_pbp_event_response.additional_properties = d
        return fixture_pbp_event_delete_fixture_pbp_event_response
