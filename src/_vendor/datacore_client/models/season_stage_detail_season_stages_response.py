...
T = TypeVar("T", bound="SeasonStageDetailSeasonStagesResponse")


@_attrs_define
class SeasonStageDetailSeasonStagesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_stage_detail_season_stages_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_stage_detail_season_stages_response.additional_properties = d
        return season_stage_detail_season_stages_response
