...
from ..models.person_update_person_put_body_gender import (
    PersonUpdatePersonPutBodyGender,
)
from ..models.person_update_person_put_body_status import (
    PersonUpdatePersonPutBodyStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.person_update_person_put_body_additional_names_type_0 import (
        PersonUpdatePersonPutBodyAdditionalNamesType0,
    )
    from ..models.person_update_person_put_body_person_additional_details import (
        PersonUpdatePersonPutBodyPersonAdditionalDetails,
    )
    from ..models.person_update_person_put_body_person_historical_name import (
        PersonUpdatePersonPutBodyPersonHistoricalName,
    )
    from ..models.person_update_person_put_body_social_media import (
        PersonUpdatePersonPutBodySocialMedia,
    )


T = TypeVar("T", bound="PersonUpdatePersonPutBody")


@_attrs_define
class PersonUpdatePersonPutBody:
    """
    Attributes:
        status (Union[Unset, PersonUpdatePersonPutBodyStatus]): Status
            >- `ACTIVE` Active
            >- `DECEASED` Deceased
            >- `INACTIVE` Inactive
            >- `PENDING` Pending
            >- `UNREGISTERED` UnRegistered
             Default: PersonUpdatePersonPutBodyStatus.ACTIVE. Example: ACTIVE.
        gender (Union[Unset, PersonUpdatePersonPutBodyGender]): The gender of the person
            >- `FEMALE` Female
            >- `MALE` Male
            >- `UNKNOWN` Unknown
             Example: MALE.
        ...
        additional_names (Union['PersonUpdatePersonPutBodyAdditionalNamesType0', None, Unset]): Additional names for the
            person. They are broken down by language, so you can have a different set of names per language
        additional_details (Union['PersonUpdatePersonPutBodyPersonAdditionalDetails', None, Unset]): Additional person
            detail fields
        social (Union['PersonUpdatePersonPutBodySocialMedia', None, Unset]): Social Media contacts
        historical_names (Union[None, Unset, list['PersonUpdatePersonPutBodyPersonHistoricalName']]): Array of person
            historical names
        representing (Union[None, Unset, str]): Who the person or team was representing Example: AUSTRALIA.
        external_id (Union[None, Unset, str]): The Id of the data as set by the provider of the data Example: A123.
    """

    status: Union[Unset, PersonUpdatePersonPutBodyStatus] = (
        PersonUpdatePersonPutBodyStatus.ACTIVE
    )
    gender: Union[Unset, PersonUpdatePersonPutBodyGender] = UNSET
    ...
    additional_names: Union[
        "PersonUpdatePersonPutBodyAdditionalNamesType0", None, Unset
    ] = UNSET
    additional_details: Union[
        "PersonUpdatePersonPutBodyPersonAdditionalDetails", None, Unset
    ] = UNSET
    social: Union["PersonUpdatePersonPutBodySocialMedia", None, Unset] = UNSET
    historical_names: Union[
        None, Unset, list["PersonUpdatePersonPutBodyPersonHistoricalName"]
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.additional_names, Unset):
            ...
            self.additional_names, PersonUpdatePersonPutBodyAdditionalNamesType0
        ):
        ...
        if isinstance(self.additional_details, Unset):
            ...
            self.additional_details, PersonUpdatePersonPutBodyPersonAdditionalDetails
        ):
        ...
        if isinstance(self.social, Unset):
            social = UNSET
        elif isinstance(self.social, PersonUpdatePersonPutBodySocialMedia):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = PersonUpdatePersonPutBodyStatus(_status)

        _gender = d.pop("gender", UNSET)
        gender: Union[Unset, PersonUpdatePersonPutBodyGender]
        if isinstance(_gender, Unset):
            gender = UNSET
        else:
            gender = PersonUpdatePersonPutBodyGender(_gender)
        ...
        def _parse_additional_names(
            data: object,
        ) -> Union["PersonUpdatePersonPutBodyAdditionalNamesType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                additional_names_type_0 = (
                    PersonUpdatePersonPutBodyAdditionalNamesType0.from_dict(data)
                )
        ...
        def _parse_additional_details(
            data: object,
        ) -> Union["PersonUpdatePersonPutBodyPersonAdditionalDetails", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                additional_details_type_0 = (
                    PersonUpdatePersonPutBodyPersonAdditionalDetails.from_dict(data)
                )
        ...
        def _parse_social(
            data: object,
        ) -> Union["PersonUpdatePersonPutBodySocialMedia", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                social_type_0 = PersonUpdatePersonPutBodySocialMedia.from_dict(data)

                return social_type_0
            except:  # noqa: E722
                pass
            return cast(
                Union["PersonUpdatePersonPutBodySocialMedia", None, Unset], data
            )
        ...
        def _parse_historical_names(
            data: object,
        ) -> Union[None, Unset, list["PersonUpdatePersonPutBodyPersonHistoricalName"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for historical_names_type_0_item_data in _historical_names_type_0:
                    historical_names_type_0_item = (
                        PersonUpdatePersonPutBodyPersonHistoricalName.from_dict(
        ...
        person_update_person_put_body = cls(
            status=status,
            gender=gender,
        ...
        return person_update_person_put_body
