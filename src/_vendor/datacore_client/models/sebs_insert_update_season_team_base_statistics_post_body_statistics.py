...
T = TypeVar("T", bound="SebsInsertUpdateSeasonTeamBaseStatisticsPostBodyStatistics")


@_attrs_define
class SebsInsertUpdateSeasonTeamBaseStatisticsPostBodyStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sebs_insert_update_season_team_base_statistics_post_body_statistics = cls(
            assists=assists,
        ...
        return sebs_insert_update_season_team_base_statistics_post_body_statistics
