...
if TYPE_CHECKING:
    ...
    from ..models.leader_criteria_model import LeaderCriteriaModel
    from ..models.response_links import ResponseLinks
    from ..models.response_meta_data import ResponseMetaData


T = TypeVar("T", bound="LeaderCriteriaDeleteLeaderCriteriaResponse")


@_attrs_define
class LeaderCriteriaDeleteLeaderCriteriaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = LeaderCriteriaModel.from_dict(data_item_data)

            data.append(data_item)

        leader_criteria_delete_leader_criteria_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        leader_criteria_delete_leader_criteria_response.additional_properties = d
        return leader_criteria_delete_leader_criteria_response
