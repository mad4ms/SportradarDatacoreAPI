...
T = TypeVar("T", bound="ConferenceDeleteResponseDefault")


@_attrs_define
class ConferenceDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        conference_delete_response_default.additional_properties = d
        return conference_delete_response_default
