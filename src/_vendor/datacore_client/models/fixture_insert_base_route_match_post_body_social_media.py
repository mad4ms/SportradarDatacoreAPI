...
T = TypeVar("T", bound="FixtureInsertBaseRouteMatchPostBodySocialMedia")


@_attrs_define
class FixtureInsertBaseRouteMatchPostBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_insert_base_route_match_post_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return fixture_insert_base_route_match_post_body_social_media
