...
T = TypeVar("T", bound="CompetitionDetailCompetitionsResponse")


@_attrs_define
class CompetitionDetailCompetitionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_detail_competitions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        competition_detail_competitions_response.additional_properties = d
        return competition_detail_competitions_response
