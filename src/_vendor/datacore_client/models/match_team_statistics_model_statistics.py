...
T = TypeVar("T", bound="MatchTeamStatisticsModelStatistics")


@_attrs_define
class MatchTeamStatisticsModelStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        match_team_statistics_model_statistics = cls(
            assists=assists,
        ...
        return match_team_statistics_model_statistics
