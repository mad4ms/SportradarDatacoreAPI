...
T = TypeVar("T", bound="SppUpdateSEASONPERSONPlacingsPutBody")


@_attrs_define
class SppUpdateSEASONPERSONPlacingsPutBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spp_update_seasonperson_placings_put_body = cls(
            season_id=season_id,
            person_id=person_id,
        ...
        return spp_update_seasonperson_placings_put_body
