...
T = TypeVar("T", bound="SiteDetailSitesResponse")


@_attrs_define
class SiteDetailSitesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_detail_sites_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        site_detail_sites_response.additional_properties = d
        return site_detail_sites_response
