...
T = TypeVar("T", bound="SpsListSeasonPersonStatisticsResponse")


@_attrs_define
class SpsListSeasonPersonStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeasonPersonStatisticsModel.from_dict(data_item_data)

            data.append(data_item)

        sps_list_season_person_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        sps_list_season_person_statistics_response.additional_properties = d
        return sps_list_season_person_statistics_response
