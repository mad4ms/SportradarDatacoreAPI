...
T = TypeVar("T", bound="SiteExternalIdsListResponseDefault")


@_attrs_define
class SiteExternalIdsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_external_ids_list_response_default = cls(
            meta=meta,
            error=error,
        )

        site_external_ids_list_response_default.additional_properties = d
        return site_external_ids_list_response_default
