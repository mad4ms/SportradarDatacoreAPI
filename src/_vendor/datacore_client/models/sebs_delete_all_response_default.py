...
T = TypeVar("T", bound="SebsDeleteAllResponseDefault")


@_attrs_define
class SebsDeleteAllResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sebs_delete_all_response_default = cls(
            meta=meta,
            error=error,
        )

        sebs_delete_all_response_default.additional_properties = d
        return sebs_delete_all_response_default
