...
if TYPE_CHECKING:
    ...
    from ..models.match_person_statistics_model import MatchPersonStatisticsModel
    from ..models.response_links import ResponseLinks
    from ..models.response_meta_data import ResponseMetaData


T = TypeVar("T", bound="FpsListBySeasonFixturePersonStatisticsResponse")


@_attrs_define
class FpsListBySeasonFixturePersonStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = MatchPersonStatisticsModel.from_dict(data_item_data)

            data.append(data_item)

        fps_list_by_season_fixture_person_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fps_list_by_season_fixture_person_statistics_response.additional_properties = d
        return fps_list_by_season_fixture_person_statistics_response
