...
T = TypeVar("T", bound="MatchTeamPeriodStatisticsPostBodyStatistics")


@_attrs_define
class MatchTeamPeriodStatisticsPostBodyStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        match_team_period_statistics_post_body_statistics = cls(
            assists=assists,
        ...
        return match_team_period_statistics_post_body_statistics
