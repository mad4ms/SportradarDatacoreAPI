...
T = TypeVar("T", bound="PersonMergeResponseDefault")


@_attrs_define
class PersonMergeResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_merge_response_default = cls(
            meta=meta,
            error=error,
        )

        person_merge_response_default.additional_properties = d
        return person_merge_response_default
