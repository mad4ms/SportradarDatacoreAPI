...
if TYPE_CHECKING:
    ...
    from ..models.uniform_items_model import UniformItemsModel


T = TypeVar("T", bound="UniformItemsInsertBaseRouteUniformItemsResponse")


@_attrs_define
class UniformItemsInsertBaseRouteUniformItemsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = UniformItemsModel.from_dict(data_item_data)

            data.append(data_item)

        uniform_items_insert_base_route_uniform_items_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        uniform_items_insert_base_route_uniform_items_response.additional_properties = d
        return uniform_items_insert_base_route_uniform_items_response
