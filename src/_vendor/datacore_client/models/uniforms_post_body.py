...
from ..models.uniforms_post_body_base_type import UniformsPostBodyBaseType
from ..types import UNSET, Unset

T = TypeVar("T", bound="UniformsPostBody")


@_attrs_define
class UniformsPostBody:
    """
    Attributes:
        base_type (UniformsPostBodyBaseType): The object that this uniform relates to
            >- `ENTITY` Entity
    ...
    base_type: UniformsPostBodyBaseType
    base_id: UUID
    name_local: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        base_type = UniformsPostBodyBaseType(d.pop("baseType"))
