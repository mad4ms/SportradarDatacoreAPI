...
T = TypeVar("T", bound="EntityUpdateTeamPutBodyContactDetails")


@_attrs_define
class EntityUpdateTeamPutBodyContactDetails:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_update_team_put_body_contact_details = cls(
            fax=fax,
            phone=phone,
        ...
        return entity_update_team_put_body_contact_details
