...
T = TypeVar("T", bound="ConferenceUpdateConferencesResponse")


@_attrs_define
class ConferenceUpdateConferencesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_update_conferences_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        conference_update_conferences_response.additional_properties = d
        return conference_update_conferences_response
