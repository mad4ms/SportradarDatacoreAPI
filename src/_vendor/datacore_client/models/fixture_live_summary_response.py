...
T = TypeVar("T", bound="FixtureLiveSummaryResponse")


@_attrs_define
class FixtureLiveSummaryResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_live_summary_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_live_summary_response.additional_properties = d
        return fixture_live_summary_response
