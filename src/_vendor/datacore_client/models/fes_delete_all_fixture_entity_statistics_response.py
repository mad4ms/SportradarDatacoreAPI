...
T = TypeVar("T", bound="FesDeleteAllFixtureEntityStatisticsResponse")


@_attrs_define
class FesDeleteAllFixtureEntityStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fes_delete_all_fixture_entity_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fes_delete_all_fixture_entity_statistics_response.additional_properties = d
        return fes_delete_all_fixture_entity_statistics_response
