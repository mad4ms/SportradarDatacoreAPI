...
T = TypeVar("T", bound="SeasonInsertSeasonsResponse")


@_attrs_define
class SeasonInsertSeasonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_insert_seasons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_insert_seasons_response.additional_properties = d
        return season_insert_seasons_response
