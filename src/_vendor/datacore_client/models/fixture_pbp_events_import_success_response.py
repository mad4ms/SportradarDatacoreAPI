...
T = TypeVar("T", bound="FixturePbpEventsImportSuccessResponse")


@_attrs_define
class FixturePbpEventsImportSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_pbp_events_import_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_pbp_events_import_success_response.additional_properties = d
        return fixture_pbp_events_import_success_response
