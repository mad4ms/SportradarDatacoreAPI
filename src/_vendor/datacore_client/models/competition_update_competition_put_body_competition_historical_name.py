...
T = TypeVar("T", bound="CompetitionUpdateCompetitionPutBodyCompetitionHistoricalName")


@_attrs_define
class CompetitionUpdateCompetitionPutBodyCompetitionHistoricalName:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_update_competition_put_body_competition_historical_name = cls(
        ...
        return competition_update_competition_put_body_competition_historical_name
