...
T = TypeVar("T", bound="FixtureDetailResponseDefault")


@_attrs_define
class FixtureDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_detail_response_default.additional_properties = d
        return fixture_detail_response_default
