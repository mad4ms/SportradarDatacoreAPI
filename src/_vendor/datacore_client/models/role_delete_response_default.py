...
T = TypeVar("T", bound="RoleDeleteResponseDefault")


@_attrs_define
class RoleDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        role_delete_response_default.additional_properties = d
        return role_delete_response_default
