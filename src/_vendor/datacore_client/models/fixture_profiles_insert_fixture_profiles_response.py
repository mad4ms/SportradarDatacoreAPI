...
T = TypeVar("T", bound="FixtureProfilesInsertFixtureProfilesResponse")


@_attrs_define
class FixtureProfilesInsertFixtureProfilesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_profiles_insert_fixture_profiles_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_profiles_insert_fixture_profiles_response.additional_properties = d
        return fixture_profiles_insert_fixture_profiles_response
