...
T = TypeVar("T", bound="UniformsUpdateUniformsResponse")


@_attrs_define
class UniformsUpdateUniformsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniforms_update_uniforms_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        uniforms_update_uniforms_response.additional_properties = d
        return uniforms_update_uniforms_response
