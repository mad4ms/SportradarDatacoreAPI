...
from ..models.competition_person_statistics_model_competition_resource_type import (
    CompetitionPersonStatisticsModelCompetitionResourceType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CompetitionPersonStatisticsModelCompetition")


@_attrs_define
class CompetitionPersonStatisticsModelCompetition:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_person_statistics_model_competition = cls(
            resource_type=resource_type,
            id=id,
        )

        competition_person_statistics_model_competition.additional_properties = d
        return competition_person_statistics_model_competition
