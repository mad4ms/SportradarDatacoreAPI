...
T = TypeVar("T", bound="SeasonRoundInsertUpdateSeasonRoundsResponse")


@_attrs_define
class SeasonRoundInsertUpdateSeasonRoundsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = RoundModel.from_dict(data_item_data)

            data.append(data_item)

        season_round_insert_update_season_rounds_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_round_insert_update_season_rounds_response.additional_properties = d
        return season_round_insert_update_season_rounds_response
