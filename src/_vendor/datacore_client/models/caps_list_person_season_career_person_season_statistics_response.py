...
if TYPE_CHECKING:
    from ..models.career_person_season_statistics_model import CareerPersonSeasonStatisticsModel
...
T = TypeVar("T", bound="CapsListPersonSeasonCareerPersonSeasonStatisticsResponse")


@_attrs_define
class CapsListPersonSeasonCareerPersonSeasonStatisticsResponse:
    """
    Attributes:
        ...
        data (Union[Unset, list['CareerPersonSeasonStatisticsModel']]):
    """

    meta: Union[Unset, "ResponseMetaData"] = UNSET
    links: Union[Unset, "ResponseLinks"] = UNSET
    included: Union[Unset, "IncludedData"] = UNSET
    data: Union[Unset, list["CareerPersonSeasonStatisticsModel"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = CareerPersonSeasonStatisticsModel.from_dict(data_item_data)

            data.append(data_item)

        caps_list_person_season_career_person_season_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        caps_list_person_season_career_person_season_statistics_response.additional_properties = d
        return caps_list_person_season_career_person_season_statistics_response
