...
T = TypeVar("T", bound="SpbsDeleteAllSeasonPersonBaseStatisticsResponse")


@_attrs_define
class SpbsDeleteAllSeasonPersonBaseStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spbs_delete_all_season_person_base_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        spbs_delete_all_season_person_base_statistics_response.additional_properties = d
        return spbs_delete_all_season_person_base_statistics_response
