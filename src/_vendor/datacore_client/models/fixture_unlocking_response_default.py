...
T = TypeVar("T", bound="FixtureUnlockingResponseDefault")


@_attrs_define
class FixtureUnlockingResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_unlocking_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_unlocking_response_default.additional_properties = d
        return fixture_unlocking_response_default
