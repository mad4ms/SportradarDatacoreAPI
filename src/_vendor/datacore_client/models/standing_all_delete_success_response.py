...
T = TypeVar("T", bound="StandingAllDeleteSuccessResponse")


@_attrs_define
class StandingAllDeleteSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_all_delete_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_all_delete_success_response.additional_properties = d
        return standing_all_delete_success_response
