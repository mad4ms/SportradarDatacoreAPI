...
T = TypeVar("T", bound="SeasonRosterDeleteResponseDefault")


@_attrs_define
class SeasonRosterDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_roster_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        season_roster_delete_response_default.additional_properties = d
        return season_roster_delete_response_default
