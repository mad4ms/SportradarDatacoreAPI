...
T = TypeVar("T", bound="PersonUpdatePersonsResponse")


@_attrs_define
class PersonUpdatePersonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_update_persons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        person_update_persons_response.additional_properties = d
        return person_update_persons_response
