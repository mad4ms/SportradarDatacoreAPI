...
from ..models.fixture_update_match_put_body_broadcasts_broadcast_type import (
    FixtureUpdateMatchPutBodyBroadcastsBroadcastType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FixtureUpdateMatchPutBodyBroadcasts")


@_attrs_define
class FixtureUpdateMatchPutBodyBroadcasts:
    """
    Attributes:
        broadcast_type (Union[Unset, FixtureUpdateMatchPutBodyBroadcastsBroadcastType]): Broadcast Type Example: TV.
    ...
    broadcast_type: Union[Unset, FixtureUpdateMatchPutBodyBroadcastsBroadcastType] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_broadcast_type, Unset):
            ...
            broadcast_type = FixtureUpdateMatchPutBodyBroadcastsBroadcastType(
                _broadcast_type
            )
        ...
        fixture_update_match_put_body_broadcasts = cls(
        ...
        return fixture_update_match_put_body_broadcasts
