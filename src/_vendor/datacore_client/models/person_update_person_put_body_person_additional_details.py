...
from ..models.person_update_person_put_body_person_additional_details_dominant_foot import (
    PersonUpdatePersonPutBodyPersonAdditionalDetailsDominantFoot,
)
from ..models.person_update_person_put_body_person_additional_details_dominant_hand import (
    PersonUpdatePersonPutBodyPersonAdditionalDetailsDominantHand,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PersonUpdatePersonPutBodyPersonAdditionalDetails")


@_attrs_define
class PersonUpdatePersonPutBodyPersonAdditionalDetails:
    ...
    Attributes:
        ...
        dominant_hand (Union[Unset, PersonUpdatePersonPutBodyPersonAdditionalDetailsDominantHand]): Dominant hand
        dominant_foot (Union[Unset, PersonUpdatePersonPutBodyPersonAdditionalDetailsDominantFoot]): Dominant foot
    ...
    dominant_hand: Union[
        Unset, PersonUpdatePersonPutBodyPersonAdditionalDetailsDominantHand
    ] = UNSET
    dominant_foot: Union[
        Unset, PersonUpdatePersonPutBodyPersonAdditionalDetailsDominantFoot
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_update_person_put_body_person_additional_details = cls(
            height=height,
        ...
        return person_update_person_put_body_person_additional_details
