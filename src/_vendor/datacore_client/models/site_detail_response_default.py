...
T = TypeVar("T", bound="SiteDetailResponseDefault")


@_attrs_define
class SiteDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        site_detail_response_default.additional_properties = d
        return site_detail_response_default
