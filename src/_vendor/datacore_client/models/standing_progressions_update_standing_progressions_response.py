...
T = TypeVar("T", bound="StandingProgressionsUpdateStandingProgressionsResponse")


@_attrs_define
class StandingProgressionsUpdateStandingProgressionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_progressions_update_standing_progressions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_progressions_update_standing_progressions_response.additional_properties = (
            d
        )
        return standing_progressions_update_standing_progressions_response
