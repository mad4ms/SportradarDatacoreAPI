...
T = TypeVar("T", bound="FixtureExternalIdsDetailFixtureExternalIdsResponse")


@_attrs_define
class FixtureExternalIdsDetailFixtureExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_external_ids_detail_fixture_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_external_ids_detail_fixture_external_ids_response.additional_properties = d
        return fixture_external_ids_detail_fixture_external_ids_response
