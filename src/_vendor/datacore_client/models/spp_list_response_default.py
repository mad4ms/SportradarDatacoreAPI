...
T = TypeVar("T", bound="SppListResponseDefault")


@_attrs_define
class SppListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spp_list_response_default = cls(
            meta=meta,
            error=error,
        )

        spp_list_response_default.additional_properties = d
        return spp_list_response_default
