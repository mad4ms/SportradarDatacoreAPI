...
T = TypeVar("T", bound="StandingPutBodyCalculatedAdditionalProperty")


@_attrs_define
class StandingPutBodyCalculatedAdditionalProperty:
    """Type of points
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_put_body_calculated_additional_property = cls(
            played=played,
        ...
        return standing_put_body_calculated_additional_property
