...
if TYPE_CHECKING:
    ...
    from ..models.season_standings_stages_pools_model import (
        SeasonStandingsStagesPoolsModel,
    )


T = TypeVar(
    "T", bound="SeasonStandingsStagesPoolsListSeasonStandingsStagesPoolsListResponse"
)
...
class SeasonStandingsStagesPoolsListSeasonStandingsStagesPoolsListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_standings_stages_pools_list_season_standings_stages_pools_list_response.additional_properties = (
            d
        )
