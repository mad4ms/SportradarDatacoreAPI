...
T = TypeVar("T", bound="FpsInsertUpdateFixturePersonStatisticsResponse")


@_attrs_define
class FpsInsertUpdateFixturePersonStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fps_insert_update_fixture_person_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fps_insert_update_fixture_person_statistics_response.additional_properties = d
        return fps_insert_update_fixture_person_statistics_response
