...
T = TypeVar("T", bound="EntityInsertTeamPostBodySocialMedia")


@_attrs_define
class EntityInsertTeamPostBodySocialMedia:
    ...
    Attributes:
        ...
        tiktok (Union[None, Unset, str]):  Example: https://www.tiktok.com/example.
        ticketing (Union[None, Unset, str]):  Example: https://www.tickets.com/example.
    """
    ...
    tiktok: Union[None, Unset, str] = UNSET
    ticketing: Union[None, Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        tiktok: Union[None, Unset, str]
        if isinstance(self.tiktok, Unset):
            tiktok = UNSET
        else:
            tiktok = self.tiktok

        ticketing: Union[None, Unset, str]
        if isinstance(self.ticketing, Unset):
            ticketing = UNSET
        else:
        ...
        if ticketing is not UNSET:
            field_dict["ticketing"] = ticketing
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_tiktok(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        tiktok = _parse_tiktok(d.pop("tiktok", UNSET))

        def _parse_ticketing(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        ticketing = _parse_ticketing(d.pop("ticketing", UNSET))

        entity_insert_team_post_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return entity_insert_team_post_body_social_media
