...
T = TypeVar("T", bound="DivisionInsertDivisionPostBodySocialMedia")


@_attrs_define
class DivisionInsertDivisionPostBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        division_insert_division_post_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return division_insert_division_post_body_social_media
