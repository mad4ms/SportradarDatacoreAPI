...
T = TypeVar("T", bound="SeasonRoundsDeleteResponseDefault")


@_attrs_define
class SeasonRoundsDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_rounds_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        season_rounds_delete_response_default.additional_properties = d
        return season_rounds_delete_response_default
