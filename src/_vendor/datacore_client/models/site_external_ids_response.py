...
T = TypeVar("T", bound="SiteExternalIdsResponse")


@_attrs_define
class SiteExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        site_external_ids_response.additional_properties = d
        return site_external_ids_response
