...
from ..models.league_model_region_type import LeagueModelRegionType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.images_model import ImagesModel
    from ..models.league_model_organization import LeagueModelOrganization
    from ..models.league_model_social_media import LeagueModelSocialMedia
...
class LeagueModel:
    ...
    Attributes:
        ...
        organization (Union[Unset, LeagueModelOrganization]): The organization that this league belongs to
        ...
        region_type (Union[Unset, LeagueModelRegionType]): How geographically relevant is this league
            ...
            >- `STATE` One state
             Example: STATE.
        social (Union['LeagueModelSocialMedia', None, Unset]): Social Media contacts
    ...
    organization: Union[Unset, "LeagueModelOrganization"] = UNSET
    ...
    region_type: Union[Unset, LeagueModelRegionType] = UNSET
    social: Union["LeagueModelSocialMedia", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.social, Unset):
            social = UNSET
        elif isinstance(self.social, LeagueModelSocialMedia):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization: Union[Unset, LeagueModelOrganization]
        if isinstance(_organization, Unset):
            organization = UNSET
        else:
            organization = LeagueModelOrganization.from_dict(_organization)
        ...
        region_type: Union[Unset, LeagueModelRegionType]
        if isinstance(_region_type, Unset):
            region_type = UNSET
        else:
            region_type = LeagueModelRegionType(_region_type)

        def _parse_social(data: object) -> Union["LeagueModelSocialMedia", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                social_type_0 = LeagueModelSocialMedia.from_dict(data)

                return social_type_0
            except:  # noqa: E722
                pass
            return cast(Union["LeagueModelSocialMedia", None, Unset], data)
