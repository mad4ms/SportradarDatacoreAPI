...
T = TypeVar("T", bound="VenueDeleteVenuesResponse")


@_attrs_define
class VenueDeleteVenuesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_delete_venues_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        venue_delete_venues_response.additional_properties = d
        return venue_delete_venues_response
