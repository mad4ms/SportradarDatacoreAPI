...
T = TypeVar("T", bound="SiteExternalIdsDetailResponseDefault")


@_attrs_define
class SiteExternalIdsDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_external_ids_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        site_external_ids_detail_response_default.additional_properties = d
        return site_external_ids_detail_response_default
