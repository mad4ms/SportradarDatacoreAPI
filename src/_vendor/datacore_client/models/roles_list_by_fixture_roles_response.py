...
T = TypeVar("T", bound="RolesListByFixtureRolesResponse")


@_attrs_define
class RolesListByFixtureRolesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roles_list_by_fixture_roles_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        roles_list_by_fixture_roles_response.additional_properties = d
        return roles_list_by_fixture_roles_response
