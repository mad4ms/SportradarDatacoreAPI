...
if TYPE_CHECKING:
    ...
    from ..models.venue_external_ids_model import VenueExternalIdsModel


T = TypeVar("T", bound="VenueExternalIdsInsertUpdateVenueExternalIdsResponse")


@_attrs_define
class VenueExternalIdsInsertUpdateVenueExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = VenueExternalIdsModel.from_dict(data_item_data)

            data.append(data_item)

        venue_external_ids_insert_update_venue_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        venue_external_ids_insert_update_venue_external_ids_response.additional_properties = (
            d
        )
        return venue_external_ids_insert_update_venue_external_ids_response
