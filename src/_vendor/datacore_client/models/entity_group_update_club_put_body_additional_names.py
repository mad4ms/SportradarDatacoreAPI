...
T = TypeVar("T", bound="EntityGroupUpdateClubPutBodyAdditionalNames")


@_attrs_define
class EntityGroupUpdateClubPutBodyAdditionalNames:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_update_club_put_body_additional_names = cls(
        ...
        entity_group_update_club_put_body_additional_names.additional_properties = d
        return entity_group_update_club_put_body_additional_names
