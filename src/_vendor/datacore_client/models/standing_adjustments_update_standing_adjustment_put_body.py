...
from ..models.standing_adjustments_update_standing_adjustment_put_body_adjustment_field import (
    StandingAdjustmentsUpdateStandingAdjustmentPutBodyAdjustmentField,
)
from ..models.standing_adjustments_update_standing_adjustment_put_body_adjustment_group import (
    StandingAdjustmentsUpdateStandingAdjustmentPutBodyAdjustmentGroup,
)
from ..models.standing_adjustments_update_standing_adjustment_put_body_adjustment_type import (
    StandingAdjustmentsUpdateStandingAdjustmentPutBodyAdjustmentType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="StandingAdjustmentsUpdateStandingAdjustmentPutBody")


@_attrs_define
class StandingAdjustmentsUpdateStandingAdjustmentPutBody:
    """
    Attributes:
        ...
        adjustment_group (Union[Unset, StandingAdjustmentsUpdateStandingAdjustmentPutBodyAdjustmentGroup]): Adjustment
            Group
            ...
            >- `OVERALL` Overall
        adjustment_type (Union[Unset, StandingAdjustmentsUpdateStandingAdjustmentPutBodyAdjustmentType]): Adjustment
            Type
            >- `ADD_MINUS` Add/Subtract Value
            >- `SET` Set Value
        adjustment_field (Union[Unset, StandingAdjustmentsUpdateStandingAdjustmentPutBodyAdjustmentField]): Adjustment
            field to calculate standings
            >- `byes` Byes
            >- `draws` Games Drawn
    ...
    adjustment_group: Union[
        Unset, StandingAdjustmentsUpdateStandingAdjustmentPutBodyAdjustmentGroup
    ] = UNSET
    adjustment_type: Union[
        Unset, StandingAdjustmentsUpdateStandingAdjustmentPutBodyAdjustmentType
    ] = UNSET
    adjustment_field: Union[
        Unset, StandingAdjustmentsUpdateStandingAdjustmentPutBodyAdjustmentField
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_adjustments_update_standing_adjustment_put_body = cls(
            season_id=season_id,
            entity_id=entity_id,
        ...
        return standing_adjustments_update_standing_adjustment_put_body
