...
T = TypeVar("T", bound="FixtureEntitiesDetailResponseDefault")


@_attrs_define
class FixtureEntitiesDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_entities_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_entities_detail_response_default.additional_properties = d
        return fixture_entities_detail_response_default
