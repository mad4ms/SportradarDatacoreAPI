...
if TYPE_CHECKING:
    ...
    from ..models.match_roster_model import MatchRosterModel
    from ..models.response_links import ResponseLinks
    from ..models.response_meta_data import ResponseMetaData


T = TypeVar("T", bound="FixtureRosterInsertUpdateBaseRouteFixtureRosterResponse")


@_attrs_define
class FixtureRosterInsertUpdateBaseRouteFixtureRosterResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = MatchRosterModel.from_dict(data_item_data)

            data.append(data_item)

        fixture_roster_insert_update_base_route_fixture_roster_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_roster_insert_update_base_route_fixture_roster_response.additional_properties = (
            d
        )
        return fixture_roster_insert_update_base_route_fixture_roster_response
