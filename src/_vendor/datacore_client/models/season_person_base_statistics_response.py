...
T = TypeVar("T", bound="SeasonPersonBaseStatisticsResponse")


@_attrs_define
class SeasonPersonBaseStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_person_base_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_person_base_statistics_response.additional_properties = d
        return season_person_base_statistics_response
