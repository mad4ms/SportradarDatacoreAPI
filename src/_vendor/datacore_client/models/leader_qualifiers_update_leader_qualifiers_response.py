...
if TYPE_CHECKING:
    ...
    from ..models.leader_qualifier_model import LeaderQualifierModel
    from ..models.response_links import ResponseLinks
    from ..models.response_meta_data import ResponseMetaData


T = TypeVar("T", bound="LeaderQualifiersUpdateLeaderQualifiersResponse")


@_attrs_define
class LeaderQualifiersUpdateLeaderQualifiersResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = LeaderQualifierModel.from_dict(data_item_data)

            data.append(data_item)

        leader_qualifiers_update_leader_qualifiers_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        leader_qualifiers_update_leader_qualifiers_response.additional_properties = d
        return leader_qualifiers_update_leader_qualifiers_response
