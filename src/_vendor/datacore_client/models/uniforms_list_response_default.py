...
T = TypeVar("T", bound="UniformsListResponseDefault")


@_attrs_define
class UniformsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniforms_list_response_default = cls(
            meta=meta,
            error=error,
        )

        uniforms_list_response_default.additional_properties = d
        return uniforms_list_response_default
