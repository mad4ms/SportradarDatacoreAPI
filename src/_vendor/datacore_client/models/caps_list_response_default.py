...
T = TypeVar("T", bound="CapsListResponseDefault")


@_attrs_define
class CapsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        caps_list_response_default = cls(
            meta=meta,
            error=error,
        )

        caps_list_response_default.additional_properties = d
        return caps_list_response_default
