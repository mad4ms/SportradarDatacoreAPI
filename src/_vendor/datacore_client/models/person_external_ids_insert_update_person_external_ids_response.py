...
if TYPE_CHECKING:
    ...
    from ..models.person_external_ids_model import PersonExternalIdsModel
    from ..models.response_links import ResponseLinks
    from ..models.response_meta_data import ResponseMetaData


T = TypeVar("T", bound="PersonExternalIdsInsertUpdatePersonExternalIdsResponse")


@_attrs_define
class PersonExternalIdsInsertUpdatePersonExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = PersonExternalIdsModel.from_dict(data_item_data)

            data.append(data_item)

        person_external_ids_insert_update_person_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        person_external_ids_insert_update_person_external_ids_response.additional_properties = (
            d
        )
        return person_external_ids_insert_update_person_external_ids_response
