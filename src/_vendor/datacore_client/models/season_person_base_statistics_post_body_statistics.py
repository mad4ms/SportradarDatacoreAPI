...
T = TypeVar("T", bound="SeasonPersonBaseStatisticsPostBodyStatistics")


@_attrs_define
class SeasonPersonBaseStatisticsPostBodyStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_person_base_statistics_post_body_statistics = cls(
        ...
        return season_person_base_statistics_post_body_statistics
