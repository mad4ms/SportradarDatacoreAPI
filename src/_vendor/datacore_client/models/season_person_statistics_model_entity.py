...
@_attrs_define
class SeasonPersonStatisticsModelEntity:
    """The team information

    Attributes:
        resource_type (Union[Unset, SeasonPersonStatisticsModelEntityResourceType]):
        id (Union[Unset, str]): Unique identifier for this resource Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
    """

    resource_type: Union[Unset, SeasonPersonStatisticsModelEntityResourceType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_person_statistics_model_entity = cls(
            resource_type=resource_type,
            id=id,
        )

        season_person_statistics_model_entity.additional_properties = d
        return season_person_statistics_model_entity
