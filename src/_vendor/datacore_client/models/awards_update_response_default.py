...
T = TypeVar("T", bound="AwardsUpdateResponseDefault")


@_attrs_define
class AwardsUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        awards_update_response_default = cls(
            meta=meta,
            error=error,
        )

        awards_update_response_default.additional_properties = d
        return awards_update_response_default
