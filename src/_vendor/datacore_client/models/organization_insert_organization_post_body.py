...
from ..models.organization_insert_organization_post_body_region_type import (
    OrganizationInsertOrganizationPostBodyRegionType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="OrganizationInsertOrganizationPostBody")


@_attrs_define
class OrganizationInsertOrganizationPostBody:
    """
    Attributes:
        ...
        region_type (OrganizationInsertOrganizationPostBodyRegionType): How geographically relevant is this organization
    ...
    name_local: str
    region_type: OrganizationInsertOrganizationPostBodyRegionType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_insert_organization_post_body = cls(
        ...
        return organization_insert_organization_post_body
