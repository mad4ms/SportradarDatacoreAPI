...
T = TypeVar("T", bound="FixturePbpEventResponse")


@_attrs_define
class FixturePbpEventResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_pbp_event_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_pbp_event_response.additional_properties = d
        return fixture_pbp_event_response
