...
T = TypeVar("T", bound="TransfersInsertTransfersResponse")


@_attrs_define
class TransfersInsertTransfersResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfers_insert_transfers_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        transfers_insert_transfers_response.additional_properties = d
        return transfers_insert_transfers_response
