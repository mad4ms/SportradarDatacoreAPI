...
from ..models.season_entities_insert_update_season_teams_post_body_roster_status import (
    SeasonEntitiesInsertUpdateSeasonTeamsPostBodyRosterStatus,
)
from ..models.season_entities_insert_update_season_teams_post_body_status import (
    SeasonEntitiesInsertUpdateSeasonTeamsPostBodyStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeasonEntitiesInsertUpdateSeasonTeamsPostBody")


@_attrs_define
class SeasonEntitiesInsertUpdateSeasonTeamsPostBody:
    """
    Attributes:
        ...
        division_id (Union[None, UUID, Unset]): The unique identifier of the division Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        roster_status (Union[Unset, SeasonEntitiesInsertUpdateSeasonTeamsPostBodyRosterStatus]): The status of the TEAM
            season teams
            >- `APPROVED` Approved
            >- `PENDING` Pending
            >- `REJECTED` Rejected
            >- `SUBMITTED` Submitted
            >- `UNKNOWN` Unknown
             Default: SeasonEntitiesInsertUpdateSeasonTeamsPostBodyRosterStatus.UNKNOWN. Example: APPROVED.
        status (Union[Unset, SeasonEntitiesInsertUpdateSeasonTeamsPostBodyStatus]): Status
            >- `ACTIVE` Active
            >- `INACTIVE` Inactive
            >- `PENDING` Pending
             Example: ACTIVE.
    ...
    roster_status: Union[
        Unset, SeasonEntitiesInsertUpdateSeasonTeamsPostBodyRosterStatus
    ] = SeasonEntitiesInsertUpdateSeasonTeamsPostBodyRosterStatus.UNKNOWN
    status: Union[Unset, SeasonEntitiesInsertUpdateSeasonTeamsPostBodyStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_roster_status, Unset):
            ...
            roster_status = SeasonEntitiesInsertUpdateSeasonTeamsPostBodyRosterStatus(
                _roster_status
            )

        _status = d.pop("status", UNSET)
        status: Union[Unset, SeasonEntitiesInsertUpdateSeasonTeamsPostBodyStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = SeasonEntitiesInsertUpdateSeasonTeamsPostBodyStatus(_status)
        ...
        season_entities_insert_update_season_teams_post_body = cls(
            season_id=season_id,
            entity_id=entity_id,
        ...
        return season_entities_insert_update_season_teams_post_body
