...
T = TypeVar("T", bound="DivisionExternalIdsInsertUpdateDivisionExternalIdsPostBody")


@_attrs_define
class DivisionExternalIdsInsertUpdateDivisionExternalIdsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        division_external_ids_insert_update_division_external_ids_post_body = cls(
            source=source,
        ...
        return division_external_ids_insert_update_division_external_ids_post_body
