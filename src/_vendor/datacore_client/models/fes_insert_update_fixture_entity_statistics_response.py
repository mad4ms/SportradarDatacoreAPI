...
T = TypeVar("T", bound="FesInsertUpdateFixtureEntityStatisticsResponse")


@_attrs_define
class FesInsertUpdateFixtureEntityStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fes_insert_update_fixture_entity_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fes_insert_update_fixture_entity_statistics_response.additional_properties = d
        return fes_insert_update_fixture_entity_statistics_response
