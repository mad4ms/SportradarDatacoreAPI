...
T = TypeVar("T", bound="PersonSwapResponseDefault")


@_attrs_define
class PersonSwapResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_swap_response_default = cls(
            meta=meta,
            error=error,
        )

        person_swap_response_default.additional_properties = d
        return person_swap_response_default
