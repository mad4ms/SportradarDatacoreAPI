...
from ..models.match_person_statistics_post_body_position_type_1 import MatchPersonStatisticsPostBodyPositionType1
from ..models.match_person_statistics_post_body_position_type_2_type_1 import (
    MatchPersonStatisticsPostBodyPositionType2Type1,
)
from ..models.match_person_statistics_post_body_position_type_3_type_1 import (
    MatchPersonStatisticsPostBodyPositionType3Type1,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.match_person_statistics_post_body_statistics import MatchPersonStatisticsPostBodyStatistics


T = TypeVar("T", bound="MatchPersonStatisticsPostBody")


@_attrs_define
class MatchPersonStatisticsPostBody:
    """
    Attributes:
        ...
        statistics (Union[Unset, MatchPersonStatisticsPostBodyStatistics]):
        bib (Union[None, Unset, str]): The number displayed on the jersey Example: 34.
        position (Union[MatchPersonStatisticsPostBodyPositionType1, MatchPersonStatisticsPostBodyPositionType2Type1,
            MatchPersonStatisticsPostBodyPositionType3Type1, None, Unset]): Playing position
            >- None None
            >- `CB` Center Backcourt
    ...
    statistics: Union[Unset, "MatchPersonStatisticsPostBodyStatistics"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.position, Unset):
            position = UNSET
        elif isinstance(self.position, MatchPersonStatisticsPostBodyPositionType1):
            position = self.position.value
        elif isinstance(self.position, MatchPersonStatisticsPostBodyPositionType2Type1):
            position = self.position.value
        elif isinstance(self.position, MatchPersonStatisticsPostBodyPositionType3Type1):
            position = self.position.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_statistics, Unset):
            ...
            statistics = MatchPersonStatisticsPostBodyStatistics.from_dict(_statistics)
        ...
        def _parse_position(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                position_type_1 = MatchPersonStatisticsPostBodyPositionType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                position_type_2_type_1 = MatchPersonStatisticsPostBodyPositionType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                position_type_3_type_1 = MatchPersonStatisticsPostBodyPositionType3Type1(data)
        ...
        match_person_statistics_post_body = cls(
            person_id=person_id,
        ...
        return match_person_statistics_post_body
