...
T = TypeVar("T", bound="RolesListFixturesResponseDefault")


@_attrs_define
class RolesListFixturesResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roles_list_fixtures_response_default = cls(
            meta=meta,
            error=error,
        )

        roles_list_fixtures_response_default.additional_properties = d
        return roles_list_fixtures_response_default
