...
T = TypeVar("T", bound="SpbsInsertUpdateSeasonPersonBaseStatisticsPostBodyStatistics")


@_attrs_define
class SpbsInsertUpdateSeasonPersonBaseStatisticsPostBodyStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spbs_insert_update_season_person_base_statistics_post_body_statistics = cls(
        ...
        return spbs_insert_update_season_person_base_statistics_post_body_statistics
