...
T = TypeVar("T", bound="PersonInsertUpdatePersonsResponse")


@_attrs_define
class PersonInsertUpdatePersonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = PersonModel.from_dict(data_item_data)

            data.append(data_item)

        person_insert_update_persons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        person_insert_update_persons_response.additional_properties = d
        return person_insert_update_persons_response
