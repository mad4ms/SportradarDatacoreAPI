...
from ..models.season_model_discipline_type_2_type_1 import (
    SeasonModelDisciplineType2Type1,
)
from ..models.season_model_discipline_type_3_type_1 import (
...
if TYPE_CHECKING:
    ...
    from ..models.season_model_season_configuration import (
        SeasonModelSeasonConfiguration,
    )
    from ..models.season_model_seasonroster_configuration import (
        SeasonModelSEASONROSTERConfiguration,
    )
    from ..models.season_model_social_media import SeasonModelSocialMedia
    from ..models.season_model_standing_configuration import (
...
class SeasonModel:
    ...
    video_production: Union[Unset, SeasonModelVideoProduction] = (
        SeasonModelVideoProduction.NONE
    )
    promotion_relegation_rules: Union[
        None, Unset, list["SeasonModelPromotionRelegationRulesType0Item"]
    ] = UNSET
    roster_configuration: Union["SeasonModelSEASONROSTERConfiguration", None, Unset] = (
        UNSET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.roster_configuration, Unset):
            ...
            self.roster_configuration, SeasonModelSEASONROSTERConfiguration
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_standing_configuration, Unset):
            ...
            standing_configuration = SeasonModelStandingConfiguration.from_dict(
        ...
        def _parse_configuration(
            data: object,
        ) -> Union["SeasonModelSeasonConfiguration", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_promotion_relegation_rules(
            ...
            try:
                ...
                for (
                    ...
                    promotion_relegation_rules_type_0_item = (
                        SeasonModelPromotionRelegationRulesType0Item.from_dict(
                            promotion_relegation_rules_type_0_item_data
                        )
                    )
        ...
        def _parse_roster_configuration(
            data: object,
        ) -> Union["SeasonModelSEASONROSTERConfiguration", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                roster_configuration_type_0 = (
                    SeasonModelSEASONROSTERConfiguration.from_dict(data)
                )
                ...
                pass
            return cast(
                Union["SeasonModelSEASONROSTERConfiguration", None, Unset], data
            )
