...
T = TypeVar("T", bound="ClubModelClubHistoricalName")


@_attrs_define
class ClubModelClubHistoricalName:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        club_model_club_historical_name = cls(
        ...
        return club_model_club_historical_name
