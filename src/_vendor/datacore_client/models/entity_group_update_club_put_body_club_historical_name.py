...
T = TypeVar("T", bound="EntityGroupUpdateClubPutBodyClubHistoricalName")


@_attrs_define
class EntityGroupUpdateClubPutBodyClubHistoricalName:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_update_club_put_body_club_historical_name = cls(
        ...
        return entity_group_update_club_put_body_club_historical_name
