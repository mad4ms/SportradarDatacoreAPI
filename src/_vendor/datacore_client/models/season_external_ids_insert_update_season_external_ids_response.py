...
if TYPE_CHECKING:
    ...
    from ..models.season_external_ids_model import SeasonExternalIdsModel


T = TypeVar("T", bound="SeasonExternalIdsInsertUpdateSeasonExternalIdsResponse")


@_attrs_define
class SeasonExternalIdsInsertUpdateSeasonExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeasonExternalIdsModel.from_dict(data_item_data)

            data.append(data_item)

        season_external_ids_insert_update_season_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_external_ids_insert_update_season_external_ids_response.additional_properties = (
            d
        )
        return season_external_ids_insert_update_season_external_ids_response
