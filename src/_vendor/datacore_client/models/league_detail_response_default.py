...
T = TypeVar("T", bound="LeagueDetailResponseDefault")


@_attrs_define
class LeagueDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        league_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        league_detail_response_default.additional_properties = d
        return league_detail_response_default
