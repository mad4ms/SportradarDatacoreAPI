...
T = TypeVar("T", bound="FesListFixtureEntityStatisticsResponse")


@_attrs_define
class FesListFixtureEntityStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fes_list_fixture_entity_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fes_list_fixture_entity_statistics_response.additional_properties = d
        return fes_list_fixture_entity_statistics_response
