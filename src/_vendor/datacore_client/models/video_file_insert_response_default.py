...
T = TypeVar("T", bound="VideoFileInsertResponseDefault")


@_attrs_define
class VideoFileInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        video_file_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        video_file_insert_response_default.additional_properties = d
        return video_file_insert_response_default
