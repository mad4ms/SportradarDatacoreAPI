...
T = TypeVar("T", bound="UniformItemsResponse")


@_attrs_define
class UniformItemsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniform_items_response.additional_properties = d
        return uniform_items_response
