...
T = TypeVar("T", bound="VenueUpdateVenuePutBodyVenueHistoricalName")


@_attrs_define
class VenueUpdateVenuePutBodyVenueHistoricalName:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_update_venue_put_body_venue_historical_name = cls(
        ...
        return venue_update_venue_put_body_venue_historical_name
