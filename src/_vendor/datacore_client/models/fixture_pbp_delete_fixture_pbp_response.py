...
T = TypeVar("T", bound="FixturePbpDeleteFixturePbpResponse")


@_attrs_define
class FixturePbpDeleteFixturePbpResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_pbp_delete_fixture_pbp_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_pbp_delete_fixture_pbp_response.additional_properties = d
        return fixture_pbp_delete_fixture_pbp_response
