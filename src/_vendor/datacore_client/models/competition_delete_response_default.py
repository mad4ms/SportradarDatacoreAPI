...
T = TypeVar("T", bound="CompetitionDeleteResponseDefault")


@_attrs_define
class CompetitionDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        competition_delete_response_default.additional_properties = d
        return competition_delete_response_default
