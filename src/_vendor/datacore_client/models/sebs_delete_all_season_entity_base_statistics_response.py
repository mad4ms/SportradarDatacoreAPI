...
T = TypeVar("T", bound="SebsDeleteAllSeasonEntityBaseStatisticsResponse")


@_attrs_define
class SebsDeleteAllSeasonEntityBaseStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sebs_delete_all_season_entity_base_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        sebs_delete_all_season_entity_base_statistics_response.additional_properties = d
        return sebs_delete_all_season_entity_base_statistics_response
