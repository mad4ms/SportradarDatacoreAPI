...
if TYPE_CHECKING:
    from ..models.competition_season_status_model import CompetitionSeasonStatusModel
...
T = TypeVar("T", bound="CompetitionListSeasonStatusCompetitionsSeasonStatusResponse")


@_attrs_define
class CompetitionListSeasonStatusCompetitionsSeasonStatusResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.competition_season_status_model import (
        ...
        for data_item_data in _data or []:
            data_item = CompetitionSeasonStatusModel.from_dict(data_item_data)

            data.append(data_item)

        competition_list_season_status_competitions_season_status_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        competition_list_season_status_competitions_season_status_response.additional_properties = (
            d
        )
        return competition_list_season_status_competitions_season_status_response
