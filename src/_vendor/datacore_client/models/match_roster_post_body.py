...
from ..models.match_roster_post_body_position_type_1 import MatchRosterPostBodyPositionType1
from ..models.match_roster_post_body_position_type_2_type_1 import MatchRosterPostBodyPositionType2Type1
from ..models.match_roster_post_body_position_type_3_type_1 import MatchRosterPostBodyPositionType3Type1
from ..types import UNSET, Unset

T = TypeVar("T", bound="MatchRosterPostBody")


@_attrs_define
class MatchRosterPostBody:
    """
    Attributes:
        ...
        position (Union[MatchRosterPostBodyPositionType1, MatchRosterPostBodyPositionType2Type1,
            MatchRosterPostBodyPositionType3Type1, None, Unset]): Playing position
            >- None None
            >- `CB` Center Backcourt
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.position, Unset):
            position = UNSET
        elif isinstance(self.position, MatchRosterPostBodyPositionType1):
            position = self.position.value
        elif isinstance(self.position, MatchRosterPostBodyPositionType2Type1):
            position = self.position.value
        elif isinstance(self.position, MatchRosterPostBodyPositionType3Type1):
            position = self.position.value
        else:
        ...
        def _parse_position(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                position_type_1 = MatchRosterPostBodyPositionType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                position_type_2_type_1 = MatchRosterPostBodyPositionType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                position_type_3_type_1 = MatchRosterPostBodyPositionType3Type1(data)
