...
T = TypeVar("T", bound="FixtureUpdateResponseDefault")


@_attrs_define
class FixtureUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_update_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_update_response_default.additional_properties = d
        return fixture_update_response_default
