...
T = TypeVar("T", bound="GamelogListpersonResponseDefault")


@_attrs_define
class GamelogListpersonResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gamelog_listperson_response_default = cls(
            meta=meta,
            error=error,
        )

        gamelog_listperson_response_default.additional_properties = d
        return gamelog_listperson_response_default
