...
from ..models.fixture_update_match_put_body_competitor_type import (
    FixtureUpdateMatchPutBodyCompetitorType,
)
from ..models.fixture_update_match_put_body_discipline_type_1 import (
    FixtureUpdateMatchPutBodyDisciplineType1,
)
from ..models.fixture_update_match_put_body_discipline_type_2_type_1 import (
    FixtureUpdateMatchPutBodyDisciplineType2Type1,
)
from ..models.fixture_update_match_put_body_discipline_type_3_type_1 import (
    FixtureUpdateMatchPutBodyDisciplineType3Type1,
)
from ..models.fixture_update_match_put_body_fixture_type import (
    FixtureUpdateMatchPutBodyFixtureType,
)
from ..models.fixture_update_match_put_body_maximum_period_type_used_type_1 import (
    FixtureUpdateMatchPutBodyMaximumPeriodTypeUsedType1,
)
from ..models.fixture_update_match_put_body_maximum_period_type_used_type_2_type_1 import (
    FixtureUpdateMatchPutBodyMaximumPeriodTypeUsedType2Type1,
)
from ..models.fixture_update_match_put_body_maximum_period_type_used_type_3_type_1 import (
    FixtureUpdateMatchPutBodyMaximumPeriodTypeUsedType3Type1,
)
from ..models.fixture_update_match_put_body_practice_drill_type_type_1 import (
    FixtureUpdateMatchPutBodyPracticeDrillTypeType1,
)
from ..models.fixture_update_match_put_body_practice_drill_type_type_2_type_1 import (
    FixtureUpdateMatchPutBodyPracticeDrillTypeType2Type1,
)
from ..models.fixture_update_match_put_body_practice_drill_type_type_3_type_1 import (
    FixtureUpdateMatchPutBodyPracticeDrillTypeType3Type1,
)
from ..models.fixture_update_match_put_body_status import (
    FixtureUpdateMatchPutBodyStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.fixture_update_match_put_body_broadcasts import (
        FixtureUpdateMatchPutBodyBroadcasts,
    )
    from ..models.fixture_update_match_put_body_environmental_details import (
        FixtureUpdateMatchPutBodyEnvironmentalDetails,
    )
    from ..models.fixture_update_match_put_body_match_competitor import (
        FixtureUpdateMatchPutBodyMatchCompetitor,
    )
    from ..models.fixture_update_match_put_body_social_media import (
        FixtureUpdateMatchPutBodySocialMedia,
    )


T = TypeVar("T", bound="FixtureUpdateMatchPutBody")


@_attrs_define
class FixtureUpdateMatchPutBody:
    """
    Attributes:
        season_id (Union[Unset, UUID]): The unique identifier of the season Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        practice_drill_type (Union[FixtureUpdateMatchPutBodyPracticeDrillTypeType1,
            FixtureUpdateMatchPutBodyPracticeDrillTypeType2Type1, FixtureUpdateMatchPutBodyPracticeDrillTypeType3Type1,
            None, Unset]): Practice types
            >- None None
            >- `DRILL` Drill
            >- `FITNESS` Fitness
            >- `GAME` Practice Game
        ...
        status (Union[Unset, FixtureUpdateMatchPutBodyStatus]): Match status
            ...
            >- `WARM_UP` Warm Up - Players have begun to warm up
             Default: FixtureUpdateMatchPutBodyStatus.SCHEDULED. Example: SCHEDULED.
        ...
        social (Union['FixtureUpdateMatchPutBodySocialMedia', None, Unset]): Social Media contacts
        environmental (Union['FixtureUpdateMatchPutBodyEnvironmentalDetails', None, Unset]): Details about the
        ...
        fixture_type (Union[Unset, FixtureUpdateMatchPutBodyFixtureType]): Type of match
            >- `ALL_STAR` All Star
            ...
            >- `REGULAR` Regular
             Example: REGULAR.
        maximum_period_type_used (Union[FixtureUpdateMatchPutBodyMaximumPeriodTypeUsedType1,
            FixtureUpdateMatchPutBodyMaximumPeriodTypeUsedType2Type1,
            FixtureUpdateMatchPutBodyMaximumPeriodTypeUsedType3Type1, None, Unset]): Maximum Period Type Used
            >- None None
            ...
            >- `SHOOTOUT` Shoot-Out
             Example: REGULAR.
        competitor_type (Union[Unset, FixtureUpdateMatchPutBodyCompetitorType]): The type of competitors in this match
            >- `ENTITY` Entity
            >- `PERSON` Person
             Example: ENTITY.
        competitors (Union[None, Unset, list['FixtureUpdateMatchPutBodyMatchCompetitor']]): Array of match competitors
        ...
        discipline (Union[FixtureUpdateMatchPutBodyDisciplineType1, FixtureUpdateMatchPutBodyDisciplineType2Type1,
            FixtureUpdateMatchPutBodyDisciplineType3Type1, None, Unset]): match discipline
            >- None None
            >- `INDOOR` Indoor
            >- `OUTDOOR` Outdoor
             Example: INDOOR.
        broadcasts (Union[Unset, list[Union['FixtureUpdateMatchPutBodyBroadcasts', None]]]):
    """
    ...
    status: Union[Unset, FixtureUpdateMatchPutBodyStatus] = (
        FixtureUpdateMatchPutBodyStatus.SCHEDULED
    )
    ...
    social: Union["FixtureUpdateMatchPutBodySocialMedia", None, Unset] = UNSET
    environmental: Union[
        "FixtureUpdateMatchPutBodyEnvironmentalDetails", None, Unset
    ] = UNSET
    ...
    fixture_type: Union[Unset, FixtureUpdateMatchPutBodyFixtureType] = UNSET
    ...
    competitor_type: Union[Unset, FixtureUpdateMatchPutBodyCompetitorType] = UNSET
    competitors: Union[
        None, Unset, list["FixtureUpdateMatchPutBodyMatchCompetitor"]
    ] = UNSET
    ...
    broadcasts: Union[
        Unset, list[Union["FixtureUpdateMatchPutBodyBroadcasts", None]]
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.practice_drill_type, Unset):
            ...
            self.practice_drill_type, FixtureUpdateMatchPutBodyPracticeDrillTypeType1
        ):
        ...
        if isinstance(self.social, Unset):
            social = UNSET
        elif isinstance(self.social, FixtureUpdateMatchPutBodySocialMedia):
        ...
        if isinstance(self.environmental, Unset):
            ...
            self.environmental, FixtureUpdateMatchPutBodyEnvironmentalDetails
        ):
        ...
        if isinstance(self.discipline, Unset):
            discipline = UNSET
        elif isinstance(self.discipline, FixtureUpdateMatchPutBodyDisciplineType1):
            discipline = self.discipline.value
        elif isinstance(self.discipline, FixtureUpdateMatchPutBodyDisciplineType2Type1):
            discipline = self.discipline.value
        elif isinstance(self.discipline, FixtureUpdateMatchPutBodyDisciplineType3Type1):
            discipline = self.discipline.value
        else:
        ...
        if not isinstance(self.broadcasts, Unset):
            ...
            for broadcasts_item_data in self.broadcasts:
                ...
                if isinstance(
                    broadcasts_item_data, FixtureUpdateMatchPutBodyBroadcasts
                ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_practice_drill_type(
            ...
            try:
                ...
                practice_drill_type_type_1 = (
                    FixtureUpdateMatchPutBodyPracticeDrillTypeType1(data)
                )
            ...
            try:
                ...
                practice_drill_type_type_2_type_1 = (
                    FixtureUpdateMatchPutBodyPracticeDrillTypeType2Type1(data)
                )
            ...
            try:
                ...
                practice_drill_type_type_3_type_1 = (
                    FixtureUpdateMatchPutBodyPracticeDrillTypeType3Type1(data)
                )
        ...
        if isinstance(_status, Unset):
            ...
            status = FixtureUpdateMatchPutBodyStatus(_status)
        ...
        def _parse_social(
            data: object,
        ) -> Union["FixtureUpdateMatchPutBodySocialMedia", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                social_type_0 = FixtureUpdateMatchPutBodySocialMedia.from_dict(data)

                return social_type_0
            except:  # noqa: E722
                pass
            return cast(
                Union["FixtureUpdateMatchPutBodySocialMedia", None, Unset], data
            )
        ...
        def _parse_environmental(
            data: object,
        ) -> Union["FixtureUpdateMatchPutBodyEnvironmentalDetails", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                environmental_type_0 = (
                    FixtureUpdateMatchPutBodyEnvironmentalDetails.from_dict(data)
                )
        ...
        fixture_type: Union[Unset, FixtureUpdateMatchPutBodyFixtureType]
        if isinstance(_fixture_type, Unset):
            fixture_type = UNSET
        else:
            fixture_type = FixtureUpdateMatchPutBodyFixtureType(_fixture_type)
        ...
        def _parse_maximum_period_type_used(
            ...
            try:
                ...
                maximum_period_type_used_type_1 = (
                    FixtureUpdateMatchPutBodyMaximumPeriodTypeUsedType1(data)
                )
            ...
            try:
                ...
                maximum_period_type_used_type_2_type_1 = (
                    FixtureUpdateMatchPutBodyMaximumPeriodTypeUsedType2Type1(data)
                )
            ...
            try:
                ...
                maximum_period_type_used_type_3_type_1 = (
                    FixtureUpdateMatchPutBodyMaximumPeriodTypeUsedType3Type1(data)
                )
        ...
        competitor_type: Union[Unset, FixtureUpdateMatchPutBodyCompetitorType]
        if isinstance(_competitor_type, Unset):
            competitor_type = UNSET
        else:
            competitor_type = FixtureUpdateMatchPutBodyCompetitorType(_competitor_type)

        def _parse_competitors(
            data: object,
        ) -> Union[None, Unset, list["FixtureUpdateMatchPutBodyMatchCompetitor"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for competitors_type_0_item_data in _competitors_type_0:
                    competitors_type_0_item = (
                        FixtureUpdateMatchPutBodyMatchCompetitor.from_dict(
        ...
        def _parse_discipline(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                discipline_type_1 = FixtureUpdateMatchPutBodyDisciplineType1(data)
            ...
            try:
                ...
                discipline_type_2_type_1 = (
                    FixtureUpdateMatchPutBodyDisciplineType2Type1(data)
                )
            ...
            try:
                ...
                discipline_type_3_type_1 = (
                    FixtureUpdateMatchPutBodyDisciplineType3Type1(data)
                )
        ...
        for broadcasts_item_data in _broadcasts or []:
            ...
            def _parse_broadcasts_item(
                data: object,
            ) -> Union["FixtureUpdateMatchPutBodyBroadcasts", None]:
                if data is None:
                    return data
                try:
                    if not isinstance(data, dict):
                    ...
                    broadcasts_item_type_0 = (
                        FixtureUpdateMatchPutBodyBroadcasts.from_dict(data)
                    )

                    return broadcasts_item_type_0
                except:  # noqa: E722
                    pass
                return cast(Union["FixtureUpdateMatchPutBodyBroadcasts", None], data)

            broadcasts_item = _parse_broadcasts_item(broadcasts_item_data)

            broadcasts.append(broadcasts_item)

        fixture_update_match_put_body = cls(
            season_id=season_id,
        ...
        return fixture_update_match_put_body
