...
T = TypeVar("T", bound="SeasonPersonPlacingsResponse")


@_attrs_define
class SeasonPersonPlacingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_person_placings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_person_placings_response.additional_properties = d
        return season_person_placings_response
