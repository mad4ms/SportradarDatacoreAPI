...
T = TypeVar("T", bound="StandingUpdateStandingsResponse")


@_attrs_define
class StandingUpdateStandingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_update_standings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_update_standings_response.additional_properties = d
        return standing_update_standings_response
