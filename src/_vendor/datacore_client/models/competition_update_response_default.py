...
T = TypeVar("T", bound="CompetitionUpdateResponseDefault")


@_attrs_define
class CompetitionUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_update_response_default = cls(
            meta=meta,
            error=error,
        )

        competition_update_response_default.additional_properties = d
        return competition_update_response_default
