...
T = TypeVar("T", bound="EntityExternalIdsInsertUpdateTeamExternalIdsPostBody")


@_attrs_define
class EntityExternalIdsInsertUpdateTeamExternalIdsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_external_ids_insert_update_team_external_ids_post_body = cls(
            source=source,
        ...
        return entity_external_ids_insert_update_team_external_ids_post_body
