...
T = TypeVar("T", bound="PersonInsertResponseDefault")


@_attrs_define
class PersonInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        person_insert_response_default.additional_properties = d
        return person_insert_response_default
