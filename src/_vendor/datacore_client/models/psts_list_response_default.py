...
T = TypeVar("T", bound="PstsListResponseDefault")


@_attrs_define
class PstsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        psts_list_response_default = cls(
            meta=meta,
            error=error,
        )

        psts_list_response_default.additional_properties = d
        return psts_list_response_default
