...
if TYPE_CHECKING:
    from ..models.division_model import DivisionModel
...
T = TypeVar("T", bound="DivisionDeleteDivisionsResponse")


@_attrs_define
class DivisionDeleteDivisionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = DivisionModel.from_dict(data_item_data)

            data.append(data_item)

        division_delete_divisions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        division_delete_divisions_response.additional_properties = d
        return division_delete_divisions_response
