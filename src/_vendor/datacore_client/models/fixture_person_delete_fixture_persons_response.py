...
T = TypeVar("T", bound="FixturePersonDeleteFixturePersonsResponse")


@_attrs_define
class FixturePersonDeleteFixturePersonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_person_delete_fixture_persons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_person_delete_fixture_persons_response.additional_properties = d
        return fixture_person_delete_fixture_persons_response
