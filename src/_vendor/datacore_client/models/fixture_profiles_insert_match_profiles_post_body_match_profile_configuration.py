...
from ..models.fixture_profiles_insert_match_profiles_post_body_match_profile_configuration_match_roles_item import (
    FixtureProfilesInsertMatchProfilesPostBodyMatchProfileConfigurationMatchRolesItem,
)
from ..models.fixture_profiles_insert_match_profiles_post_body_match_profile_configuration_type_of_cards_item import (
    FixtureProfilesInsertMatchProfilesPostBodyMatchProfileConfigurationTypeOfCardsItem,
)
from ..types import UNSET, Unset

T = TypeVar(
    "T", bound="FixtureProfilesInsertMatchProfilesPostBodyMatchProfileConfiguration"
)


@_attrs_define
class FixtureProfilesInsertMatchProfilesPostBodyMatchProfileConfiguration:
    ...
    Attributes:
        ...
        type_of_cards (Union[Unset,
            list[FixtureProfilesInsertMatchProfilesPostBodyMatchProfileConfigurationTypeOfCardsItem]]): The type of cards
        ...
        blue_card_seconds (Union[Unset, float]): The length (in seconds) a player leaves the field for when issued a
            blue card.
        match_roles (Union[Unset,
            list[FixtureProfilesInsertMatchProfilesPostBodyMatchProfileConfigurationMatchRolesItem]]): The official roles
            that are assignable for this match.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if maximum_goalkeeper_substitutions is not UNSET:
            field_dict["maximumGoalkeeperSubstitutions"] = (
                maximum_goalkeeper_substitutions
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        maximum_goalkeeper_substitutions = d.pop(
            "maximumGoalkeeperSubstitutions", UNSET
        )

        type_of_cards = []
        _type_of_cards = d.pop("typeOfCards", UNSET)
        for type_of_cards_item_data in _type_of_cards or []:
            type_of_cards_item = FixtureProfilesInsertMatchProfilesPostBodyMatchProfileConfigurationTypeOfCardsItem(
                type_of_cards_item_data
            )
        ...
        for match_roles_item_data in _match_roles or []:
            match_roles_item = FixtureProfilesInsertMatchProfilesPostBodyMatchProfileConfigurationMatchRolesItem(
                match_roles_item_data
            )
        ...
        def _parse_switch_playing_direction(
            data: object,
        ...
        switch_playing_direction = _parse_switch_playing_direction(
            d.pop("switchPlayingDirection", UNSET)
        )
        ...
        def _parse_reset_timeouts_after_periods(
            data: object,
        ) -> Union[None, Unset, list[float]]:
            if data is None:
                return data
        ...
        reset_timeouts_after_periods = _parse_reset_timeouts_after_periods(
            d.pop("resetTimeoutsAfterPeriods", UNSET)
        )

        fixture_profiles_insert_match_profiles_post_body_match_profile_configuration = (
            cls(
