...
T = TypeVar("T", bound="PersonExternalIdsListResponseDefault")


@_attrs_define
class PersonExternalIdsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_external_ids_list_response_default = cls(
            meta=meta,
            error=error,
        )

        person_external_ids_list_response_default.additional_properties = d
        return person_external_ids_list_response_default
