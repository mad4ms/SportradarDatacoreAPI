...
T = TypeVar("T", bound="SeasonFixtureStagesPoolsListResponse")


@_attrs_define
class SeasonFixtureStagesPoolsListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_fixture_stages_pools_list_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_fixture_stages_pools_list_response.additional_properties = d
        return season_fixture_stages_pools_list_response
