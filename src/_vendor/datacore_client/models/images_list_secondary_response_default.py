...
T = TypeVar("T", bound="ImagesListSecondaryResponseDefault")


@_attrs_define
class ImagesListSecondaryResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_list_secondary_response_default = cls(
            meta=meta,
            error=error,
        )

        images_list_secondary_response_default.additional_properties = d
        return images_list_secondary_response_default
