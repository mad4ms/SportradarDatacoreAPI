...
T = TypeVar("T", bound="SiteUpdateResponseDefault")


@_attrs_define
class SiteUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_update_response_default = cls(
            meta=meta,
            error=error,
        )

        site_update_response_default.additional_properties = d
        return site_update_response_default
