...
T = TypeVar("T", bound="EntityGroupInsertClubPostBodyContactDetails")


@_attrs_define
class EntityGroupInsertClubPostBodyContactDetails:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_insert_club_post_body_contact_details = cls(
            fax=fax,
            phone=phone,
        ...
        return entity_group_insert_club_post_body_contact_details
