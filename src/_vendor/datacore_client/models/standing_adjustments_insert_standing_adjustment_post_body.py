...
from ..models.standing_adjustments_insert_standing_adjustment_post_body_adjustment_field import (
    StandingAdjustmentsInsertStandingAdjustmentPostBodyAdjustmentField,
)
from ..models.standing_adjustments_insert_standing_adjustment_post_body_adjustment_group import (
    StandingAdjustmentsInsertStandingAdjustmentPostBodyAdjustmentGroup,
)
from ..models.standing_adjustments_insert_standing_adjustment_post_body_adjustment_type import (
    StandingAdjustmentsInsertStandingAdjustmentPostBodyAdjustmentType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="StandingAdjustmentsInsertStandingAdjustmentPostBody")


@_attrs_define
class StandingAdjustmentsInsertStandingAdjustmentPostBody:
    """
    Attributes:
        ...
        adjustment_group (StandingAdjustmentsInsertStandingAdjustmentPostBodyAdjustmentGroup): Adjustment Group
            >- `IN_CONFERENCE` In Conference
            >- `IN_DIVISION` In Division
            >- `OUT_CONFERENCE` Out Conference
            >- `OUT_DIVISION` Out Division
            >- `OVERALL` Overall
        adjustment_type (StandingAdjustmentsInsertStandingAdjustmentPostBodyAdjustmentType): Adjustment Type
            >- `ADD_MINUS` Add/Subtract Value
            >- `SET` Set Value
        adjustment_field (StandingAdjustmentsInsertStandingAdjustmentPostBodyAdjustmentField): Adjustment field to
            calculate standings
            >- `byes` Byes
            >- `draws` Games Drawn
    ...
    season_id: UUID
    entity_id: UUID
    adjustment_group: StandingAdjustmentsInsertStandingAdjustmentPostBodyAdjustmentGroup
    adjustment_type: StandingAdjustmentsInsertStandingAdjustmentPostBodyAdjustmentType
    adjustment_field: StandingAdjustmentsInsertStandingAdjustmentPostBodyAdjustmentField
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        adjustment_group = (
            StandingAdjustmentsInsertStandingAdjustmentPostBodyAdjustmentGroup(
                d.pop("adjustmentGroup")
            )
        )

        adjustment_type = (
            StandingAdjustmentsInsertStandingAdjustmentPostBodyAdjustmentType(
                d.pop("adjustmentType")
            )
        )

        adjustment_field = (
            StandingAdjustmentsInsertStandingAdjustmentPostBodyAdjustmentField(
                d.pop("adjustmentField")
            )
        )
        ...
        standing_adjustments_insert_standing_adjustment_post_body = cls(
            season_id=season_id,
            entity_id=entity_id,
        ...
        return standing_adjustments_insert_standing_adjustment_post_body
