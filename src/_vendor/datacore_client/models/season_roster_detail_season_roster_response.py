...
T = TypeVar("T", bound="SeasonRosterDetailSeasonRosterResponse")


@_attrs_define
class SeasonRosterDetailSeasonRosterResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_roster_detail_season_roster_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_roster_detail_season_roster_response.additional_properties = d
        return season_roster_detail_season_roster_response
