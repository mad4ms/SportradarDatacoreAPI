...
if TYPE_CHECKING:
    from ..models.conference_external_ids_model import ConferenceExternalIdsModel
...
T = TypeVar("T", bound="ConferenceExternalIdsInsertUpdateConferenceExternalIdsResponse")


@_attrs_define
class ConferenceExternalIdsInsertUpdateConferenceExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = ConferenceExternalIdsModel.from_dict(data_item_data)

            data.append(data_item)

        conference_external_ids_insert_update_conference_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        conference_external_ids_insert_update_conference_external_ids_response.additional_properties = (
            d
        )
        return conference_external_ids_insert_update_conference_external_ids_response
