...
T = TypeVar("T", bound="SeasonExternalIdsListResponseDefault")


@_attrs_define
class SeasonExternalIdsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_external_ids_list_response_default = cls(
            meta=meta,
            error=error,
        )

        season_external_ids_list_response_default.additional_properties = d
        return season_external_ids_list_response_default
