...
T = TypeVar("T", bound="ImagesInsertResponseDefault")


@_attrs_define
class ImagesInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        images_insert_response_default.additional_properties = d
        return images_insert_response_default
