...
T = TypeVar("T", bound="ImagesForFixtureListResponseDefault")


@_attrs_define
class ImagesForFixtureListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_for_fixture_list_response_default = cls(
            meta=meta,
            error=error,
        )

        images_for_fixture_list_response_default.additional_properties = d
        return images_for_fixture_list_response_default
