...
from ..models.uniform_items_insert_uniform_items_post_body_item_type import (
    UniformItemsInsertUniformItemsPostBodyItemType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.uniform_items_insert_uniform_items_post_body_colors import (
        UniformItemsInsertUniformItemsPostBodyColors,
    )


T = TypeVar("T", bound="UniformItemsInsertUniformItemsPostBody")


@_attrs_define
class UniformItemsInsertUniformItemsPostBody:
    """
    Attributes:
        uniform_id (UUID): The unique identifier of the uniform Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        item_type (UniformItemsInsertUniformItemsPostBodyItemType): The type of Uniform Item
            >- `BOTTOM` Bottom
        ...
        colors (Union[Unset, UniformItemsInsertUniformItemsPostBodyColors]):
    """

    uniform_id: UUID
    item_type: UniformItemsInsertUniformItemsPostBodyItemType
    uniform_item_id: Union[Unset, UUID] = UNSET
    name_local: Union[Unset, str] = UNSET
    name_latin: Union[None, Unset, str] = UNSET
    colors: Union[Unset, "UniformItemsInsertUniformItemsPostBodyColors"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        item_type = UniformItemsInsertUniformItemsPostBodyItemType(d.pop("itemType"))
        ...
        if isinstance(_colors, Unset):
            ...
            colors = UniformItemsInsertUniformItemsPostBodyColors.from_dict(_colors)

        uniform_items_insert_uniform_items_post_body = cls(
        ...
        return uniform_items_insert_uniform_items_post_body
