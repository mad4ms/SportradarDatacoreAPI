...
T = TypeVar("T", bound="LeagueUpdateResponseDefault")


@_attrs_define
class LeagueUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        league_update_response_default = cls(
            meta=meta,
            error=error,
        )

        league_update_response_default.additional_properties = d
        return league_update_response_default
