...
T = TypeVar("T", bound="EntityUpdateTeamPutBodyTeamHistoricalName")


@_attrs_define
class EntityUpdateTeamPutBodyTeamHistoricalName:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_update_team_put_body_team_historical_name = cls(
        ...
        return entity_update_team_put_body_team_historical_name
