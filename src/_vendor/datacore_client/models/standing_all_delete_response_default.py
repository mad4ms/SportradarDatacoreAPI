...
T = TypeVar("T", bound="StandingAllDeleteResponseDefault")


@_attrs_define
class StandingAllDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_all_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        standing_all_delete_response_default.additional_properties = d
        return standing_all_delete_response_default
