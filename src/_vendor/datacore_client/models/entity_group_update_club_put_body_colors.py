...
T = TypeVar("T", bound="EntityGroupUpdateClubPutBodyColors")


@_attrs_define
class EntityGroupUpdateClubPutBodyColors:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_update_club_put_body_colors = cls(
            primary=primary,
            secondary=secondary,
            tertiary=tertiary,
        )

        entity_group_update_club_put_body_colors.additional_properties = d
        return entity_group_update_club_put_body_colors
