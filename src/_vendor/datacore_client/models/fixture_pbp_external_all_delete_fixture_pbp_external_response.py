...
if TYPE_CHECKING:
    from ..models.fixture_pbp_external_model import FixturePbpExternalModel
...
T = TypeVar("T", bound="FixturePbpExternalAllDeleteFixturePbpExternalResponse")


@_attrs_define
class FixturePbpExternalAllDeleteFixturePbpExternalResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = FixturePbpExternalModel.from_dict(data_item_data)

            data.append(data_item)

        fixture_pbp_external_all_delete_fixture_pbp_external_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_pbp_external_all_delete_fixture_pbp_external_response.additional_properties = (
            d
        )
        return fixture_pbp_external_all_delete_fixture_pbp_external_response
