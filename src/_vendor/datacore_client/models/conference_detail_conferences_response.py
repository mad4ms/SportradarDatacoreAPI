...
T = TypeVar("T", bound="ConferenceDetailConferencesResponse")


@_attrs_define
class ConferenceDetailConferencesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = ConferenceModel.from_dict(data_item_data)

            data.append(data_item)

        conference_detail_conferences_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        conference_detail_conferences_response.additional_properties = d
        return conference_detail_conferences_response
