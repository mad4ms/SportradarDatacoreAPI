...
T = TypeVar("T", bound="PersonInsertUpdateResponseDefault")


@_attrs_define
class PersonInsertUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_insert_update_response_default = cls(
            meta=meta,
            error=error,
        )

        person_insert_update_response_default.additional_properties = d
        return person_insert_update_response_default
