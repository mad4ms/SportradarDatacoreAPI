...
if TYPE_CHECKING:
    ...
    from ..models.season_person_base_statistics_model import (
        SeasonPersonBaseStatisticsModel,
    )


T = TypeVar("T", bound="SpbsInsertUpdateSeasonPersonBaseStatisticsResponse")


@_attrs_define
class SpbsInsertUpdateSeasonPersonBaseStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeasonPersonBaseStatisticsModel.from_dict(data_item_data)

            data.append(data_item)

        spbs_insert_update_season_person_base_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        spbs_insert_update_season_person_base_statistics_response.additional_properties = (
            d
        )
        return spbs_insert_update_season_person_base_statistics_response
