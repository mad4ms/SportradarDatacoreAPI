...
T = TypeVar("T", bound="SesListperiodsResponseDefault")


@_attrs_define
class SesListperiodsResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ses_listperiods_response_default = cls(
            meta=meta,
            error=error,
        )

        ses_listperiods_response_default.additional_properties = d
        return ses_listperiods_response_default
