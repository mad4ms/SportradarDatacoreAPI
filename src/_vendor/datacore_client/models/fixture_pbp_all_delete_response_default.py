...
T = TypeVar("T", bound="FixturePbpAllDeleteResponseDefault")


@_attrs_define
class FixturePbpAllDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_pbp_all_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_pbp_all_delete_response_default.additional_properties = d
        return fixture_pbp_all_delete_response_default
