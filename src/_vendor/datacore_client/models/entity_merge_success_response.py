...
T = TypeVar("T", bound="EntityMergeSuccessResponse")


@_attrs_define
class EntityMergeSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_merge_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_merge_success_response.additional_properties = d
        return entity_merge_success_response
