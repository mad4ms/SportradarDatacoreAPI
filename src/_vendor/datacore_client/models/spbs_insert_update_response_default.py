...
T = TypeVar("T", bound="SpbsInsertUpdateResponseDefault")


@_attrs_define
class SpbsInsertUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spbs_insert_update_response_default = cls(
            meta=meta,
            error=error,
        )

        spbs_insert_update_response_default.additional_properties = d
        return spbs_insert_update_response_default
