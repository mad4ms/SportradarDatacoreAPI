...
if TYPE_CHECKING:
    ...
    from ..models.match_teams_model import MatchTeamsModel
    from ..models.response_links import ResponseLinks
    from ..models.response_meta_data import ResponseMetaData


T = TypeVar("T", bound="FixtureEntitiesInsertUpdateFixtureEntitiesResponse")


@_attrs_define
class FixtureEntitiesInsertUpdateFixtureEntitiesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = MatchTeamsModel.from_dict(data_item_data)

            data.append(data_item)

        fixture_entities_insert_update_fixture_entities_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_entities_insert_update_fixture_entities_response.additional_properties = (
            d
        )
        return fixture_entities_insert_update_fixture_entities_response
