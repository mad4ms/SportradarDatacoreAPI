...
T = TypeVar("T", bound="EntityExternalIdsInsertTeamExternalIdsPostBody")


@_attrs_define
class EntityExternalIdsInsertTeamExternalIdsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_external_ids_insert_team_external_ids_post_body = cls(
            source=source,
        ...
        return entity_external_ids_insert_team_external_ids_post_body
