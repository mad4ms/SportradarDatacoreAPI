...
T = TypeVar("T", bound="UniformItemsInsertBaseRouteUniformItemsPostBodyColors")


@_attrs_define
class UniformItemsInsertBaseRouteUniformItemsPostBodyColors:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniform_items_insert_base_route_uniform_items_post_body_colors = cls(
            lettering=lettering,
            primary=primary,
            secondary=secondary,
            tertiary=tertiary,
        ...
        uniform_items_insert_base_route_uniform_items_post_body_colors.additional_properties = (
            d
        )
        return uniform_items_insert_base_route_uniform_items_post_body_colors
