...
T = TypeVar("T", bound="SepUpdateResponseDefault")


@_attrs_define
class SepUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sep_update_response_default = cls(
            meta=meta,
            error=error,
        )

        sep_update_response_default.additional_properties = d
        return sep_update_response_default
