...
T = TypeVar("T", bound="SeasonEntitiesDeleteResponseDefault")


@_attrs_define
class SeasonEntitiesDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_entities_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        season_entities_delete_response_default.additional_properties = d
        return season_entities_delete_response_default
