...
from ..models.conduct_penalty_result_penalty_type import ConductPenaltyResultPenaltyType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ConductPenaltyResult")


@_attrs_define
class ConductPenaltyResult:
    """
    Attributes:
        penalty_type (Union[Unset, ConductPenaltyResultPenaltyType]): Penalty type Example: WEEK.
        penalty_value (Union[None, Unset, int]): Penalty value Example: 6.
    """

    penalty_type: Union[Unset, ConductPenaltyResultPenaltyType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        penalty_type: Union[Unset, ConductPenaltyResultPenaltyType]
        if isinstance(_penalty_type, Unset):
            penalty_type = UNSET
        else:
            penalty_type = ConductPenaltyResultPenaltyType(_penalty_type)
        ...
        conduct_penalty_result = cls(
            penalty_type=penalty_type,
            penalty_value=penalty_value,
        )

        return conduct_penalty_result
