...
T = TypeVar("T", bound="MatchTeamPeriodStatisticsModelStatistics")


@_attrs_define
class MatchTeamPeriodStatisticsModelStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        match_team_period_statistics_model_statistics = cls(
            assists=assists,
        ...
        return match_team_period_statistics_model_statistics
