...
T = TypeVar("T", bound="EntityMergeResponseDefault")


@_attrs_define
class EntityMergeResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_merge_response_default = cls(
            meta=meta,
            error=error,
        )

        entity_merge_response_default.additional_properties = d
        return entity_merge_response_default
