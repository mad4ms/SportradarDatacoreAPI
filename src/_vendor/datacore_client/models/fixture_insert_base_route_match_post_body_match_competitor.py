...
from ..models.fixture_insert_base_route_match_post_body_match_competitor_result_status import (
    FixtureInsertBaseRouteMatchPostBodyMatchCompetitorResultStatus,
)
from ..models.fixture_insert_base_route_match_post_body_match_competitor_roster_status import (
    FixtureInsertBaseRouteMatchPostBodyMatchCompetitorRosterStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FixtureInsertBaseRouteMatchPostBodyMatchCompetitor")


@_attrs_define
class FixtureInsertBaseRouteMatchPostBodyMatchCompetitor:
    """
    Attributes:
        ...
        result_status (Union[Unset, FixtureInsertBaseRouteMatchPostBodyMatchCompetitorResultStatus]): Result status
        ...
        roster_status (Union[Unset, FixtureInsertBaseRouteMatchPostBodyMatchCompetitorRosterStatus]): Roster status
    ...
    result_status: Union[
        Unset, FixtureInsertBaseRouteMatchPostBodyMatchCompetitorResultStatus
    ] = UNSET
    ...
    roster_status: Union[
        Unset, FixtureInsertBaseRouteMatchPostBodyMatchCompetitorRosterStatus
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_insert_base_route_match_post_body_match_competitor = cls(
            entity_id=entity_id,
        ...
        return fixture_insert_base_route_match_post_body_match_competitor
