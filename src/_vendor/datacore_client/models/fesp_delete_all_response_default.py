...
T = TypeVar("T", bound="FespDeleteAllResponseDefault")


@_attrs_define
class FespDeleteAllResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fesp_delete_all_response_default = cls(
            meta=meta,
            error=error,
        )

        fesp_delete_all_response_default.additional_properties = d
        return fesp_delete_all_response_default
