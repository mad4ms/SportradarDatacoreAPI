...
@_attrs_define
class VenueExternalIdsModelOrganization:
    """The organization that this venue external ids belongs to

    Attributes:
        resource_type (Union[Unset, VenueExternalIdsModelOrganizationResourceType]):
        id (Union[Unset, str]): Unique identifier for this resource Example: 9.
    """

    resource_type: Union[Unset, VenueExternalIdsModelOrganizationResourceType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_external_ids_model_organization = cls(
            resource_type=resource_type,
            id=id,
        )

        venue_external_ids_model_organization.additional_properties = d
        return venue_external_ids_model_organization
