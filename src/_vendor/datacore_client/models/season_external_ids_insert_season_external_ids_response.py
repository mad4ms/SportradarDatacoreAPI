...
T = TypeVar("T", bound="SeasonExternalIdsInsertSeasonExternalIdsResponse")


@_attrs_define
class SeasonExternalIdsInsertSeasonExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_external_ids_insert_season_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_external_ids_insert_season_external_ids_response.additional_properties = (
            d
        )
        return season_external_ids_insert_season_external_ids_response
