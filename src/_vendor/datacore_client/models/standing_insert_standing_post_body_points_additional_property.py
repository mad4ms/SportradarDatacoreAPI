...
T = TypeVar("T", bound="StandingInsertStandingPostBodyPointsAdditionalProperty")


@_attrs_define
class StandingInsertStandingPostBodyPointsAdditionalProperty:
    """Type of points
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_insert_standing_post_body_points_additional_property = cls(
        ...
        return standing_insert_standing_post_body_points_additional_property
