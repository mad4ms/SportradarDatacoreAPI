...
from ..models.conduct_model_role_type_3_type_1 import ConductModelRoleType3Type1
from ..models.conduct_model_status_type_1 import ConductModelStatusType1
from ..models.conduct_model_status_type_2_type_1 import ConductModelStatusType2Type1
from ..models.conduct_model_status_type_3_type_1 import ConductModelStatusType3Type1
...
if TYPE_CHECKING:
    ...
    from ..models.conduct_model_organization import ConductModelOrganization
...
class ConductModel:
    ...
    Attributes:
        ...
        organization (Union[Unset, ConductModelOrganization]): The organization that this conduct belongs to
        person_id (Union[Unset, UUID]): The unique identifier of the person Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        person (Union[Unset, ConductModelPerson]): The person information
        entity_group_id (Union[Unset, UUID]): The club that this team belongs to Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        entity_group (Union[Unset, ConductModelEntityGroup]): The club that this team belongs to
        entity_id (Union[Unset, UUID]): The unique identifier of the team Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        entity (Union[Unset, ConductModelEntity]): The team information
        venue_id (Union[Unset, UUID]): The unique identifier of the venue Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        venue (Union[Unset, ConductModelVenue]): The venue that this match belongs to
        fixture_id (Union[Unset, UUID]): The unique identifier of the match Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        fixture (Union[Unset, ConductModelFixture]): The match
        season_id (Union[Unset, UUID]): The unique identifier of the season Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        season (Union[Unset, ConductModelSeason]): The season linked to this record
        competition_id (Union[Unset, UUID]): The unique identifier of the competition Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        competition (Union[Unset, ConductModelCompetition]): The competition that this season belongs to
        ...
        event_id (Union[Unset, UUID]): The ~event~ that this conduct is linked to Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        period_id (Union[Unset, ConductModelPeriodId]): The identifier for the period
            >- `1` Period 1
            >- `2` Period 2
        ...
        role (Union[ConductModelRoleType1, ConductModelRoleType2Type1, ConductModelRoleType3Type1, None, Unset]): The
            role of person
            >- None None
        ...
        conduct_type (Union[Unset, list[ConductModelConductTypeItem]]):
        ...
        hearing_status (Union[ConductModelHearingStatusType1, ConductModelHearingStatusType2Type1,
            ConductModelHearingStatusType3Type1, None, Unset]): Conduct hearing status
            >- None None
            >- `FINALIZED` Finalized
            >- `PENDING` Pending
             Example: PENDING.
        ...
        fine_status (Union[ConductModelFineStatusType1, ConductModelFineStatusType2Type1,
            ConductModelFineStatusType3Type1, None, Unset]): Conduct fine due status
            >- None None
            >- `CANCELLED` Cancelled
            >- `ISSUED` Issued
            >- `OTHER` Other
        ...
        status (Union[ConductModelStatusType1, ConductModelStatusType2Type1, ConductModelStatusType3Type1, None,
            Unset]): Conduct status
            >- None None
            >- `ACTIVE` Active
            >- `CLOSED` Closed
            >- `COMPLETE` Complete
    ...
    organization: Union[Unset, "ConductModelOrganization"] = UNSET
    person_id: Union[Unset, UUID] = UNSET
    person: Union[Unset, "ConductModelPerson"] = UNSET
    entity_group_id: Union[Unset, UUID] = UNSET
    entity_group: Union[Unset, "ConductModelEntityGroup"] = UNSET
    entity_id: Union[Unset, UUID] = UNSET
    entity: Union[Unset, "ConductModelEntity"] = UNSET
    venue_id: Union[Unset, UUID] = UNSET
    venue: Union[Unset, "ConductModelVenue"] = UNSET
    fixture_id: Union[Unset, UUID] = UNSET
    fixture: Union[Unset, "ConductModelFixture"] = UNSET
    season_id: Union[Unset, UUID] = UNSET
    season: Union[Unset, "ConductModelSeason"] = UNSET
    competition_id: Union[Unset, UUID] = UNSET
    competition: Union[Unset, "ConductModelCompetition"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.role, Unset):
            role = UNSET
        elif isinstance(self.role, ConductModelRoleType1):
            role = self.role.value
        elif isinstance(self.role, ConductModelRoleType2Type1):
            role = self.role.value
        elif isinstance(self.role, ConductModelRoleType3Type1):
            role = self.role.value
        else:
            role = self.role
        ...
        elif isinstance(self.hearing_status, ConductModelHearingStatusType1):
            hearing_status = self.hearing_status.value
        elif isinstance(self.hearing_status, ConductModelHearingStatusType2Type1):
            hearing_status = self.hearing_status.value
        elif isinstance(self.hearing_status, ConductModelHearingStatusType3Type1):
            hearing_status = self.hearing_status.value
        else:
        ...
        if isinstance(self.fine_status, Unset):
            fine_status = UNSET
        elif isinstance(self.fine_status, ConductModelFineStatusType1):
            fine_status = self.fine_status.value
        elif isinstance(self.fine_status, ConductModelFineStatusType2Type1):
            fine_status = self.fine_status.value
        elif isinstance(self.fine_status, ConductModelFineStatusType3Type1):
            fine_status = self.fine_status.value
        else:
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, ConductModelStatusType1):
            status = self.status.value
        elif isinstance(self.status, ConductModelStatusType2Type1):
            status = self.status.value
        elif isinstance(self.status, ConductModelStatusType3Type1):
            status = self.status.value
        else:
            status = self.status
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization: Union[Unset, ConductModelOrganization]
        if isinstance(_organization, Unset):
            organization = UNSET
        else:
            organization = ConductModelOrganization.from_dict(_organization)
        ...
        person: Union[Unset, ConductModelPerson]
        if isinstance(_person, Unset):
            person = UNSET
        else:
            person = ConductModelPerson.from_dict(_person)
        ...
        entity_group: Union[Unset, ConductModelEntityGroup]
        if isinstance(_entity_group, Unset):
            entity_group = UNSET
        else:
            entity_group = ConductModelEntityGroup.from_dict(_entity_group)
        ...
        entity: Union[Unset, ConductModelEntity]
        if isinstance(_entity, Unset):
            entity = UNSET
        else:
            entity = ConductModelEntity.from_dict(_entity)
        ...
        venue: Union[Unset, ConductModelVenue]
        if isinstance(_venue, Unset):
            venue = UNSET
        else:
            venue = ConductModelVenue.from_dict(_venue)
        ...
        fixture: Union[Unset, ConductModelFixture]
        if isinstance(_fixture, Unset):
            fixture = UNSET
        else:
            fixture = ConductModelFixture.from_dict(_fixture)
        ...
        season: Union[Unset, ConductModelSeason]
        if isinstance(_season, Unset):
            season = UNSET
        else:
            season = ConductModelSeason.from_dict(_season)
        ...
        competition: Union[Unset, ConductModelCompetition]
        if isinstance(_competition, Unset):
            competition = UNSET
        else:
            competition = ConductModelCompetition.from_dict(_competition)
        ...
        period_id: Union[Unset, ConductModelPeriodId]
        if isinstance(_period_id, Unset):
            period_id = UNSET
        else:
            period_id = ConductModelPeriodId(_period_id)
        ...
        def _parse_role(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                role_type_1 = ConductModelRoleType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                role_type_2_type_1 = ConductModelRoleType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                role_type_3_type_1 = ConductModelRoleType3Type1(data)
        ...
        for conduct_type_item_data in _conduct_type or []:
            conduct_type_item = ConductModelConductTypeItem(conduct_type_item_data)
        ...
        def _parse_hearing_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                hearing_status_type_1 = ConductModelHearingStatusType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                hearing_status_type_2_type_1 = ConductModelHearingStatusType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                hearing_status_type_3_type_1 = ConductModelHearingStatusType3Type1(data)
        ...
        def _parse_fine_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                fine_status_type_1 = ConductModelFineStatusType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                fine_status_type_2_type_1 = ConductModelFineStatusType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                fine_status_type_3_type_1 = ConductModelFineStatusType3Type1(data)
        ...
        def _parse_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_1 = ConductModelStatusType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_2_type_1 = ConductModelStatusType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_3_type_1 = ConductModelStatusType3Type1(data)
