...
T = TypeVar("T", bound="LeaderCriteriaUpdateResponseDefault")


@_attrs_define
class LeaderCriteriaUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        leader_criteria_update_response_default = cls(
            meta=meta,
            error=error,
        )

        leader_criteria_update_response_default.additional_properties = d
        return leader_criteria_update_response_default
