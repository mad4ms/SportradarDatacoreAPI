...
if TYPE_CHECKING:
    from ..models.competition_external_ids_model import CompetitionExternalIdsModel
...
T = TypeVar(
    "T", bound="CompetitionExternalIdsInsertUpdateCompetitionExternalIdsResponse"
)


@_attrs_define
class CompetitionExternalIdsInsertUpdateCompetitionExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = CompetitionExternalIdsModel.from_dict(data_item_data)

            data.append(data_item)

        competition_external_ids_insert_update_competition_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        competition_external_ids_insert_update_competition_external_ids_response.additional_properties = (
            d
        )
        return competition_external_ids_insert_update_competition_external_ids_response
