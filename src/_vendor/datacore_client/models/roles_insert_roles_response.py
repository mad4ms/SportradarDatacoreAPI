...
T = TypeVar("T", bound="RolesInsertRolesResponse")


@_attrs_define
class RolesInsertRolesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roles_insert_roles_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        roles_insert_roles_response.additional_properties = d
        return roles_insert_roles_response
