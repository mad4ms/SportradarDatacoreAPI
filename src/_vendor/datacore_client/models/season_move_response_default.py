...
T = TypeVar("T", bound="SeasonMoveResponseDefault")


@_attrs_define
class SeasonMoveResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_move_response_default = cls(
            meta=meta,
            error=error,
        )

        season_move_response_default.additional_properties = d
        return season_move_response_default
