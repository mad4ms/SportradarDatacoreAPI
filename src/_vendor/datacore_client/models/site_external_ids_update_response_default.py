...
T = TypeVar("T", bound="SiteExternalIdsUpdateResponseDefault")


@_attrs_define
class SiteExternalIdsUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_external_ids_update_response_default = cls(
            meta=meta,
            error=error,
        )

        site_external_ids_update_response_default.additional_properties = d
        return site_external_ids_update_response_default
