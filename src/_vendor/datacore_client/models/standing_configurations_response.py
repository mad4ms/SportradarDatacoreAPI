...
T = TypeVar("T", bound="StandingConfigurationsResponse")


@_attrs_define
class StandingConfigurationsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_configurations_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_configurations_response.additional_properties = d
        return standing_configurations_response
