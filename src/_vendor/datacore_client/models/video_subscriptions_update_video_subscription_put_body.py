...
from ..models.video_subscriptions_update_video_subscription_put_body_audio import (
    VideoSubscriptionsUpdateVideoSubscriptionPutBodyAudio,
)
from ..models.video_subscriptions_update_video_subscription_put_body_content import (
    VideoSubscriptionsUpdateVideoSubscriptionPutBodyContent,
)
from ..models.video_subscriptions_update_video_subscription_put_body_feed_type import (
    VideoSubscriptionsUpdateVideoSubscriptionPutBodyFeedType,
)
from ..models.video_subscriptions_update_video_subscription_put_body_output_format import (
    VideoSubscriptionsUpdateVideoSubscriptionPutBodyOutputFormat,
)
from ..models.video_subscriptions_update_video_subscription_put_body_output_resolution import (
    VideoSubscriptionsUpdateVideoSubscriptionPutBodyOutputResolution,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="VideoSubscriptionsUpdateVideoSubscriptionPutBody")


@_attrs_define
class VideoSubscriptionsUpdateVideoSubscriptionPutBody:
    """
    Attributes:
        ...
        feed_type (Union[Unset, VideoSubscriptionsUpdateVideoSubscriptionPutBodyFeedType]): Type of video input
            >- `ADDITIONAL_ANGLE` Additional angle
            >- `LOW_LATENCY` Low Latency
            >- `PRIMARY` Primary
             Example: PRIMARY.
        output_resolution (Union[Unset, VideoSubscriptionsUpdateVideoSubscriptionPutBodyOutputResolution]): The
            resolution that you want to receive the video in.  This is only valid if outputFormat is `RTMP`.  If
            outputFormat is not `RTMP` then the output resolution is the same as the input resolution.  If specified the
            output resolution cannot be higher than the input resolution. You must have specific permission to chose
            anything other than 720p or 1080p.
            >- `1080` 1920 x 1080
            ...
            >- `MOBILE_768x432@1000k_BUFFERED` MOBILE_768x432@1000k_BUFFERED
             Example: 720.
        output_format (Union[Unset, VideoSubscriptionsUpdateVideoSubscriptionPutBodyOutputFormat]): The output format
            >- `HLS` HLS
            >- `RTMP` RTMP
            >- `RTMP_PULL` RTMP Pull
            >- `SRT` SRT
        ...
        audio (Union[Unset, VideoSubscriptionsUpdateVideoSubscriptionPutBodyAudio]): Audio
            ...
            >- `COMMENTARY` Only commentary
             Default: VideoSubscriptionsUpdateVideoSubscriptionPutBodyAudio.BOTH. Example: COMMENTARY.
        content (Union[Unset, VideoSubscriptionsUpdateVideoSubscriptionPutBodyContent]): Content of the stream
    ...
    feed_type: Union[
        Unset, VideoSubscriptionsUpdateVideoSubscriptionPutBodyFeedType
    ] = UNSET
    output_resolution: Union[
        Unset, VideoSubscriptionsUpdateVideoSubscriptionPutBodyOutputResolution
    ] = UNSET
    output_format: Union[
        Unset, VideoSubscriptionsUpdateVideoSubscriptionPutBodyOutputFormat
    ] = UNSET
    stream_name: Union[Unset, str] = UNSET
    subscription_name: Union[Unset, str] = UNSET
    output_url: Union[Unset, str] = UNSET
    audio: Union[Unset, VideoSubscriptionsUpdateVideoSubscriptionPutBodyAudio] = (
        VideoSubscriptionsUpdateVideoSubscriptionPutBodyAudio.BOTH
    )
    content: Union[Unset, VideoSubscriptionsUpdateVideoSubscriptionPutBodyContent] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_feed_type, Unset):
            ...
            feed_type = VideoSubscriptionsUpdateVideoSubscriptionPutBodyFeedType(
                _feed_type
            )
        ...
        if isinstance(_audio, Unset):
            ...
            audio = VideoSubscriptionsUpdateVideoSubscriptionPutBodyAudio(_audio)
        ...
        if isinstance(_content, Unset):
            ...
            content = VideoSubscriptionsUpdateVideoSubscriptionPutBodyContent(_content)

        mux_rate = d.pop("muxRate", UNSET)

        video_subscriptions_update_video_subscription_put_body = cls(
        ...
        return video_subscriptions_update_video_subscription_put_body
