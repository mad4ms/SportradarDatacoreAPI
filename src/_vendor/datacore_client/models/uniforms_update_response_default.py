...
T = TypeVar("T", bound="UniformsUpdateResponseDefault")


@_attrs_define
class UniformsUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniforms_update_response_default = cls(
            meta=meta,
            error=error,
        )

        uniforms_update_response_default.additional_properties = d
        return uniforms_update_response_default
