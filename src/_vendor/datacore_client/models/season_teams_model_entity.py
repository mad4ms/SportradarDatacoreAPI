...
@_attrs_define
class SeasonTeamsModelEntity:
    """The team information

    Attributes:
        resource_type (Union[Unset, SeasonTeamsModelEntityResourceType]):
        id (Union[Unset, str]): Unique identifier for this resource Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
    """

    resource_type: Union[Unset, SeasonTeamsModelEntityResourceType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource_type, Unset):
            ...
            resource_type = SeasonTeamsModelEntityResourceType(_resource_type)

        id = d.pop("id", UNSET)

        season_teams_model_entity = cls(
            resource_type=resource_type,
            id=id,
        )

        season_teams_model_entity.additional_properties = d
        return season_teams_model_entity
