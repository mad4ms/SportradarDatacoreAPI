...
T = TypeVar("T", bound="StandingProgressionsUpdateStandingProgressionsPutBody")


@_attrs_define
class StandingProgressionsUpdateStandingProgressionsPutBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_progressions_update_standing_progressions_put_body = cls(
            season_id=season_id,
        ...
        return standing_progressions_update_standing_progressions_put_body
