...
if TYPE_CHECKING:
    ...
    from ..models.season_teams_model import SeasonTeamsModel


T = TypeVar("T", bound="SeasonEntitiesInsertUpdateSeasonPayloadSeasonEntitiesResponse")


@_attrs_define
class SeasonEntitiesInsertUpdateSeasonPayloadSeasonEntitiesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeasonTeamsModel.from_dict(data_item_data)

            data.append(data_item)

        season_entities_insert_update_season_payload_season_entities_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_entities_insert_update_season_payload_season_entities_response.additional_properties = (
            d
        )
        return season_entities_insert_update_season_payload_season_entities_response
