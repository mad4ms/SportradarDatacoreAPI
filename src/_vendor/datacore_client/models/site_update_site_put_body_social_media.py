...
T = TypeVar("T", bound="SiteUpdateSitePutBodySocialMedia")


@_attrs_define
class SiteUpdateSitePutBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_update_site_put_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return site_update_site_put_body_social_media
