...
T = TypeVar("T", bound="UniformsDeleteUniformsResponse")


@_attrs_define
class UniformsDeleteUniformsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniforms_delete_uniforms_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        uniforms_delete_uniforms_response.additional_properties = d
        return uniforms_delete_uniforms_response
