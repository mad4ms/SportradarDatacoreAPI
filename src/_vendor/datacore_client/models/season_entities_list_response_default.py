...
T = TypeVar("T", bound="SeasonEntitiesListResponseDefault")


@_attrs_define
class SeasonEntitiesListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_entities_list_response_default = cls(
            meta=meta,
            error=error,
        )

        season_entities_list_response_default.additional_properties = d
        return season_entities_list_response_default
