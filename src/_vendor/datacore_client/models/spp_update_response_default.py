...
T = TypeVar("T", bound="SppUpdateResponseDefault")


@_attrs_define
class SppUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spp_update_response_default = cls(
            meta=meta,
            error=error,
        )

        spp_update_response_default.additional_properties = d
        return spp_update_response_default
