...
T = TypeVar("T", bound="TransfersInsertResponseDefault")


@_attrs_define
class TransfersInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfers_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        transfers_insert_response_default.additional_properties = d
        return transfers_insert_response_default
