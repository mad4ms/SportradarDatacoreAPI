...
T = TypeVar("T", bound="StandingBuildLiveResponseDefault")


@_attrs_define
class StandingBuildLiveResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_build_live_response_default = cls(
            meta=meta,
            error=error,
        )

        standing_build_live_response_default.additional_properties = d
        return standing_build_live_response_default
