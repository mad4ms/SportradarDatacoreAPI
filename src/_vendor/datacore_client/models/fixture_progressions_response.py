...
T = TypeVar("T", bound="FixtureProgressionsResponse")


@_attrs_define
class FixtureProgressionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_progressions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_progressions_response.additional_properties = d
        return fixture_progressions_response
