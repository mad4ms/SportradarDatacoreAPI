...
T = TypeVar("T", bound="FixtureRosterResponse")


@_attrs_define
class FixtureRosterResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_roster_response.additional_properties = d
        return fixture_roster_response
