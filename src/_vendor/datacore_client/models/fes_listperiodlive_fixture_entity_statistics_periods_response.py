...
T = TypeVar("T", bound="FesListperiodliveFixtureEntityStatisticsPeriodsResponse")


@_attrs_define
class FesListperiodliveFixtureEntityStatisticsPeriodsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fes_listperiodlive_fixture_entity_statistics_periods_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fes_listperiodlive_fixture_entity_statistics_periods_response.additional_properties = d
        return fes_listperiodlive_fixture_entity_statistics_periods_response
