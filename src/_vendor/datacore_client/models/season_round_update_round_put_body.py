...
T = TypeVar("T", bound="SeasonRoundUpdateRoundPutBody")


@_attrs_define
class SeasonRoundUpdateRoundPutBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_round_update_round_put_body = cls(
            pool_code=pool_code,
        ...
        return season_round_update_round_put_body
