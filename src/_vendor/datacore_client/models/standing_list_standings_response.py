...
T = TypeVar("T", bound="StandingListStandingsResponse")


@_attrs_define
class StandingListStandingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_list_standings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_list_standings_response.additional_properties = d
        return standing_list_standings_response
