...
T = TypeVar("T", bound="EntityGroupInsertClubPostBodyEntityAdditionalDetails")


@_attrs_define
class EntityGroupInsertClubPostBodyEntityAdditionalDetails:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_insert_club_post_body_entity_additional_details = cls(
            founded=founded,
            squad_value=squad_value,
        )

        return entity_group_insert_club_post_body_entity_additional_details
