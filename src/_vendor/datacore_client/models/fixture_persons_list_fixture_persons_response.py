...
T = TypeVar("T", bound="FixturePersonsListFixturePersonsResponse")


@_attrs_define
class FixturePersonsListFixturePersonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_persons_list_fixture_persons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_persons_list_fixture_persons_response.additional_properties = d
        return fixture_persons_list_fixture_persons_response
