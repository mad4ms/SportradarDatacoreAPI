...
T = TypeVar("T", bound="EntityExternalIdsInsertEntityExternalIdsResponse")


@_attrs_define
class EntityExternalIdsInsertEntityExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_external_ids_insert_entity_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_external_ids_insert_entity_external_ids_response.additional_properties = (
            d
        )
        return entity_external_ids_insert_entity_external_ids_response
