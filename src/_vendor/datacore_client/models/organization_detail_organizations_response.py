...
T = TypeVar("T", bound="OrganizationDetailOrganizationsResponse")


@_attrs_define
class OrganizationDetailOrganizationsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_detail_organizations_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        organization_detail_organizations_response.additional_properties = d
        return organization_detail_organizations_response
