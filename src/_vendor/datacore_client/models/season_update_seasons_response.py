...
T = TypeVar("T", bound="SeasonUpdateSeasonsResponse")


@_attrs_define
class SeasonUpdateSeasonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_update_seasons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_update_seasons_response.additional_properties = d
        return season_update_seasons_response
