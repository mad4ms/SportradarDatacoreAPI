...
from ..models.entity_group_update_club_put_body_status import (
    EntityGroupUpdateClubPutBodyStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.entity_group_update_club_put_body_additional_names import (
        EntityGroupUpdateClubPutBodyAdditionalNames,
    )
    from ..models.entity_group_update_club_put_body_club_address import (
        EntityGroupUpdateClubPutBodyClubAddress,
    )
    from ..models.entity_group_update_club_put_body_club_historical_name import (
        EntityGroupUpdateClubPutBodyClubHistoricalName,
    )
    from ..models.entity_group_update_club_put_body_colors import (
        EntityGroupUpdateClubPutBodyColors,
    )
    from ..models.entity_group_update_club_put_body_contact_details import (
        EntityGroupUpdateClubPutBodyContactDetails,
    )
    from ..models.entity_group_update_club_put_body_entity_additional_details import (
        EntityGroupUpdateClubPutBodyEntityAdditionalDetails,
    )
    from ..models.entity_group_update_club_put_body_social_media import (
        EntityGroupUpdateClubPutBodySocialMedia,
    )


T = TypeVar("T", bound="EntityGroupUpdateClubPutBody")


@_attrs_define
class EntityGroupUpdateClubPutBody:
    """
    Attributes:
        ...
        status (Union[Unset, EntityGroupUpdateClubPutBodyStatus]): Status
            >- `ACTIVE` Active
            >- `INACTIVE` Inactive
            >- `PENDING` Pending
             Example: ACTIVE.
        ...
        additional_names (Union[Unset, EntityGroupUpdateClubPutBodyAdditionalNames]):
        ...
        address (Union['EntityGroupUpdateClubPutBodyClubAddress', None, Unset]): Street Address for the club
        social (Union['EntityGroupUpdateClubPutBodySocialMedia', None, Unset]): Social Media contacts
        details (Union['EntityGroupUpdateClubPutBodyEntityAdditionalDetails', None, Unset]): Additional detail fields
        contacts (Union['EntityGroupUpdateClubPutBodyContactDetails', None, Unset]): Public contact fields
        colors (Union[Unset, EntityGroupUpdateClubPutBodyColors]):
        historical_names (Union[None, Unset, list['EntityGroupUpdateClubPutBodyClubHistoricalName']]): Array of club
            historical names
    ...
    status: Union[Unset, EntityGroupUpdateClubPutBodyStatus] = UNSET
    ...
    address: Union["EntityGroupUpdateClubPutBodyClubAddress", None, Unset] = UNSET
    social: Union["EntityGroupUpdateClubPutBodySocialMedia", None, Unset] = UNSET
    details: Union[
        "EntityGroupUpdateClubPutBodyEntityAdditionalDetails", None, Unset
    ] = UNSET
    contacts: Union["EntityGroupUpdateClubPutBodyContactDetails", None, Unset] = UNSET
    colors: Union[Unset, "EntityGroupUpdateClubPutBodyColors"] = UNSET
    historical_names: Union[
        None, Unset, list["EntityGroupUpdateClubPutBodyClubHistoricalName"]
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.address, Unset):
            address = UNSET
        elif isinstance(self.address, EntityGroupUpdateClubPutBodyClubAddress):
        ...
        if isinstance(self.social, Unset):
            social = UNSET
        elif isinstance(self.social, EntityGroupUpdateClubPutBodySocialMedia):
        ...
        if isinstance(self.details, Unset):
            ...
            self.details, EntityGroupUpdateClubPutBodyEntityAdditionalDetails
        ):
        ...
        if isinstance(self.contacts, Unset):
            contacts = UNSET
        elif isinstance(self.contacts, EntityGroupUpdateClubPutBodyContactDetails):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, EntityGroupUpdateClubPutBodyStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = EntityGroupUpdateClubPutBodyStatus(_status)
        ...
        if isinstance(_additional_names, Unset):
            ...
            additional_names = EntityGroupUpdateClubPutBodyAdditionalNames.from_dict(
                _additional_names
            )
        ...
        def _parse_address(
            data: object,
        ) -> Union["EntityGroupUpdateClubPutBodyClubAddress", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                address_type_0 = EntityGroupUpdateClubPutBodyClubAddress.from_dict(data)

                return address_type_0
            except:  # noqa: E722
                pass
            return cast(
                Union["EntityGroupUpdateClubPutBodyClubAddress", None, Unset], data
            )
        ...
        def _parse_social(
            data: object,
        ) -> Union["EntityGroupUpdateClubPutBodySocialMedia", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                social_type_0 = EntityGroupUpdateClubPutBodySocialMedia.from_dict(data)

                return social_type_0
            except:  # noqa: E722
                pass
            return cast(
                Union["EntityGroupUpdateClubPutBodySocialMedia", None, Unset], data
            )
        ...
        def _parse_details(
            data: object,
        ) -> Union["EntityGroupUpdateClubPutBodyEntityAdditionalDetails", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                details_type_0 = (
                    EntityGroupUpdateClubPutBodyEntityAdditionalDetails.from_dict(data)
                )
        ...
        def _parse_contacts(
            data: object,
        ) -> Union["EntityGroupUpdateClubPutBodyContactDetails", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                contacts_type_0 = EntityGroupUpdateClubPutBodyContactDetails.from_dict(
                    data
                )
                ...
                pass
            return cast(
                Union["EntityGroupUpdateClubPutBodyContactDetails", None, Unset], data
            )
        ...
        if isinstance(_colors, Unset):
            ...
            colors = EntityGroupUpdateClubPutBodyColors.from_dict(_colors)

        def _parse_historical_names(
            data: object,
        ) -> Union[None, Unset, list["EntityGroupUpdateClubPutBodyClubHistoricalName"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for historical_names_type_0_item_data in _historical_names_type_0:
                    historical_names_type_0_item = (
                        EntityGroupUpdateClubPutBodyClubHistoricalName.from_dict(
        ...
        entity_group_update_club_put_body = cls(
        ...
        return entity_group_update_club_put_body
