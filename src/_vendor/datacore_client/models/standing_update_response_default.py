...
T = TypeVar("T", bound="StandingUpdateResponseDefault")


@_attrs_define
class StandingUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_update_response_default = cls(
            meta=meta,
            error=error,
        )

        standing_update_response_default.additional_properties = d
        return standing_update_response_default
