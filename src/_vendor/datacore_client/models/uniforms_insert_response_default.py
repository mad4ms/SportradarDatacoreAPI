...
T = TypeVar("T", bound="UniformsInsertResponseDefault")


@_attrs_define
class UniformsInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniforms_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        uniforms_insert_response_default.additional_properties = d
        return uniforms_insert_response_default
