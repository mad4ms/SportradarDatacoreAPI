...
T = TypeVar("T", bound="SeasonMoveSuccessResponse")


@_attrs_define
class SeasonMoveSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_move_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_move_success_response.additional_properties = d
        return season_move_success_response
