...
from ..models.standing_update_standing_put_body_fixture_type import (
    StandingUpdateStandingPutBodyFixtureType,
)
from ..models.standing_update_standing_put_body_grouping_base import (
    StandingUpdateStandingPutBodyGroupingBase,
)
from ..models.standing_update_standing_put_body_grouping_conference_division import (
    StandingUpdateStandingPutBodyGroupingConferenceDivision,
)
from ..models.standing_update_standing_put_body_grouping_stage_pool import (
    StandingUpdateStandingPutBodyGroupingStagePool,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.standing_update_standing_put_body_calculated import (
        StandingUpdateStandingPutBodyCalculated,
    )
    from ..models.standing_update_standing_put_body_points import (
        StandingUpdateStandingPutBodyPoints,
    )


T = TypeVar("T", bound="StandingUpdateStandingPutBody")


@_attrs_define
class StandingUpdateStandingPutBody:
    """
    Attributes:
        ...
        grouping_base (Union[Unset, StandingUpdateStandingPutBodyGroupingBase]): Base grouping of standings row
            >- `OVERALL` Overall
            >- `ROUND` Round
             Example: OVERALL.
        grouping_conference_division (Union[Unset, StandingUpdateStandingPutBodyGroupingConferenceDivision]):
            Conference/Division grouping of standings row
            >- `CONFERENCE` Conference
            >- `DIVISION` Division
            >- `OVERALL` Overall
             Example: OVERALL.
        grouping_stage_pool (Union[Unset, StandingUpdateStandingPutBodyGroupingStagePool]): Stage/Pool grouping of
            standings row
            >- `OVERALL` Overall
            >- `STAGE` Stage
        ...
        fixture_type (Union[Unset, StandingUpdateStandingPutBodyFixtureType]): Type of match
            >- `ALL_STAR` All Star
        ...
        points (Union[Unset, StandingUpdateStandingPutBodyPoints]): standings points fields
        calculated (Union[Unset, StandingUpdateStandingPutBodyCalculated]): standings points fields
    ...
    grouping_base: Union[Unset, StandingUpdateStandingPutBodyGroupingBase] = UNSET
    grouping_conference_division: Union[
        Unset, StandingUpdateStandingPutBodyGroupingConferenceDivision
    ] = UNSET
    grouping_stage_pool: Union[
        Unset, StandingUpdateStandingPutBodyGroupingStagePool
    ] = UNSET
    ...
    fixture_type: Union[Unset, StandingUpdateStandingPutBodyFixtureType] = UNSET
    position: Union[None, Unset, int] = UNSET
    secured_finals: Union[Unset, str] = UNSET
    points: Union[Unset, "StandingUpdateStandingPutBodyPoints"] = UNSET
    calculated: Union[Unset, "StandingUpdateStandingPutBodyCalculated"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grouping_base: Union[Unset, StandingUpdateStandingPutBodyGroupingBase]
        if isinstance(_grouping_base, Unset):
            grouping_base = UNSET
        else:
            grouping_base = StandingUpdateStandingPutBodyGroupingBase(_grouping_base)
        ...
        if isinstance(_grouping_stage_pool, Unset):
            ...
            grouping_stage_pool = StandingUpdateStandingPutBodyGroupingStagePool(
                _grouping_stage_pool
            )
        ...
        fixture_type: Union[Unset, StandingUpdateStandingPutBodyFixtureType]
        if isinstance(_fixture_type, Unset):
            fixture_type = UNSET
        else:
            fixture_type = StandingUpdateStandingPutBodyFixtureType(_fixture_type)
        ...
        points: Union[Unset, StandingUpdateStandingPutBodyPoints]
        if isinstance(_points, Unset):
            points = UNSET
        else:
            points = StandingUpdateStandingPutBodyPoints.from_dict(_points)

        _calculated = d.pop("calculated", UNSET)
        calculated: Union[Unset, StandingUpdateStandingPutBodyCalculated]
        if isinstance(_calculated, Unset):
            calculated = UNSET
        else:
            calculated = StandingUpdateStandingPutBodyCalculated.from_dict(_calculated)
        ...
        standing_update_standing_put_body = cls(
            season_id=season_id,
            entity_id=entity_id,
        ...
        return standing_update_standing_put_body
