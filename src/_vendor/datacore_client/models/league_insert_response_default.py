...
T = TypeVar("T", bound="LeagueInsertResponseDefault")


@_attrs_define
class LeagueInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        league_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        league_insert_response_default.additional_properties = d
        return league_insert_response_default
