...
T = TypeVar("T", bound="OrganizationInsertOrganizationsResponse")


@_attrs_define
class OrganizationInsertOrganizationsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_insert_organizations_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        organization_insert_organizations_response.additional_properties = d
        return organization_insert_organizations_response
