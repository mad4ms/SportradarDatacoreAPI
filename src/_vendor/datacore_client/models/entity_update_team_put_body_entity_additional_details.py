...
T = TypeVar("T", bound="EntityUpdateTeamPutBodyEntityAdditionalDetails")


@_attrs_define
class EntityUpdateTeamPutBodyEntityAdditionalDetails:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_update_team_put_body_entity_additional_details = cls(
            founded=founded,
            squad_value=squad_value,
        )

        return entity_update_team_put_body_entity_additional_details
