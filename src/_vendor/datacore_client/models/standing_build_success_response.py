...
T = TypeVar("T", bound="StandingBuildSuccessResponse")


@_attrs_define
class StandingBuildSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_build_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_build_success_response.additional_properties = d
        return standing_build_success_response
