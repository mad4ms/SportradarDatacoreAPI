...
T = TypeVar("T", bound="VenueExternalIdsListResponseDefault")


@_attrs_define
class VenueExternalIdsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_external_ids_list_response_default = cls(
            meta=meta,
            error=error,
        )

        venue_external_ids_list_response_default.additional_properties = d
        return venue_external_ids_list_response_default
