...
@_attrs_define
class UniformItemsModelUniform:
    """The Uniform information

    Attributes:
        resource_type (Union[Unset, UniformItemsModelUniformResourceType]):
        id (Union[Unset, str]): Unique identifier for this resource Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
    """

    resource_type: Union[Unset, UniformItemsModelUniformResourceType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource_type, Unset):
            ...
            resource_type = UniformItemsModelUniformResourceType(_resource_type)

        id = d.pop("id", UNSET)

        uniform_items_model_uniform = cls(
            resource_type=resource_type,
            id=id,
        )

        uniform_items_model_uniform.additional_properties = d
        return uniform_items_model_uniform
