...
T = TypeVar("T", bound="CompetitionExternalIdsInsertUpdateResponseDefault")


@_attrs_define
class CompetitionExternalIdsInsertUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_external_ids_insert_update_response_default = cls(
            meta=meta,
            error=error,
        )
