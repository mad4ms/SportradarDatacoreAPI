...
T = TypeVar("T", bound="FpsListFixturePersonStatisticsResponse")


@_attrs_define
class FpsListFixturePersonStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fps_list_fixture_person_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fps_list_fixture_person_statistics_response.additional_properties = d
        return fps_list_fixture_person_statistics_response
