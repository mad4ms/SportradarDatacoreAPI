...
T = TypeVar("T", bound="LeagueListResponseDefault")


@_attrs_define
class LeagueListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        league_list_response_default = cls(
            meta=meta,
            error=error,
        )

        league_list_response_default.additional_properties = d
        return league_list_response_default
