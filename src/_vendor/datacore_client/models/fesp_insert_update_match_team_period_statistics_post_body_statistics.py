...
T = TypeVar("T", bound="FespInsertUpdateMatchTeamPeriodStatisticsPostBodyStatistics")


@_attrs_define
class FespInsertUpdateMatchTeamPeriodStatisticsPostBodyStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fesp_insert_update_match_team_period_statistics_post_body_statistics = cls(
            assists=assists,
        ...
        return fesp_insert_update_match_team_period_statistics_post_body_statistics
