...
T = TypeVar("T", bound="SeasonVenueVideostreamDisableSuccessResponse")


@_attrs_define
class SeasonVenueVideostreamDisableSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_venue_videostream_disable_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_venue_videostream_disable_success_response.additional_properties = d
        return season_venue_videostream_disable_success_response
