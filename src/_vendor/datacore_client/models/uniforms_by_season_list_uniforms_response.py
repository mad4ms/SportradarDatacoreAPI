...
if TYPE_CHECKING:
    ...
    from ..models.uniforms_model import UniformsModel


T = TypeVar("T", bound="UniformsBySeasonListUniformsResponse")


@_attrs_define
class UniformsBySeasonListUniformsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = UniformsModel.from_dict(data_item_data)

            data.append(data_item)

        uniforms_by_season_list_uniforms_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        uniforms_by_season_list_uniforms_response.additional_properties = d
        return uniforms_by_season_list_uniforms_response
