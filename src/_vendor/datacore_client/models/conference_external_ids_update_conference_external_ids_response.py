...
T = TypeVar("T", bound="ConferenceExternalIdsUpdateConferenceExternalIdsResponse")


@_attrs_define
class ConferenceExternalIdsUpdateConferenceExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_external_ids_update_conference_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        conference_external_ids_update_conference_external_ids_response.additional_properties = (
            d
        )
        return conference_external_ids_update_conference_external_ids_response
