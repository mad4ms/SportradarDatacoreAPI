...
from ..models.fixture_insert_match_post_body_competitor_type import (
    FixtureInsertMatchPostBodyCompetitorType,
)
from ..models.fixture_insert_match_post_body_discipline_type_1 import (
    FixtureInsertMatchPostBodyDisciplineType1,
)
from ..models.fixture_insert_match_post_body_discipline_type_2_type_1 import (
    FixtureInsertMatchPostBodyDisciplineType2Type1,
)
from ..models.fixture_insert_match_post_body_discipline_type_3_type_1 import (
    FixtureInsertMatchPostBodyDisciplineType3Type1,
)
from ..models.fixture_insert_match_post_body_fixture_type import (
    FixtureInsertMatchPostBodyFixtureType,
)
from ..models.fixture_insert_match_post_body_maximum_period_type_used_type_1 import (
    FixtureInsertMatchPostBodyMaximumPeriodTypeUsedType1,
)
from ..models.fixture_insert_match_post_body_maximum_period_type_used_type_2_type_1 import (
    FixtureInsertMatchPostBodyMaximumPeriodTypeUsedType2Type1,
)
from ..models.fixture_insert_match_post_body_maximum_period_type_used_type_3_type_1 import (
    FixtureInsertMatchPostBodyMaximumPeriodTypeUsedType3Type1,
)
from ..models.fixture_insert_match_post_body_practice_drill_type_type_1 import (
    FixtureInsertMatchPostBodyPracticeDrillTypeType1,
)
from ..models.fixture_insert_match_post_body_practice_drill_type_type_2_type_1 import (
    FixtureInsertMatchPostBodyPracticeDrillTypeType2Type1,
)
from ..models.fixture_insert_match_post_body_practice_drill_type_type_3_type_1 import (
    FixtureInsertMatchPostBodyPracticeDrillTypeType3Type1,
)
from ..models.fixture_insert_match_post_body_status import (
    FixtureInsertMatchPostBodyStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.fixture_insert_match_post_body_broadcasts import (
        FixtureInsertMatchPostBodyBroadcasts,
    )
    from ..models.fixture_insert_match_post_body_environmental_details import (
        FixtureInsertMatchPostBodyEnvironmentalDetails,
    )
    from ..models.fixture_insert_match_post_body_match_competitor import (
        FixtureInsertMatchPostBodyMatchCompetitor,
    )
    from ..models.fixture_insert_match_post_body_social_media import (
        FixtureInsertMatchPostBodySocialMedia,
    )


T = TypeVar("T", bound="FixtureInsertMatchPostBody")


@_attrs_define
class FixtureInsertMatchPostBody:
    """
    Attributes:
        season_id (UUID): The unique identifier of the season Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        competitor_type (FixtureInsertMatchPostBodyCompetitorType): The type of competitors in this match
            >- `ENTITY` Entity
            >- `PERSON` Person
             Example: ENTITY.
        fixture_id (Union[Unset, UUID]): The unique identifier of the match Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        practice_drill_type (Union[FixtureInsertMatchPostBodyPracticeDrillTypeType1,
            FixtureInsertMatchPostBodyPracticeDrillTypeType2Type1, FixtureInsertMatchPostBodyPracticeDrillTypeType3Type1,
        ...
        status (Union[Unset, FixtureInsertMatchPostBodyStatus]): Match status
            ...
            >- `WARM_UP` Warm Up - Players have begun to warm up
             Default: FixtureInsertMatchPostBodyStatus.SCHEDULED. Example: SCHEDULED.
        ...
        social (Union['FixtureInsertMatchPostBodySocialMedia', None, Unset]): Social Media contacts
        environmental (Union['FixtureInsertMatchPostBodyEnvironmentalDetails', None, Unset]): Details about the
        ...
        fixture_type (Union[Unset, FixtureInsertMatchPostBodyFixtureType]): Type of match
            >- `ALL_STAR` All Star
            ...
            >- `REGULAR` Regular
             Example: REGULAR.
        maximum_period_type_used (Union[FixtureInsertMatchPostBodyMaximumPeriodTypeUsedType1,
            FixtureInsertMatchPostBodyMaximumPeriodTypeUsedType2Type1,
            FixtureInsertMatchPostBodyMaximumPeriodTypeUsedType3Type1, None, Unset]): Maximum Period Type Used
            >- None None
            ...
            >- `SHOOTOUT` Shoot-Out
             Example: REGULAR.
        competitors (Union[None, Unset, list['FixtureInsertMatchPostBodyMatchCompetitor']]): Array of match competitors
        ...
        discipline (Union[FixtureInsertMatchPostBodyDisciplineType1, FixtureInsertMatchPostBodyDisciplineType2Type1,
            FixtureInsertMatchPostBodyDisciplineType3Type1, None, Unset]): match discipline
            >- None None
            >- `INDOOR` Indoor
            >- `OUTDOOR` Outdoor
             Example: INDOOR.
        broadcasts (Union[Unset, list[Union['FixtureInsertMatchPostBodyBroadcasts', None]]]):
    """

    season_id: UUID
    competitor_type: FixtureInsertMatchPostBodyCompetitorType
    ...
    status: Union[Unset, FixtureInsertMatchPostBodyStatus] = (
        FixtureInsertMatchPostBodyStatus.SCHEDULED
    )
    ...
    social: Union["FixtureInsertMatchPostBodySocialMedia", None, Unset] = UNSET
    environmental: Union[
        "FixtureInsertMatchPostBodyEnvironmentalDetails", None, Unset
    ] = UNSET
    ...
    fixture_type: Union[Unset, FixtureInsertMatchPostBodyFixtureType] = UNSET
    ...
    competitors: Union[
        None, Unset, list["FixtureInsertMatchPostBodyMatchCompetitor"]
    ] = UNSET
    ...
    broadcasts: Union[
        Unset, list[Union["FixtureInsertMatchPostBodyBroadcasts", None]]
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.practice_drill_type, Unset):
            ...
            self.practice_drill_type, FixtureInsertMatchPostBodyPracticeDrillTypeType1
        ):
        ...
        if isinstance(self.social, Unset):
            social = UNSET
        elif isinstance(self.social, FixtureInsertMatchPostBodySocialMedia):
        ...
        if isinstance(self.environmental, Unset):
            ...
            self.environmental, FixtureInsertMatchPostBodyEnvironmentalDetails
        ):
        ...
        if isinstance(self.discipline, Unset):
            discipline = UNSET
        elif isinstance(self.discipline, FixtureInsertMatchPostBodyDisciplineType1):
            discipline = self.discipline.value
        elif isinstance(
            self.discipline, FixtureInsertMatchPostBodyDisciplineType2Type1
        ):
            discipline = self.discipline.value
        elif isinstance(
            self.discipline, FixtureInsertMatchPostBodyDisciplineType3Type1
        ):
            discipline = self.discipline.value
        else:
        ...
        if not isinstance(self.broadcasts, Unset):
            ...
            for broadcasts_item_data in self.broadcasts:
                ...
                if isinstance(
                    broadcasts_item_data, FixtureInsertMatchPostBodyBroadcasts
                ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_practice_drill_type(
            ...
            try:
                ...
                practice_drill_type_type_1 = (
                    FixtureInsertMatchPostBodyPracticeDrillTypeType1(data)
                )
            ...
            try:
                ...
                practice_drill_type_type_2_type_1 = (
                    FixtureInsertMatchPostBodyPracticeDrillTypeType2Type1(data)
                )
            ...
            try:
                ...
                practice_drill_type_type_3_type_1 = (
                    FixtureInsertMatchPostBodyPracticeDrillTypeType3Type1(data)
                )
        ...
        if isinstance(_status, Unset):
            ...
            status = FixtureInsertMatchPostBodyStatus(_status)
        ...
        def _parse_social(
            data: object,
        ) -> Union["FixtureInsertMatchPostBodySocialMedia", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                social_type_0 = FixtureInsertMatchPostBodySocialMedia.from_dict(data)

                return social_type_0
            except:  # noqa: E722
                pass
            return cast(
                Union["FixtureInsertMatchPostBodySocialMedia", None, Unset], data
            )
        ...
        def _parse_environmental(
            data: object,
        ) -> Union["FixtureInsertMatchPostBodyEnvironmentalDetails", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                environmental_type_0 = (
                    FixtureInsertMatchPostBodyEnvironmentalDetails.from_dict(data)
                )
        ...
        fixture_type: Union[Unset, FixtureInsertMatchPostBodyFixtureType]
        if isinstance(_fixture_type, Unset):
            fixture_type = UNSET
        else:
            fixture_type = FixtureInsertMatchPostBodyFixtureType(_fixture_type)
        ...
        def _parse_maximum_period_type_used(
            ...
            try:
                ...
                maximum_period_type_used_type_1 = (
                    FixtureInsertMatchPostBodyMaximumPeriodTypeUsedType1(data)
                )
            ...
            try:
                ...
                maximum_period_type_used_type_2_type_1 = (
                    FixtureInsertMatchPostBodyMaximumPeriodTypeUsedType2Type1(data)
                )
            ...
            try:
                ...
                maximum_period_type_used_type_3_type_1 = (
                    FixtureInsertMatchPostBodyMaximumPeriodTypeUsedType3Type1(data)
                )
        ...
        def _parse_competitors(
            data: object,
        ) -> Union[None, Unset, list["FixtureInsertMatchPostBodyMatchCompetitor"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for competitors_type_0_item_data in _competitors_type_0:
                    competitors_type_0_item = (
                        FixtureInsertMatchPostBodyMatchCompetitor.from_dict(
        ...
        def _parse_discipline(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                discipline_type_1 = FixtureInsertMatchPostBodyDisciplineType1(data)
            ...
            try:
                ...
                discipline_type_2_type_1 = (
                    FixtureInsertMatchPostBodyDisciplineType2Type1(data)
                )
            ...
            try:
                ...
                discipline_type_3_type_1 = (
                    FixtureInsertMatchPostBodyDisciplineType3Type1(data)
                )
        ...
        for broadcasts_item_data in _broadcasts or []:
            ...
            def _parse_broadcasts_item(
                data: object,
            ) -> Union["FixtureInsertMatchPostBodyBroadcasts", None]:
                if data is None:
                    return data
                try:
                    if not isinstance(data, dict):
                    ...
                    broadcasts_item_type_0 = (
                        FixtureInsertMatchPostBodyBroadcasts.from_dict(data)
                    )

                    return broadcasts_item_type_0
                except:  # noqa: E722
                    pass
                return cast(Union["FixtureInsertMatchPostBodyBroadcasts", None], data)

            broadcasts_item = _parse_broadcasts_item(broadcasts_item_data)

            broadcasts.append(broadcasts_item)

        fixture_insert_match_post_body = cls(
            season_id=season_id,
        ...
        return fixture_insert_match_post_body
