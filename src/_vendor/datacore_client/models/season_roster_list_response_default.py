...
T = TypeVar("T", bound="SeasonRosterListResponseDefault")


@_attrs_define
class SeasonRosterListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_roster_list_response_default = cls(
            meta=meta,
            error=error,
        )

        season_roster_list_response_default.additional_properties = d
        return season_roster_list_response_default
