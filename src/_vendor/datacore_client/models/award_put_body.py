...
from ..models.award_put_body_award import AwardPutBodyAward
from ..types import UNSET, Unset

T = TypeVar("T", bound="AwardPutBody")
...
class AwardPutBody:
    ...
    Attributes:
        ...
        award (Union[Unset, AwardPutBodyAward]): Award
    ...
    award: Union[Unset, AwardPutBodyAward] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        award: Union[Unset, AwardPutBodyAward]
        if isinstance(_award, Unset):
            award = UNSET
        else:
            award = AwardPutBodyAward(_award)
