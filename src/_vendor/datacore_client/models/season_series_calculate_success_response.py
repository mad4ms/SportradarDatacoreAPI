...
T = TypeVar("T", bound="SeasonSeriesCalculateSuccessResponse")


@_attrs_define
class SeasonSeriesCalculateSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_series_calculate_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_series_calculate_success_response.additional_properties = d
        return season_series_calculate_success_response
