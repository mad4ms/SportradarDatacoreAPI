...
T = TypeVar("T", bound="SebsInsertUpdateResponseDefault")


@_attrs_define
class SebsInsertUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sebs_insert_update_response_default = cls(
            meta=meta,
            error=error,
        )

        sebs_insert_update_response_default.additional_properties = d
        return sebs_insert_update_response_default
