...
T = TypeVar("T", bound="SeasonRosterInsertUpdateSeasonRosterResponse")


@_attrs_define
class SeasonRosterInsertUpdateSeasonRosterResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_roster_insert_update_season_roster_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_roster_insert_update_season_roster_response.additional_properties = d
        return season_roster_insert_update_season_roster_response
