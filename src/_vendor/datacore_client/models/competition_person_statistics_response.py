...
T = TypeVar("T", bound="CompetitionPersonStatisticsResponse")


@_attrs_define
class CompetitionPersonStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_person_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        competition_person_statistics_response.additional_properties = d
        return competition_person_statistics_response
