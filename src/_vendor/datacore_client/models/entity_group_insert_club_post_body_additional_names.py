...
T = TypeVar("T", bound="EntityGroupInsertClubPostBodyAdditionalNames")


@_attrs_define
class EntityGroupInsertClubPostBodyAdditionalNames:
    """
    Attributes:
        name_short_local (Union[None, Unset, str]): The short name of the club in the
            [local](#section/Introduction/Character-Sets-and-Names) language Example: Armadillos.
        name_place_local (Union[None, Unset, str]): The name of the place associated with the club in the
            [local](#section/Introduction/Character-Sets-and-Names) language Example: Los Angeles.
        name_short_latin (Union[None, Unset, str]): The short name of the club using
            [latin](#section/Introduction/Character-Sets-and-Names) characters Example: Armadillos.
        name_place_latin (Union[None, Unset, str]): The name of the place associated with the club using
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_insert_club_post_body_additional_names = cls(
        ...
        entity_group_insert_club_post_body_additional_names.additional_properties = d
        return entity_group_insert_club_post_body_additional_names
