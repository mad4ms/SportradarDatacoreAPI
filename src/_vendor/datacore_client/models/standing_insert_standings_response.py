...
T = TypeVar("T", bound="StandingInsertStandingsResponse")


@_attrs_define
class StandingInsertStandingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_insert_standings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_insert_standings_response.additional_properties = d
        return standing_insert_standings_response
