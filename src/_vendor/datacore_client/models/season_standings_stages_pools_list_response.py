...
T = TypeVar("T", bound="SeasonStandingsStagesPoolsListResponse")


@_attrs_define
class SeasonStandingsStagesPoolsListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_standings_stages_pools_list_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_standings_stages_pools_list_response.additional_properties = d
        return season_standings_stages_pools_list_response
