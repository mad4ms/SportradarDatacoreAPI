...
T = TypeVar("T", bound="FixtureByEntityListResponseDefault")


@_attrs_define
class FixtureByEntityListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_by_entity_list_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_by_entity_list_response_default.additional_properties = d
        return fixture_by_entity_list_response_default
