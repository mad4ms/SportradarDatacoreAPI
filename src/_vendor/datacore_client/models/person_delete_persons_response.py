...
T = TypeVar("T", bound="PersonDeletePersonsResponse")


@_attrs_define
class PersonDeletePersonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_delete_persons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        person_delete_persons_response.additional_properties = d
        return person_delete_persons_response
