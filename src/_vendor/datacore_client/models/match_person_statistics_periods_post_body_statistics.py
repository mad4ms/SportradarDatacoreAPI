...
T = TypeVar("T", bound="MatchPersonStatisticsPeriodsPostBodyStatistics")


@_attrs_define
class MatchPersonStatisticsPeriodsPostBodyStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        match_person_statistics_periods_post_body_statistics = cls(
        ...
        return match_person_statistics_periods_post_body_statistics
