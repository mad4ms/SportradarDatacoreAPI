...
T = TypeVar("T", bound="StandingUpdateStandingPutBodyCalculatedAdditionalProperty")


@_attrs_define
class StandingUpdateStandingPutBodyCalculatedAdditionalProperty:
    """Type of points
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_update_standing_put_body_calculated_additional_property = cls(
            played=played,
        ...
        return standing_update_standing_put_body_calculated_additional_property
