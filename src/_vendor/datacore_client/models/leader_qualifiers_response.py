...
T = TypeVar("T", bound="LeaderQualifiersResponse")


@_attrs_define
class LeaderQualifiersResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        leader_qualifiers_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        leader_qualifiers_response.additional_properties = d
        return leader_qualifiers_response
