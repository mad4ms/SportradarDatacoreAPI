...
T = TypeVar("T", bound="SiteExternalIdsUpdateSiteExternalIdsResponse")


@_attrs_define
class SiteExternalIdsUpdateSiteExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_external_ids_update_site_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        site_external_ids_update_site_external_ids_response.additional_properties = d
        return site_external_ids_update_site_external_ids_response
