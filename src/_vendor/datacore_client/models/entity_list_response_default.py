...
T = TypeVar("T", bound="EntityListResponseDefault")


@_attrs_define
class EntityListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_list_response_default = cls(
            meta=meta,
            error=error,
        )

        entity_list_response_default.additional_properties = d
        return entity_list_response_default
