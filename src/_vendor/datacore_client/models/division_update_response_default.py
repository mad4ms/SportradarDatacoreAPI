...
T = TypeVar("T", bound="DivisionUpdateResponseDefault")


@_attrs_define
class DivisionUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        division_update_response_default = cls(
            meta=meta,
            error=error,
        )

        division_update_response_default.additional_properties = d
        return division_update_response_default
