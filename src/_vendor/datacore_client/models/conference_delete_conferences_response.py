...
T = TypeVar("T", bound="ConferenceDeleteConferencesResponse")


@_attrs_define
class ConferenceDeleteConferencesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_delete_conferences_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        conference_delete_conferences_response.additional_properties = d
        return conference_delete_conferences_response
