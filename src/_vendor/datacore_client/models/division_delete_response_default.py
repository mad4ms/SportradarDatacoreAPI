...
T = TypeVar("T", bound="DivisionDeleteResponseDefault")


@_attrs_define
class DivisionDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        division_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        division_delete_response_default.additional_properties = d
        return division_delete_response_default
