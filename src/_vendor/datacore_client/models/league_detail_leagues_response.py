...
T = TypeVar("T", bound="LeagueDetailLeaguesResponse")


@_attrs_define
class LeagueDetailLeaguesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        league_detail_leagues_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        league_detail_leagues_response.additional_properties = d
        return league_detail_leagues_response
