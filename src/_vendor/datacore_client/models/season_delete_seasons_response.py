...
T = TypeVar("T", bound="SeasonDeleteSeasonsResponse")


@_attrs_define
class SeasonDeleteSeasonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_delete_seasons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_delete_seasons_response.additional_properties = d
        return season_delete_seasons_response
