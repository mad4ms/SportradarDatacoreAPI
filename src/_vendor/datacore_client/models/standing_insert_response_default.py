...
T = TypeVar("T", bound="StandingInsertResponseDefault")


@_attrs_define
class StandingInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        standing_insert_response_default.additional_properties = d
        return standing_insert_response_default
