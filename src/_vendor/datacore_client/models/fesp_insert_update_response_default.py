...
T = TypeVar("T", bound="FespInsertUpdateResponseDefault")


@_attrs_define
class FespInsertUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fesp_insert_update_response_default = cls(
            meta=meta,
            error=error,
        )

        fesp_insert_update_response_default.additional_properties = d
        return fesp_insert_update_response_default
