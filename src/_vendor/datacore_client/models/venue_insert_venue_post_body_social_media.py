...
T = TypeVar("T", bound="VenueInsertVenuePostBodySocialMedia")


@_attrs_define
class VenueInsertVenuePostBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_insert_venue_post_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return venue_insert_venue_post_body_social_media
