...
T = TypeVar("T", bound="OrganizationDeleteResponseDefault")


@_attrs_define
class OrganizationDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        organization_delete_response_default.additional_properties = d
        return organization_delete_response_default
