...
T = TypeVar("T", bound="SeasonPersonsDeleteResponseDefault")


@_attrs_define
class SeasonPersonsDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_persons_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        season_persons_delete_response_default.additional_properties = d
        return season_persons_delete_response_default
