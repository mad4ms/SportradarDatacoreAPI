...
from ..models.standing_configurations_update_standing_configurations_put_body_standing_building_build_type import (
    StandingConfigurationsUpdateStandingConfigurationsPutBodyStandingBuildingBuildType,
)
from ..models.standing_configurations_update_standing_configurations_put_body_standing_building_fixture_types_item import (
    StandingConfigurationsUpdateStandingConfigurationsPutBodyStandingBuildingFixtureTypesItem,
)
from ..models.standing_configurations_update_standing_configurations_put_body_standing_building_grouping import (
...
T = TypeVar(
    "T",
    bound="StandingConfigurationsUpdateStandingConfigurationsPutBodyStandingBuilding",
)


@_attrs_define
class StandingConfigurationsUpdateStandingConfigurationsPutBodyStandingBuilding:
    """Suilding definitions

    Attributes:
        build_type (StandingConfigurationsUpdateStandingConfigurationsPutBodyStandingBuildingBuildType): Overall
            standing Type (ROUND not used on live Standings) Example: OVERALL.
        grouping (StandingConfigurationsUpdateStandingConfigurationsPutBodyStandingBuildingGrouping): How to Group
            Example: NONE.
        fixture_types (list[StandingConfigurationsUpdateStandingConfigurationsPutBodyStandingBuildingFixtureTypesItem]):
    ...
    build_type: StandingConfigurationsUpdateStandingConfigurationsPutBodyStandingBuildingBuildType
    grouping: StandingConfigurationsUpdateStandingConfigurationsPutBodyStandingBuildingGrouping
    fixture_types: list[
        StandingConfigurationsUpdateStandingConfigurationsPutBodyStandingBuildingFixtureTypesItem
    ]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for fixture_types_item_data in _fixture_types:
            fixture_types_item = StandingConfigurationsUpdateStandingConfigurationsPutBodyStandingBuildingFixtureTypesItem(
        ...
        standing_configurations_update_standing_configurations_put_body_standing_building = cls(
        ...
        return standing_configurations_update_standing_configurations_put_body_standing_building
