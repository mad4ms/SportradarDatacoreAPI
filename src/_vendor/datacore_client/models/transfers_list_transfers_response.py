...
T = TypeVar("T", bound="TransfersListTransfersResponse")


@_attrs_define
class TransfersListTransfersResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfers_list_transfers_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        transfers_list_transfers_response.additional_properties = d
        return transfers_list_transfers_response
