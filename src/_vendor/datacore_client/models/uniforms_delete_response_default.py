...
T = TypeVar("T", bound="UniformsDeleteResponseDefault")


@_attrs_define
class UniformsDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniforms_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        uniforms_delete_response_default.additional_properties = d
        return uniforms_delete_response_default
