...
from ..models.conduct_insert_conduct_post_body_conduct_type_item import (
    ConductInsertConductPostBodyConductTypeItem,
)
from ..models.conduct_insert_conduct_post_body_fine_status_type_1 import (
    ConductInsertConductPostBodyFineStatusType1,
)
from ..models.conduct_insert_conduct_post_body_fine_status_type_2_type_1 import (
    ConductInsertConductPostBodyFineStatusType2Type1,
)
from ..models.conduct_insert_conduct_post_body_fine_status_type_3_type_1 import (
    ConductInsertConductPostBodyFineStatusType3Type1,
)
from ..models.conduct_insert_conduct_post_body_hearing_status_type_1 import (
    ConductInsertConductPostBodyHearingStatusType1,
)
from ..models.conduct_insert_conduct_post_body_hearing_status_type_2_type_1 import (
    ConductInsertConductPostBodyHearingStatusType2Type1,
)
from ..models.conduct_insert_conduct_post_body_hearing_status_type_3_type_1 import (
    ConductInsertConductPostBodyHearingStatusType3Type1,
)
from ..models.conduct_insert_conduct_post_body_period_id import (
    ConductInsertConductPostBodyPeriodId,
)
from ..models.conduct_insert_conduct_post_body_role_type_1 import (
    ConductInsertConductPostBodyRoleType1,
)
from ..models.conduct_insert_conduct_post_body_role_type_2_type_1 import (
    ConductInsertConductPostBodyRoleType2Type1,
)
from ..models.conduct_insert_conduct_post_body_role_type_3_type_1 import (
    ConductInsertConductPostBodyRoleType3Type1,
)
from ..models.conduct_insert_conduct_post_body_status_type_1 import (
    ConductInsertConductPostBodyStatusType1,
)
from ..models.conduct_insert_conduct_post_body_status_type_2_type_1 import (
    ConductInsertConductPostBodyStatusType2Type1,
)
from ..models.conduct_insert_conduct_post_body_status_type_3_type_1 import (
    ConductInsertConductPostBodyStatusType3Type1,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.conduct_insert_conduct_post_body_conduct_penalty_result import (
        ConductInsertConductPostBodyConductPenaltyResult,
    )


T = TypeVar("T", bound="ConductInsertConductPostBody")


@_attrs_define
class ConductInsertConductPostBody:
    """
    Attributes:
        conduct_type (list[ConductInsertConductPostBodyConductTypeItem]):
        conduct_id (Union[Unset, UUID]): The unique identifier of the conduct Example:
        ...
        event_id (Union[Unset, UUID]): The ~event~ that this conduct is linked to Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        period_id (Union[Unset, ConductInsertConductPostBodyPeriodId]): The identifier for the period
            >- `1` Period 1
            >- `2` Period 2
        ...
        role (Union[ConductInsertConductPostBodyRoleType1, ConductInsertConductPostBodyRoleType2Type1,
            ConductInsertConductPostBodyRoleType3Type1, None, Unset]): The role of person
            >- None None
        ...
        hearing_status (Union[ConductInsertConductPostBodyHearingStatusType1,
            ConductInsertConductPostBodyHearingStatusType2Type1, ConductInsertConductPostBodyHearingStatusType3Type1, None,
        ...
        penalty_results (Union[Unset, list[Union['ConductInsertConductPostBodyConductPenaltyResult', None]]]):
        fine_amount (Union[Unset, float]): Conduct fine amount
        fine_currency (Union[None, Unset, str]): Fine currency Example: USD.
        fine_status (Union[ConductInsertConductPostBodyFineStatusType1,
            ConductInsertConductPostBodyFineStatusType2Type1, ConductInsertConductPostBodyFineStatusType3Type1, None,
            Unset]): Conduct fine due status
            >- None None
            >- `CANCELLED` Cancelled
            >- `ISSUED` Issued
            >- `OTHER` Other
        ...
        status (Union[ConductInsertConductPostBodyStatusType1, ConductInsertConductPostBodyStatusType2Type1,
            ConductInsertConductPostBodyStatusType3Type1, None, Unset]): Conduct status
            >- None None
            >- `ACTIVE` Active
            >- `CLOSED` Closed
            >- `COMPLETE` Complete
    ...
    conduct_type: list[ConductInsertConductPostBodyConductTypeItem]
    conduct_id: Union[Unset, UUID] = UNSET
    ...
    period_id: Union[Unset, ConductInsertConductPostBodyPeriodId] = UNSET
    ...
    penalty_results: Union[
        Unset, list[Union["ConductInsertConductPostBodyConductPenaltyResult", None]]
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.conduct_id, Unset):
            conduct_id = str(self.conduct_id)
        ...
        if isinstance(self.role, Unset):
            role = UNSET
        elif isinstance(self.role, ConductInsertConductPostBodyRoleType1):
            role = self.role.value
        elif isinstance(self.role, ConductInsertConductPostBodyRoleType2Type1):
            role = self.role.value
        elif isinstance(self.role, ConductInsertConductPostBodyRoleType3Type1):
            role = self.role.value
        else:
            role = self.role
        ...
        if isinstance(self.hearing_status, Unset):
            ...
            self.hearing_status, ConductInsertConductPostBodyHearingStatusType1
        ):
            hearing_status = self.hearing_status.value
        elif isinstance(
            self.hearing_status, ConductInsertConductPostBodyHearingStatusType2Type1
        ):
            hearing_status = self.hearing_status.value
        elif isinstance(
            self.hearing_status, ConductInsertConductPostBodyHearingStatusType3Type1
        ):
            hearing_status = self.hearing_status.value
        else:
        ...
        if isinstance(self.fine_status, Unset):
            fine_status = UNSET
        elif isinstance(self.fine_status, ConductInsertConductPostBodyFineStatusType1):
            fine_status = self.fine_status.value
        elif isinstance(
            self.fine_status, ConductInsertConductPostBodyFineStatusType2Type1
        ):
            fine_status = self.fine_status.value
        elif isinstance(
            self.fine_status, ConductInsertConductPostBodyFineStatusType3Type1
        ):
            fine_status = self.fine_status.value
        else:
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, ConductInsertConductPostBodyStatusType1):
            status = self.status.value
        elif isinstance(self.status, ConductInsertConductPostBodyStatusType2Type1):
            status = self.status.value
        elif isinstance(self.status, ConductInsertConductPostBodyStatusType3Type1):
            status = self.status.value
        else:
            status = self.status
        ...
        if conduct_id is not UNSET:
            field_dict["conductId"] = conduct_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        conduct_type = []
        _conduct_type = d.pop("conductType")
        for conduct_type_item_data in _conduct_type:
            conduct_type_item = ConductInsertConductPostBodyConductTypeItem(
        ...
        conduct_id: Union[Unset, UUID]
        if isinstance(_conduct_id, Unset):
            conduct_id = UNSET
        else:
            conduct_id = UUID(_conduct_id)
        ...
        period_id: Union[Unset, ConductInsertConductPostBodyPeriodId]
        if isinstance(_period_id, Unset):
            period_id = UNSET
        else:
            period_id = ConductInsertConductPostBodyPeriodId(_period_id)
        ...
        def _parse_role(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                role_type_1 = ConductInsertConductPostBodyRoleType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                role_type_2_type_1 = ConductInsertConductPostBodyRoleType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                role_type_3_type_1 = ConductInsertConductPostBodyRoleType3Type1(data)
        ...
        def _parse_hearing_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                hearing_status_type_1 = ConductInsertConductPostBodyHearingStatusType1(
                    data
                )
            ...
            try:
                ...
                hearing_status_type_2_type_1 = (
                    ConductInsertConductPostBodyHearingStatusType2Type1(data)
                )
            ...
            try:
                ...
                hearing_status_type_3_type_1 = (
                    ConductInsertConductPostBodyHearingStatusType3Type1(data)
                )
        ...
        for penalty_results_item_data in _penalty_results or []:
            ...
            def _parse_penalty_results_item(
                data: object,
            ) -> Union["ConductInsertConductPostBodyConductPenaltyResult", None]:
                if data is None:
                    return data
                try:
                    ...
                    penalty_results_item_type_0 = (
                        ConductInsertConductPostBodyConductPenaltyResult.from_dict(data)
                    )
        ...
        def _parse_fine_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                fine_status_type_1 = ConductInsertConductPostBodyFineStatusType1(data)
            ...
            try:
                ...
                fine_status_type_2_type_1 = (
                    ConductInsertConductPostBodyFineStatusType2Type1(data)
                )
            ...
            try:
                ...
                fine_status_type_3_type_1 = (
                    ConductInsertConductPostBodyFineStatusType3Type1(data)
                )
        ...
        def _parse_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_1 = ConductInsertConductPostBodyStatusType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_2_type_1 = ConductInsertConductPostBodyStatusType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_3_type_1 = ConductInsertConductPostBodyStatusType3Type1(
                    data
                )
        ...
        conduct_insert_conduct_post_body = cls(
        ...
        return conduct_insert_conduct_post_body
