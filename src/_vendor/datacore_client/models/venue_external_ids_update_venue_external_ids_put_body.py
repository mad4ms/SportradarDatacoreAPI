...
T = TypeVar("T", bound="VenueExternalIdsUpdateVenueExternalIdsPutBody")


@_attrs_define
class VenueExternalIdsUpdateVenueExternalIdsPutBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_external_ids_update_venue_external_ids_put_body = cls(
            venue_id=venue_id,
            source=source,
        ...
        return venue_external_ids_update_venue_external_ids_put_body
