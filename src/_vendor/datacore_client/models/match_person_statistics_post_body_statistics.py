...
T = TypeVar("T", bound="MatchPersonStatisticsPostBodyStatistics")


@_attrs_define
class MatchPersonStatisticsPostBodyStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        match_person_statistics_post_body_statistics = cls(
        ...
        return match_person_statistics_post_body_statistics
