...
T = TypeVar("T", bound="MatchTeamStatisticsPostBodyStatistics")


@_attrs_define
class MatchTeamStatisticsPostBodyStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        match_team_statistics_post_body_statistics = cls(
            assists=assists,
        ...
        return match_team_statistics_post_body_statistics
