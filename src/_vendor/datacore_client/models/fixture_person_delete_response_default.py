...
T = TypeVar("T", bound="FixturePersonDeleteResponseDefault")


@_attrs_define
class FixturePersonDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_person_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_person_delete_response_default.additional_properties = d
        return fixture_person_delete_response_default
