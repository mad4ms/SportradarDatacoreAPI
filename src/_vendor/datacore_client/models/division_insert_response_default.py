...
T = TypeVar("T", bound="DivisionInsertResponseDefault")


@_attrs_define
class DivisionInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        division_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        division_insert_response_default.additional_properties = d
        return division_insert_response_default
