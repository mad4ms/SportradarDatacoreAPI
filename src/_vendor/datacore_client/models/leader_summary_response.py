...
T = TypeVar("T", bound="LeaderSummaryResponse")


@_attrs_define
class LeaderSummaryResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        leader_summary_response.additional_properties = d
        return leader_summary_response
