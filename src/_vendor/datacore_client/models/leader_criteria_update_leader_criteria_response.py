...
T = TypeVar("T", bound="LeaderCriteriaUpdateLeaderCriteriaResponse")


@_attrs_define
class LeaderCriteriaUpdateLeaderCriteriaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        leader_criteria_update_leader_criteria_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        leader_criteria_update_leader_criteria_response.additional_properties = d
        return leader_criteria_update_leader_criteria_response
