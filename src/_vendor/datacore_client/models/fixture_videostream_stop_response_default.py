...
T = TypeVar("T", bound="FixtureVideostreamStopResponseDefault")


@_attrs_define
class FixtureVideostreamStopResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_videostream_stop_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_videostream_stop_response_default.additional_properties = d
        return fixture_videostream_stop_response_default
