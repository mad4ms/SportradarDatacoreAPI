...
T = TypeVar("T", bound="FixturePbpEventDeleteResponseDefault")


@_attrs_define
class FixturePbpEventDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_pbp_event_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_pbp_event_delete_response_default.additional_properties = d
        return fixture_pbp_event_delete_response_default
