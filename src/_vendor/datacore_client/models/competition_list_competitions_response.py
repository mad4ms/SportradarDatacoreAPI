...
T = TypeVar("T", bound="CompetitionListCompetitionsResponse")


@_attrs_define
class CompetitionListCompetitionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_list_competitions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        competition_list_competitions_response.additional_properties = d
        return competition_list_competitions_response
