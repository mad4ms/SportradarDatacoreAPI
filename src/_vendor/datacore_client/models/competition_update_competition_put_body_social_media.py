...
T = TypeVar("T", bound="CompetitionUpdateCompetitionPutBodySocialMedia")


@_attrs_define
class CompetitionUpdateCompetitionPutBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_update_competition_put_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return competition_update_competition_put_body_social_media
