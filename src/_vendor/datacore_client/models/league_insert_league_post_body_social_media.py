...
T = TypeVar("T", bound="LeagueInsertLeaguePostBodySocialMedia")


@_attrs_define
class LeagueInsertLeaguePostBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        league_insert_league_post_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return league_insert_league_post_body_social_media
