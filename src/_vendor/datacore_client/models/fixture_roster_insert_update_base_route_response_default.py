...
T = TypeVar("T", bound="FixtureRosterInsertUpdateBaseRouteResponseDefault")


@_attrs_define
class FixtureRosterInsertUpdateBaseRouteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_roster_insert_update_base_route_response_default = cls(
            meta=meta,
            error=error,
        )
