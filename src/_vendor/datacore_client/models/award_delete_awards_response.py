...
T = TypeVar("T", bound="AwardDeleteAwardsResponse")


@_attrs_define
class AwardDeleteAwardsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        award_delete_awards_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        award_delete_awards_response.additional_properties = d
        return award_delete_awards_response
