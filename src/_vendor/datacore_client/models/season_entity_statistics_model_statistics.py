...
T = TypeVar("T", bound="SeasonEntityStatisticsModelStatistics")


@_attrs_define
class SeasonEntityStatisticsModelStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_entity_statistics_model_statistics = cls(
            assists=assists,
        ...
        return season_entity_statistics_model_statistics
