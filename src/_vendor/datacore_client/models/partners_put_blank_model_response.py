...
T = TypeVar("T", bound="PartnersPutBlankModelResponse")


@_attrs_define
class PartnersPutBlankModelResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        partners_put_blank_model_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        partners_put_blank_model_response.additional_properties = d
        return partners_put_blank_model_response
