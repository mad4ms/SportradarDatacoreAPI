...
T = TypeVar("T", bound="FixturePersonStatisticsResponse")


@_attrs_define
class FixturePersonStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_person_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_person_statistics_response.additional_properties = d
        return fixture_person_statistics_response
