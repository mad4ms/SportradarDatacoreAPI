...
T = TypeVar("T", bound="SeasonEntityBaseStatisticsResponse")


@_attrs_define
class SeasonEntityBaseStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_entity_base_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_entity_base_statistics_response.additional_properties = d
        return season_entity_base_statistics_response
