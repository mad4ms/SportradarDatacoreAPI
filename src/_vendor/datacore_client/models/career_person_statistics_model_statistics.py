...
T = TypeVar("T", bound="CareerPersonStatisticsModelStatistics")


@_attrs_define
class CareerPersonStatisticsModelStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        career_person_statistics_model_statistics = cls(
        ...
        return career_person_statistics_model_statistics
