...
T = TypeVar("T", bound="SeasonPoolInsertResponseDefault")


@_attrs_define
class SeasonPoolInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_pool_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        season_pool_insert_response_default.additional_properties = d
        return season_pool_insert_response_default
