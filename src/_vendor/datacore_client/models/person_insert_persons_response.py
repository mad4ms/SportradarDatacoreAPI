...
T = TypeVar("T", bound="PersonInsertPersonsResponse")


@_attrs_define
class PersonInsertPersonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_insert_persons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        person_insert_persons_response.additional_properties = d
        return person_insert_persons_response
