...
T = TypeVar("T", bound="VenueInsertVenuePostBodyVenueAddress")


@_attrs_define
class VenueInsertVenuePostBodyVenueAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_insert_venue_post_body_venue_address = cls(
            address1=address1,
            address2=address2,
            address3=address3,
            city=city,
        ...
        return venue_insert_venue_post_body_venue_address
