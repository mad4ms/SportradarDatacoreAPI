...
T = TypeVar("T", bound="PersonDetailPersonsResponse")


@_attrs_define
class PersonDetailPersonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_detail_persons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        person_detail_persons_response.additional_properties = d
        return person_detail_persons_response
