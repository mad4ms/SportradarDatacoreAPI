...
T = TypeVar("T", bound="EntityInsertTeamPostBodyContactDetails")


@_attrs_define
class EntityInsertTeamPostBodyContactDetails:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_insert_team_post_body_contact_details = cls(
            fax=fax,
            phone=phone,
        ...
        return entity_insert_team_post_body_contact_details
