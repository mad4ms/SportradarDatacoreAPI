...
T = TypeVar("T", bound="SeasonPoolsDeleteSeasonPoolsResponse")


@_attrs_define
class SeasonPoolsDeleteSeasonPoolsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = PoolModel.from_dict(data_item_data)

            data.append(data_item)

        season_pools_delete_season_pools_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_pools_delete_season_pools_response.additional_properties = d
        return season_pools_delete_season_pools_response
