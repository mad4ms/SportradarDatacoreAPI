...
T = TypeVar("T", bound="HeadToHeadListFixturesHeadToHeadEntityResponse")


@_attrs_define
class HeadToHeadListFixturesHeadToHeadEntityResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        head_to_head_list_fixtures_head_to_head_entity_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        head_to_head_list_fixtures_head_to_head_entity_response.additional_properties = d
        return head_to_head_list_fixtures_head_to_head_entity_response
