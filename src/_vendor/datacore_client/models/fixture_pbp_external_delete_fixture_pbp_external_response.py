...
T = TypeVar("T", bound="FixturePbpExternalDeleteFixturePbpExternalResponse")


@_attrs_define
class FixturePbpExternalDeleteFixturePbpExternalResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_pbp_external_delete_fixture_pbp_external_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_pbp_external_delete_fixture_pbp_external_response.additional_properties = (
            d
        )
        return fixture_pbp_external_delete_fixture_pbp_external_response
