...
@_attrs_define
class ConductModelCompetition:
    """The competition that this season belongs to

    Attributes:
        resource_type (Union[Unset, ConductModelCompetitionResourceType]):
        id (Union[Unset, str]): Unique identifier for this resource Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
    """

    resource_type: Union[Unset, ConductModelCompetitionResourceType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource_type, Unset):
            ...
            resource_type = ConductModelCompetitionResourceType(_resource_type)

        id = d.pop("id", UNSET)

        conduct_model_competition = cls(
            resource_type=resource_type,
            id=id,
        )

        conduct_model_competition.additional_properties = d
        return conduct_model_competition
