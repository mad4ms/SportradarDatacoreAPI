...
T = TypeVar("T", bound="FpspInsertUpdateResponseDefault")


@_attrs_define
class FpspInsertUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fpsp_insert_update_response_default = cls(
            meta=meta,
            error=error,
        )

        fpsp_insert_update_response_default.additional_properties = d
        return fpsp_insert_update_response_default
