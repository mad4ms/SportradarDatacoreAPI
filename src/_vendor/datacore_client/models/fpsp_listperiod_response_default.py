...
T = TypeVar("T", bound="FpspListperiodResponseDefault")


@_attrs_define
class FpspListperiodResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fpsp_listperiod_response_default = cls(
            meta=meta,
            error=error,
        )

        fpsp_listperiod_response_default.additional_properties = d
        return fpsp_listperiod_response_default
