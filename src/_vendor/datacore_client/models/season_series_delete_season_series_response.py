...
T = TypeVar("T", bound="SeasonSeriesDeleteSeasonSeriesResponse")


@_attrs_define
class SeasonSeriesDeleteSeasonSeriesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeriesModel.from_dict(data_item_data)

            data.append(data_item)

        season_series_delete_season_series_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_series_delete_season_series_response.additional_properties = d
        return season_series_delete_season_series_response
