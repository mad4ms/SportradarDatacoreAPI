...
T = TypeVar("T", bound="PersonUpdateResponseDefault")


@_attrs_define
class PersonUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_update_response_default = cls(
            meta=meta,
            error=error,
        )

        person_update_response_default.additional_properties = d
        return person_update_response_default
