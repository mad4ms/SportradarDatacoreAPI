...
T = TypeVar("T", bound="OrganizationListResponseDefault")


@_attrs_define
class OrganizationListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_list_response_default = cls(
            meta=meta,
            error=error,
        )

        organization_list_response_default.additional_properties = d
        return organization_list_response_default
