...
T = TypeVar("T", bound="PartnersGetBlankModelResponse")


@_attrs_define
class PartnersGetBlankModelResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        partners_get_blank_model_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        partners_get_blank_model_response.additional_properties = d
        return partners_get_blank_model_response
