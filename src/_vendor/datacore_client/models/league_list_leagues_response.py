...
T = TypeVar("T", bound="LeagueListLeaguesResponse")


@_attrs_define
class LeagueListLeaguesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        league_list_leagues_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        league_list_leagues_response.additional_properties = d
        return league_list_leagues_response
