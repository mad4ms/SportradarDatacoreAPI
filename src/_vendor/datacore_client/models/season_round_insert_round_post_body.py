...
T = TypeVar("T", bound="SeasonRoundInsertRoundPostBody")


@_attrs_define
class SeasonRoundInsertRoundPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_round_insert_round_post_body = cls(
            season_id=season_id,
        ...
        return season_round_insert_round_post_body
