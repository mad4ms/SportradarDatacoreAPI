...
if TYPE_CHECKING:
    from ..models.game_log_person_model import GameLogPersonModel
...
T = TypeVar("T", bound="GamelogListpersonGameLogPersonResponse")


@_attrs_define
class GamelogListpersonGameLogPersonResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = GameLogPersonModel.from_dict(data_item_data)

            data.append(data_item)

        gamelog_listperson_game_log_person_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        gamelog_listperson_game_log_person_response.additional_properties = d
        return gamelog_listperson_game_log_person_response
