...
T = TypeVar("T", bound="FixtureEntityStatisticsResponse")


@_attrs_define
class FixtureEntityStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_entity_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_entity_statistics_response.additional_properties = d
        return fixture_entity_statistics_response
