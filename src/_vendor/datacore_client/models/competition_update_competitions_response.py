...
T = TypeVar("T", bound="CompetitionUpdateCompetitionsResponse")


@_attrs_define
class CompetitionUpdateCompetitionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_update_competitions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        competition_update_competitions_response.additional_properties = d
        return competition_update_competitions_response
