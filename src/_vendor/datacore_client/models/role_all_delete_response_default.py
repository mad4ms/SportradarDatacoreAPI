...
T = TypeVar("T", bound="RoleAllDeleteResponseDefault")


@_attrs_define
class RoleAllDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role_all_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        role_all_delete_response_default.additional_properties = d
        return role_all_delete_response_default
