...
from ..models.standing_configurations_insert_standing_configurations_post_body_standing_configuration_streak import (
    StandingConfigurationsInsertStandingConfigurationsPostBodyStandingConfigurationStreak,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.standing_configurations_insert_standing_configurations_post_body_standing_configuration_head_to_head_identification import (
        StandingConfigurationsInsertStandingConfigurationsPostBodyStandingConfigurationHeadToHeadIdentification,
    )
    from ..models.standing_configurations_insert_standing_configurations_post_body_standing_configuration_head_to_head_identification_for_subsequent_checks import (
    ...
    from ..models.standing_configurations_insert_standing_configurations_post_body_standing_configuration_head_to_head_resolution import (
        StandingConfigurationsInsertStandingConfigurationsPostBodyStandingConfigurationHeadToHeadResolution,
    )
    from ..models.standing_configurations_insert_standing_configurations_post_body_standing_configuration_head_to_head_resolution_for_extra_depth_h2_hs import (
        StandingConfigurationsInsertStandingConfigurationsPostBodyStandingConfigurationHeadToHeadResolutionForExtraDepthH2Hs,
    )
    from ..models.standing_configurations_insert_standing_configurations_post_body_standing_configuration_sorting import (
...
T = TypeVar(
    "T",
    bound="StandingConfigurationsInsertStandingConfigurationsPostBodyStandingConfiguration",
)


@_attrs_define
class StandingConfigurationsInsertStandingConfigurationsPostBodyStandingConfiguration:
    ...
    Attributes:
        ...
        streak (Union[Unset, StandingConfigurationsInsertStandingConfigurationsPostBodyStandingConfigurationStreak]):
            How is a streak calculated ?
        sorts (Union[Unset,
            list['StandingConfigurationsInsertStandingConfigurationsPostBodyStandingConfigurationSorting']]): Sortings
        head_to_head_identification (Union[Unset, list['StandingConfigurationsInsertStandingConfigurationsPostBodyStandi
            ngConfigurationHeadToHeadIdentification']]): Head to head identifications
        head_to_head_identification_subsequent (Union[Unset, list['StandingConfigurationsInsertStandingConfigurationsPos
            tBodyStandingConfigurationHeadToHeadIdentificationForSubsequentChecks']]): Head to head identifications for
            subsequent checks
        ...
        head_to_head_resolutions (Union[Unset,
            list['StandingConfigurationsInsertStandingConfigurationsPostBodyStandingConfigurationHeadToHeadResolution']]):
            Head to head resolutions
        head_to_head_resolutions_subsequent (Union[Unset, list['StandingConfigurationsInsertStandingConfigurationsPostBo
            dyStandingConfigurationHeadToHeadResolutionForExtraDepthH2Hs']]): Head to head resolutions for extra depth h2h's
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_streak, Unset):
            ...
            streak = StandingConfigurationsInsertStandingConfigurationsPostBodyStandingConfigurationStreak(
                _streak
            )
        ...
        for sorts_item_data in _sorts or []:
            sorts_item = StandingConfigurationsInsertStandingConfigurationsPostBodyStandingConfigurationSorting.from_dict(
                sorts_item_data
            )
        ...
        for head_to_head_identification_item_data in _head_to_head_identification or []:
            head_to_head_identification_item = StandingConfigurationsInsertStandingConfigurationsPostBodyStandingConfigurationHeadToHeadIdentification.from_dict(
                head_to_head_identification_item_data
            )
        ...
        for head_to_head_identification_subsequent_item_data in (
            ...
            head_to_head_identification_subsequent_item = StandingConfigurationsInsertStandingConfigurationsPostBodyStandingConfigurationHeadToHeadIdentificationForSubsequentChecks.from_dict(
                head_to_head_identification_subsequent_item_data
            )
        ...
        for head_to_head_resolutions_item_data in _head_to_head_resolutions or []:
            head_to_head_resolutions_item = StandingConfigurationsInsertStandingConfigurationsPostBodyStandingConfigurationHeadToHeadResolution.from_dict(
        ...
        for head_to_head_resolutions_subsequent_item_data in (
            ...
            head_to_head_resolutions_subsequent_item = StandingConfigurationsInsertStandingConfigurationsPostBodyStandingConfigurationHeadToHeadResolutionForExtraDepthH2Hs.from_dict(
                head_to_head_resolutions_subsequent_item_data
            )
        ...
        standing_configurations_insert_standing_configurations_post_body_standing_configuration = cls(
        ...
        return standing_configurations_insert_standing_configurations_post_body_standing_configuration
