...
T = TypeVar("T", bound="FixtureProgressionsDeleteFixtureProgressionsResponse")


@_attrs_define
class FixtureProgressionsDeleteFixtureProgressionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_progressions_delete_fixture_progressions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_progressions_delete_fixture_progressions_response.additional_properties = (
            d
        )
        return fixture_progressions_delete_fixture_progressions_response
