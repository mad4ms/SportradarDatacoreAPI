...
T = TypeVar("T", bound="EntityGroupDeleteEntityGroupsResponse")


@_attrs_define
class EntityGroupDeleteEntityGroupsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = ClubModel.from_dict(data_item_data)

            data.append(data_item)

        entity_group_delete_entity_groups_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_group_delete_entity_groups_response.additional_properties = d
        return entity_group_delete_entity_groups_response
