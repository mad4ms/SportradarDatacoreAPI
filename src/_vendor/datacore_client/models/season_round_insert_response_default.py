...
T = TypeVar("T", bound="SeasonRoundInsertResponseDefault")


@_attrs_define
class SeasonRoundInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_round_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        season_round_insert_response_default.additional_properties = d
        return season_round_insert_response_default
