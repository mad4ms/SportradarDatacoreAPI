...
T = TypeVar("T", bound="OrganizationUpdateOrganizationsResponse")


@_attrs_define
class OrganizationUpdateOrganizationsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_update_organizations_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        organization_update_organizations_response.additional_properties = d
        return organization_update_organizations_response
