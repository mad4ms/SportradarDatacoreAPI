...
T = TypeVar("T", bound="FixtureRosterDeleteResponseDefault")


@_attrs_define
class FixtureRosterDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_roster_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_roster_delete_response_default.additional_properties = d
        return fixture_roster_delete_response_default
