...
if TYPE_CHECKING:
    ...
    from ..models.standing_model import StandingModel


T = TypeVar("T", bound="StandingLiveListStandingsResponse")


@_attrs_define
class StandingLiveListStandingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = StandingModel.from_dict(data_item_data)

            data.append(data_item)

        standing_live_list_standings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_live_list_standings_response.additional_properties = d
        return standing_live_list_standings_response
