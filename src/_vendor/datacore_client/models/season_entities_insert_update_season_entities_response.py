...
T = TypeVar("T", bound="SeasonEntitiesInsertUpdateSeasonEntitiesResponse")


@_attrs_define
class SeasonEntitiesInsertUpdateSeasonEntitiesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_entities_insert_update_season_entities_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_entities_insert_update_season_entities_response.additional_properties = d
        return season_entities_insert_update_season_entities_response
