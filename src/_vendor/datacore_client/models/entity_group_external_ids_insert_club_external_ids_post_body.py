...
T = TypeVar("T", bound="EntityGroupExternalIdsInsertClubExternalIdsPostBody")


@_attrs_define
class EntityGroupExternalIdsInsertClubExternalIdsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_external_ids_insert_club_external_ids_post_body = cls(
            source=source,
        ...
        return entity_group_external_ids_insert_club_external_ids_post_body
