...
T = TypeVar("T", bound="StandingBuildResponseDefault")


@_attrs_define
class StandingBuildResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_build_response_default = cls(
            meta=meta,
            error=error,
        )

        standing_build_response_default.additional_properties = d
        return standing_build_response_default
