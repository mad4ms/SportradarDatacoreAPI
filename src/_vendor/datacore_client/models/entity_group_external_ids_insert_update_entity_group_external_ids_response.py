...
T = TypeVar(
    "T", bound="EntityGroupExternalIdsInsertUpdateEntityGroupExternalIdsResponse"
)


@_attrs_define
class EntityGroupExternalIdsInsertUpdateEntityGroupExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_external_ids_insert_update_entity_group_external_ids_response = (
            cls(
                meta=meta,
                links=links,
                included=included,
        ...
        entity_group_external_ids_insert_update_entity_group_external_ids_response.additional_properties = (
            d
        )
        return (
            entity_group_external_ids_insert_update_entity_group_external_ids_response
