...
T = TypeVar("T", bound="TransfersInsertTransferPostBodyTransferComponent")


@_attrs_define
class TransfersInsertTransferPostBodyTransferComponent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfers_insert_transfer_post_body_transfer_component = cls(
            person_id=person_id,
        ...
        return transfers_insert_transfer_post_body_transfer_component
