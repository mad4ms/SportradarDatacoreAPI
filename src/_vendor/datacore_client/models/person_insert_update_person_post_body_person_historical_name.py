...
T = TypeVar("T", bound="PersonInsertUpdatePersonPostBodyPersonHistoricalName")


@_attrs_define
class PersonInsertUpdatePersonPostBodyPersonHistoricalName:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_insert_update_person_post_body_person_historical_name = cls(
        ...
        return person_insert_update_person_post_body_person_historical_name
