...
if TYPE_CHECKING:
    ...
    from ..models.season_team_base_statistics_model import SeasonTeamBaseStatisticsModel


T = TypeVar("T", bound="SebsInsertUpdateSeasonEntityBaseStatisticsResponse")


@_attrs_define
class SebsInsertUpdateSeasonEntityBaseStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.response_links import ResponseLinks
        from ..models.response_meta_data import ResponseMetaData
        from ..models.season_team_base_statistics_model import (
        ...
        for data_item_data in _data or []:
            data_item = SeasonTeamBaseStatisticsModel.from_dict(data_item_data)

            data.append(data_item)

        sebs_insert_update_season_entity_base_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        sebs_insert_update_season_entity_base_statistics_response.additional_properties = (
            d
        )
        return sebs_insert_update_season_entity_base_statistics_response
