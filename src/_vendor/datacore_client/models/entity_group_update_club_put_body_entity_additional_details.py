...
T = TypeVar("T", bound="EntityGroupUpdateClubPutBodyEntityAdditionalDetails")


@_attrs_define
class EntityGroupUpdateClubPutBodyEntityAdditionalDetails:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_update_club_put_body_entity_additional_details = cls(
            founded=founded,
            squad_value=squad_value,
        )

        return entity_group_update_club_put_body_entity_additional_details
