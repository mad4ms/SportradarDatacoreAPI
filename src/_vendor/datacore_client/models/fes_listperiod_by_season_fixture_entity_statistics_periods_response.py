...
if TYPE_CHECKING:
    ...
    from ..models.match_team_period_statistics_model import MatchTeamPeriodStatisticsModel
    from ..models.response_links import ResponseLinks
    from ..models.response_meta_data import ResponseMetaData


T = TypeVar("T", bound="FesListperiodBySeasonFixtureEntityStatisticsPeriodsResponse")


@_attrs_define
class FesListperiodBySeasonFixtureEntityStatisticsPeriodsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = MatchTeamPeriodStatisticsModel.from_dict(data_item_data)

            data.append(data_item)

        fes_listperiod_by_season_fixture_entity_statistics_periods_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fes_listperiod_by_season_fixture_entity_statistics_periods_response.additional_properties = d
        return fes_listperiod_by_season_fixture_entity_statistics_periods_response
