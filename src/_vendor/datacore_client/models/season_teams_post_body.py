...
from ..models.season_teams_post_body_roster_status import SeasonTeamsPostBodyRosterStatus
from ..models.season_teams_post_body_status import SeasonTeamsPostBodyStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeasonTeamsPostBody")


@_attrs_define
class SeasonTeamsPostBody:
    """
    Attributes:
        ...
        division_id (Union[None, UUID, Unset]): The unique identifier of the division Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        roster_status (Union[Unset, SeasonTeamsPostBodyRosterStatus]): The status of the TEAM season teams
            >- `APPROVED` Approved
            >- `PENDING` Pending
            >- `REJECTED` Rejected
            >- `SUBMITTED` Submitted
            >- `UNKNOWN` Unknown
             Default: SeasonTeamsPostBodyRosterStatus.UNKNOWN. Example: APPROVED.
        status (Union[Unset, SeasonTeamsPostBodyStatus]): Status
            >- `ACTIVE` Active
            >- `INACTIVE` Inactive
            >- `PENDING` Pending
             Example: ACTIVE.
    ...
    roster_status: Union[Unset, SeasonTeamsPostBodyRosterStatus] = SeasonTeamsPostBodyRosterStatus.UNKNOWN
    status: Union[Unset, SeasonTeamsPostBodyStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roster_status: Union[Unset, SeasonTeamsPostBodyRosterStatus]
        if isinstance(_roster_status, Unset):
            roster_status = UNSET
        else:
            roster_status = SeasonTeamsPostBodyRosterStatus(_roster_status)

        _status = d.pop("status", UNSET)
        status: Union[Unset, SeasonTeamsPostBodyStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = SeasonTeamsPostBodyStatus(_status)
