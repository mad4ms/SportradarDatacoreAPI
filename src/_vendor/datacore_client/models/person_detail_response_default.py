...
T = TypeVar("T", bound="PersonDetailResponseDefault")


@_attrs_define
class PersonDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        person_detail_response_default.additional_properties = d
        return person_detail_response_default
