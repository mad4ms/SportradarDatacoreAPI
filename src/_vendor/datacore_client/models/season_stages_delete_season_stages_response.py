...
if TYPE_CHECKING:
    ...
    from ..models.season_stage_model import SeasonStageModel


T = TypeVar("T", bound="SeasonStagesDeleteSeasonStagesResponse")


@_attrs_define
class SeasonStagesDeleteSeasonStagesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeasonStageModel.from_dict(data_item_data)

            data.append(data_item)

        season_stages_delete_season_stages_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_stages_delete_season_stages_response.additional_properties = d
        return season_stages_delete_season_stages_response
