...
T = TypeVar("T", bound="CompetitionInsertResponseDefault")


@_attrs_define
class CompetitionInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        competition_insert_response_default.additional_properties = d
        return competition_insert_response_default
