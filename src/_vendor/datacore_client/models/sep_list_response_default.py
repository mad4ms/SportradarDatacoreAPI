...
T = TypeVar("T", bound="SepListResponseDefault")


@_attrs_define
class SepListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sep_list_response_default = cls(
            meta=meta,
            error=error,
        )

        sep_list_response_default.additional_properties = d
        return sep_list_response_default
