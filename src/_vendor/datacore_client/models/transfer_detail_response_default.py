...
T = TypeVar("T", bound="TransferDetailResponseDefault")


@_attrs_define
class TransferDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfer_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        transfer_detail_response_default.additional_properties = d
        return transfer_detail_response_default
