...
T = TypeVar("T", bound="AwardsInsertAwardsResponse")


@_attrs_define
class AwardsInsertAwardsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        awards_insert_awards_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        awards_insert_awards_response.additional_properties = d
        return awards_insert_awards_response
