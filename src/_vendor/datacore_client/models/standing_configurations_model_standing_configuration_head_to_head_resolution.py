...
T = TypeVar(
    "T", bound="StandingConfigurationsModelStandingConfigurationHeadToHeadResolution"
)
...
class StandingConfigurationsModelStandingConfigurationHeadToHeadResolution:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_configurations_model_standing_configuration_head_to_head_resolution = (
            cls(
