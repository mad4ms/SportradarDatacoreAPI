...
from ..models.uniform_items_put_body_item_type import UniformItemsPutBodyItemType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.uniform_items_put_body_colors import UniformItemsPutBodyColors


T = TypeVar("T", bound="UniformItemsPutBody")


@_attrs_define
class UniformItemsPutBody:
    """
    Attributes:
        uniform_id (Union[Unset, UUID]): The unique identifier of the uniform Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        item_type (Union[Unset, UniformItemsPutBodyItemType]): The type of Uniform Item
            >- `BOTTOM` Bottom
        ...
        colors (Union[Unset, UniformItemsPutBodyColors]):
    """

    uniform_id: Union[Unset, UUID] = UNSET
    item_type: Union[Unset, UniformItemsPutBodyItemType] = UNSET
    name_local: Union[Unset, str] = UNSET
    name_latin: Union[None, Unset, str] = UNSET
    colors: Union[Unset, "UniformItemsPutBodyColors"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        item_type: Union[Unset, UniformItemsPutBodyItemType]
        if isinstance(_item_type, Unset):
            item_type = UNSET
        else:
            item_type = UniformItemsPutBodyItemType(_item_type)
        ...
        if isinstance(_colors, Unset):
            ...
            colors = UniformItemsPutBodyColors.from_dict(_colors)

        uniform_items_put_body = cls(
