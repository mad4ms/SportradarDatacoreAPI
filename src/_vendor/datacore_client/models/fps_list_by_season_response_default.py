...
T = TypeVar("T", bound="FpsListBySeasonResponseDefault")


@_attrs_define
class FpsListBySeasonResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fps_list_by_season_response_default = cls(
            meta=meta,
            error=error,
        )

        fps_list_by_season_response_default.additional_properties = d
        return fps_list_by_season_response_default
