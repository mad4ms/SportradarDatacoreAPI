...
T = TypeVar("T", bound="DivisionListDivisionsResponse")


@_attrs_define
class DivisionListDivisionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        division_list_divisions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        division_list_divisions_response.additional_properties = d
        return division_list_divisions_response
