...
T = TypeVar("T", bound="SepUpdateSeasonEntityPlacingsResponse")


@_attrs_define
class SepUpdateSeasonEntityPlacingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sep_update_season_entity_placings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        sep_update_season_entity_placings_response.additional_properties = d
        return sep_update_season_entity_placings_response
