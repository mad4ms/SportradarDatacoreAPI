...
T = TypeVar("T", bound="MatchPersonStatisticsPeriodsModelStatistics")


@_attrs_define
class MatchPersonStatisticsPeriodsModelStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        match_person_statistics_periods_model_statistics = cls(
        ...
        return match_person_statistics_periods_model_statistics
