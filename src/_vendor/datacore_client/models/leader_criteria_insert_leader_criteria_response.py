...
T = TypeVar("T", bound="LeaderCriteriaInsertLeaderCriteriaResponse")


@_attrs_define
class LeaderCriteriaInsertLeaderCriteriaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        leader_criteria_insert_leader_criteria_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        leader_criteria_insert_leader_criteria_response.additional_properties = d
        return leader_criteria_insert_leader_criteria_response
