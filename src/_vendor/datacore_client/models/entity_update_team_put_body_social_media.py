...
T = TypeVar("T", bound="EntityUpdateTeamPutBodySocialMedia")


@_attrs_define
class EntityUpdateTeamPutBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_update_team_put_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return entity_update_team_put_body_social_media
