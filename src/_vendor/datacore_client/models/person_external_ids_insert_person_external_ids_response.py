...
T = TypeVar("T", bound="PersonExternalIdsInsertPersonExternalIdsResponse")


@_attrs_define
class PersonExternalIdsInsertPersonExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_external_ids_insert_person_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        person_external_ids_insert_person_external_ids_response.additional_properties = (
            d
        )
        return person_external_ids_insert_person_external_ids_response
