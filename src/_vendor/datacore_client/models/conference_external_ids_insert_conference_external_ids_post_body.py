...
T = TypeVar("T", bound="ConferenceExternalIdsInsertConferenceExternalIdsPostBody")


@_attrs_define
class ConferenceExternalIdsInsertConferenceExternalIdsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_external_ids_insert_conference_external_ids_post_body = cls(
            source=source,
        ...
        return conference_external_ids_insert_conference_external_ids_post_body
