...
from ..models.role_put_body_role import RolePutBodyRole
from ..models.role_put_body_status import RolePutBodyStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="RolePutBody")
...
class RolePutBody:
    ...
    Attributes:
        ...
        person_id (Union[Unset, UUID]): The unique identifier of the person Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        status (Union[Unset, RolePutBodyStatus]): Status
            >- `ACTIVE` Active
            >- `INACTIVE` Inactive
            >- `PENDING` Pending
             Example: ACTIVE.
        ...
        role (Union[Unset, RolePutBodyRole]): Role
    ...
    status: Union[Unset, RolePutBodyStatus] = UNSET
    ...
    role: Union[Unset, RolePutBodyRole] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, RolePutBodyStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = RolePutBodyStatus(_status)
        ...
        role: Union[Unset, RolePutBodyRole]
        if isinstance(_role, Unset):
            role = UNSET
        else:
            role = RolePutBodyRole(_role)
