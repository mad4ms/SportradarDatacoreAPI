...
T = TypeVar("T", bound="ConferenceExternalIdsDeleteConferenceExternalIdsResponse")


@_attrs_define
class ConferenceExternalIdsDeleteConferenceExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_external_ids_delete_conference_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        conference_external_ids_delete_conference_external_ids_response.additional_properties = (
            d
        )
        return conference_external_ids_delete_conference_external_ids_response
