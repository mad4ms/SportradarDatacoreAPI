...
T = TypeVar("T", bound="LeaderCriteriaResponse")


@_attrs_define
class LeaderCriteriaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        leader_criteria_response.additional_properties = d
        return leader_criteria_response
