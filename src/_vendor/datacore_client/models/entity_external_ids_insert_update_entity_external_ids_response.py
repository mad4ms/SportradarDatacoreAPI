...
if TYPE_CHECKING:
    ...
    from ..models.team_external_ids_model import TeamExternalIdsModel


T = TypeVar("T", bound="EntityExternalIdsInsertUpdateEntityExternalIdsResponse")


@_attrs_define
class EntityExternalIdsInsertUpdateEntityExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = TeamExternalIdsModel.from_dict(data_item_data)

            data.append(data_item)

        entity_external_ids_insert_update_entity_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_external_ids_insert_update_entity_external_ids_response.additional_properties = (
            d
        )
        return entity_external_ids_insert_update_entity_external_ids_response
