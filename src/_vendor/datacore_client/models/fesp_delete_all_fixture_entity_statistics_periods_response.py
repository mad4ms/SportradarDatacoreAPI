...
T = TypeVar("T", bound="FespDeleteAllFixtureEntityStatisticsPeriodsResponse")


@_attrs_define
class FespDeleteAllFixtureEntityStatisticsPeriodsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fesp_delete_all_fixture_entity_statistics_periods_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fesp_delete_all_fixture_entity_statistics_periods_response.additional_properties = (
            d
        )
        return fesp_delete_all_fixture_entity_statistics_periods_response
