...
from ..models.spbs_insert_update_season_person_base_statistics_post_body_competitor_type import (
    SpbsInsertUpdateSeasonPersonBaseStatisticsPostBodyCompetitorType,
)
from ..models.spbs_insert_update_season_person_base_statistics_post_body_fixture_type import (
    SpbsInsertUpdateSeasonPersonBaseStatisticsPostBodyFixtureType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.spbs_insert_update_season_person_base_statistics_post_body_statistics import (
        SpbsInsertUpdateSeasonPersonBaseStatisticsPostBodyStatistics,
    )


T = TypeVar("T", bound="SpbsInsertUpdateSeasonPersonBaseStatisticsPostBody")


@_attrs_define
class SpbsInsertUpdateSeasonPersonBaseStatisticsPostBody:
    """
    Attributes:
        ...
        fixture_type (SpbsInsertUpdateSeasonPersonBaseStatisticsPostBodyFixtureType): Type of match
            >- `ALL_STAR` All Star
            ...
            >- `REGULAR` Regular
             Example: REGULAR.
        competitor_type (SpbsInsertUpdateSeasonPersonBaseStatisticsPostBodyCompetitorType): The type of competitors in
            this match
            >- `ENTITY` Entity
            >- `PERSON` Person
             Example: ENTITY.
        ...
        statistics (Union[Unset, SpbsInsertUpdateSeasonPersonBaseStatisticsPostBodyStatistics]):
    """

    season_id: UUID
    person_id: UUID
    fixture_type: SpbsInsertUpdateSeasonPersonBaseStatisticsPostBodyFixtureType
    competitor_type: SpbsInsertUpdateSeasonPersonBaseStatisticsPostBodyCompetitorType
    entity_id: Union[Unset, UUID] = UNSET
    representing: Union[Unset, str] = UNSET
    statistics: Union[
        Unset, "SpbsInsertUpdateSeasonPersonBaseStatisticsPostBodyStatistics"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_statistics, Unset):
            ...
            statistics = (
                SpbsInsertUpdateSeasonPersonBaseStatisticsPostBodyStatistics.from_dict(
                    _statistics
                )
            )

        spbs_insert_update_season_person_base_statistics_post_body = cls(
            season_id=season_id,
            person_id=person_id,
        ...
        return spbs_insert_update_season_person_base_statistics_post_body
