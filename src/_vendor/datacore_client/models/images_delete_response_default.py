...
T = TypeVar("T", bound="ImagesDeleteResponseDefault")


@_attrs_define
class ImagesDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        images_delete_response_default.additional_properties = d
        return images_delete_response_default
