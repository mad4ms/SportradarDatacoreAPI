...
T = TypeVar("T", bound="SeasonTeamBaseStatisticsPostBodyStatistics")


@_attrs_define
class SeasonTeamBaseStatisticsPostBodyStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_team_base_statistics_post_body_statistics = cls(
            assists=assists,
        ...
        return season_team_base_statistics_post_body_statistics
