...
T = TypeVar("T", bound="ConductListConductResponse")


@_attrs_define
class ConductListConductResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conduct_list_conduct_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        conduct_list_conduct_response.additional_properties = d
        return conduct_list_conduct_response
