...
T = TypeVar("T", bound="EntityGroupInsertClubPostBodyColors")


@_attrs_define
class EntityGroupInsertClubPostBodyColors:
    """
    Attributes:
        primary (Union[None, Unset, str]): Primary color of the club.  Colors are a hexadecimal string `RRGGBB` with
            `RR`(red), `GG`(green) and `BB`(blue) representing the components of the colour.  Example: FFF111.
        secondary (Union[None, Unset, str]): Secondary color of the club.  Colors are a hexadecimal string `RRGGBB` with
            `RR`(red), `GG`(green) and `BB`(blue) representing the components of the colour.  Example: FFF111.
        tertiary (Union[None, Unset, str]): Tertiary color of the club.  Colors are a hexadecimal string `RRGGBB` with
            `RR`(red), `GG`(green) and `BB`(blue) representing the components of the colour.  Example: FFF111.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_insert_club_post_body_colors = cls(
            primary=primary,
            secondary=secondary,
            tertiary=tertiary,
        )

        entity_group_insert_club_post_body_colors.additional_properties = d
        return entity_group_insert_club_post_body_colors
