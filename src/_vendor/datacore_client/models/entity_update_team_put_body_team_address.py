...
T = TypeVar("T", bound="EntityUpdateTeamPutBodyTeamAddress")


@_attrs_define
class EntityUpdateTeamPutBodyTeamAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_update_team_put_body_team_address = cls(
            address1=address1,
            address2=address2,
            address3=address3,
            city=city,
        ...
        return entity_update_team_put_body_team_address
