...
T = TypeVar("T", bound="GameLogEntityResponse")


@_attrs_define
class GameLogEntityResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        game_log_entity_response.additional_properties = d
        return game_log_entity_response
