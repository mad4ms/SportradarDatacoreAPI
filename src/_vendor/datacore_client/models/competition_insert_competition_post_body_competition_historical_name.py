...
T = TypeVar("T", bound="CompetitionInsertCompetitionPostBodyCompetitionHistoricalName")


@_attrs_define
class CompetitionInsertCompetitionPostBodyCompetitionHistoricalName:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_insert_competition_post_body_competition_historical_name = cls(
        ...
        return competition_insert_competition_post_body_competition_historical_name
