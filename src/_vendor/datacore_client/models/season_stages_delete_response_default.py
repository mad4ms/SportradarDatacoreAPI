...
T = TypeVar("T", bound="SeasonStagesDeleteResponseDefault")


@_attrs_define
class SeasonStagesDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_stages_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        season_stages_delete_response_default.additional_properties = d
        return season_stages_delete_response_default
