...
T = TypeVar("T", bound="DivisionListResponseDefault")


@_attrs_define
class DivisionListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        division_list_response_default = cls(
            meta=meta,
            error=error,
        )

        division_list_response_default.additional_properties = d
        return division_list_response_default
