...
from ..models.conduct_update_conduct_put_body_conduct_penalty_result_penalty_type import (
    ConductUpdateConductPutBodyConductPenaltyResultPenaltyType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ConductUpdateConductPutBodyConductPenaltyResult")


@_attrs_define
class ConductUpdateConductPutBodyConductPenaltyResult:
    """
    Attributes:
        penalty_type (Union[Unset, ConductUpdateConductPutBodyConductPenaltyResultPenaltyType]): Penalty type Example:
            WEEK.
        penalty_value (Union[None, Unset, int]): Penalty value Example: 6.
    """

    penalty_type: Union[
        Unset, ConductUpdateConductPutBodyConductPenaltyResultPenaltyType
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_penalty_type, Unset):
            ...
            penalty_type = ConductUpdateConductPutBodyConductPenaltyResultPenaltyType(
                _penalty_type
            )
        ...
        conduct_update_conduct_put_body_conduct_penalty_result = cls(
            penalty_type=penalty_type,
            penalty_value=penalty_value,
        )

        return conduct_update_conduct_put_body_conduct_penalty_result
