...
T = TypeVar("T", bound="ImagesUpdateImagesResponse")


@_attrs_define
class ImagesUpdateImagesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_update_images_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        images_update_images_response.additional_properties = d
        return images_update_images_response
