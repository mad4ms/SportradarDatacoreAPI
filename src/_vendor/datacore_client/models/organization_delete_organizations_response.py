...
T = TypeVar("T", bound="OrganizationDeleteOrganizationsResponse")


@_attrs_define
class OrganizationDeleteOrganizationsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = OrganizationModel.from_dict(data_item_data)

            data.append(data_item)

        organization_delete_organizations_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        organization_delete_organizations_response.additional_properties = d
        return organization_delete_organizations_response
