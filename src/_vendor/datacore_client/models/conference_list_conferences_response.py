...
T = TypeVar("T", bound="ConferenceListConferencesResponse")


@_attrs_define
class ConferenceListConferencesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_list_conferences_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        conference_list_conferences_response.additional_properties = d
        return conference_list_conferences_response
