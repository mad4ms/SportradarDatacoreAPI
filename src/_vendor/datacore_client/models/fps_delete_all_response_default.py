...
T = TypeVar("T", bound="FpsDeleteAllResponseDefault")


@_attrs_define
class FpsDeleteAllResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fps_delete_all_response_default = cls(
            meta=meta,
            error=error,
        )

        fps_delete_all_response_default.additional_properties = d
        return fps_delete_all_response_default
