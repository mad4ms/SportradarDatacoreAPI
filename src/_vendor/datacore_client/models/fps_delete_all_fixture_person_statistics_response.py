...
T = TypeVar("T", bound="FpsDeleteAllFixturePersonStatisticsResponse")


@_attrs_define
class FpsDeleteAllFixturePersonStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fps_delete_all_fixture_person_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fps_delete_all_fixture_person_statistics_response.additional_properties = d
        return fps_delete_all_fixture_person_statistics_response
