...
T = TypeVar("T", bound="SppDeleteResponseDefault")


@_attrs_define
class SppDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spp_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        spp_delete_response_default.additional_properties = d
        return spp_delete_response_default
