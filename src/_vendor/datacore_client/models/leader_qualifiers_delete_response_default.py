...
T = TypeVar("T", bound="LeaderQualifiersDeleteResponseDefault")


@_attrs_define
class LeaderQualifiersDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        leader_qualifiers_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        leader_qualifiers_delete_response_default.additional_properties = d
        return leader_qualifiers_delete_response_default
