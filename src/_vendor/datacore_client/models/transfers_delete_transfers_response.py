...
T = TypeVar("T", bound="TransfersDeleteTransfersResponse")


@_attrs_define
class TransfersDeleteTransfersResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = TransferModel.from_dict(data_item_data)

            data.append(data_item)

        transfers_delete_transfers_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        transfers_delete_transfers_response.additional_properties = d
        return transfers_delete_transfers_response
