...
T = TypeVar("T", bound="OrggroupFixtureDetailFixturesResponse")


@_attrs_define
class OrggroupFixtureDetailFixturesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orggroup_fixture_detail_fixtures_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        orggroup_fixture_detail_fixtures_response.additional_properties = d
        return orggroup_fixture_detail_fixtures_response
