...
T = TypeVar("T", bound="UniformItemsUpdateUniformItemsResponse")


@_attrs_define
class UniformItemsUpdateUniformItemsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniform_items_update_uniform_items_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        uniform_items_update_uniform_items_response.additional_properties = d
        return uniform_items_update_uniform_items_response
