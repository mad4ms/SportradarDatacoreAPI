...
T = TypeVar("T", bound="SeasonPoolsResponse")


@_attrs_define
class SeasonPoolsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_pools_response.additional_properties = d
        return season_pools_response
