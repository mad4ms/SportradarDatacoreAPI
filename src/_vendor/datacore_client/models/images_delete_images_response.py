...
T = TypeVar("T", bound="ImagesDeleteImagesResponse")


@_attrs_define
class ImagesDeleteImagesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_delete_images_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        images_delete_images_response.additional_properties = d
        return images_delete_images_response
