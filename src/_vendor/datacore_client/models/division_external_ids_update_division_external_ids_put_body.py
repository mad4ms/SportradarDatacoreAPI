...
T = TypeVar("T", bound="DivisionExternalIdsUpdateDivisionExternalIdsPutBody")


@_attrs_define
class DivisionExternalIdsUpdateDivisionExternalIdsPutBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        division_external_ids_update_division_external_ids_put_body = cls(
        ...
        return division_external_ids_update_division_external_ids_put_body
