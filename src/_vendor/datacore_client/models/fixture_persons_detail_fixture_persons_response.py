...
T = TypeVar("T", bound="FixturePersonsDetailFixturePersonsResponse")


@_attrs_define
class FixturePersonsDetailFixturePersonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_persons_detail_fixture_persons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_persons_detail_fixture_persons_response.additional_properties = d
        return fixture_persons_detail_fixture_persons_response
