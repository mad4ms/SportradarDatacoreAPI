...
if TYPE_CHECKING:
    ...
    from ..models.season_fixture_stages_pools_model import SeasonFixtureStagesPoolsModel


T = TypeVar("T", bound="SeasonFixtureStagesPoolsListSeasonFixtureStagesPoolsListResponse")


@_attrs_define
class SeasonFixtureStagesPoolsListSeasonFixtureStagesPoolsListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeasonFixtureStagesPoolsModel.from_dict(data_item_data)

            data.append(data_item)

        season_fixture_stages_pools_list_season_fixture_stages_pools_list_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_fixture_stages_pools_list_season_fixture_stages_pools_list_response.additional_properties = d
        return season_fixture_stages_pools_list_season_fixture_stages_pools_list_response
