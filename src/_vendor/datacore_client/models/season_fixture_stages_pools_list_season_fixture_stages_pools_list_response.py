...
T = TypeVar(
    "T", bound="SeasonFixtureStagesPoolsListSeasonFixtureStagesPoolsListResponse"
)
...
class SeasonFixtureStagesPoolsListSeasonFixtureStagesPoolsListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.response_links import ResponseLinks
        from ..models.response_meta_data import ResponseMetaData
        from ..models.season_fixture_stages_pools_model import (
        ...
        season_fixture_stages_pools_list_season_fixture_stages_pools_list_response = (
            cls(
                meta=meta,
                links=links,
                included=included,
        ...
        season_fixture_stages_pools_list_season_fixture_stages_pools_list_response.additional_properties = (
            d
        )
        return (
            season_fixture_stages_pools_list_season_fixture_stages_pools_list_response
