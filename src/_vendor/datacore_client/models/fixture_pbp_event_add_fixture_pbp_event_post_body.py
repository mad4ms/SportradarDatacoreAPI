...
from ..models.fixture_pbp_event_add_fixture_pbp_event_post_body_class import (
    FixturePbpEventAddFixturePBPEventPostBodyClass,
)
from ..models.fixture_pbp_event_add_fixture_pbp_event_post_body_period_id import (
    FixturePbpEventAddFixturePBPEventPostBodyPeriodId,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.fixture_pbp_event_add_fixture_pbp_event_post_body_current_scores import (
        FixturePbpEventAddFixturePBPEventPostBodyCurrentScores,
    )


T = TypeVar("T", bound="FixturePbpEventAddFixturePBPEventPostBody")


@_attrs_define
class FixturePbpEventAddFixturePBPEventPostBody:
    """
    Attributes:
        fixture_id (Union[Unset, UUID]): The unique identifier of the match Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        period_id (Union[Unset, FixturePbpEventAddFixturePBPEventPostBodyPeriodId]): The identifier for the period
            >- `1` Period 1
            >- `2` Period 2
        ...
        class_ (Union[Unset, FixturePbpEventAddFixturePBPEventPostBodyClass]): The class of the event
            ...
            >- `sport` A sporting action that relates to the running of the match
             Default: FixturePbpEventAddFixturePBPEventPostBodyClass.SPORT. Example: sport.
        ...
        scores (Union['FixturePbpEventAddFixturePBPEventPostBodyCurrentScores', None, Unset]): The current scores
    ...
    period_id: Union[Unset, FixturePbpEventAddFixturePBPEventPostBodyPeriodId] = UNSET
    section: Union[Unset, str] = UNSET
    events: Union[Unset, Any] = UNSET
    class_: Union[Unset, FixturePbpEventAddFixturePBPEventPostBodyClass] = (
        FixturePbpEventAddFixturePBPEventPostBodyClass.SPORT
    )
    ...
    scores: Union[
        "FixturePbpEventAddFixturePBPEventPostBodyCurrentScores", None, Unset
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.scores, Unset):
            ...
            self.scores, FixturePbpEventAddFixturePBPEventPostBodyCurrentScores
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        period_id: Union[Unset, FixturePbpEventAddFixturePBPEventPostBodyPeriodId]
        if isinstance(_period_id, Unset):
            period_id = UNSET
        else:
            period_id = FixturePbpEventAddFixturePBPEventPostBodyPeriodId(_period_id)
        ...
        if isinstance(_class_, Unset):
            ...
            class_ = FixturePbpEventAddFixturePBPEventPostBodyClass(_class_)
        ...
        def _parse_scores(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                scores_type_0 = (
                    FixturePbpEventAddFixturePBPEventPostBodyCurrentScores.from_dict(
                        data
                    )
                )
        ...
        fixture_pbp_event_add_fixture_pbp_event_post_body = cls(
        ...
        return fixture_pbp_event_add_fixture_pbp_event_post_body
