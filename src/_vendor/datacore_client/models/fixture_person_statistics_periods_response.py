...
T = TypeVar("T", bound="FixturePersonStatisticsPeriodsResponse")


@_attrs_define
class FixturePersonStatisticsPeriodsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_person_statistics_periods_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_person_statistics_periods_response.additional_properties = d
        return fixture_person_statistics_periods_response
