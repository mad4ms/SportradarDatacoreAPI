...
T = TypeVar("T", bound="SeasonExternalIdsInsertUpdateSeasonExternalIdsPostBody")


@_attrs_define
class SeasonExternalIdsInsertUpdateSeasonExternalIdsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_external_ids_insert_update_season_external_ids_post_body = cls(
            source=source,
        ...
        return season_external_ids_insert_update_season_external_ids_post_body
