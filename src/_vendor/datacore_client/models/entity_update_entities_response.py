...
T = TypeVar("T", bound="EntityUpdateEntitiesResponse")


@_attrs_define
class EntityUpdateEntitiesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_update_entities_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_update_entities_response.additional_properties = d
        return entity_update_entities_response
