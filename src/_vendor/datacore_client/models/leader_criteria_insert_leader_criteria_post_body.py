...
T = TypeVar("T", bound="LeaderCriteriaInsertLeaderCriteriaPostBody")


@_attrs_define
class LeaderCriteriaInsertLeaderCriteriaPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        leader_criteria_insert_leader_criteria_post_body = cls(
            name=name,
            leader_criteria_id=leader_criteria_id,
        )

        return leader_criteria_insert_leader_criteria_post_body
