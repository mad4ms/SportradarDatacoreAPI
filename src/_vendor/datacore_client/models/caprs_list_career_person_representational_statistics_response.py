...
if TYPE_CHECKING:
    from ..models.career_person_representational_statistics_model import (
...
class CaprsListCareerPersonRepresentationalStatisticsResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = CareerPersonRepresentationalStatisticsModel.from_dict(
                data_item_data
            )
        ...
        caprs_list_career_person_representational_statistics_response.additional_properties = (
            d
        )
