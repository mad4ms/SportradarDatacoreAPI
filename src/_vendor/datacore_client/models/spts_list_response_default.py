...
T = TypeVar("T", bound="SptsListResponseDefault")


@_attrs_define
class SptsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spts_list_response_default = cls(
            meta=meta,
            error=error,
        )

        spts_list_response_default.additional_properties = d
        return spts_list_response_default
