...
T = TypeVar("T", bound="FixtureRosterInsertUpdateFixtureRosterResponse")


@_attrs_define
class FixtureRosterInsertUpdateFixtureRosterResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_roster_insert_update_fixture_roster_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_roster_insert_update_fixture_roster_response.additional_properties = d
        return fixture_roster_insert_update_fixture_roster_response
