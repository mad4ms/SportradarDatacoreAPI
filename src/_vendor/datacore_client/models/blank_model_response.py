...
T = TypeVar("T", bound="BlankModelResponse")


@_attrs_define
class BlankModelResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        blank_model_response.additional_properties = d
        return blank_model_response
