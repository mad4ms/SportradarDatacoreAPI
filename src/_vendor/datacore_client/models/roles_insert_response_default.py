...
T = TypeVar("T", bound="RolesInsertResponseDefault")


@_attrs_define
class RolesInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roles_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        roles_insert_response_default.additional_properties = d
        return roles_insert_response_default
