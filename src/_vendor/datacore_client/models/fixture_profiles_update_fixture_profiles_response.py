...
T = TypeVar("T", bound="FixtureProfilesUpdateFixtureProfilesResponse")


@_attrs_define
class FixtureProfilesUpdateFixtureProfilesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_profiles_update_fixture_profiles_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_profiles_update_fixture_profiles_response.additional_properties = d
        return fixture_profiles_update_fixture_profiles_response
