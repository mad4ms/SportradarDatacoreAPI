...
T = TypeVar("T", bound="FixturePbpResponse")


@_attrs_define
class FixturePbpResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_pbp_response.additional_properties = d
        return fixture_pbp_response
