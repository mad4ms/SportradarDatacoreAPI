...
T = TypeVar("T", bound="ImagesListOrganizationImagesResponse")


@_attrs_define
class ImagesListOrganizationImagesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_list_organization_images_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        images_list_organization_images_response.additional_properties = d
        return images_list_organization_images_response
