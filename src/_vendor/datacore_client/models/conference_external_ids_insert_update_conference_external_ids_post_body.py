...
T = TypeVar("T", bound="ConferenceExternalIdsInsertUpdateConferenceExternalIdsPostBody")


@_attrs_define
class ConferenceExternalIdsInsertUpdateConferenceExternalIdsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_external_ids_insert_update_conference_external_ids_post_body = cls(
            source=source,
        ...
        return conference_external_ids_insert_update_conference_external_ids_post_body
