...
T = TypeVar("T", bound="SiteInsertSitePostBodySocialMedia")


@_attrs_define
class SiteInsertSitePostBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_insert_site_post_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return site_insert_site_post_body_social_media
