...
T = TypeVar("T", bound="TransfersUpdateTransfersResponse")


@_attrs_define
class TransfersUpdateTransfersResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfers_update_transfers_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        transfers_update_transfers_response.additional_properties = d
        return transfers_update_transfers_response
