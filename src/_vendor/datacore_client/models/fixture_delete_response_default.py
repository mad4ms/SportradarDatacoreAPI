...
T = TypeVar("T", bound="FixtureDeleteResponseDefault")


@_attrs_define
class FixtureDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_delete_response_default.additional_properties = d
        return fixture_delete_response_default
