...
T = TypeVar("T", bound="SiteInsertSitePostBodySiteAddress")


@_attrs_define
class SiteInsertSitePostBodySiteAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_insert_site_post_body_site_address = cls(
            address1=address1,
            address2=address2,
            address3=address3,
            city=city,
        ...
        return site_insert_site_post_body_site_address
