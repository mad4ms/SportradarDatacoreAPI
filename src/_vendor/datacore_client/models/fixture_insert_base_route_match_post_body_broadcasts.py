...
from ..models.fixture_insert_base_route_match_post_body_broadcasts_broadcast_type import (
    FixtureInsertBaseRouteMatchPostBodyBroadcastsBroadcastType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FixtureInsertBaseRouteMatchPostBodyBroadcasts")


@_attrs_define
class FixtureInsertBaseRouteMatchPostBodyBroadcasts:
    """
    Attributes:
        broadcast_type (Union[Unset, FixtureInsertBaseRouteMatchPostBodyBroadcastsBroadcastType]): Broadcast Type
            Example: TV.
    ...
    broadcast_type: Union[
        Unset, FixtureInsertBaseRouteMatchPostBodyBroadcastsBroadcastType
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_broadcast_type, Unset):
            ...
            broadcast_type = FixtureInsertBaseRouteMatchPostBodyBroadcastsBroadcastType(
                _broadcast_type
            )
        ...
        fixture_insert_base_route_match_post_body_broadcasts = cls(
        ...
        return fixture_insert_base_route_match_post_body_broadcasts
