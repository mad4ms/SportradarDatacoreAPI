...
T = TypeVar("T", bound="FixtureLockingResponseDefault")


@_attrs_define
class FixtureLockingResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_locking_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_locking_response_default.additional_properties = d
        return fixture_locking_response_default
