...
T = TypeVar("T", bound="SesListResponseDefault")


@_attrs_define
class SesListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ses_list_response_default = cls(
            meta=meta,
            error=error,
        )

        ses_list_response_default.additional_properties = d
        return ses_list_response_default
