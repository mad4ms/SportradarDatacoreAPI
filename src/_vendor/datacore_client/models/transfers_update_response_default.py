...
T = TypeVar("T", bound="TransfersUpdateResponseDefault")


@_attrs_define
class TransfersUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfers_update_response_default = cls(
            meta=meta,
            error=error,
        )

        transfers_update_response_default.additional_properties = d
        return transfers_update_response_default
