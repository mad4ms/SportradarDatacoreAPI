...
from ..models.leader_qualifier_put_body_comparison_type import LeaderQualifierPutBodyComparisonType
from ..types import UNSET, Unset

T = TypeVar("T", bound="LeaderQualifierPutBody")


@_attrs_define
class LeaderQualifierPutBody:
    """
    Attributes:
        ...
        comparison_type (Union[Unset, LeaderQualifierPutBodyComparisonType]): Comparison type for the qualifier
            >- `EQUAL` Equal
    ...
    comparison_type: Union[Unset, LeaderQualifierPutBodyComparisonType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        comparison_type: Union[Unset, LeaderQualifierPutBodyComparisonType]
        if isinstance(_comparison_type, Unset):
            comparison_type = UNSET
        else:
            comparison_type = LeaderQualifierPutBodyComparisonType(_comparison_type)

        comparison_value = d.pop("comparisonValue", UNSET)

        leader_qualifier_put_body = cls(
        ...
        return leader_qualifier_put_body
