...
T = TypeVar("T", bound="VenueListVenuesResponse")


@_attrs_define
class VenueListVenuesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_list_venues_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        venue_list_venues_response.additional_properties = d
        return venue_list_venues_response
