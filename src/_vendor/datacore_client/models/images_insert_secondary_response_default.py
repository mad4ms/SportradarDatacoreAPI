...
T = TypeVar("T", bound="ImagesInsertSecondaryResponseDefault")


@_attrs_define
class ImagesInsertSecondaryResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_insert_secondary_response_default = cls(
            meta=meta,
            error=error,
        )

        images_insert_secondary_response_default.additional_properties = d
        return images_insert_secondary_response_default
