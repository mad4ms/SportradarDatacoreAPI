...
T = TypeVar("T", bound="SeasonStageListSeasonStagesResponse")


@_attrs_define
class SeasonStageListSeasonStagesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_stage_list_season_stages_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_stage_list_season_stages_response.additional_properties = d
        return season_stage_list_season_stages_response
