...
T = TypeVar("T", bound="CareerPersonSeasonStatisticsModelStatistics")


@_attrs_define
class CareerPersonSeasonStatisticsModelStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        career_person_season_statistics_model_statistics = cls(
        ...
        return career_person_season_statistics_model_statistics
