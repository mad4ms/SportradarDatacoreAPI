...
T = TypeVar("T", bound="SeasonListByOrganizationSeasonsResponse")


@_attrs_define
class SeasonListByOrganizationSeasonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeasonModel.from_dict(data_item_data)

            data.append(data_item)

        season_list_by_organization_seasons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_list_by_organization_seasons_response.additional_properties = d
        return season_list_by_organization_seasons_response
