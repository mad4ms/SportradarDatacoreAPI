...
from ..models.fixture_roster_insert_update_match_roster_post_body_position_type_1 import (
    FixtureRosterInsertUpdateMatchRosterPostBodyPositionType1,
)
from ..models.fixture_roster_insert_update_match_roster_post_body_position_type_2_type_1 import (
    FixtureRosterInsertUpdateMatchRosterPostBodyPositionType2Type1,
)
from ..models.fixture_roster_insert_update_match_roster_post_body_position_type_3_type_1 import (
    FixtureRosterInsertUpdateMatchRosterPostBodyPositionType3Type1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FixtureRosterInsertUpdateMatchRosterPostBody")


@_attrs_define
class FixtureRosterInsertUpdateMatchRosterPostBody:
    """
    Attributes:
        ...
        position (Union[FixtureRosterInsertUpdateMatchRosterPostBodyPositionType1,
            FixtureRosterInsertUpdateMatchRosterPostBodyPositionType2Type1,
            FixtureRosterInsertUpdateMatchRosterPostBodyPositionType3Type1, None, Unset]): Playing position
            >- None None
            >- `CB` Center Backcourt
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.position, Unset):
            ...
            self.position, FixtureRosterInsertUpdateMatchRosterPostBodyPositionType1
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_position(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                position_type_1 = (
                    FixtureRosterInsertUpdateMatchRosterPostBodyPositionType1(data)
                )
            ...
            try:
                ...
                position_type_2_type_1 = (
                    FixtureRosterInsertUpdateMatchRosterPostBodyPositionType2Type1(data)
                )
            ...
            try:
                ...
                position_type_3_type_1 = (
                    FixtureRosterInsertUpdateMatchRosterPostBodyPositionType3Type1(data)
                )
        ...
        fixture_roster_insert_update_match_roster_post_body = cls(
        ...
        return fixture_roster_insert_update_match_roster_post_body
