...
T = TypeVar("T", bound="SppDeleteSeasonPersonPlacingsResponse")


@_attrs_define
class SppDeleteSeasonPersonPlacingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spp_delete_season_person_placings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        spp_delete_season_person_placings_response.additional_properties = d
        return spp_delete_season_person_placings_response
