...
from ..models.season_persons_insert_update_season_persons_post_body_status import (
    SeasonPersonsInsertUpdateSeasonPersonsPostBodyStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeasonPersonsInsertUpdateSeasonPersonsPostBody")


@_attrs_define
class SeasonPersonsInsertUpdateSeasonPersonsPostBody:
    """
    Attributes:
        ...
        entity_group_id (Union[Unset, UUID]): The club that this team belongs to Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        status (Union[Unset, SeasonPersonsInsertUpdateSeasonPersonsPostBodyStatus]): Status
            >- `ACTIVE` Active
            >- `INACTIVE` Inactive
            >- `PENDING` Pending
             Example: ACTIVE.
    ...
    status: Union[Unset, SeasonPersonsInsertUpdateSeasonPersonsPostBodyStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, SeasonPersonsInsertUpdateSeasonPersonsPostBodyStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = SeasonPersonsInsertUpdateSeasonPersonsPostBodyStatus(_status)
        ...
        season_persons_insert_update_season_persons_post_body = cls(
            season_id=season_id,
            person_id=person_id,
        ...
        return season_persons_insert_update_season_persons_post_body
