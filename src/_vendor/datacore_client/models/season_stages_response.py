...
T = TypeVar("T", bound="SeasonStagesResponse")


@_attrs_define
class SeasonStagesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_stages_response.additional_properties = d
        return season_stages_response
