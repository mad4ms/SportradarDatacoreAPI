...
T = TypeVar("T", bound="ConferenceUpdateConferencePutBodySocialMedia")


@_attrs_define
class ConferenceUpdateConferencePutBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_update_conference_put_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return conference_update_conference_put_body_social_media
