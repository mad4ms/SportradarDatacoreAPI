...
T = TypeVar("T", bound="SiteListResponseDefault")


@_attrs_define
class SiteListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_list_response_default = cls(
            meta=meta,
            error=error,
        )

        site_list_response_default.additional_properties = d
        return site_list_response_default
