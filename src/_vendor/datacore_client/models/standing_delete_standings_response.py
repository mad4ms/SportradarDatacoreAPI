...
T = TypeVar("T", bound="StandingDeleteStandingsResponse")


@_attrs_define
class StandingDeleteStandingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_delete_standings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_delete_standings_response.additional_properties = d
        return standing_delete_standings_response
