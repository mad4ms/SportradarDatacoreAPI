...
T = TypeVar("T", bound="FixtureVideostreamResetSuccessResponse")


@_attrs_define
class FixtureVideostreamResetSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_videostream_reset_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_videostream_reset_success_response.additional_properties = d
        return fixture_videostream_reset_success_response
