...
if TYPE_CHECKING:
    from ..models.conduct_model import ConductModel
...
T = TypeVar("T", bound="ConductDeleteConductResponse")


@_attrs_define
class ConductDeleteConductResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = ConductModel.from_dict(data_item_data)

            data.append(data_item)

        conduct_delete_conduct_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        conduct_delete_conduct_response.additional_properties = d
        return conduct_delete_conduct_response
