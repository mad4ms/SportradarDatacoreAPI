...
T = TypeVar("T", bound="VenueExternalIdsInsertVenueExternalIdsResponse")


@_attrs_define
class VenueExternalIdsInsertVenueExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_external_ids_insert_venue_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        venue_external_ids_insert_venue_external_ids_response.additional_properties = d
        return venue_external_ids_insert_venue_external_ids_response
