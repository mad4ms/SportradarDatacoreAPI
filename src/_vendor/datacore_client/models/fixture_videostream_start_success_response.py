...
T = TypeVar("T", bound="FixtureVideostreamStartSuccessResponse")


@_attrs_define
class FixtureVideostreamStartSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_videostream_start_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_videostream_start_success_response.additional_properties = d
        return fixture_videostream_start_success_response
