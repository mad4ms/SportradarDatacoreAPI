...
T = TypeVar("T", bound="VenueUpdateVenuesResponse")


@_attrs_define
class VenueUpdateVenuesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_update_venues_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        venue_update_venues_response.additional_properties = d
        return venue_update_venues_response
