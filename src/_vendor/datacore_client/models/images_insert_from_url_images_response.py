...
T = TypeVar("T", bound="ImagesInsertFromUrlImagesResponse")


@_attrs_define
class ImagesInsertFromUrlImagesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_insert_from_url_images_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        images_insert_from_url_images_response.additional_properties = d
        return images_insert_from_url_images_response
