...
T = TypeVar("T", bound="SppInsertResponseDefault")


@_attrs_define
class SppInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spp_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        spp_insert_response_default.additional_properties = d
        return spp_insert_response_default
