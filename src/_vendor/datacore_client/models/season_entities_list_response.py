...
T = TypeVar("T", bound="SeasonEntitiesListResponse")


@_attrs_define
class SeasonEntitiesListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_entities_list_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_entities_list_response.additional_properties = d
        return season_entities_list_response
