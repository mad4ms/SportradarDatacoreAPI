...
from ..models.season_series_insert_series_post_body_series_type import (
    SeasonSeriesInsertSeriesPostBodySeriesType,
)
from ..models.season_series_insert_series_post_body_status import (
    SeasonSeriesInsertSeriesPostBodyStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.season_series_insert_series_post_body_season_series_competitor import (
        SeasonSeriesInsertSeriesPostBodySeasonSeriesCompetitor,
    )


T = TypeVar("T", bound="SeasonSeriesInsertSeriesPostBody")


@_attrs_define
class SeasonSeriesInsertSeriesPostBody:
    """
    Attributes:
        series_code (str): A unique code for the season series. (Unique for season) Example: ST1.
        season_id (UUID): The unique identifier of the season Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        name_local (str): The name of the series in the [local](#section/Introduction/Character-Sets-and-Names) language
            Example: Test name local.
        status (SeasonSeriesInsertSeriesPostBodyStatus): Status
            >- `ACTIVE` Active
            >- `COMPLETE` Complete
            >- `NOT_STARTED` Not Started
             Example: COMPLETE.
        series_type (SeasonSeriesInsertSeriesPostBodySeriesType): The type of series
            >- `BEST_OF` Best of
        ...
        competitors (Union[None, Unset, list['SeasonSeriesInsertSeriesPostBodySeasonSeriesCompetitor']]): Array of
    ...
    season_id: UUID
    name_local: str
    status: SeasonSeriesInsertSeriesPostBodyStatus
    series_type: SeasonSeriesInsertSeriesPostBodySeriesType
    ...
    competitors: Union[
        None, Unset, list["SeasonSeriesInsertSeriesPostBodySeasonSeriesCompetitor"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        series_code = d.pop("seriesCode")

        season_id = UUID(d.pop("seasonId"))

        name_local = d.pop("nameLocal")

        status = SeasonSeriesInsertSeriesPostBodyStatus(d.pop("status"))

        series_type = SeasonSeriesInsertSeriesPostBodySeriesType(d.pop("seriesType"))
        ...
        def _parse_competitors(
            ...
            try:
                ...
                for competitors_type_0_item_data in _competitors_type_0:
                    competitors_type_0_item = SeasonSeriesInsertSeriesPostBodySeasonSeriesCompetitor.from_dict(
            ...
            return cast(
                Union[
                    None,
                    Unset,
                    list["SeasonSeriesInsertSeriesPostBodySeasonSeriesCompetitor"],
                ],
                data,
            )
        ...
        season_series_insert_series_post_body = cls(
        ...
        return season_series_insert_series_post_body
