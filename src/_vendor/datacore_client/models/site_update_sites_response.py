...
T = TypeVar("T", bound="SiteUpdateSitesResponse")


@_attrs_define
class SiteUpdateSitesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_update_sites_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        site_update_sites_response.additional_properties = d
        return site_update_sites_response
