...
from ..models.competition_model_age_group_type_2_type_1 import (
    CompetitionModelAgeGroupType2Type1,
)
from ..models.competition_model_age_group_type_3_type_1 import (
...
if TYPE_CHECKING:
    from ..models.competition_model_competition_historical_name import (
...
class CompetitionModel:
    ...
    event_type: Union[Unset, CompetitionModelEventType] = (
        CompetitionModelEventType.FIXTURE
    )
    ...
    historical_names: Union[
        None, Unset, list["CompetitionModelCompetitionHistoricalName"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_social(
            data: object,
        ) -> Union["CompetitionModelSocialMedia", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_historical_names(
            ...
            try:
                ...
                for historical_names_type_0_item_data in _historical_names_type_0:
                    historical_names_type_0_item = (
                        CompetitionModelCompetitionHistoricalName.from_dict(
