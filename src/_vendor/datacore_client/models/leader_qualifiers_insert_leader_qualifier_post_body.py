...
from ..models.leader_qualifiers_insert_leader_qualifier_post_body_comparison_type import (
    LeaderQualifiersInsertLeaderQualifierPostBodyComparisonType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="LeaderQualifiersInsertLeaderQualifierPostBody")


@_attrs_define
class LeaderQualifiersInsertLeaderQualifierPostBody:
    """
    Attributes:
        ...
        comparison_type (LeaderQualifiersInsertLeaderQualifierPostBodyComparisonType): Comparison type for the qualifier
            >- `EQUAL` Equal
    ...
    comparison_type: LeaderQualifiersInsertLeaderQualifierPostBodyComparisonType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        leader_qualifiers_insert_leader_qualifier_post_body = cls(
        ...
        return leader_qualifiers_insert_leader_qualifier_post_body
