...
T = TypeVar("T", bound="SeasonEntityListByMultipleSeasonsResponseDefault")


@_attrs_define
class SeasonEntityListByMultipleSeasonsResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_entity_list_by_multiple_seasons_response_default = cls(
            meta=meta,
            error=error,
        )
