...
T = TypeVar("T", bound="SepUpdateSEASONTEAMPlacingsPutBody")


@_attrs_define
class SepUpdateSEASONTEAMPlacingsPutBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sep_update_seasonteam_placings_put_body = cls(
            season_id=season_id,
            entity_id=entity_id,
        ...
        return sep_update_seasonteam_placings_put_body
