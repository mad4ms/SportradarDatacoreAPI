...
T = TypeVar("T", bound="VenueDeleteResponseDefault")


@_attrs_define
class VenueDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        venue_delete_response_default.additional_properties = d
        return venue_delete_response_default
