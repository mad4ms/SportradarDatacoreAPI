...
T = TypeVar("T", bound="EntityDeleteEntitiesResponse")


@_attrs_define
class EntityDeleteEntitiesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_delete_entities_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_delete_entities_response.additional_properties = d
        return entity_delete_entities_response
