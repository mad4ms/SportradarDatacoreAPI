...
T = TypeVar("T", bound="RolesUpdateRolesResponse")


@_attrs_define
class RolesUpdateRolesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roles_update_roles_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        roles_update_roles_response.additional_properties = d
        return roles_update_roles_response
