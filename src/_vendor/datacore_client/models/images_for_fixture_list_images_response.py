...
T = TypeVar("T", bound="ImagesForFixtureListImagesResponse")


@_attrs_define
class ImagesForFixtureListImagesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_for_fixture_list_images_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        images_for_fixture_list_images_response.additional_properties = d
        return images_for_fixture_list_images_response
