...
T = TypeVar("T", bound="SeasonInsertResponseDefault")


@_attrs_define
class SeasonInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        season_insert_response_default.additional_properties = d
        return season_insert_response_default
