...
T = TypeVar("T", bound="EntityGroupInsertClubPostBodyClubAddress")


@_attrs_define
class EntityGroupInsertClubPostBodyClubAddress:
    """Street Address for the club
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_insert_club_post_body_club_address = cls(
            address1=address1,
            address2=address2,
            address3=address3,
            city=city,
        ...
        return entity_group_insert_club_post_body_club_address
