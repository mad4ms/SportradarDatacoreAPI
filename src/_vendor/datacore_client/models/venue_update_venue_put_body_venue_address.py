...
T = TypeVar("T", bound="VenueUpdateVenuePutBodyVenueAddress")


@_attrs_define
class VenueUpdateVenuePutBodyVenueAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_update_venue_put_body_venue_address = cls(
            address1=address1,
            address2=address2,
            address3=address3,
            city=city,
        ...
        return venue_update_venue_put_body_venue_address
