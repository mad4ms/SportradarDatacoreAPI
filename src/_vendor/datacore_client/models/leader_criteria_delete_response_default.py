...
T = TypeVar("T", bound="LeaderCriteriaDeleteResponseDefault")


@_attrs_define
class LeaderCriteriaDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        leader_criteria_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        leader_criteria_delete_response_default.additional_properties = d
        return leader_criteria_delete_response_default
