...
from ..models.standing_configuration_streak import StandingConfigurationStreak
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.head_to_head_identification import HeadToHeadIdentification
    from ..models.head_to_head_identification_for_subsequent_checks import HeadToHeadIdentificationForSubsequentChecks
    from ..models.head_to_head_resolution import HeadToHeadResolution
    from ..models.head_to_head_resolution_for_extra_depth_h2_hs import HeadToHeadResolutionForExtraDepthH2Hs
    from ..models.sorting import Sorting


T = TypeVar("T", bound="StandingConfiguration")


@_attrs_define
class StandingConfiguration:
    ...
    Attributes:
        ...
        streak (Union[Unset, StandingConfigurationStreak]): How is a streak calculated ?
        sorts (Union[Unset, list['Sorting']]): Sortings
        head_to_head_identification (Union[Unset, list['HeadToHeadIdentification']]): Head to head identifications
        head_to_head_identification_subsequent (Union[Unset, list['HeadToHeadIdentificationForSubsequentChecks']]): Head
            to head identifications for subsequent checks
        ...
        head_to_head_resolutions (Union[Unset, list['HeadToHeadResolution']]): Head to head resolutions
        head_to_head_resolutions_subsequent (Union[Unset, list['HeadToHeadResolutionForExtraDepthH2Hs']]): Head to head
    ...
    streak: Union[Unset, StandingConfigurationStreak] = UNSET
    sorts: Union[Unset, list["Sorting"]] = UNSET
    head_to_head_identification: Union[Unset, list["HeadToHeadIdentification"]] = UNSET
    head_to_head_identification_subsequent: Union[Unset, list["HeadToHeadIdentificationForSubsequentChecks"]] = UNSET
    ...
    head_to_head_resolutions: Union[Unset, list["HeadToHeadResolution"]] = UNSET
    head_to_head_resolutions_subsequent: Union[Unset, list["HeadToHeadResolutionForExtraDepthH2Hs"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.head_to_head_identification import HeadToHeadIdentification
        from ..models.head_to_head_identification_for_subsequent_checks import (
        ...
        streak: Union[Unset, StandingConfigurationStreak]
        if isinstance(_streak, Unset):
            streak = UNSET
        else:
            streak = StandingConfigurationStreak(_streak)

        sorts = []
        _sorts = d.pop("sorts", UNSET)
        for sorts_item_data in _sorts or []:
            sorts_item = Sorting.from_dict(sorts_item_data)
        ...
        for head_to_head_identification_item_data in _head_to_head_identification or []:
            head_to_head_identification_item = HeadToHeadIdentification.from_dict(head_to_head_identification_item_data)
        ...
        for head_to_head_identification_subsequent_item_data in _head_to_head_identification_subsequent or []:
            head_to_head_identification_subsequent_item = HeadToHeadIdentificationForSubsequentChecks.from_dict(
        ...
        for head_to_head_resolutions_item_data in _head_to_head_resolutions or []:
            head_to_head_resolutions_item = HeadToHeadResolution.from_dict(head_to_head_resolutions_item_data)
        ...
        for head_to_head_resolutions_subsequent_item_data in _head_to_head_resolutions_subsequent or []:
            head_to_head_resolutions_subsequent_item = HeadToHeadResolutionForExtraDepthH2Hs.from_dict(
                head_to_head_resolutions_subsequent_item_data
            )

            head_to_head_resolutions_subsequent.append(head_to_head_resolutions_subsequent_item)

        standing_configuration = cls(
