...
from ..models.uniforms_put_body_base_type import UniformsPutBodyBaseType
from ..types import UNSET, Unset

T = TypeVar("T", bound="UniformsPutBody")


@_attrs_define
class UniformsPutBody:
    """
    Attributes:
        base_type (Union[Unset, UniformsPutBodyBaseType]): The object that this uniform relates to
            >- `ENTITY` Entity
    ...
    base_type: Union[Unset, UniformsPutBodyBaseType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        base_type: Union[Unset, UniformsPutBodyBaseType]
        if isinstance(_base_type, Unset):
            base_type = UNSET
        else:
            base_type = UniformsPutBodyBaseType(_base_type)
