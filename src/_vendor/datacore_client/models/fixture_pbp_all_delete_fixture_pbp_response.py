...
if TYPE_CHECKING:
    from ..models.fixture_pbp_model import FixturePbpModel
...
T = TypeVar("T", bound="FixturePbpAllDeleteFixturePbpResponse")


@_attrs_define
class FixturePbpAllDeleteFixturePbpResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = FixturePbpModel.from_dict(data_item_data)

            data.append(data_item)

        fixture_pbp_all_delete_fixture_pbp_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_pbp_all_delete_fixture_pbp_response.additional_properties = d
        return fixture_pbp_all_delete_fixture_pbp_response
