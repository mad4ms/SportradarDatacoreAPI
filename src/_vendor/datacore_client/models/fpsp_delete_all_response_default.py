...
T = TypeVar("T", bound="FpspDeleteAllResponseDefault")


@_attrs_define
class FpspDeleteAllResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fpsp_delete_all_response_default = cls(
            meta=meta,
            error=error,
        )

        fpsp_delete_all_response_default.additional_properties = d
        return fpsp_delete_all_response_default
