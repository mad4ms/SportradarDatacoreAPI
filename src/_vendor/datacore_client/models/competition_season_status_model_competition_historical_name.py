...
T = TypeVar("T", bound="CompetitionSeasonStatusModelCompetitionHistoricalName")


@_attrs_define
class CompetitionSeasonStatusModelCompetitionHistoricalName:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_season_status_model_competition_historical_name = cls(
        ...
        return competition_season_status_model_competition_historical_name
