...
T = TypeVar("T", bound="SepDeleteResponseDefault")


@_attrs_define
class SepDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sep_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        sep_delete_response_default.additional_properties = d
        return sep_delete_response_default
