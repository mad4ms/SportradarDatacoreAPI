...
T = TypeVar("T", bound="FesDeleteAllResponseDefault")


@_attrs_define
class FesDeleteAllResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fes_delete_all_response_default = cls(
            meta=meta,
            error=error,
        )

        fes_delete_all_response_default.additional_properties = d
        return fes_delete_all_response_default
