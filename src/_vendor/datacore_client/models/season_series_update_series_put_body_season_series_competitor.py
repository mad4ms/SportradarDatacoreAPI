...
from ..models.season_series_update_series_put_body_season_series_competitor_series_result import (
    SeasonSeriesUpdateSeriesPutBodySeasonSeriesCompetitorSeriesResult,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeasonSeriesUpdateSeriesPutBodySeasonSeriesCompetitor")


@_attrs_define
class SeasonSeriesUpdateSeriesPutBodySeasonSeriesCompetitor:
    """
    Attributes:
        ...
        series_result (Union[Unset, SeasonSeriesUpdateSeriesPutBodySeasonSeriesCompetitorSeriesResult]): Result for the
    ...
    series_result: Union[
        Unset, SeasonSeriesUpdateSeriesPutBodySeasonSeriesCompetitorSeriesResult
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_series_update_series_put_body_season_series_competitor = cls(
            entity_id=entity_id,
            person_id=person_id,
        ...
        return season_series_update_series_put_body_season_series_competitor
