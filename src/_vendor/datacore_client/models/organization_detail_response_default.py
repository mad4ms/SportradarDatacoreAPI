...
T = TypeVar("T", bound="OrganizationDetailResponseDefault")


@_attrs_define
class OrganizationDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        organization_detail_response_default.additional_properties = d
        return organization_detail_response_default
