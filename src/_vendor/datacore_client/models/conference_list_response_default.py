...
T = TypeVar("T", bound="ConferenceListResponseDefault")


@_attrs_define
class ConferenceListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_list_response_default = cls(
            meta=meta,
            error=error,
        )

        conference_list_response_default.additional_properties = d
        return conference_list_response_default
