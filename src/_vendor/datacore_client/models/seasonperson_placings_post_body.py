...
T = TypeVar("T", bound="SEASONPERSONPlacingsPostBody")


@_attrs_define
class SEASONPERSONPlacingsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        seasonperson_placings_post_body = cls(
            season_id=season_id,
            person_id=person_id,
        ...
        return seasonperson_placings_post_body
