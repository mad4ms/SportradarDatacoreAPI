...
T = TypeVar("T", bound="ImagesInsertFromUrlResponseDefault")


@_attrs_define
class ImagesInsertFromUrlResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_insert_from_url_response_default = cls(
            meta=meta,
            error=error,
        )

        images_insert_from_url_response_default.additional_properties = d
        return images_insert_from_url_response_default
