...
T = TypeVar("T", bound="FixtureInsertMatchPostBodySocialMedia")


@_attrs_define
class FixtureInsertMatchPostBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_insert_match_post_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return fixture_insert_match_post_body_social_media
