...
T = TypeVar("T", bound="PersonDeleteResponseDefault")


@_attrs_define
class PersonDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        person_delete_response_default.additional_properties = d
        return person_delete_response_default
