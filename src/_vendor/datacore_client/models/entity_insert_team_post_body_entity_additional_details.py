...
T = TypeVar("T", bound="EntityInsertTeamPostBodyEntityAdditionalDetails")


@_attrs_define
class EntityInsertTeamPostBodyEntityAdditionalDetails:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_insert_team_post_body_entity_additional_details = cls(
            founded=founded,
            squad_value=squad_value,
        )

        return entity_insert_team_post_body_entity_additional_details
