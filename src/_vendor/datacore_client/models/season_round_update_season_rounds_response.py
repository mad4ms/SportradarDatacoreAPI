...
T = TypeVar("T", bound="SeasonRoundUpdateSeasonRoundsResponse")


@_attrs_define
class SeasonRoundUpdateSeasonRoundsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_round_update_season_rounds_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_round_update_season_rounds_response.additional_properties = d
        return season_round_update_season_rounds_response
