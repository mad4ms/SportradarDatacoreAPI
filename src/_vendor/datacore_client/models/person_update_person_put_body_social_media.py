...
T = TypeVar("T", bound="PersonUpdatePersonPutBodySocialMedia")


@_attrs_define
class PersonUpdatePersonPutBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_update_person_put_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return person_update_person_put_body_social_media
