...
T = TypeVar("T", bound="StandingPutBodyPointsAdditionalProperty")


@_attrs_define
class StandingPutBodyPointsAdditionalProperty:
    """Type of points
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_put_body_points_additional_property = cls(
        ...
        return standing_put_body_points_additional_property
