...
T = TypeVar("T", bound="FixtureProfilesResponse")


@_attrs_define
class FixtureProfilesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_profiles_response.additional_properties = d
        return fixture_profiles_response
