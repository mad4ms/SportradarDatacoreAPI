...
if TYPE_CHECKING:
    ...
    from ..models.video_stream_local_model import VideoStreamLocalModel


T = TypeVar("T", bound="VideoStreamLocalDeleteVideoStreamLocalResponse")


@_attrs_define
class VideoStreamLocalDeleteVideoStreamLocalResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = VideoStreamLocalModel.from_dict(data_item_data)

            data.append(data_item)

        video_stream_local_delete_video_stream_local_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        video_stream_local_delete_video_stream_local_response.additional_properties = d
        return video_stream_local_delete_video_stream_local_response
