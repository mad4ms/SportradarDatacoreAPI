...
T = TypeVar("T", bound="OrggroupFixtureListResponseDefault")


@_attrs_define
class OrggroupFixtureListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orggroup_fixture_list_response_default = cls(
            meta=meta,
            error=error,
        )

        orggroup_fixture_list_response_default.additional_properties = d
        return orggroup_fixture_list_response_default
