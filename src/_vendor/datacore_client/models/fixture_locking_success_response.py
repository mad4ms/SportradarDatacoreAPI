...
T = TypeVar("T", bound="FixtureLockingSuccessResponse")


@_attrs_define
class FixtureLockingSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_locking_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_locking_success_response.additional_properties = d
        return fixture_locking_success_response
