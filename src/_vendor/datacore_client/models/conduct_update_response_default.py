...
T = TypeVar("T", bound="ConductUpdateResponseDefault")


@_attrs_define
class ConductUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conduct_update_response_default = cls(
            meta=meta,
            error=error,
        )

        conduct_update_response_default.additional_properties = d
        return conduct_update_response_default
