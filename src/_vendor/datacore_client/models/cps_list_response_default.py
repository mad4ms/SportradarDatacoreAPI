...
T = TypeVar("T", bound="CpsListResponseDefault")


@_attrs_define
class CpsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cps_list_response_default = cls(
            meta=meta,
            error=error,
        )

        cps_list_response_default.additional_properties = d
        return cps_list_response_default
