...
T = TypeVar("T", bound="DivisionUpdateDivisionPutBodySocialMedia")


@_attrs_define
class DivisionUpdateDivisionPutBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        division_update_division_put_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return division_update_division_put_body_social_media
