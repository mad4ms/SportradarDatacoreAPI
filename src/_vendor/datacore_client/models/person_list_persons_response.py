...
T = TypeVar("T", bound="PersonListPersonsResponse")


@_attrs_define
class PersonListPersonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_list_persons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        person_list_persons_response.additional_properties = d
        return person_list_persons_response
