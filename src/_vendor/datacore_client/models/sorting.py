...
from ..models.sorting_sort_direction import SortingSortDirection
...
class Sorting:
    ...
    Attributes:
        ...
        sort_direction (Union[Unset, SortingSortDirection]): Sort direction
    """

    sort_field: Union[Unset, str] = UNSET
    sort_direction: Union[Unset, SortingSortDirection] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sort_direction: Union[Unset, SortingSortDirection]
        if isinstance(_sort_direction, Unset):
            sort_direction = UNSET
        else:
            sort_direction = SortingSortDirection(_sort_direction)
