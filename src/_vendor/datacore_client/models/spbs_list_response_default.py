...
T = TypeVar("T", bound="SpbsListResponseDefault")


@_attrs_define
class SpbsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spbs_list_response_default = cls(
            meta=meta,
            error=error,
        )

        spbs_list_response_default.additional_properties = d
        return spbs_list_response_default
