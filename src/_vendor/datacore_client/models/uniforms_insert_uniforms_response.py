...
T = TypeVar("T", bound="UniformsInsertUniformsResponse")


@_attrs_define
class UniformsInsertUniformsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniforms_insert_uniforms_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        uniforms_insert_uniforms_response.additional_properties = d
        return uniforms_insert_uniforms_response
