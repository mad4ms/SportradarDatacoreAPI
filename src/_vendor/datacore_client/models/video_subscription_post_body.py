...
from ..models.video_subscription_post_body_audio import VideoSubscriptionPostBodyAudio
from ..models.video_subscription_post_body_content import VideoSubscriptionPostBodyContent
from ..models.video_subscription_post_body_feed_type import VideoSubscriptionPostBodyFeedType
from ..models.video_subscription_post_body_output_format import VideoSubscriptionPostBodyOutputFormat
from ..models.video_subscription_post_body_output_resolution import VideoSubscriptionPostBodyOutputResolution
from ..types import UNSET, Unset

T = TypeVar("T", bound="VideoSubscriptionPostBody")


@_attrs_define
class VideoSubscriptionPostBody:
    """
    Attributes:
        ...
        source_number (int): Unique identifier for the video source. This is unique for the provider/fixtureId/locale
            ...
            Default: 1. Example: 1.
        feed_type (VideoSubscriptionPostBodyFeedType): Type of video input
            >- `ADDITIONAL_ANGLE` Additional angle
            >- `LOW_LATENCY` Low Latency
            >- `PRIMARY` Primary
             Example: PRIMARY.
        output_resolution (VideoSubscriptionPostBodyOutputResolution): The resolution that you want to receive the video
            in.  This is only valid if outputFormat is `RTMP`.  If outputFormat is not `RTMP` then the output resolution is
            the same as the input resolution.  If specified the output resolution cannot be higher than the input
            resolution. You must have specific permission to chose anything other than 720p or 1080p.
            >- `1080` 1920 x 1080
            ...
            >- `MOBILE_768x432@1000k_BUFFERED` MOBILE_768x432@1000k_BUFFERED
             Example: 720.
        output_format (VideoSubscriptionPostBodyOutputFormat): The output format
            >- `HLS` HLS
            >- `RTMP` RTMP
            >- `RTMP_PULL` RTMP Pull
            >- `SRT` SRT
             Example: RTMP.
        content (VideoSubscriptionPostBodyContent): Content of the stream
        ...
        audio (Union[Unset, VideoSubscriptionPostBodyAudio]): Audio
            ...
            >- `COMMENTARY` Only commentary
             Default: VideoSubscriptionPostBodyAudio.BOTH. Example: COMMENTARY.
    ...
    provider: str
    locale: str
    feed_type: VideoSubscriptionPostBodyFeedType
    output_resolution: VideoSubscriptionPostBodyOutputResolution
    output_format: VideoSubscriptionPostBodyOutputFormat
    content: VideoSubscriptionPostBodyContent
    source_number: int = 1
    ...
    audio: Union[Unset, VideoSubscriptionPostBodyAudio] = VideoSubscriptionPostBodyAudio.BOTH
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        feed_type = VideoSubscriptionPostBodyFeedType(d.pop("feedType"))

        output_resolution = VideoSubscriptionPostBodyOutputResolution(d.pop("outputResolution"))

        output_format = VideoSubscriptionPostBodyOutputFormat(d.pop("outputFormat"))

        content = VideoSubscriptionPostBodyContent(d.pop("content"))
        ...
        audio: Union[Unset, VideoSubscriptionPostBodyAudio]
        if isinstance(_audio, Unset):
            audio = UNSET
        else:
            audio = VideoSubscriptionPostBodyAudio(_audio)

        mux_rate = d.pop("muxRate", UNSET)

        video_subscription_post_body = cls(
        ...
        return video_subscription_post_body
