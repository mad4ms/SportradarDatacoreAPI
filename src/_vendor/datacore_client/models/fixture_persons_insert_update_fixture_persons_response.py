...
if TYPE_CHECKING:
    ...
    from ..models.match_persons_model import MatchPersonsModel
    from ..models.response_links import ResponseLinks
    from ..models.response_meta_data import ResponseMetaData


T = TypeVar("T", bound="FixturePersonsInsertUpdateFixturePersonsResponse")


@_attrs_define
class FixturePersonsInsertUpdateFixturePersonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = MatchPersonsModel.from_dict(data_item_data)

            data.append(data_item)

        fixture_persons_insert_update_fixture_persons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_persons_insert_update_fixture_persons_response.additional_properties = d
        return fixture_persons_insert_update_fixture_persons_response
