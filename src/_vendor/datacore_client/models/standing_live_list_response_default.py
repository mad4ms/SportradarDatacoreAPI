...
T = TypeVar("T", bound="StandingLiveListResponseDefault")


@_attrs_define
class StandingLiveListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_live_list_response_default = cls(
            meta=meta,
            error=error,
        )

        standing_live_list_response_default.additional_properties = d
        return standing_live_list_response_default
