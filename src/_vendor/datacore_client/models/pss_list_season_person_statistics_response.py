...
T = TypeVar("T", bound="PssListSeasonPersonStatisticsResponse")


@_attrs_define
class PssListSeasonPersonStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pss_list_season_person_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        pss_list_season_person_statistics_response.additional_properties = d
        return pss_list_season_person_statistics_response
