...
T = TypeVar("T", bound="VideoStreamOutputsResponse")


@_attrs_define
class VideoStreamOutputsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        video_stream_outputs_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        video_stream_outputs_response.additional_properties = d
        return video_stream_outputs_response
