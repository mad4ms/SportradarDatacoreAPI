...
T = TypeVar("T", bound="SeasonVideostreamDisableSuccessResponse")


@_attrs_define
class SeasonVideostreamDisableSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_videostream_disable_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_videostream_disable_success_response.additional_properties = d
        return season_videostream_disable_success_response
