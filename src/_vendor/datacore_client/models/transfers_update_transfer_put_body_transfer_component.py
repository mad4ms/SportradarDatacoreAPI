...
T = TypeVar("T", bound="TransfersUpdateTransferPutBodyTransferComponent")


@_attrs_define
class TransfersUpdateTransferPutBodyTransferComponent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfers_update_transfer_put_body_transfer_component = cls(
            person_id=person_id,
        ...
        return transfers_update_transfer_put_body_transfer_component
