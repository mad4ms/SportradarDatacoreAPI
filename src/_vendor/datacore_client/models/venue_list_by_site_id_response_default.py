...
T = TypeVar("T", bound="VenueListBySiteIdResponseDefault")


@_attrs_define
class VenueListBySiteIdResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_list_by_site_id_response_default = cls(
            meta=meta,
            error=error,
        )

        venue_list_by_site_id_response_default.additional_properties = d
        return venue_list_by_site_id_response_default
