...
T = TypeVar("T", bound="FixtureVideostreamEnableSuccessResponse")


@_attrs_define
class FixtureVideostreamEnableSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_videostream_enable_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_videostream_enable_success_response.additional_properties = d
        return fixture_videostream_enable_success_response
