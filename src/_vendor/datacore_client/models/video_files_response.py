...
T = TypeVar("T", bound="VideoFilesResponse")


@_attrs_define
class VideoFilesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        video_files_response.additional_properties = d
        return video_files_response
