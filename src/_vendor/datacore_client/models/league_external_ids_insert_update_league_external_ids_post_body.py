...
T = TypeVar("T", bound="LeagueExternalIdsInsertUpdateLeagueExternalIdsPostBody")


@_attrs_define
class LeagueExternalIdsInsertUpdateLeagueExternalIdsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        league_external_ids_insert_update_league_external_ids_post_body = cls(
            source=source,
        ...
        return league_external_ids_insert_update_league_external_ids_post_body
