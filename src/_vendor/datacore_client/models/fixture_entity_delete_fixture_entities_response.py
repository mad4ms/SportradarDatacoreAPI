...
T = TypeVar("T", bound="FixtureEntityDeleteFixtureEntitiesResponse")


@_attrs_define
class FixtureEntityDeleteFixtureEntitiesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_entity_delete_fixture_entities_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_entity_delete_fixture_entities_response.additional_properties = d
        return fixture_entity_delete_fixture_entities_response
