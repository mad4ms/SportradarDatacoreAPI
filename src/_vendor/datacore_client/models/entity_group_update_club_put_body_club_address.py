...
T = TypeVar("T", bound="EntityGroupUpdateClubPutBodyClubAddress")


@_attrs_define
class EntityGroupUpdateClubPutBodyClubAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_update_club_put_body_club_address = cls(
            address1=address1,
            address2=address2,
            address3=address3,
            city=city,
        ...
        return entity_group_update_club_put_body_club_address
