...
T = TypeVar("T", bound="VenueInsertResponseDefault")


@_attrs_define
class VenueInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        venue_insert_response_default.additional_properties = d
        return venue_insert_response_default
