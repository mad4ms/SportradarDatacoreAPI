...
T = TypeVar("T", bound="VenueExternalIdsInsertVenueExternalIdsPostBody")


@_attrs_define
class VenueExternalIdsInsertVenueExternalIdsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_external_ids_insert_venue_external_ids_post_body = cls(
            source=source,
        ...
        return venue_external_ids_insert_venue_external_ids_post_body
