...
if TYPE_CHECKING:
    ...
    from ..models.season_person_total_statistics_model import SeasonPersonTotalStatisticsModel


T = TypeVar("T", bound="SptsListSeasonPersonTotalStatisticsResponse")


@_attrs_define
class SptsListSeasonPersonTotalStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeasonPersonTotalStatisticsModel.from_dict(data_item_data)

            data.append(data_item)

        spts_list_season_person_total_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        spts_list_season_person_total_statistics_response.additional_properties = d
        return spts_list_season_person_total_statistics_response
