...
T = TypeVar("T", bound="ConductDetailResponseDefault")


@_attrs_define
class ConductDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conduct_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        conduct_detail_response_default.additional_properties = d
        return conduct_detail_response_default
