...
T = TypeVar("T", bound="OrganizationListOrganizationsResponse")


@_attrs_define
class OrganizationListOrganizationsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_list_organizations_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        organization_list_organizations_response.additional_properties = d
        return organization_list_organizations_response
