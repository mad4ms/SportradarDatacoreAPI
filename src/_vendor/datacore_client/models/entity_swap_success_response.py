...
T = TypeVar("T", bound="EntitySwapSuccessResponse")


@_attrs_define
class EntitySwapSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_swap_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_swap_success_response.additional_properties = d
        return entity_swap_success_response
