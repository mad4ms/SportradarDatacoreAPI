...
if TYPE_CHECKING:
    ...
    from ..models.seasonperson_placings_model import SEASONPERSONPlacingsModel


T = TypeVar("T", bound="SppUpdateSeasonPersonPlacingsResponse")


@_attrs_define
class SppUpdateSeasonPersonPlacingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SEASONPERSONPlacingsModel.from_dict(data_item_data)

            data.append(data_item)

        spp_update_season_person_placings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        spp_update_season_person_placings_response.additional_properties = d
        return spp_update_season_person_placings_response
