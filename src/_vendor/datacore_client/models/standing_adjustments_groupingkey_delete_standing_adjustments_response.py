...
if TYPE_CHECKING:
    ...
    from ..models.standing_adjustment_model import StandingAdjustmentModel


T = TypeVar(
    "T", bound="StandingAdjustmentsGroupingkeyDeleteStandingAdjustmentsResponse"
)


@_attrs_define
class StandingAdjustmentsGroupingkeyDeleteStandingAdjustmentsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = StandingAdjustmentModel.from_dict(data_item_data)

            data.append(data_item)

        standing_adjustments_groupingkey_delete_standing_adjustments_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_adjustments_groupingkey_delete_standing_adjustments_response.additional_properties = (
            d
        )
        return standing_adjustments_groupingkey_delete_standing_adjustments_response
