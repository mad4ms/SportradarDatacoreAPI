...
T = TypeVar("T", bound="PartnersDeleteResponseDefault")


@_attrs_define
class PartnersDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        partners_delete_response_default = cls(
            meta=meta,
            error=error,
        )

        partners_delete_response_default.additional_properties = d
        return partners_delete_response_default
