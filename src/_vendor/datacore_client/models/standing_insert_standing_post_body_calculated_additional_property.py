...
T = TypeVar("T", bound="StandingInsertStandingPostBodyCalculatedAdditionalProperty")


@_attrs_define
class StandingInsertStandingPostBodyCalculatedAdditionalProperty:
    """Type of points
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_insert_standing_post_body_calculated_additional_property = cls(
            played=played,
        ...
        return standing_insert_standing_post_body_calculated_additional_property
