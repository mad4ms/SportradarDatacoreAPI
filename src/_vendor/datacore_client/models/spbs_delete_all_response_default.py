...
T = TypeVar("T", bound="SpbsDeleteAllResponseDefault")


@_attrs_define
class SpbsDeleteAllResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spbs_delete_all_response_default = cls(
            meta=meta,
            error=error,
        )

        spbs_delete_all_response_default.additional_properties = d
        return spbs_delete_all_response_default
