...
T = TypeVar("T", bound="OrganizationInsertResponseDefault")


@_attrs_define
class OrganizationInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        organization_insert_response_default.additional_properties = d
        return organization_insert_response_default
