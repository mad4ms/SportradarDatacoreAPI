...
T = TypeVar("T", bound="CesListentityCompetitionEntityStatisticsResponse")


@_attrs_define
class CesListentityCompetitionEntityStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ces_listentity_competition_entity_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        ces_listentity_competition_entity_statistics_response.additional_properties = d
        return ces_listentity_competition_entity_statistics_response
