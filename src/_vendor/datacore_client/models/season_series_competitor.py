...
from ..models.season_series_competitor_series_result import SeasonSeriesCompetitorSeriesResult
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeasonSeriesCompetitor")


@_attrs_define
class SeasonSeriesCompetitor:
    """
    Attributes:
        ...
        series_result (Union[Unset, SeasonSeriesCompetitorSeriesResult]): Result for the competitor in the series
    """
    ...
    series_result: Union[Unset, SeasonSeriesCompetitorSeriesResult] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        series_result: Union[Unset, SeasonSeriesCompetitorSeriesResult]
        if isinstance(_series_result, Unset):
            series_result = UNSET
        else:
            series_result = SeasonSeriesCompetitorSeriesResult(_series_result)

        season_series_competitor = cls(
            entity_id=entity_id,
            person_id=person_id,
        ...
        return season_series_competitor
