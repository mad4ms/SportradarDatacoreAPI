...
T = TypeVar("T", bound="EntityGroupUpdateClubPutBodyContactDetails")


@_attrs_define
class EntityGroupUpdateClubPutBodyContactDetails:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_update_club_put_body_contact_details = cls(
            fax=fax,
            phone=phone,
        ...
        return entity_group_update_club_put_body_contact_details
