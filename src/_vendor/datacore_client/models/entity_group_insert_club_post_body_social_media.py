...
T = TypeVar("T", bound="EntityGroupInsertClubPostBodySocialMedia")


@_attrs_define
class EntityGroupInsertClubPostBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_insert_club_post_body_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return entity_group_insert_club_post_body_social_media
