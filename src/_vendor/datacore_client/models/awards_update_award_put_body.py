...
from ..models.awards_update_award_put_body_award import AwardsUpdateAwardPutBodyAward
from ..types import UNSET, Unset

T = TypeVar("T", bound="AwardsUpdateAwardPutBody")


@_attrs_define
class AwardsUpdateAwardPutBody:
    """
    Attributes:
        ...
        award (Union[Unset, AwardsUpdateAwardPutBodyAward]): Award
    ...
    award: Union[Unset, AwardsUpdateAwardPutBodyAward] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        award: Union[Unset, AwardsUpdateAwardPutBodyAward]
        if isinstance(_award, Unset):
            award = UNSET
        else:
            award = AwardsUpdateAwardPutBodyAward(_award)
        ...
        awards_update_award_put_body = cls(
            person_id=person_id,
        ...
        return awards_update_award_put_body
