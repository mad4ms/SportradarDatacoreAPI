...
from ..models.season_insert_season_post_body_seasonroster_configuration_season_roster_status_allowed_item import (
    SeasonInsertSeasonPostBodySEASONROSTERConfigurationSeasonRosterStatusAllowedItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeasonInsertSeasonPostBodySEASONROSTERConfiguration")


@_attrs_define
class SeasonInsertSeasonPostBodySEASONROSTERConfiguration:
    ...
    Attributes:
        ...
        season_roster_status_allowed (Union[Unset,
            list[SeasonInsertSeasonPostBodySEASONROSTERConfigurationSeasonRosterStatusAllowedItem]]): Season Roster status
            allowed
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for season_roster_status_allowed_item_data in (
            ...
            season_roster_status_allowed_item = SeasonInsertSeasonPostBodySEASONROSTERConfigurationSeasonRosterStatusAllowedItem(
                season_roster_status_allowed_item_data
            )
        ...
        season_insert_season_post_body_seasonroster_configuration = cls(
        ...
        return season_insert_season_post_body_seasonroster_configuration
