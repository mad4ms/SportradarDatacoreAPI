...
T = TypeVar("T", bound="RolesUpdateResponseDefault")


@_attrs_define
class RolesUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roles_update_response_default = cls(
            meta=meta,
            error=error,
        )

        roles_update_response_default.additional_properties = d
        return roles_update_response_default
