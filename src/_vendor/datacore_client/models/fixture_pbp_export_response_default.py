...
T = TypeVar("T", bound="FixturePbpExportResponseDefault")


@_attrs_define
class FixturePbpExportResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_pbp_export_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_pbp_export_response_default.additional_properties = d
        return fixture_pbp_export_response_default
