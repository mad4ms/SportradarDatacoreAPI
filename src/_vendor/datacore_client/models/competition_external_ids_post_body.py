...
T = TypeVar("T", bound="CompetitionExternalIdsPostBody")


@_attrs_define
class CompetitionExternalIdsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_external_ids_post_body = cls(
            source=source,
        ...
        return competition_external_ids_post_body
