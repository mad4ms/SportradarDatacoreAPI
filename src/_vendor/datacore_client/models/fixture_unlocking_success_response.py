...
T = TypeVar("T", bound="FixtureUnlockingSuccessResponse")


@_attrs_define
class FixtureUnlockingSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_unlocking_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_unlocking_success_response.additional_properties = d
        return fixture_unlocking_success_response
