...
T = TypeVar("T", bound="LeagueUpdateLeaguesResponse")


@_attrs_define
class LeagueUpdateLeaguesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        league_update_leagues_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        league_update_leagues_response.additional_properties = d
        return league_update_leagues_response
