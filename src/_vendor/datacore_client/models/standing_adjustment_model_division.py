...
@_attrs_define
class StandingAdjustmentModelDivision:
    """The division information

    Attributes:
        resource_type (Union[Unset, StandingAdjustmentModelDivisionResourceType]):
        id (Union[Unset, str]): Unique identifier for this resource Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
    """

    resource_type: Union[Unset, StandingAdjustmentModelDivisionResourceType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource_type, Unset):
            ...
            resource_type = StandingAdjustmentModelDivisionResourceType(_resource_type)

        id = d.pop("id", UNSET)

        standing_adjustment_model_division = cls(
            resource_type=resource_type,
            id=id,
        )

        standing_adjustment_model_division.additional_properties = d
        return standing_adjustment_model_division
