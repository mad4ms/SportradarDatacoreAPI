...
T = TypeVar("T", bound="SiteExternalIdsInsertUpdateSiteExternalIdsPostBody")


@_attrs_define
class SiteExternalIdsInsertUpdateSiteExternalIdsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_external_ids_insert_update_site_external_ids_post_body = cls(
            source=source,
        ...
        return site_external_ids_insert_update_site_external_ids_post_body
