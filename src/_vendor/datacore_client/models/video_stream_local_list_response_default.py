...
T = TypeVar("T", bound="VideoStreamLocalListResponseDefault")


@_attrs_define
class VideoStreamLocalListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        video_stream_local_list_response_default = cls(
            meta=meta,
            error=error,
        )

        video_stream_local_list_response_default.additional_properties = d
        return video_stream_local_list_response_default
