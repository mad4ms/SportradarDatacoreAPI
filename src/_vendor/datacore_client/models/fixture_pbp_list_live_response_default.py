...
T = TypeVar("T", bound="FixturePbpListLiveResponseDefault")


@_attrs_define
class FixturePbpListLiveResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_pbp_list_live_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_pbp_list_live_response_default.additional_properties = d
        return fixture_pbp_list_live_response_default
