...
T = TypeVar("T", bound="SppInsertSeasonPersonPlacingsResponse")


@_attrs_define
class SppInsertSeasonPersonPlacingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spp_insert_season_person_placings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        spp_insert_season_person_placings_response.additional_properties = d
        return spp_insert_season_person_placings_response
