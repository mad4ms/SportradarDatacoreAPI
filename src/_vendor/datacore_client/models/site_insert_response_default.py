...
T = TypeVar("T", bound="SiteInsertResponseDefault")


@_attrs_define
class SiteInsertResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_insert_response_default = cls(
            meta=meta,
            error=error,
        )

        site_insert_response_default.additional_properties = d
        return site_insert_response_default
