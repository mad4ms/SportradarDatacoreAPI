...
T = TypeVar("T", bound="FixtureInsertBaseRouteMatchPostBodyEnvironmentalDetails")


@_attrs_define
class FixtureInsertBaseRouteMatchPostBodyEnvironmentalDetails:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_insert_base_route_match_post_body_environmental_details = cls(
            surface_condition=surface_condition,
        )

        return fixture_insert_base_route_match_post_body_environmental_details
