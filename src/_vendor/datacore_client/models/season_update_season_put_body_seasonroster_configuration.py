...
from ..models.season_update_season_put_body_seasonroster_configuration_season_roster_status_allowed_item import (
    SeasonUpdateSeasonPutBodySEASONROSTERConfigurationSeasonRosterStatusAllowedItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeasonUpdateSeasonPutBodySEASONROSTERConfiguration")


@_attrs_define
class SeasonUpdateSeasonPutBodySEASONROSTERConfiguration:
    ...
    Attributes:
        ...
        season_roster_status_allowed (Union[Unset,
            list[SeasonUpdateSeasonPutBodySEASONROSTERConfigurationSeasonRosterStatusAllowedItem]]): Season Roster status
            allowed
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for season_roster_status_allowed_item_data in (
            ...
            season_roster_status_allowed_item = SeasonUpdateSeasonPutBodySEASONROSTERConfigurationSeasonRosterStatusAllowedItem(
                season_roster_status_allowed_item_data
            )
        ...
        season_update_season_put_body_seasonroster_configuration = cls(
        ...
        return season_update_season_put_body_seasonroster_configuration
