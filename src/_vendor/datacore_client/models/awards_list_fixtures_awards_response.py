...
T = TypeVar("T", bound="AwardsListFixturesAwardsResponse")


@_attrs_define
class AwardsListFixturesAwardsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        awards_list_fixtures_awards_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        awards_list_fixtures_awards_response.additional_properties = d
        return awards_list_fixtures_awards_response
