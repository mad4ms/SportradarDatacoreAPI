...
T = TypeVar("T", bound="PartnersPutResponseDefault")


@_attrs_define
class PartnersPutResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        partners_put_response_default = cls(
            meta=meta,
            error=error,
        )

        partners_put_response_default.additional_properties = d
        return partners_put_response_default
