...
T = TypeVar("T", bound="FpsInsertUpdateResponseDefault")


@_attrs_define
class FpsInsertUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fps_insert_update_response_default = cls(
            meta=meta,
            error=error,
        )

        fps_insert_update_response_default.additional_properties = d
        return fps_insert_update_response_default
