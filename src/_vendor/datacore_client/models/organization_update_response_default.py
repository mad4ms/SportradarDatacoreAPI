...
T = TypeVar("T", bound="OrganizationUpdateResponseDefault")


@_attrs_define
class OrganizationUpdateResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_update_response_default = cls(
            meta=meta,
            error=error,
        )

        organization_update_response_default.additional_properties = d
        return organization_update_response_default
