...
T = TypeVar("T", bound="SeasonExternalIdsDeleteSeasonExternalIdsResponse")


@_attrs_define
class SeasonExternalIdsDeleteSeasonExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_external_ids_delete_season_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_external_ids_delete_season_external_ids_response.additional_properties = (
            d
        )
        return season_external_ids_delete_season_external_ids_response
