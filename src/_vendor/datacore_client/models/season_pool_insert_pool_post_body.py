...
T = TypeVar("T", bound="SeasonPoolInsertPoolPostBody")


@_attrs_define
class SeasonPoolInsertPoolPostBody:
    """
    Attributes:
        season_id (UUID): The unique identifier of the season Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        pool_code (str): A unique code for the pool. (Unique for season) Example: P1.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_pool_insert_pool_post_body = cls(
            season_id=season_id,
            pool_code=pool_code,
        ...
        return season_pool_insert_pool_post_body
