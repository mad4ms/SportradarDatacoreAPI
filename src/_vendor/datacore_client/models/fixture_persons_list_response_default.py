...
T = TypeVar("T", bound="FixturePersonsListResponseDefault")


@_attrs_define
class FixturePersonsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_persons_list_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_persons_list_response_default.additional_properties = d
        return fixture_persons_list_response_default
