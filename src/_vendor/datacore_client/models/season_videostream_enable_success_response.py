...
T = TypeVar("T", bound="SeasonVideostreamEnableSuccessResponse")


@_attrs_define
class SeasonVideostreamEnableSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_videostream_enable_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_videostream_enable_success_response.additional_properties = d
        return season_videostream_enable_success_response
