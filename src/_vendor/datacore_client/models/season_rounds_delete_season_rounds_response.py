...
T = TypeVar("T", bound="SeasonRoundsDeleteSeasonRoundsResponse")


@_attrs_define
class SeasonRoundsDeleteSeasonRoundsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_rounds_delete_season_rounds_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_rounds_delete_season_rounds_response.additional_properties = d
        return season_rounds_delete_season_rounds_response
