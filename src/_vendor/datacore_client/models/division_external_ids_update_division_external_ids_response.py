...
T = TypeVar("T", bound="DivisionExternalIdsUpdateDivisionExternalIdsResponse")


@_attrs_define
class DivisionExternalIdsUpdateDivisionExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        division_external_ids_update_division_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        division_external_ids_update_division_external_ids_response.additional_properties = (
            d
        )
        return division_external_ids_update_division_external_ids_response
