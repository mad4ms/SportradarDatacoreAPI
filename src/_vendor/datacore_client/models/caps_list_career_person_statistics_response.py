...
T = TypeVar("T", bound="CapsListCareerPersonStatisticsResponse")


@_attrs_define
class CapsListCareerPersonStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        caps_list_career_person_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        caps_list_career_person_statistics_response.additional_properties = d
        return caps_list_career_person_statistics_response
