...
T = TypeVar("T", bound="FpsListliveResponseDefault")


@_attrs_define
class FpsListliveResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fps_listlive_response_default = cls(
            meta=meta,
            error=error,
        )

        fps_listlive_response_default.additional_properties = d
        return fps_listlive_response_default
