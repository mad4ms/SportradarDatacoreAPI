...
T = TypeVar("T", bound="FixtureResetResponseDefault")


@_attrs_define
class FixtureResetResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_reset_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_reset_response_default.additional_properties = d
        return fixture_reset_response_default
