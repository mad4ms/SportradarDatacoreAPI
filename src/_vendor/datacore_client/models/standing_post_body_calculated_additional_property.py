...
T = TypeVar("T", bound="StandingPostBodyCalculatedAdditionalProperty")


@_attrs_define
class StandingPostBodyCalculatedAdditionalProperty:
    """Type of points
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_post_body_calculated_additional_property = cls(
            played=played,
        ...
        return standing_post_body_calculated_additional_property
