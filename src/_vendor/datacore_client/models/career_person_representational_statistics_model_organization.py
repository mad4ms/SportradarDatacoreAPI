...
from ..models.career_person_representational_statistics_model_organization_resource_type import (
    CareerPersonRepresentationalStatisticsModelOrganizationResourceType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CareerPersonRepresentationalStatisticsModelOrganization")


@_attrs_define
class CareerPersonRepresentationalStatisticsModelOrganization:
    """The organization that this career person representational_statistics belongs to
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        career_person_representational_statistics_model_organization = cls(
