...
T = TypeVar("T", bound="VideoSubscriptionListResponseDefault")


@_attrs_define
class VideoSubscriptionListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        video_subscription_list_response_default = cls(
            meta=meta,
            error=error,
        )

        video_subscription_list_response_default.additional_properties = d
        return video_subscription_list_response_default
