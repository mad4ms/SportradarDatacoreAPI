...
T = TypeVar("T", bound="FixtureRosterDeleteAllFixtureRosterResponse")


@_attrs_define
class FixtureRosterDeleteAllFixtureRosterResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_roster_delete_all_fixture_roster_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_roster_delete_all_fixture_roster_response.additional_properties = d
        return fixture_roster_delete_all_fixture_roster_response
