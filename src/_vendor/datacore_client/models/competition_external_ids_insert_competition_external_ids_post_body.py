...
T = TypeVar("T", bound="CompetitionExternalIdsInsertCompetitionExternalIdsPostBody")


@_attrs_define
class CompetitionExternalIdsInsertCompetitionExternalIdsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_external_ids_insert_competition_external_ids_post_body = cls(
            source=source,
        ...
        return competition_external_ids_insert_competition_external_ids_post_body
