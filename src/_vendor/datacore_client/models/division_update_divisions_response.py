...
T = TypeVar("T", bound="DivisionUpdateDivisionsResponse")


@_attrs_define
class DivisionUpdateDivisionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        division_update_divisions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        division_update_divisions_response.additional_properties = d
        return division_update_divisions_response
