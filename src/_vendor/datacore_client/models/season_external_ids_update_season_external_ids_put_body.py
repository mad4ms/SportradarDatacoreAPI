...
T = TypeVar("T", bound="SeasonExternalIdsUpdateSeasonExternalIdsPutBody")


@_attrs_define
class SeasonExternalIdsUpdateSeasonExternalIdsPutBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_external_ids_update_season_external_ids_put_body = cls(
            season_id=season_id,
            source=source,
        ...
        return season_external_ids_update_season_external_ids_put_body
