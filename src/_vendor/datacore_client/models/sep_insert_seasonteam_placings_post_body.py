...
T = TypeVar("T", bound="SepInsertSEASONTEAMPlacingsPostBody")


@_attrs_define
class SepInsertSEASONTEAMPlacingsPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sep_insert_seasonteam_placings_post_body = cls(
            season_id=season_id,
            entity_id=entity_id,
        ...
        return sep_insert_seasonteam_placings_post_body
