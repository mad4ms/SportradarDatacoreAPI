...
T = TypeVar("T", bound="StandingAdjustmentsGroupingkeyDeleteResponseDefault")


@_attrs_define
class StandingAdjustmentsGroupingkeyDeleteResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_adjustments_groupingkey_delete_response_default = cls(
            meta=meta,
            error=error,
        )
