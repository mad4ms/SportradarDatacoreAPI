...
T = TypeVar("T", bound="CompetitionExternalIdsUpdateCompetitionExternalIdsResponse")


@_attrs_define
class CompetitionExternalIdsUpdateCompetitionExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_external_ids_update_competition_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        competition_external_ids_update_competition_external_ids_response.additional_properties = (
            d
        )
        return competition_external_ids_update_competition_external_ids_response
