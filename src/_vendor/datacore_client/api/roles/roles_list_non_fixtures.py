...
from ...models.roles_list_non_fixtures_roles_response import RolesListNonFixturesRolesResponse
...
def _get_kwargs(
    ...
    *,
    ...
    role: Union[Unset, RolesListNonFixturesRole] = UNSET,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    response_default = RolesListNonFixturesResponseDefault.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        role (Union[Unset, RolesListNonFixturesRole]):  Example: COACH.
        season_id (Union[Unset, UUID]):  Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        sort_by (Union[Unset, str]):  Example: role.
        status (Union[Unset, RolesListNonFixturesStatus]):  Example: ACTIVE.
...
def sync(
    ...
    *,
    ...
    status: Union[Unset, RolesListNonFixturesStatus] = UNSET,
    updated: Union[Unset, datetime.datetime] = UNSET,
) -> Optional[Union[RolesListNonFixturesResponseDefault, RolesListNonFixturesRolesResponse]]:
    """Get a list of non-match roles
