...
from ...models.roles_list_by_fixture_roles_response import RolesListByFixtureRolesResponse
...
def sync(
    ...
    *,
    ...
    status: Union[Unset, RolesListByFixtureStatus] = UNSET,
    updated: Union[Unset, datetime.datetime] = UNSET,
) -> Optional[Union[RolesListByFixtureResponseDefault, RolesListByFixtureRolesResponse]]:
    """Get a list of roles in a match
