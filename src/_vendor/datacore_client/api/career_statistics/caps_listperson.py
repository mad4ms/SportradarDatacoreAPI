...
from ...models.caps_listperson_career_person_statistics_response import (
...
from ...models.caps_listperson_win_loss import CapsListpersonWinLoss
...
def _get_kwargs(
    ...
    *,
    ...
    fixture_type: Union[Unset, CapsListpersonFixtureType] = UNSET,
    hide_null: Union[Unset, bool] = UNSET,
    home_away: Union[Unset, CapsListpersonHomeAway] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/statistics/for/person/in/career/persons/{person_id}",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CapsListpersonCareerPersonStatisticsResponse.from_dict(
            response.json()
        )
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        fixture_type (Union[Unset, CapsListpersonFixtureType]):  Example: REGULAR.
        hide_null (Union[Unset, bool]):  Example: True.
        home_away (Union[Unset, CapsListpersonHomeAway]):
        ...
        win_loss (Union[Unset, CapsListpersonWinLoss]):
