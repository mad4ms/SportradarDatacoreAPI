...
from ...models.ces_listentity_win_loss import CesListentityWinLoss
...
def _get_kwargs(
    ...
    *,
    ...
    fixture_type: Union[Unset, CesListentityFixtureType] = UNSET,
    hide_null: Union[Unset, bool] = UNSET,
    home_away: Union[Unset, CesListentityHomeAway] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/statistics/for/entity/in/competitions/{competition_id}/entities/{entity_id}",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    CesListentityCompetitionEntityStatisticsResponse, CesListentityResponseDefault
]:
    if response.status_code == 200:
        response_200 = CesListentityCompetitionEntityStatisticsResponse.from_dict(
            response.json()
        )
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        fixture_type (Union[Unset, CesListentityFixtureType]):  Example: REGULAR.
        hide_null (Union[Unset, bool]):  Example: True.
        home_away (Union[Unset, CesListentityHomeAway]):
        include (Union[Unset, str]):  Example: organizations,fixtures,entities.
        limit (Union[Unset, int]):  Default: 10. Example: 10.
        offset (Union[Unset, int]):  Example: 10.
        section (Union[Unset, str]):
        win_loss (Union[Unset, CesListentityWinLoss]):
