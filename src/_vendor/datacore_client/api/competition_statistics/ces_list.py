...
from ...models.ces_list_competition_entity_statistics_response import CesListCompetitionEntityStatisticsResponse
...
) -> Union[CesListCompetitionEntityStatisticsResponse, CesListResponseDefault]:
    if response.status_code == 200:
        response_200 = CesListCompetitionEntityStatisticsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CesListCompetitionEntityStatisticsResponse, CesListResponseDefault]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    offset: Union[Unset, int] = UNSET,
    win_loss: Union[Unset, CesListWinLoss] = UNSET,
) -> Optional[Union[CesListCompetitionEntityStatisticsResponse, CesListResponseDefault]]:
    """Team statistics for a competition
