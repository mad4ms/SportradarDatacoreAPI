...
from ...models.entity_group_detail_entity_groups_response import EntityGroupDetailEntityGroupsResponse
...
def sync(
    ...
    *,
    ...
    limit: Union[Unset, int] = 10,
    offset: Union[Unset, int] = UNSET,
) -> Optional[Union[EntityGroupDetailEntityGroupsResponse, EntityGroupDetailResponseDefault]]:
    """Get a club
