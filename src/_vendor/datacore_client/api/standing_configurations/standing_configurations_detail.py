...
from ...models.standing_configurations_detail_response_default import StandingConfigurationsDetailResponseDefault
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    response_default = StandingConfigurationsDetailResponseDefault.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[StandingConfigurationsDetailResponseDefault]:
    return Response(
...
def sync(
    ...
    *,
    ...
    limit: Union[Unset, int] = 10,
    offset: Union[Unset, int] = UNSET,
) -> Optional[StandingConfigurationsDetailResponseDefault]:
    """Get standing configuration
