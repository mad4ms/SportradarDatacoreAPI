...
from ...models.standing_configurations_list_response_default import (
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = (
            StandingConfigurationsListStandingConfigurationsResponse.from_dict(
                response.json()
            )
        )
    ...
    response_default = StandingConfigurationsListResponseDefault.from_dict(
        response.json()
    )
