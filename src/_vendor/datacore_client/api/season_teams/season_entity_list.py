...
from ...models.season_entity_list_response_default import (
    SeasonEntityListResponseDefault,
)
from ...models.season_entity_list_season_entities_list_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/seasons/entities/{entity_id}",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SeasonEntityListSeasonEntitiesListResponse.from_dict(
            response.json()
        )
