...
from ...models.video_stream_inputs_list_response_default import (
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    VideoStreamInputsListResponseDefault, VideoStreamInputsListVideoStreamInputsResponse
]:
    if response.status_code == 200:
        response_200 = VideoStreamInputsListVideoStreamInputsResponse.from_dict(
            response.json()
        )
