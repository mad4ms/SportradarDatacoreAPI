...
from ...models.conference_detail_conferences_response import ConferenceDetailConferencesResponse
...
def sync(
    ...
    *,
    ...
    limit: Union[Unset, int] = 10,
    offset: Union[Unset, int] = UNSET,
) -> Optional[Union[ConferenceDetailConferencesResponse, ConferenceDetailResponseDefault]]:
    """Get a conference
