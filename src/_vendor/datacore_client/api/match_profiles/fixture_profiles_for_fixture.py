...
from ...models.fixture_profiles_for_fixture_response_default import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/fixtureProfiles/for/fixture/{fixture_id}",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = FixtureProfilesForFixtureFixtureProfilesResponse.from_dict(
            response.json()
        )

        return response_200

    response_default = FixtureProfilesForFixtureResponseDefault.from_dict(
        response.json()
    )
