...
from ...models.fixture_profiles_delete_response_default import FixtureProfilesDeleteResponseDefault
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[FixtureProfilesDeleteResponseDefault]:
    return Response(
...
def sync(
    ...
    *,
    ...
    hide_null: Union[Unset, bool] = UNSET,
    include: Union[Unset, str] = UNSET,
) -> Optional[FixtureProfilesDeleteResponseDefault]:
    """Delete a match profile
