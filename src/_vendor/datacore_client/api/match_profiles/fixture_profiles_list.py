...
from ...models.fixture_profiles_list_fixture_profiles_response import FixtureProfilesListFixtureProfilesResponse
...
) -> Union[FixtureProfilesListFixtureProfilesResponse, FixtureProfilesListResponseDefault]:
    if response.status_code == 200:
        response_200 = FixtureProfilesListFixtureProfilesResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[FixtureProfilesListFixtureProfilesResponse, FixtureProfilesListResponseDefault]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    sort_by: Union[Unset, str] = UNSET,
    updated: Union[Unset, datetime.datetime] = UNSET,
) -> Optional[Union[FixtureProfilesListFixtureProfilesResponse, FixtureProfilesListResponseDefault]]:
    """Get a list of match profiles
