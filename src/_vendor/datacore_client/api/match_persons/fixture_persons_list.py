...
from ...models.fixture_persons_list_fixture_persons_response import (
    FixturePersonsListFixturePersonsResponse,
)
from ...models.fixture_persons_list_response_default import (
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = FixturePersonsListFixturePersonsResponse.from_dict(
            response.json()
        )

        return response_200

    response_default = FixturePersonsListResponseDefault.from_dict(response.json())
