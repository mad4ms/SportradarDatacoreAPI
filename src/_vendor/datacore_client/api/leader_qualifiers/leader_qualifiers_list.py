...
from ...models.leader_qualifiers_list_leader_qualifiers_response import LeaderQualifiersListLeaderQualifiersResponse
...
def _get_kwargs(
    ...
    *,
    ...
    params["statisticField"] = statistic_field
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = LeaderQualifiersListLeaderQualifiersResponse.from_dict(response.json())

        return response_200

    response_default = LeaderQualifiersListResponseDefault.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        statistic_field (Union[Unset, str]):  Example: points.
...
def sync(
    ...
    *,
    ...
    offset: Union[Unset, int] = UNSET,
    statistic_field: Union[Unset, str] = UNSET,
) -> Optional[Union[LeaderQualifiersListLeaderQualifiersResponse, LeaderQualifiersListResponseDefault]]:
    """Get a list of leader qualifiers for a criteria set
