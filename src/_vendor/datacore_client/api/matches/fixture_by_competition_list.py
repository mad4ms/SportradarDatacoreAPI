...
def _get_kwargs(
    ...
    *,
    ...
    competitor_type: Union[Unset, FixtureByCompetitionListCompetitorType] = UNSET,
    discipline: Union[Unset, FixtureByCompetitionListDiscipline] = UNSET,
    external: Union[Unset, str] = UNSET,
    fields: Union[Unset, str] = UNSET,
    fixture_id: Union[Unset, UUID] = UNSET,
    fixture_type: Union[Unset, FixtureByCompetitionListFixtureType] = UNSET,
    ...
    status: Union[Unset, FixtureByCompetitionListStatus] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/competitions/{competition_id}/fixtures",
        "params": params,
    }
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[FixtureByCompetitionListResponseDefault]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        competitor_type (Union[Unset, FixtureByCompetitionListCompetitorType]):  Example: PERSON.
        discipline (Union[Unset, FixtureByCompetitionListDiscipline]):  Example: INDOOR.
        external (Union[Unset, str]):  Example: entityId,personId.
        fields (Union[Unset, str]):  Example: dob,firstName,organization(id),organizations[name],
            teams[name,details/metrics/*,tags(id)].
        fixture_id (Union[Unset, UUID]):  Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        fixture_type (Union[Unset, FixtureByCompetitionListFixtureType]):  Example: REGULAR.
        ...
        status (Union[Unset, FixtureByCompetitionListStatus]):  Example: SCHEDULED.
...
def sync(
    ...
    *,
    ...
    updated: Union[Unset, datetime.datetime] = UNSET,
    venue_id: Union[Unset, UUID] = UNSET,
) -> Optional[FixtureByCompetitionListResponseDefault]:
    """Get a list of matches for a Competition
