...
def _get_kwargs(
    ...
    *,
    ...
    fixture_type: Union[Unset, SeasonFixtureStagesPoolsListFixtureType] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/seasons/{season_id}/fixtures/stages/pools",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        fixture_type (Union[Unset, SeasonFixtureStagesPoolsListFixtureType]):  Example: REGULAR.
