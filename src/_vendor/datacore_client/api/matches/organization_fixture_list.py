...
from ...models.organization_fixture_list_competitor_type import (
    OrganizationFixtureListCompetitorType,
)
from ...models.organization_fixture_list_discipline import (
    OrganizationFixtureListDiscipline,
)
from ...models.organization_fixture_list_fixture_type import (
    OrganizationFixtureListFixtureType,
)
from ...models.organization_fixture_list_fixtures_response import (
    OrganizationFixtureListFixturesResponse,
)
from ...models.organization_fixture_list_response_default import (
    OrganizationFixtureListResponseDefault,
)
from ...models.organization_fixture_list_status import OrganizationFixtureListStatus
from ...models.organization_fixture_list_status_not import (
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    OrganizationFixtureListFixturesResponse, OrganizationFixtureListResponseDefault
]:
    if response.status_code == 200:
        response_200 = OrganizationFixtureListFixturesResponse.from_dict(
            response.json()
        )
