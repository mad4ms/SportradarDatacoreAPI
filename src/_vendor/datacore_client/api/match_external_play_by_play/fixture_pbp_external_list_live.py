...
from ...models.fixture_pbp_external_list_live_period_id import (
    FixturePbpExternalListLivePeriodId,
)
from ...models.fixture_pbp_external_list_live_response_default import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/fixtures/{fixture_id}/playbyplay/external/live",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = FixturePbpExternalListLiveFixturePbpExternalResponse.from_dict(
            response.json()
        )

        return response_200

    response_default = FixturePbpExternalListLiveResponseDefault.from_dict(
        response.json()
    )
...
def sync_detailed(
    ...
    *,
    ...
    """Get a list of live play-by-play external records for a match
        ...
        Return a list of live play-by-play external records for a match. This call will return external
    records of matches
        still in-progress if available.  If the match is complete this call operates the same as the non
    'live'
        route.
    ...
    Args:
        ...
        period_id (Union[Unset, FixturePbpExternalListLivePeriodId]):
