...
from ...models.ses_listperiods_fixture_type import SesListperiodsFixtureType
...
from ...models.ses_listperiods_season_entity_statistics_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    fixture_type: Union[Unset, SesListperiodsFixtureType] = UNSET,
    from_time_utc: Union[Unset, datetime.datetime] = UNSET,
    hide_null: Union[Unset, bool] = UNSET,
    home_away: Union[Unset, SesListperiodsHomeAway] = UNSET,
    include: Union[Unset, str] = UNSET,
    limit: Union[Unset, int] = 10,
    offset: Union[Unset, int] = UNSET,
    period_id: Union[Unset, SesListperiodsPeriodId] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/statistics/for/entity/in/seasons/{season_id}/periods",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SesListperiodsSeasonEntityStatisticsResponse.from_dict(
            response.json()
        )
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        fixture_type (Union[Unset, SesListperiodsFixtureType]):  Example: REGULAR.
        from_time_utc (Union[Unset, datetime.datetime]):  Example: 2018-08-16T18:00:00.
        hide_null (Union[Unset, bool]):  Example: True.
        home_away (Union[Unset, SesListperiodsHomeAway]):
        include (Union[Unset, str]):  Example: organizations,fixtures,entities.
        limit (Union[Unset, int]):  Default: 10. Example: 10.
        offset (Union[Unset, int]):  Example: 10.
        period_id (Union[Unset, SesListperiodsPeriodId]):
        ...
        win_loss (Union[Unset, SesListperiodsWinLoss]):
