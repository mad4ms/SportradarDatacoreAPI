...
from ...models.sps_list_season_person_statistics_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    fixture_type: Union[Unset, SpsListFixtureType] = UNSET,
    from_time_utc: Union[Unset, datetime.datetime] = UNSET,
    hide_null: Union[Unset, bool] = UNSET,
    home_away: Union[Unset, SpsListHomeAway] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/statistics/for/person/in/seasons/{season_id}",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    response_default = SpsListResponseDefault.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        fixture_type (Union[Unset, SpsListFixtureType]):  Example: REGULAR.
        from_time_utc (Union[Unset, datetime.datetime]):  Example: 2018-08-16T18:00:00.
        hide_null (Union[Unset, bool]):  Example: True.
        home_away (Union[Unset, SpsListHomeAway]):
        ...
        win_loss (Union[Unset, SpsListWinLoss]):
