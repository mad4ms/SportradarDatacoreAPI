...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/seasons/{season_id}/statistics/for/person/in/fixtures",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    FpsListBySeasonFixturePersonStatisticsResponse, FpsListBySeasonResponseDefault
]:
    if response.status_code == 200:
        response_200 = FpsListBySeasonFixturePersonStatisticsResponse.from_dict(
            response.json()
        )
...
def sync_detailed(
    ...
    *,
    ...
    periods added together) for the match.
