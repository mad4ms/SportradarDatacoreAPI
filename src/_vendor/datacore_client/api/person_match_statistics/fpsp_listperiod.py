...
def _get_kwargs(
    ...
    *,
    ...
    period_id: Union[Unset, FpspListperiodPeriodId] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/statistics/for/person/in/fixtures/{fixture_id}/periods",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    FpspListperiodFixturePersonStatisticsPeriodsResponse, FpspListperiodResponseDefault
]:
    if response.status_code == 200:
        response_200 = FpspListperiodFixturePersonStatisticsPeriodsResponse.from_dict(
            response.json()
        )

        return response_200

    response_default = FpspListperiodResponseDefault.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        period_id (Union[Unset, FpspListperiodPeriodId]):
