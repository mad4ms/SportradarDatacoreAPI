...
from ...models.season_external_ids_list_response_default import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/seasons/externalids",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    SeasonExternalIdsListResponseDefault, SeasonExternalIdsListSeasonExternalIdsResponse
]:
    if response.status_code == 200:
        response_200 = SeasonExternalIdsListSeasonExternalIdsResponse.from_dict(
            response.json()
        )

        return response_200

    response_default = SeasonExternalIdsListResponseDefault.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        season_id (Union[Unset, str]):  Example:
