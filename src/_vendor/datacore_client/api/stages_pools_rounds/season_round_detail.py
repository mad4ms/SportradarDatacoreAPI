...
from ...models.season_round_detail_season_rounds_response import SeasonRoundDetailSeasonRoundsResponse
...
def sync(
    ...
    *,
    ...
    limit: Union[Unset, int] = 10,
    offset: Union[Unset, int] = UNSET,
) -> Optional[Union[SeasonRoundDetailResponseDefault, SeasonRoundDetailSeasonRoundsResponse]]:
    """Get a round
