...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ConferenceExternalIdsListConferenceExternalIdsResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        conference_id (Union[Unset, str]):  Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
...
def sync(
    ...
    *,
    ...
    source_type: Union[Unset, str] = UNSET,
    updated: Union[Unset, datetime.datetime] = UNSET,
) -> Optional[Union[ConferenceExternalIdsListConferenceExternalIdsResponse, ConferenceExternalIdsListResponseDefault]]:
    """Get a list of a conference external ids
