...
def _get_kwargs(
    ...
    *,
    ...
    base_type: Union[Unset, UniformsListBaseType] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/uniforms",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    response_default = UniformsListResponseDefault.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        base_type (Union[Unset, UniformsListBaseType]):  Example: PERSON.
