...
from ...models.person_external_ids_delete_response_default import PersonExternalIdsDeleteResponseDefault
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PersonExternalIdsDeleteResponseDefault]:
    return Response(
...
def sync(
    ...
    *,
    ...
    hide_null: Union[Unset, bool] = UNSET,
    include: Union[Unset, str] = UNSET,
) -> Optional[PersonExternalIdsDeleteResponseDefault]:
    """Delete a person external identifier information
