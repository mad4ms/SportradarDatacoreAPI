...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = EntityExternalIdsListEntityExternalIdsResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    source_type: Union[Unset, str] = UNSET,
    updated: Union[Unset, datetime.datetime] = UNSET,
) -> Optional[Union[EntityExternalIdsListEntityExternalIdsResponse, EntityExternalIdsListResponseDefault]]:
    """Get a list of a team external ids
