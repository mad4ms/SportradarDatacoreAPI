...
from ...models.fixture_external_ids_delete_response_default import FixtureExternalIdsDeleteResponseDefault
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    response_default = FixtureExternalIdsDeleteResponseDefault.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[FixtureExternalIdsDeleteResponseDefault]:
    return Response(
...
def sync(
    ...
    *,
    ...
    hide_null: Union[Unset, bool] = UNSET,
    include: Union[Unset, str] = UNSET,
) -> Optional[FixtureExternalIdsDeleteResponseDefault]:
    """Delete a match external identifier information
