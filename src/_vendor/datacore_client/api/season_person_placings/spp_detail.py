...
from ...models.spp_detail_season_person_placings_response import SppDetailSeasonPersonPlacingsResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/seasons/persons/placings/{placing_id}",
        "params": params,
    }
