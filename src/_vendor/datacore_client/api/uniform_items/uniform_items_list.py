...
from ...models.uniform_items_list_response_default import (
    UniformItemsListResponseDefault,
)
from ...models.uniform_items_list_uniform_items_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    item_type: Union[Unset, UniformItemsListItemType] = UNSET,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    response_default = UniformItemsListResponseDefault.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        item_type (Union[Unset, UniformItemsListItemType]):  Example: JERSEY.
