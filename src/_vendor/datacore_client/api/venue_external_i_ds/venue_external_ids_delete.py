...
from ...models.venue_external_ids_delete_response_default import VenueExternalIdsDeleteResponseDefault
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[VenueExternalIdsDeleteResponseDefault]:
    return Response(
...
def sync(
    ...
    *,
    ...
    hide_null: Union[Unset, bool] = UNSET,
    include: Union[Unset, str] = UNSET,
) -> Optional[VenueExternalIdsDeleteResponseDefault]:
    """Delete a venue external identifier information
