...
from ...models.venue_external_ids_delete_response_default import (
    VenueExternalIdsDeleteResponseDefault,
)
from ...models.venue_external_ids_delete_venue_external_ids_response import (
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = VenueExternalIdsDeleteVenueExternalIdsResponse.from_dict(
            response.json()
        )

        return response_200

    response_default = VenueExternalIdsDeleteResponseDefault.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[VenueExternalIdsDeleteResponseDefault, VenueExternalIdsDeleteVenueExternalIdsResponse]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[VenueExternalIdsDeleteResponseDefault, VenueExternalIdsDeleteVenueExternalIdsResponse]
    """
