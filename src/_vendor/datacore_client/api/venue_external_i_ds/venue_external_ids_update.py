...
from ...models.venue_external_ids_put_body import VenueExternalIdsPutBody
from ...models.venue_external_ids_update_response_default import VenueExternalIdsUpdateResponseDefault
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[VenueExternalIdsUpdateResponseDefault]:
    return Response(
...
def sync(
    ...
    *,
    ...
    hide_null: Union[Unset, bool] = UNSET,
    include: Union[Unset, str] = UNSET,
) -> Optional[VenueExternalIdsUpdateResponseDefault]:
    """Update a venue external identifier information
