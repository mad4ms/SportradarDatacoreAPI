...
from ...models.video_stream_local_delete_response_default import VideoStreamLocalDeleteResponseDefault
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[VideoStreamLocalDeleteResponseDefault]:
    return Response(
...
def sync(
    ...
    *,
    ...
    hide_null: Union[Unset, bool] = UNSET,
    include: Union[Unset, str] = UNSET,
) -> Optional[VideoStreamLocalDeleteResponseDefault]:
    """Delete a local streaming video endpoint
