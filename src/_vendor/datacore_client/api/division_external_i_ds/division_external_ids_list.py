...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/divisions/externalids",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = DivisionExternalIdsListDivisionExternalIdsResponse.from_dict(response.json())

        return response_200

    response_default = DivisionExternalIdsListResponseDefault.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        division_id (Union[Unset, str]):  Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
...
def sync(
    ...
    *,
    ...
    source_type: Union[Unset, str] = UNSET,
    updated: Union[Unset, datetime.datetime] = UNSET,
) -> Optional[Union[DivisionExternalIdsListDivisionExternalIdsResponse, DivisionExternalIdsListResponseDefault]]:
    """Get a list of a division external ids
