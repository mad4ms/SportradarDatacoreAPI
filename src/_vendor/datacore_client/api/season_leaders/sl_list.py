...
from ...models.sl_list_season_person_statistics_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    fixture_type: Union[Unset, SlListFixtureType] = UNSET,
    hide_null: Union[Unset, bool] = UNSET,
    home_away: Union[Unset, SlListHomeAway] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/statistics/leaders/for/{statistic}/in/seasons/{season_id}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    This call is similar to the person match statistics call~ however this call applies the
    qualification criteria (defined in the leaders qualification api calls) to each person.

    Args:
        organization_id (str):  Example: b1a23.
        statistic (str):  Example: points.
        ...
        fixture_type (Union[Unset, SlListFixtureType]):  Example: REGULAR.
        hide_null (Union[Unset, bool]):  Example: True.
        home_away (Union[Unset, SlListHomeAway]):
        ...
        win_loss (Union[Unset, SlListWinLoss]):
