...
from ...models.images_list_organization_image_type import (
    ImagesListOrganizationImageType,
)
from ...models.images_list_organization_images_response import (
    ImagesListOrganizationImagesResponse,
)
from ...models.images_list_organization_rating import ImagesListOrganizationRating
from ...models.images_list_organization_response_default import (
...
def _get_kwargs(
    ...
    *,
    ...
    base_type: Union[
        Unset, ImagesListOrganizationBaseType
    ] = ImagesListOrganizationBaseType.ORGANIZATION,
    external: Union[Unset, str] = UNSET,
    fields: Union[Unset, str] = UNSET,
    hide_null: Union[Unset, bool] = UNSET,
    image_type: Union[Unset, ImagesListOrganizationImageType] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/images/for/ORGANIZATION",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        base_type (Union[Unset, ImagesListOrganizationBaseType]):  Default:
            ImagesListOrganizationBaseType.ORGANIZATION. Example: PERSON.
        external (Union[Unset, str]):  Example: entityId,personId.
        fields (Union[Unset, str]):  Example: dob,firstName,organization(id),organizations[name],
            teams[name,details/metrics/*,tags(id)].
        hide_null (Union[Unset, bool]):  Example: True.
        image_type (Union[Unset, ImagesListOrganizationImageType]):  Example: LOGO.
        include (Union[Unset, str]):  Example: organizations,fixtures,entities.
        limit (Union[Unset, int]):  Default: 10. Example: 10.
        offset (Union[Unset, int]):  Example: 10.
        rating (Union[Unset, ImagesListOrganizationRating]):  Example: UNKNOWN.
