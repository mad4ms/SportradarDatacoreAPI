...
from ...models.images_list_secondary_images_response import ImagesListSecondaryImagesResponse
...
def sync(
    ...
    *,
    ...
    rating: Union[Unset, ImagesListSecondaryRating] = UNSET,
    updated: Union[Unset, datetime.datetime] = UNSET,
) -> Optional[Union[ImagesListSecondaryImagesResponse, ImagesListSecondaryResponseDefault]]:
    """Get a list of images for a type in a secondary Type
