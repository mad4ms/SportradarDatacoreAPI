...
from ...models.fes_listperiodlive_response_default import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/statistics/for/entity/in/fixtures/{fixture_id}/periods/live",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = (
            FesListperiodliveFixtureEntityStatisticsPeriodsResponse.from_dict(
                response.json()
            )
        )
...
def sync_detailed(
    ...
    *,
    ...
    """Team period statistics - live
        ...
        records of matches still in-progress if available.  If the match is complete this call operates
    the same
    ...
    Args:
        ...
        period_id (Union[Unset, FesListperiodlivePeriodId]):
