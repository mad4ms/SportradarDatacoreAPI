...
from ...models.fes_listperiod_by_season_response_default import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/seasons/{season_id}/statistics/for/entity/in/fixtures/periods",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = (
            FesListperiodBySeasonFixtureEntityStatisticsPeriodsResponse.from_dict(
                response.json()
            )
        )
