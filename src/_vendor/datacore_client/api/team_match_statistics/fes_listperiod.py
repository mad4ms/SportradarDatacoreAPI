...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    FesListperiodFixtureEntityStatisticsPeriodsResponse, FesListperiodResponseDefault
]:
    if response.status_code == 200:
        response_200 = FesListperiodFixtureEntityStatisticsPeriodsResponse.from_dict(
            response.json()
        )
