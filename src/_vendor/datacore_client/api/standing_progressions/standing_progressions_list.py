...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = StandingProgressionsListStandingProgressionsResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    offset: Union[Unset, int] = UNSET,
    updated: Union[Unset, datetime.datetime] = UNSET,
) -> Optional[Union[StandingProgressionsListResponseDefault, StandingProgressionsListStandingProgressionsResponse]]:
    """Get a list of standing progressions
