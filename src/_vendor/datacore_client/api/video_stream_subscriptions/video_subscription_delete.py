...
from ...models.video_subscription_delete_response_default import VideoSubscriptionDeleteResponseDefault
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[VideoSubscriptionDeleteResponseDefault]:
    return Response(
...
def sync(
    ...
    *,
    ...
    hide_null: Union[Unset, bool] = UNSET,
    include: Union[Unset, str] = UNSET,
) -> Optional[VideoSubscriptionDeleteResponseDefault]:
    """Delete a video stream subscription
