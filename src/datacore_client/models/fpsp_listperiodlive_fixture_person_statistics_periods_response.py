...
if TYPE_CHECKING:
    ...
    from ..models.match_person_statistics_periods_model import MatchPersonStatisticsPeriodsModel
    from ..models.response_links import ResponseLinks
    from ..models.response_meta_data import ResponseMetaData


T = TypeVar("T", bound="FpspListperiodliveFixturePersonStatisticsPeriodsResponse")


@_attrs_define
class FpspListperiodliveFixturePersonStatisticsPeriodsResponse:
    """
    Attributes:
        ...
        data (Union[Unset, list['MatchPersonStatisticsPeriodsModel']]):
    """

    meta: Union[Unset, "ResponseMetaData"] = UNSET
    links: Union[Unset, "ResponseLinks"] = UNSET
    included: Union[Unset, "IncludedData"] = UNSET
    data: Union[Unset, list["MatchPersonStatisticsPeriodsModel"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = MatchPersonStatisticsPeriodsModel.from_dict(data_item_data)

            data.append(data_item)

        fpsp_listperiodlive_fixture_person_statistics_periods_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fpsp_listperiodlive_fixture_person_statistics_periods_response.additional_properties = d
        return fpsp_listperiodlive_fixture_person_statistics_periods_response
