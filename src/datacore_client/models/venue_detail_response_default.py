...
T = TypeVar("T", bound="VenueDetailResponseDefault")


@_attrs_define
class VenueDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        venue_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        venue_detail_response_default.additional_properties = d
        return venue_detail_response_default
