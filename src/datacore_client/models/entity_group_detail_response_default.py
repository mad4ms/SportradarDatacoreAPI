...
T = TypeVar("T", bound="EntityGroupDetailResponseDefault")


@_attrs_define
class EntityGroupDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        entity_group_detail_response_default.additional_properties = d
        return entity_group_detail_response_default
