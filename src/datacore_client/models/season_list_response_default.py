...
T = TypeVar("T", bound="SeasonListResponseDefault")


@_attrs_define
class SeasonListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_list_response_default = cls(
            meta=meta,
            error=error,
        )

        season_list_response_default.additional_properties = d
        return season_list_response_default
