...
T = TypeVar("T", bound="ConductDetailConductResponse")


@_attrs_define
class ConductDetailConductResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conduct_detail_conduct_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        conduct_detail_conduct_response.additional_properties = d
        return conduct_detail_conduct_response
