...
T = TypeVar("T", bound="PersonListResponseDefault")


@_attrs_define
class PersonListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_list_response_default = cls(
            meta=meta,
            error=error,
        )

        person_list_response_default.additional_properties = d
        return person_list_response_default
