...
T = TypeVar("T", bound="VideoFileListVideoFilesResponse")


@_attrs_define
class VideoFileListVideoFilesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        video_file_list_video_files_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        video_file_list_video_files_response.additional_properties = d
        return video_file_list_video_files_response
