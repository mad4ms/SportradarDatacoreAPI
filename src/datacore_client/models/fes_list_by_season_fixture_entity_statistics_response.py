...
if TYPE_CHECKING:
    ...
    from ..models.match_team_statistics_model import MatchTeamStatisticsModel
    from ..models.response_links import ResponseLinks
    from ..models.response_meta_data import ResponseMetaData


T = TypeVar("T", bound="FesListBySeasonFixtureEntityStatisticsResponse")


@_attrs_define
class FesListBySeasonFixtureEntityStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = MatchTeamStatisticsModel.from_dict(data_item_data)

            data.append(data_item)

        fes_list_by_season_fixture_entity_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fes_list_by_season_fixture_entity_statistics_response.additional_properties = d
        return fes_list_by_season_fixture_entity_statistics_response
