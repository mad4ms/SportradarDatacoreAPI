...
T = TypeVar("T", bound="SpspListperiodsResponseDefault")


@_attrs_define
class SpspListperiodsResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spsp_listperiods_response_default = cls(
            meta=meta,
            error=error,
        )

        spsp_listperiods_response_default.additional_properties = d
        return spsp_listperiods_response_default
