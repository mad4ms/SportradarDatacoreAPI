...
T = TypeVar("T", bound="SpsListResponseDefault")


@_attrs_define
class SpsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sps_list_response_default = cls(
            meta=meta,
            error=error,
        )

        sps_list_response_default.additional_properties = d
        return sps_list_response_default
