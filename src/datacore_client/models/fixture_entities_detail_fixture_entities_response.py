...
T = TypeVar("T", bound="FixtureEntitiesDetailFixtureEntitiesResponse")


@_attrs_define
class FixtureEntitiesDetailFixtureEntitiesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_entities_detail_fixture_entities_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_entities_detail_fixture_entities_response.additional_properties = d
        return fixture_entities_detail_fixture_entities_response
