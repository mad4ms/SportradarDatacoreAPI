...
T = TypeVar("T", bound="LeaderCriteriaDetailLeaderCriteriaResponse")


@_attrs_define
class LeaderCriteriaDetailLeaderCriteriaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        leader_criteria_detail_leader_criteria_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        leader_criteria_detail_leader_criteria_response.additional_properties = d
        return leader_criteria_detail_leader_criteria_response
