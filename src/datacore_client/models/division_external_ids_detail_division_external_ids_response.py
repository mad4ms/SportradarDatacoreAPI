...
T = TypeVar("T", bound="DivisionExternalIdsDetailDivisionExternalIdsResponse")


@_attrs_define
class DivisionExternalIdsDetailDivisionExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        division_external_ids_detail_division_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        division_external_ids_detail_division_external_ids_response.additional_properties = d
        return division_external_ids_detail_division_external_ids_response
