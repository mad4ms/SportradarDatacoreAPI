...
T = TypeVar("T", bound="SeasonVenuesModelSeasonVenuesAddress")


@_attrs_define
class SeasonVenuesModelSeasonVenuesAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_venues_model_season_venues_address = cls(
            address1=address1,
            address2=address2,
            address3=address3,
            city=city,
        ...
        return season_venues_model_season_venues_address
