...
T = TypeVar("T", bound="TransferDetailTransfersResponse")


@_attrs_define
class TransferDetailTransfersResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfer_detail_transfers_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        transfer_detail_transfers_response.additional_properties = d
        return transfer_detail_transfers_response
