...
T = TypeVar("T", bound="FesListperiodFixtureEntityStatisticsPeriodsResponse")


@_attrs_define
class FesListperiodFixtureEntityStatisticsPeriodsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fes_listperiod_fixture_entity_statistics_periods_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fes_listperiod_fixture_entity_statistics_periods_response.additional_properties = d
        return fes_listperiod_fixture_entity_statistics_periods_response
