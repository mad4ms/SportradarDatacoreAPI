...
if TYPE_CHECKING:
    ...
    from ..models.video_stream_outputs_model import VideoStreamOutputsModel


T = TypeVar("T", bound="VideoStreamOutputsOrggroupListVideoStreamOutputsResponse")


@_attrs_define
class VideoStreamOutputsOrggroupListVideoStreamOutputsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = VideoStreamOutputsModel.from_dict(data_item_data)

            data.append(data_item)

        video_stream_outputs_orggroup_list_video_stream_outputs_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        video_stream_outputs_orggroup_list_video_stream_outputs_response.additional_properties = d
        return video_stream_outputs_orggroup_list_video_stream_outputs_response
