...
if TYPE_CHECKING:
    ...
    from ..models.season_standings_stages_pools_model import SeasonStandingsStagesPoolsModel


T = TypeVar("T", bound="SeasonStandingsStagesPoolsListSeasonStandingsStagesPoolsListResponse")


@_attrs_define
class SeasonStandingsStagesPoolsListSeasonStandingsStagesPoolsListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeasonStandingsStagesPoolsModel.from_dict(data_item_data)

            data.append(data_item)

        season_standings_stages_pools_list_season_standings_stages_pools_list_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_standings_stages_pools_list_season_standings_stages_pools_list_response.additional_properties = d
        return season_standings_stages_pools_list_season_standings_stages_pools_list_response
