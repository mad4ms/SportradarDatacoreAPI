...
T = TypeVar("T", bound="FixtureListResponseDefault")


@_attrs_define
class FixtureListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_list_response_default = cls(
            meta=meta,
            error=error,
        )

        fixture_list_response_default.additional_properties = d
        return fixture_list_response_default
