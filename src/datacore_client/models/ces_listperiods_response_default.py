...
T = TypeVar("T", bound="CesListperiodsResponseDefault")


@_attrs_define
class CesListperiodsResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ces_listperiods_response_default = cls(
            meta=meta,
            error=error,
        )

        ces_listperiods_response_default.additional_properties = d
        return ces_listperiods_response_default
