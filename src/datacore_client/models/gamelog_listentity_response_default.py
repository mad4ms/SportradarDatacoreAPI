...
T = TypeVar("T", bound="GamelogListentityResponseDefault")


@_attrs_define
class GamelogListentityResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gamelog_listentity_response_default = cls(
            meta=meta,
            error=error,
        )

        gamelog_listentity_response_default.additional_properties = d
        return gamelog_listentity_response_default
