...
T = TypeVar("T", bound="CapsListpersonResponseDefault")


@_attrs_define
class CapsListpersonResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        caps_listperson_response_default = cls(
            meta=meta,
            error=error,
        )

        caps_listperson_response_default.additional_properties = d
        return caps_listperson_response_default
