...
if TYPE_CHECKING:
    ...
    from ..models.season_persons_model import SeasonPersonsModel


T = TypeVar("T", bound="SeasonPersonsListSeasonPersonsListResponse")


@_attrs_define
class SeasonPersonsListSeasonPersonsListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeasonPersonsModel.from_dict(data_item_data)

            data.append(data_item)

        season_persons_list_season_persons_list_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_persons_list_season_persons_list_response.additional_properties = d
        return season_persons_list_season_persons_list_response
