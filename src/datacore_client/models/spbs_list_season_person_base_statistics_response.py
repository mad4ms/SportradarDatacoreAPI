...
if TYPE_CHECKING:
    ...
    from ..models.season_person_base_statistics_model import SeasonPersonBaseStatisticsModel


T = TypeVar("T", bound="SpbsListSeasonPersonBaseStatisticsResponse")


@_attrs_define
class SpbsListSeasonPersonBaseStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spbs_list_season_person_base_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        spbs_list_season_person_base_statistics_response.additional_properties = d
        return spbs_list_season_person_base_statistics_response
