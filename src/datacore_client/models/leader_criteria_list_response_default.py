...
T = TypeVar("T", bound="LeaderCriteriaListResponseDefault")


@_attrs_define
class LeaderCriteriaListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        leader_criteria_list_response_default = cls(
            meta=meta,
            error=error,
        )

        leader_criteria_list_response_default.additional_properties = d
        return leader_criteria_list_response_default
