...
T = TypeVar("T", bound="SeasonVenuesListResponseDefault")


@_attrs_define
class SeasonVenuesListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_venues_list_response_default = cls(
            meta=meta,
            error=error,
        )

        season_venues_list_response_default.additional_properties = d
        return season_venues_list_response_default
