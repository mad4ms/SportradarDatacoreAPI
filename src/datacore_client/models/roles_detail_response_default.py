...
T = TypeVar("T", bound="RolesDetailResponseDefault")


@_attrs_define
class RolesDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roles_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        roles_detail_response_default.additional_properties = d
        return roles_detail_response_default
