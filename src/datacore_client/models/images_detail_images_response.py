...
T = TypeVar("T", bound="ImagesDetailImagesResponse")


@_attrs_define
class ImagesDetailImagesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_detail_images_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        images_detail_images_response.additional_properties = d
        return images_detail_images_response
