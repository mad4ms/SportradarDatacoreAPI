...
T = TypeVar("T", bound="ConferenceDetailResponseDefault")


@_attrs_define
class ConferenceDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conference_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        conference_detail_response_default.additional_properties = d
        return conference_detail_response_default
