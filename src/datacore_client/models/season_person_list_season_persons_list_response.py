...
T = TypeVar("T", bound="SeasonPersonListSeasonPersonsListResponse")


@_attrs_define
class SeasonPersonListSeasonPersonsListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_person_list_season_persons_list_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_person_list_season_persons_list_response.additional_properties = d
        return season_person_list_season_persons_list_response
