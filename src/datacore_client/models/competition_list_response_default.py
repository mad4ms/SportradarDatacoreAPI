...
T = TypeVar("T", bound="CompetitionListResponseDefault")


@_attrs_define
class CompetitionListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_list_response_default = cls(
            meta=meta,
            error=error,
        )

        competition_list_response_default.additional_properties = d
        return competition_list_response_default
