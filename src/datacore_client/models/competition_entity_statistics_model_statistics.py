...
T = TypeVar("T", bound="CompetitionEntityStatisticsModelStatistics")


@_attrs_define
class CompetitionEntityStatisticsModelStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_entity_statistics_model_statistics = cls(
            assists=assists,
        ...
        return competition_entity_statistics_model_statistics
