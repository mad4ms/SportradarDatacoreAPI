...
T = TypeVar("T", bound="EntityDetailResponseDefault")


@_attrs_define
class EntityDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        entity_detail_response_default.additional_properties = d
        return entity_detail_response_default
