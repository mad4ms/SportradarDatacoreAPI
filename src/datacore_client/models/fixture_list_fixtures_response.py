...
T = TypeVar("T", bound="FixtureListFixturesResponse")


@_attrs_define
class FixtureListFixturesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_list_fixtures_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_list_fixtures_response.additional_properties = d
        return fixture_list_fixtures_response
