...
T = TypeVar("T", bound="SppDetailResponseDefault")


@_attrs_define
class SppDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spp_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        spp_detail_response_default.additional_properties = d
        return spp_detail_response_default
