...
T = TypeVar("T", bound="SeasonPoolDetailResponseDefault")


@_attrs_define
class SeasonPoolDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_pool_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        season_pool_detail_response_default.additional_properties = d
        return season_pool_detail_response_default
