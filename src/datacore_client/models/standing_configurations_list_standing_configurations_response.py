...
T = TypeVar("T", bound="StandingConfigurationsListStandingConfigurationsResponse")


@_attrs_define
class StandingConfigurationsListStandingConfigurationsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_configurations_list_standing_configurations_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_configurations_list_standing_configurations_response.additional_properties = d
        return standing_configurations_list_standing_configurations_response
