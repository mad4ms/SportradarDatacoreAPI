...
T = TypeVar("T", bound="SeasonDetailSeasonsResponse")


@_attrs_define
class SeasonDetailSeasonsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_detail_seasons_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_detail_seasons_response.additional_properties = d
        return season_detail_seasons_response
