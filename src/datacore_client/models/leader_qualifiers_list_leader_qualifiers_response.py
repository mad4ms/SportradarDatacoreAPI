...
T = TypeVar("T", bound="LeaderQualifiersListLeaderQualifiersResponse")


@_attrs_define
class LeaderQualifiersListLeaderQualifiersResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        leader_qualifiers_list_leader_qualifiers_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        leader_qualifiers_list_leader_qualifiers_response.additional_properties = d
        return leader_qualifiers_list_leader_qualifiers_response
