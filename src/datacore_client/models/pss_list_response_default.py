...
T = TypeVar("T", bound="PssListResponseDefault")


@_attrs_define
class PssListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pss_list_response_default = cls(
            meta=meta,
            error=error,
        )

        pss_list_response_default.additional_properties = d
        return pss_list_response_default
