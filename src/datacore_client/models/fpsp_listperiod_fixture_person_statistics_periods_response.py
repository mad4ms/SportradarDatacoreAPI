...
T = TypeVar("T", bound="FpspListperiodFixturePersonStatisticsPeriodsResponse")


@_attrs_define
class FpspListperiodFixturePersonStatisticsPeriodsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fpsp_listperiod_fixture_person_statistics_periods_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fpsp_listperiod_fixture_person_statistics_periods_response.additional_properties = d
        return fpsp_listperiod_fixture_person_statistics_periods_response
