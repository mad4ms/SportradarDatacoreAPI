...
T = TypeVar("T", bound="UniformsDetailResponseDefault")


@_attrs_define
class UniformsDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniforms_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        uniforms_detail_response_default.additional_properties = d
        return uniforms_detail_response_default
