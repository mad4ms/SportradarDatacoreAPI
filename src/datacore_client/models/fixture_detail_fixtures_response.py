...
T = TypeVar("T", bound="FixtureDetailFixturesResponse")


@_attrs_define
class FixtureDetailFixturesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_detail_fixtures_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_detail_fixtures_response.additional_properties = d
        return fixture_detail_fixtures_response
