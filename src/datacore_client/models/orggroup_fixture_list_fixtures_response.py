...
T = TypeVar("T", bound="OrggroupFixtureListFixturesResponse")


@_attrs_define
class OrggroupFixtureListFixturesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orggroup_fixture_list_fixtures_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        orggroup_fixture_list_fixtures_response.additional_properties = d
        return orggroup_fixture_list_fixtures_response
