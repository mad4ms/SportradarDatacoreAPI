...
T = TypeVar("T", bound="PartnersGetResponseDefault")


@_attrs_define
class PartnersGetResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        partners_get_response_default = cls(
            meta=meta,
            error=error,
        )

        partners_get_response_default.additional_properties = d
        return partners_get_response_default
