...
T = TypeVar("T", bound="ConductListResponseDefault")


@_attrs_define
class ConductListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conduct_list_response_default = cls(
            meta=meta,
            error=error,
        )

        conduct_list_response_default.additional_properties = d
        return conduct_list_response_default
