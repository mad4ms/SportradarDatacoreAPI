...
T = TypeVar("T", bound="UniformsListUniformsResponse")


@_attrs_define
class UniformsListUniformsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniforms_list_uniforms_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        uniforms_list_uniforms_response.additional_properties = d
        return uniforms_list_uniforms_response
