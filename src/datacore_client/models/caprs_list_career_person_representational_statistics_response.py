...
if TYPE_CHECKING:
    from ..models.career_person_representational_statistics_model import CareerPersonRepresentationalStatisticsModel
...
T = TypeVar("T", bound="CaprsListCareerPersonRepresentationalStatisticsResponse")


@_attrs_define
class CaprsListCareerPersonRepresentationalStatisticsResponse:
    """
    Attributes:
        ...
        data (Union[Unset, list['CareerPersonRepresentationalStatisticsModel']]):
    """

    meta: Union[Unset, "ResponseMetaData"] = UNSET
    links: Union[Unset, "ResponseLinks"] = UNSET
    included: Union[Unset, "IncludedData"] = UNSET
    data: Union[Unset, list["CareerPersonRepresentationalStatisticsModel"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = CareerPersonRepresentationalStatisticsModel.from_dict(data_item_data)

            data.append(data_item)

        caprs_list_career_person_representational_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        caprs_list_career_person_representational_statistics_response.additional_properties = d
        return caprs_list_career_person_representational_statistics_response
