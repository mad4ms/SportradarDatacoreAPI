...
T = TypeVar("T", bound="SeasonDetailResponseDefault")


@_attrs_define
class SeasonDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        season_detail_response_default.additional_properties = d
        return season_detail_response_default
