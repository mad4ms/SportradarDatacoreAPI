...
T = TypeVar("T", bound="SlListSummaryResponseDefault")


@_attrs_define
class SlListSummaryResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sl_list_summary_response_default = cls(
            meta=meta,
            error=error,
        )

        sl_list_summary_response_default.additional_properties = d
        return sl_list_summary_response_default
