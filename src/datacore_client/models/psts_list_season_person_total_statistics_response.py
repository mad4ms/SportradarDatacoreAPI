...
T = TypeVar("T", bound="PstsListSeasonPersonTotalStatisticsResponse")


@_attrs_define
class PstsListSeasonPersonTotalStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        psts_list_season_person_total_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        psts_list_season_person_total_statistics_response.additional_properties = d
        return psts_list_season_person_total_statistics_response
