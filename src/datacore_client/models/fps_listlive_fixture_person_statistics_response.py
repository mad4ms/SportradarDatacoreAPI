...
T = TypeVar("T", bound="FpsListliveFixturePersonStatisticsResponse")


@_attrs_define
class FpsListliveFixturePersonStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fps_listlive_fixture_person_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fps_listlive_fixture_person_statistics_response.additional_properties = d
        return fps_listlive_fixture_person_statistics_response
