...
T = TypeVar("T", bound="SepDetailSeasonEntityPlacingsResponse")


@_attrs_define
class SepDetailSeasonEntityPlacingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sep_detail_season_entity_placings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        sep_detail_season_entity_placings_response.additional_properties = d
        return sep_detail_season_entity_placings_response
