...
T = TypeVar("T", bound="SepListSeasonEntityPlacingsResponse")


@_attrs_define
class SepListSeasonEntityPlacingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sep_list_season_entity_placings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        sep_list_season_entity_placings_response.additional_properties = d
        return sep_list_season_entity_placings_response
