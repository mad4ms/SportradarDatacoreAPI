...
T = TypeVar("T", bound="CaprsListResponseDefault")


@_attrs_define
class CaprsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        caprs_list_response_default = cls(
            meta=meta,
            error=error,
        )

        caprs_list_response_default.additional_properties = d
        return caprs_list_response_default
