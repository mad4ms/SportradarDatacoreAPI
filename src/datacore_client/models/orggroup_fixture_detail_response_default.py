...
T = TypeVar("T", bound="OrggroupFixtureDetailResponseDefault")


@_attrs_define
class OrggroupFixtureDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orggroup_fixture_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        orggroup_fixture_detail_response_default.additional_properties = d
        return orggroup_fixture_detail_response_default
