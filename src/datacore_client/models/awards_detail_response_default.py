...
T = TypeVar("T", bound="AwardsDetailResponseDefault")


@_attrs_define
class AwardsDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        awards_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        awards_detail_response_default.additional_properties = d
        return awards_detail_response_default
