...
T = TypeVar("T", bound="DivisionDetailDivisionsResponse")


@_attrs_define
class DivisionDetailDivisionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        division_detail_divisions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        division_detail_divisions_response.additional_properties = d
        return division_detail_divisions_response
