...
T = TypeVar("T", bound="FixturePbpListLiveFixturePbpEventResponse")


@_attrs_define
class FixturePbpListLiveFixturePbpEventResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_pbp_list_live_fixture_pbp_event_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_pbp_list_live_fixture_pbp_event_response.additional_properties = d
        return fixture_pbp_list_live_fixture_pbp_event_response
