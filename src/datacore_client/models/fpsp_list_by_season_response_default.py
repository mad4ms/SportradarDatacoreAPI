...
T = TypeVar("T", bound="FpspListBySeasonResponseDefault")


@_attrs_define
class FpspListBySeasonResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fpsp_list_by_season_response_default = cls(
            meta=meta,
            error=error,
        )

        fpsp_list_by_season_response_default.additional_properties = d
        return fpsp_list_by_season_response_default
