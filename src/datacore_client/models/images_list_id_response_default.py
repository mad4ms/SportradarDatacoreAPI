...
T = TypeVar("T", bound="ImagesListIdResponseDefault")


@_attrs_define
class ImagesListIdResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_list_id_response_default = cls(
            meta=meta,
            error=error,
        )

        images_list_id_response_default.additional_properties = d
        return images_list_id_response_default
