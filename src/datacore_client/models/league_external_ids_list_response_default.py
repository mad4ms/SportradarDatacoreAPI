...
T = TypeVar("T", bound="LeagueExternalIdsListResponseDefault")


@_attrs_define
class LeagueExternalIdsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        league_external_ids_list_response_default = cls(
            meta=meta,
            error=error,
        )

        league_external_ids_list_response_default.additional_properties = d
        return league_external_ids_list_response_default
