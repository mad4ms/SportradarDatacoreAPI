...
T = TypeVar("T", bound="CesListResponseDefault")


@_attrs_define
class CesListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ces_list_response_default = cls(
            meta=meta,
            error=error,
        )

        ces_list_response_default.additional_properties = d
        return ces_list_response_default
