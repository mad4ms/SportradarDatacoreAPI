...
T = TypeVar("T", bound="RolesListNonFixturesResponseDefault")


@_attrs_define
class RolesListNonFixturesResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roles_list_non_fixtures_response_default = cls(
            meta=meta,
            error=error,
        )

        roles_list_non_fixtures_response_default.additional_properties = d
        return roles_list_non_fixtures_response_default
