...
T = TypeVar("T", bound="CesListCompetitionEntityStatisticsResponse")


@_attrs_define
class CesListCompetitionEntityStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ces_list_competition_entity_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        ces_list_competition_entity_statistics_response.additional_properties = d
        return ces_list_competition_entity_statistics_response
