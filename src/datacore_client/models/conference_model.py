...
if TYPE_CHECKING:
    from ..models.conference_model_organization import ConferenceModelOrganization
    from ..models.conference_model_social_media import ConferenceModelSocialMedia
    from ..models.images_model import ImagesModel


T = TypeVar("T", bound="ConferenceModel")
...
class ConferenceModel:
    ...
    Attributes:
        ...
        organization (Union[Unset, ConferenceModelOrganization]): The organization that this conference belongs to
        ...
        social (Union['ConferenceModelSocialMedia', None, Unset]): Social Media contacts
    ...
    organization: Union[Unset, "ConferenceModelOrganization"] = UNSET
    ...
    social: Union["ConferenceModelSocialMedia", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.social, Unset):
            social = UNSET
        elif isinstance(self.social, ConferenceModelSocialMedia):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization: Union[Unset, ConferenceModelOrganization]
        if isinstance(_organization, Unset):
            organization = UNSET
        else:
            organization = ConferenceModelOrganization.from_dict(_organization)
        ...
        def _parse_social(data: object) -> Union["ConferenceModelSocialMedia", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                social_type_0 = ConferenceModelSocialMedia.from_dict(data)

                return social_type_0
            except:  # noqa: E722
                pass
            return cast(Union["ConferenceModelSocialMedia", None, Unset], data)
