...
T = TypeVar("T", bound="EntityGroupListEntityGroupsResponse")


@_attrs_define
class EntityGroupListEntityGroupsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_list_entity_groups_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_group_list_entity_groups_response.additional_properties = d
        return entity_group_list_entity_groups_response
