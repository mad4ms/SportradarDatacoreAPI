...
T = TypeVar("T", bound="SppDetailSeasonPersonPlacingsResponse")


@_attrs_define
class SppDetailSeasonPersonPlacingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spp_detail_season_person_placings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        spp_detail_season_person_placings_response.additional_properties = d
        return spp_detail_season_person_placings_response
