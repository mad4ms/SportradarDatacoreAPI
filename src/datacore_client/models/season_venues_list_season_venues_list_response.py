...
if TYPE_CHECKING:
    ...
    from ..models.season_venues_model import SeasonVenuesModel


T = TypeVar("T", bound="SeasonVenuesListSeasonVenuesListResponse")


@_attrs_define
class SeasonVenuesListSeasonVenuesListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeasonVenuesModel.from_dict(data_item_data)

            data.append(data_item)

        season_venues_list_season_venues_list_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_venues_list_season_venues_list_response.additional_properties = d
        return season_venues_list_season_venues_list_response
