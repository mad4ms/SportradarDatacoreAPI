...
T = TypeVar("T", bound="FixturePbpExportSuccessResponse")


@_attrs_define
class FixturePbpExportSuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_pbp_export_success_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_pbp_export_success_response.additional_properties = d
        return fixture_pbp_export_success_response
