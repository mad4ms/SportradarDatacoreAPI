...
if TYPE_CHECKING:
    ...
    from ..models.season_entities_model import SeasonEntitiesModel


T = TypeVar("T", bound="SeasonEntityListByMultipleSeasonsSeasonEntitiesListResponse")


@_attrs_define
class SeasonEntityListByMultipleSeasonsSeasonEntitiesListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeasonEntitiesModel.from_dict(data_item_data)

            data.append(data_item)

        season_entity_list_by_multiple_seasons_season_entities_list_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        season_entity_list_by_multiple_seasons_season_entities_list_response.additional_properties = d
        return season_entity_list_by_multiple_seasons_season_entities_list_response
