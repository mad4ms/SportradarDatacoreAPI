...
if TYPE_CHECKING:
    ...
    from ..models.standing_configurations_model import StandingConfigurationsModel


T = TypeVar("T", bound="StandingConfigurationsDetailStandingConfigurationsResponse")


@_attrs_define
class StandingConfigurationsDetailStandingConfigurationsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = StandingConfigurationsModel.from_dict(data_item_data)

            data.append(data_item)

        standing_configurations_detail_standing_configurations_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_configurations_detail_standing_configurations_response.additional_properties = d
        return standing_configurations_detail_standing_configurations_response
