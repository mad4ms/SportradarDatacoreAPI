...
T = TypeVar("T", bound="UniformItemsBySeasonListUniformItemsResponse")


@_attrs_define
class UniformItemsBySeasonListUniformItemsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniform_items_by_season_list_uniform_items_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        uniform_items_by_season_list_uniform_items_response.additional_properties = d
        return uniform_items_by_season_list_uniform_items_response
