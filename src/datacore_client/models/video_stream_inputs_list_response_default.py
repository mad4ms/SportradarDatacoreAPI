...
T = TypeVar("T", bound="VideoStreamInputsListResponseDefault")


@_attrs_define
class VideoStreamInputsListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        video_stream_inputs_list_response_default = cls(
            meta=meta,
            error=error,
        )

        video_stream_inputs_list_response_default.additional_properties = d
        return video_stream_inputs_list_response_default
