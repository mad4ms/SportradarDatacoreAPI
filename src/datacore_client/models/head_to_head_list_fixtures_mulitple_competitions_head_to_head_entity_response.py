...
if TYPE_CHECKING:
    from ..models.head_to_head_entity_model import HeadToHeadEntityModel
...
T = TypeVar("T", bound="HeadToHeadListFixturesMulitpleCompetitionsHeadToHeadEntityResponse")


@_attrs_define
class HeadToHeadListFixturesMulitpleCompetitionsHeadToHeadEntityResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = HeadToHeadEntityModel.from_dict(data_item_data)

            data.append(data_item)

        head_to_head_list_fixtures_mulitple_competitions_head_to_head_entity_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        head_to_head_list_fixtures_mulitple_competitions_head_to_head_entity_response.additional_properties = d
        return head_to_head_list_fixtures_mulitple_competitions_head_to_head_entity_response
