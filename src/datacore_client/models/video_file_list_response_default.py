...
T = TypeVar("T", bound="VideoFileListResponseDefault")


@_attrs_define
class VideoFileListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        video_file_list_response_default = cls(
            meta=meta,
            error=error,
        )

        video_file_list_response_default.additional_properties = d
        return video_file_list_response_default
