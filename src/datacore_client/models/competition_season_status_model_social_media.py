...
T = TypeVar("T", bound="CompetitionSeasonStatusModelSocialMedia")


@_attrs_define
class CompetitionSeasonStatusModelSocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_season_status_model_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return competition_season_status_model_social_media
