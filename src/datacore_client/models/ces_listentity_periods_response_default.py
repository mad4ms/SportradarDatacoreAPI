...
T = TypeVar("T", bound="CesListentityPeriodsResponseDefault")


@_attrs_define
class CesListentityPeriodsResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ces_listentity_periods_response_default = cls(
            meta=meta,
            error=error,
        )

        ces_listentity_periods_response_default.additional_properties = d
        return ces_listentity_periods_response_default
