...
T = TypeVar("T", bound="ImagesDetailResponseDefault")


@_attrs_define
class ImagesDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        images_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        images_detail_response_default.additional_properties = d
        return images_detail_response_default
