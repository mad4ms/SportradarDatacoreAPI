...
T = TypeVar("T", bound="SeasonEntityListResponseDefault")


@_attrs_define
class SeasonEntityListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_entity_list_response_default = cls(
            meta=meta,
            error=error,
        )

        season_entity_list_response_default.additional_properties = d
        return season_entity_list_response_default
