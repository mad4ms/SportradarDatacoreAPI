...
T = TypeVar("T", bound="AwardsDetailAwardsResponse")


@_attrs_define
class AwardsDetailAwardsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        awards_detail_awards_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        awards_detail_awards_response.additional_properties = d
        return awards_detail_awards_response
