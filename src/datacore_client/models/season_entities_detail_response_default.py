...
T = TypeVar("T", bound="SeasonEntitiesDetailResponseDefault")


@_attrs_define
class SeasonEntitiesDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_entities_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        season_entities_detail_response_default.additional_properties = d
        return season_entities_detail_response_default
