...
T = TypeVar("T", bound="CompetitionListByLeagueIdCompetitionsResponse")


@_attrs_define
class CompetitionListByLeagueIdCompetitionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = CompetitionModel.from_dict(data_item_data)

            data.append(data_item)

        competition_list_by_league_id_competitions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        competition_list_by_league_id_competitions_response.additional_properties = d
        return competition_list_by_league_id_competitions_response
