...
if TYPE_CHECKING:
    ...
    from ..models.video_stream_inputs_model import VideoStreamInputsModel


T = TypeVar("T", bound="VideoStreamInputsFixtureListVideoStreamInputsResponse")


@_attrs_define
class VideoStreamInputsFixtureListVideoStreamInputsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = VideoStreamInputsModel.from_dict(data_item_data)

            data.append(data_item)

        video_stream_inputs_fixture_list_video_stream_inputs_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        video_stream_inputs_fixture_list_video_stream_inputs_response.additional_properties = d
        return video_stream_inputs_fixture_list_video_stream_inputs_response
