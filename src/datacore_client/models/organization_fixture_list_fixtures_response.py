...
T = TypeVar("T", bound="OrganizationFixtureListFixturesResponse")


@_attrs_define
class OrganizationFixtureListFixturesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = MatchModel.from_dict(data_item_data)

            data.append(data_item)

        organization_fixture_list_fixtures_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        organization_fixture_list_fixtures_response.additional_properties = d
        return organization_fixture_list_fixtures_response
