...
if TYPE_CHECKING:
    ...
    from ..models.standing_progressions_model import StandingProgressionsModel


T = TypeVar("T", bound="StandingProgressionsDetailStandingProgressionsResponse")


@_attrs_define
class StandingProgressionsDetailStandingProgressionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = StandingProgressionsModel.from_dict(data_item_data)

            data.append(data_item)

        standing_progressions_detail_standing_progressions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_progressions_detail_standing_progressions_response.additional_properties = d
        return standing_progressions_detail_standing_progressions_response
