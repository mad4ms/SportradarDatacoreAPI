...
T = TypeVar("T", bound="SeasonPersonListResponseDefault")


@_attrs_define
class SeasonPersonListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_person_list_response_default = cls(
            meta=meta,
            error=error,
        )

        season_person_list_response_default.additional_properties = d
        return season_person_list_response_default
