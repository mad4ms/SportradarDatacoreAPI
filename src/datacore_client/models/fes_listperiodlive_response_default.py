...
T = TypeVar("T", bound="FesListperiodliveResponseDefault")


@_attrs_define
class FesListperiodliveResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fes_listperiodlive_response_default = cls(
            meta=meta,
            error=error,
        )

        fes_listperiodlive_response_default.additional_properties = d
        return fes_listperiodlive_response_default
