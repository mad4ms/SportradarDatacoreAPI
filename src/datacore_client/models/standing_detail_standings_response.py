...
T = TypeVar("T", bound="StandingDetailStandingsResponse")


@_attrs_define
class StandingDetailStandingsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_detail_standings_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_detail_standings_response.additional_properties = d
        return standing_detail_standings_response
