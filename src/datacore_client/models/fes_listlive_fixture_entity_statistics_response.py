...
T = TypeVar("T", bound="FesListliveFixtureEntityStatisticsResponse")


@_attrs_define
class FesListliveFixtureEntityStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fes_listlive_fixture_entity_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fes_listlive_fixture_entity_statistics_response.additional_properties = d
        return fes_listlive_fixture_entity_statistics_response
