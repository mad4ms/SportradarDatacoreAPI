...
from ..models.fixture_pbp_model_period_id import FixturePbpModelPeriodId
...
T = TypeVar("T", bound="FixturePbpModel")


@_attrs_define
class FixturePbpModel:
    """
    Attributes:
        organization_id (Union[Unset, str]): The unique identifier of the organization Example: 9.
        organization (Union[Unset, FixturePbpModelOrganization]): The organization that this fixture_pbp belongs to
        fixture_id (Union[Unset, UUID]): The unique identifier of the match Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        fixture (Union[Unset, FixturePbpModelFixture]): The match
        period_id (Union[Unset, FixturePbpModelPeriodId]): The identifier for the period
            >- `1` Period 1
            >- `2` Period 2
    ...
    organization: Union[Unset, "FixturePbpModelOrganization"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization: Union[Unset, FixturePbpModelOrganization]
        if isinstance(_organization, Unset):
            organization = UNSET
        else:
            organization = FixturePbpModelOrganization.from_dict(_organization)
        ...
        fixture: Union[Unset, FixturePbpModelFixture]
        if isinstance(_fixture, Unset):
            fixture = UNSET
        else:
            fixture = FixturePbpModelFixture.from_dict(_fixture)

        _period_id = d.pop("periodId", UNSET)
        period_id: Union[Unset, FixturePbpModelPeriodId]
        if isinstance(_period_id, Unset):
            period_id = UNSET
        else:
            period_id = FixturePbpModelPeriodId(_period_id)

        section = d.pop("section", UNSET)

        def _parse_events(data: object) -> Union["FixturePbpModelEventDetails", None, Unset]:
            if data is None:
                return data
