...
T = TypeVar("T", bound="CesListperiodsCompetitionEntityStatisticsResponse")


@_attrs_define
class CesListperiodsCompetitionEntityStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ces_listperiods_competition_entity_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        ces_listperiods_competition_entity_statistics_response.additional_properties = d
        return ces_listperiods_competition_entity_statistics_response
