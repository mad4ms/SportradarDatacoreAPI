...
T = TypeVar("T", bound="EntityDetailEntitiesResponse")


@_attrs_define
class EntityDetailEntitiesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_detail_entities_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_detail_entities_response.additional_properties = d
        return entity_detail_entities_response
