...
T = TypeVar("T", bound="SeasonPersonTotalStatisticsModelStatistics")


@_attrs_define
class SeasonPersonTotalStatisticsModelStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_person_total_statistics_model_statistics = cls(
        ...
        return season_person_total_statistics_model_statistics
