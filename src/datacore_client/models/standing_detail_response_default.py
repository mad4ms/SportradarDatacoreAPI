...
T = TypeVar("T", bound="StandingDetailResponseDefault")


@_attrs_define
class StandingDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        standing_detail_response_default.additional_properties = d
        return standing_detail_response_default
