...
T = TypeVar("T", bound="UniformsDetailUniformsResponse")


@_attrs_define
class UniformsDetailUniformsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniforms_detail_uniforms_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        uniforms_detail_uniforms_response.additional_properties = d
        return uniforms_detail_uniforms_response
