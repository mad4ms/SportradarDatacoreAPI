...
T = TypeVar("T", bound="SeasonVenuesModelSocialMedia")


@_attrs_define
class SeasonVenuesModelSocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_venues_model_social_media = cls(
            website=website,
            facebook=facebook,
            twitter=twitter,
            wikipedia=wikipedia,
        ...
        return season_venues_model_social_media
