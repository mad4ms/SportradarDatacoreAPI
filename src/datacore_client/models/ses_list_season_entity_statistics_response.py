...
T = TypeVar("T", bound="SesListSeasonEntityStatisticsResponse")


@_attrs_define
class SesListSeasonEntityStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ses_list_season_entity_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        ses_list_season_entity_statistics_response.additional_properties = d
        return ses_list_season_entity_statistics_response
