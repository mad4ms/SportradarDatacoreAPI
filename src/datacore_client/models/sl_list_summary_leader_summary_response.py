...
if TYPE_CHECKING:
    ...
    from ..models.season_leader_summary_model import SeasonLeaderSummaryModel


T = TypeVar("T", bound="SlListSummaryLeaderSummaryResponse")


@_attrs_define
class SlListSummaryLeaderSummaryResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeasonLeaderSummaryModel.from_dict(data_item_data)

            data.append(data_item)

        sl_list_summary_leader_summary_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        sl_list_summary_leader_summary_response.additional_properties = d
        return sl_list_summary_leader_summary_response
