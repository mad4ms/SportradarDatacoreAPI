...
T = TypeVar("T", bound="VenueListBySiteIdVenuesResponse")


@_attrs_define
class VenueListBySiteIdVenuesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = VenueModel.from_dict(data_item_data)

            data.append(data_item)

        venue_list_by_site_id_venues_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        venue_list_by_site_id_venues_response.additional_properties = d
        return venue_list_by_site_id_venues_response
