...
T = TypeVar("T", bound="RolesListByFixtureResponseDefault")


@_attrs_define
class RolesListByFixtureResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roles_list_by_fixture_response_default = cls(
            meta=meta,
            error=error,
        )

        roles_list_by_fixture_response_default.additional_properties = d
        return roles_list_by_fixture_response_default
