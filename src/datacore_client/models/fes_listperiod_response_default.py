...
T = TypeVar("T", bound="FesListperiodResponseDefault")


@_attrs_define
class FesListperiodResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fes_listperiod_response_default = cls(
            meta=meta,
            error=error,
        )

        fes_listperiod_response_default.additional_properties = d
        return fes_listperiod_response_default
