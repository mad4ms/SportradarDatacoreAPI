...
T = TypeVar("T", bound="GameLogPersonModelStatistics")


@_attrs_define
class GameLogPersonModelStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        game_log_person_model_statistics = cls(
        ...
        return game_log_person_model_statistics
