...
T = TypeVar("T", bound="RolesListFixturesRolesResponse")


@_attrs_define
class RolesListFixturesRolesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        roles_list_fixtures_roles_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        roles_list_fixtures_roles_response.additional_properties = d
        return roles_list_fixtures_roles_response
