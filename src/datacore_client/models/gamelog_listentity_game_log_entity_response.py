...
if TYPE_CHECKING:
    from ..models.game_log_entity_model import GameLogEntityModel
...
T = TypeVar("T", bound="GamelogListentityGameLogEntityResponse")


@_attrs_define
class GamelogListentityGameLogEntityResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = GameLogEntityModel.from_dict(data_item_data)

            data.append(data_item)

        gamelog_listentity_game_log_entity_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        gamelog_listentity_game_log_entity_response.additional_properties = d
        return gamelog_listentity_game_log_entity_response
