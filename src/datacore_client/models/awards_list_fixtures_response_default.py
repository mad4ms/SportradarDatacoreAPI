...
T = TypeVar("T", bound="AwardsListFixturesResponseDefault")


@_attrs_define
class AwardsListFixturesResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        awards_list_fixtures_response_default = cls(
            meta=meta,
            error=error,
        )

        awards_list_fixtures_response_default.additional_properties = d
        return awards_list_fixtures_response_default
