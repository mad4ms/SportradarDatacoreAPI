...
T = TypeVar("T", bound="StandingAdjustmentsListStandingAdjustmentsResponse")


@_attrs_define
class StandingAdjustmentsListStandingAdjustmentsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_adjustments_list_standing_adjustments_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        standing_adjustments_list_standing_adjustments_response.additional_properties = d
        return standing_adjustments_list_standing_adjustments_response
