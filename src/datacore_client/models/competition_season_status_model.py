...
from ..models.competition_season_status_model_age_group_type_1 import CompetitionSeasonStatusModelAgeGroupType1
from ..models.competition_season_status_model_age_group_type_2_type_1 import (
    CompetitionSeasonStatusModelAgeGroupType2Type1,
)
from ..models.competition_season_status_model_age_group_type_3_type_1 import (
    CompetitionSeasonStatusModelAgeGroupType3Type1,
)
from ..models.competition_season_status_model_event_type import CompetitionSeasonStatusModelEventType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.competition_season_status_model_competition_historical_name import (
        CompetitionSeasonStatusModelCompetitionHistoricalName,
    )
    from ..models.competition_season_status_model_league import CompetitionSeasonStatusModelLeague
    from ..models.competition_season_status_model_organization import CompetitionSeasonStatusModelOrganization
    from ..models.competition_season_status_model_social_media import CompetitionSeasonStatusModelSocialMedia
    from ..models.images_model import ImagesModel


T = TypeVar("T", bound="CompetitionSeasonStatusModel")


@_attrs_define
class CompetitionSeasonStatusModel:
    """
    Attributes:
        competition_id (Union[Unset, UUID]): The unique identifier of the competition Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        organization_id (Union[Unset, str]): The unique identifier of the organization Example: 9.
        organization (Union[Unset, CompetitionSeasonStatusModelOrganization]): The organization that this competition
            season status belongs to
        league_id (Union[Unset, UUID]): The unique identifier of the league Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        league (Union[Unset, CompetitionSeasonStatusModelLeague]): The league that this competition season status
            belongs to
        international_reference (Union[None, Unset, str]): The international reference for this competition season
            status given by the sport governing body Example: CA3243-3.
        ...
        name_local (Union[Unset, str]): The name of the competition season status in the
            [local](#section/Introduction/Character-Sets-and-Names) language Example: Test name local.
        event_type (Union[Unset, CompetitionSeasonStatusModelEventType]): Primary Type of Matches
            >- `FIXTURE` Fixture
            >- `PRACTICE` Practice
             Default: CompetitionSeasonStatusModelEventType.FIXTURE. Example: FIXTURE.
        ...
        name_latin (Union[None, Unset, str]): The name of the competition season status in
            [latin](#section/Introduction/Character-Sets-and-Names) characters Example: Test name latin .
        social (Union['CompetitionSeasonStatusModelSocialMedia', None, Unset]): Social Media contacts
        external_id (Union[None, Unset, str]): The Id of the data as set by the provider of the data Example: A123.
        historical_names (Union[None, Unset, list['CompetitionSeasonStatusModelCompetitionHistoricalName']]): Array of
            competition historical names
        ...
        age_group (Union[CompetitionSeasonStatusModelAgeGroupType1, CompetitionSeasonStatusModelAgeGroupType2Type1,
            CompetitionSeasonStatusModelAgeGroupType3Type1, None, Unset]): The age group of the competition
            >- None None
            >- `JUNIOR` Junior
            >- `MASTERS` Masters
            >- `SENIOR` Senior
    ...
    organization: Union[Unset, "CompetitionSeasonStatusModelOrganization"] = UNSET
    league_id: Union[Unset, UUID] = UNSET
    league: Union[Unset, "CompetitionSeasonStatusModelLeague"] = UNSET
    ...
    event_type: Union[Unset, CompetitionSeasonStatusModelEventType] = CompetitionSeasonStatusModelEventType.FIXTURE
    abbreviation_latin: Union[None, Unset, str] = UNSET
    name_latin: Union[None, Unset, str] = UNSET
    social: Union["CompetitionSeasonStatusModelSocialMedia", None, Unset] = UNSET
    external_id: Union[None, Unset, str] = UNSET
    historical_names: Union[None, Unset, list["CompetitionSeasonStatusModelCompetitionHistoricalName"]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.social, Unset):
            social = UNSET
        elif isinstance(self.social, CompetitionSeasonStatusModelSocialMedia):
        ...
        if isinstance(self.age_group, Unset):
            age_group = UNSET
        elif isinstance(self.age_group, CompetitionSeasonStatusModelAgeGroupType1):
            age_group = self.age_group.value
        elif isinstance(self.age_group, CompetitionSeasonStatusModelAgeGroupType2Type1):
            age_group = self.age_group.value
        elif isinstance(self.age_group, CompetitionSeasonStatusModelAgeGroupType3Type1):
            age_group = self.age_group.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization: Union[Unset, CompetitionSeasonStatusModelOrganization]
        if isinstance(_organization, Unset):
            organization = UNSET
        else:
            organization = CompetitionSeasonStatusModelOrganization.from_dict(_organization)
        ...
        league: Union[Unset, CompetitionSeasonStatusModelLeague]
        if isinstance(_league, Unset):
            league = UNSET
        else:
            league = CompetitionSeasonStatusModelLeague.from_dict(_league)
        ...
        event_type: Union[Unset, CompetitionSeasonStatusModelEventType]
        if isinstance(_event_type, Unset):
            event_type = UNSET
        else:
            event_type = CompetitionSeasonStatusModelEventType(_event_type)
        ...
        def _parse_social(data: object) -> Union["CompetitionSeasonStatusModelSocialMedia", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                social_type_0 = CompetitionSeasonStatusModelSocialMedia.from_dict(data)

                return social_type_0
            except:  # noqa: E722
                pass
            return cast(Union["CompetitionSeasonStatusModelSocialMedia", None, Unset], data)
        ...
        def _parse_historical_names(
            data: object,
        ) -> Union[None, Unset, list["CompetitionSeasonStatusModelCompetitionHistoricalName"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for historical_names_type_0_item_data in _historical_names_type_0:
                    historical_names_type_0_item = CompetitionSeasonStatusModelCompetitionHistoricalName.from_dict(
                ...
                pass
            return cast(Union[None, Unset, list["CompetitionSeasonStatusModelCompetitionHistoricalName"]], data)
        ...
        def _parse_age_group(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                age_group_type_1 = CompetitionSeasonStatusModelAgeGroupType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                age_group_type_2_type_1 = CompetitionSeasonStatusModelAgeGroupType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                age_group_type_3_type_1 = CompetitionSeasonStatusModelAgeGroupType3Type1(data)
        ...
        competition_season_status_model = cls(
        ...
        return competition_season_status_model
