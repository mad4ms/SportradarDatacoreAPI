...
T = TypeVar("T", bound="FesListResponseDefault")


@_attrs_define
class FesListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fes_list_response_default = cls(
            meta=meta,
            error=error,
        )

        fes_list_response_default.additional_properties = d
        return fes_list_response_default
