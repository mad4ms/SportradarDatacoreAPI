...
T = TypeVar("T", bound="FesListliveResponseDefault")


@_attrs_define
class FesListliveResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fes_listlive_response_default = cls(
            meta=meta,
            error=error,
        )

        fes_listlive_response_default.additional_properties = d
        return fes_listlive_response_default
