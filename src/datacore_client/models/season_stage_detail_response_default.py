...
T = TypeVar("T", bound="SeasonStageDetailResponseDefault")


@_attrs_define
class SeasonStageDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_stage_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        season_stage_detail_response_default.additional_properties = d
        return season_stage_detail_response_default
