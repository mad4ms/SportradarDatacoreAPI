...
if TYPE_CHECKING:
    from ..models.club_external_ids_model import ClubExternalIdsModel
...
T = TypeVar("T", bound="EntityGroupExternalIdsDetailEntityGroupExternalIdsResponse")


@_attrs_define
class EntityGroupExternalIdsDetailEntityGroupExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = ClubExternalIdsModel.from_dict(data_item_data)

            data.append(data_item)

        entity_group_external_ids_detail_entity_group_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_group_external_ids_detail_entity_group_external_ids_response.additional_properties = d
        return entity_group_external_ids_detail_entity_group_external_ids_response
