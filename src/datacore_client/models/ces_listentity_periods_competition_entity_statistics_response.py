...
if TYPE_CHECKING:
    from ..models.competition_entity_statistics_model import CompetitionEntityStatisticsModel
...
T = TypeVar("T", bound="CesListentityPeriodsCompetitionEntityStatisticsResponse")


@_attrs_define
class CesListentityPeriodsCompetitionEntityStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = CompetitionEntityStatisticsModel.from_dict(data_item_data)

            data.append(data_item)

        ces_listentity_periods_competition_entity_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        ces_listentity_periods_competition_entity_statistics_response.additional_properties = d
        return ces_listentity_periods_competition_entity_statistics_response
