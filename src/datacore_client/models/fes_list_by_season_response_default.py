...
T = TypeVar("T", bound="FesListBySeasonResponseDefault")


@_attrs_define
class FesListBySeasonResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fes_list_by_season_response_default = cls(
            meta=meta,
            error=error,
        )

        fes_list_by_season_response_default.additional_properties = d
        return fes_list_by_season_response_default
