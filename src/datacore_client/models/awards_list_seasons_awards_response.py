...
T = TypeVar("T", bound="AwardsListSeasonsAwardsResponse")


@_attrs_define
class AwardsListSeasonsAwardsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        awards_list_seasons_awards_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        awards_list_seasons_awards_response.additional_properties = d
        return awards_list_seasons_awards_response
