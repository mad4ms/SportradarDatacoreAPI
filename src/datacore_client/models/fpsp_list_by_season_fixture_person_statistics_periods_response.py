...
T = TypeVar("T", bound="FpspListBySeasonFixturePersonStatisticsPeriodsResponse")


@_attrs_define
class FpspListBySeasonFixturePersonStatisticsPeriodsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fpsp_list_by_season_fixture_person_statistics_periods_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fpsp_list_by_season_fixture_person_statistics_periods_response.additional_properties = d
        return fpsp_list_by_season_fixture_person_statistics_periods_response
