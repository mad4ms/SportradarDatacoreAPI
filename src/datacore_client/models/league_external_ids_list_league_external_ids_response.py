...
T = TypeVar("T", bound="LeagueExternalIdsListLeagueExternalIdsResponse")


@_attrs_define
class LeagueExternalIdsListLeagueExternalIdsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        league_external_ids_list_league_external_ids_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        league_external_ids_list_league_external_ids_response.additional_properties = d
        return league_external_ids_list_league_external_ids_response
