...
if TYPE_CHECKING:
    from ..models.career_person_statistics_model import CareerPersonStatisticsModel
...
T = TypeVar("T", bound="CapsListpersonCareerPersonStatisticsResponse")


@_attrs_define
class CapsListpersonCareerPersonStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = CareerPersonStatisticsModel.from_dict(data_item_data)

            data.append(data_item)

        caps_listperson_career_person_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        caps_listperson_career_person_statistics_response.additional_properties = d
        return caps_listperson_career_person_statistics_response
