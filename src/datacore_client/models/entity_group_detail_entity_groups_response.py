...
T = TypeVar("T", bound="EntityGroupDetailEntityGroupsResponse")


@_attrs_define
class EntityGroupDetailEntityGroupsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_group_detail_entity_groups_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        entity_group_detail_entity_groups_response.additional_properties = d
        return entity_group_detail_entity_groups_response
