...
T = TypeVar("T", bound="SlListSeasonPersonStatisticsResponse")


@_attrs_define
class SlListSeasonPersonStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sl_list_season_person_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        sl_list_season_person_statistics_response.additional_properties = d
        return sl_list_season_person_statistics_response
