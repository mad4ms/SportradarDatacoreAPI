...
T = TypeVar("T", bound="CapsListPersonSeasonResponseDefault")


@_attrs_define
class CapsListPersonSeasonResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        caps_list_person_season_response_default = cls(
            meta=meta,
            error=error,
        )

        caps_list_person_season_response_default.additional_properties = d
        return caps_list_person_season_response_default
