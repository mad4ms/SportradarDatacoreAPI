...
if TYPE_CHECKING:
    ...
    from ..models.season_entity_statistics_model import SeasonEntityStatisticsModel


T = TypeVar("T", bound="SesListperiodsSeasonEntityStatisticsResponse")


@_attrs_define
class SesListperiodsSeasonEntityStatisticsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeasonEntityStatisticsModel.from_dict(data_item_data)

            data.append(data_item)

        ses_listperiods_season_entity_statistics_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        ses_listperiods_season_entity_statistics_response.additional_properties = d
        return ses_listperiods_season_entity_statistics_response
