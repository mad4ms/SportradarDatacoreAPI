...
T = TypeVar("T", bound="VideoSubscriptionDetailVideoSubscriptionsResponse")


@_attrs_define
class VideoSubscriptionDetailVideoSubscriptionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        video_subscription_detail_video_subscriptions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        video_subscription_detail_video_subscriptions_response.additional_properties = d
        return video_subscription_detail_video_subscriptions_response
