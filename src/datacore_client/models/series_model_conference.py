...
@_attrs_define
class SeriesModelConference:
    """The conference information

    Attributes:
        resource_type (Union[Unset, SeriesModelConferenceResourceType]):
        id (Union[Unset, str]): Unique identifier for this resource Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
    """

    resource_type: Union[Unset, SeriesModelConferenceResourceType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource_type, Unset):
            ...
            resource_type = SeriesModelConferenceResourceType(_resource_type)

        id = d.pop("id", UNSET)

        series_model_conference = cls(
            resource_type=resource_type,
            id=id,
        )

        series_model_conference.additional_properties = d
        return series_model_conference
