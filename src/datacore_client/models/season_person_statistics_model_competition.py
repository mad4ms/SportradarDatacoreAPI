...
from ..models.season_person_statistics_model_competition_resource_type import (
    SeasonPersonStatisticsModelCompetitionResourceType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeasonPersonStatisticsModelCompetition")


@_attrs_define
class SeasonPersonStatisticsModelCompetition:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_person_statistics_model_competition = cls(
            resource_type=resource_type,
            id=id,
        )

        season_person_statistics_model_competition.additional_properties = d
        return season_person_statistics_model_competition
