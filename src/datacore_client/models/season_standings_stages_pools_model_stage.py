...
from ..models.season_standings_stages_pools_model_stage_resource_type import (
    SeasonStandingsStagesPoolsModelStageResourceType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeasonStandingsStagesPoolsModelStage")


@_attrs_define
class SeasonStandingsStagesPoolsModelStage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_standings_stages_pools_model_stage = cls(
            resource_type=resource_type,
            id=id,
        )

        season_standings_stages_pools_model_stage.additional_properties = d
        return season_standings_stages_pools_model_stage
