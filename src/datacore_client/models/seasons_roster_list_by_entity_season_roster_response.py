...
if TYPE_CHECKING:
    ...
    from ..models.season_roster_model import SeasonRosterModel


T = TypeVar("T", bound="SeasonsRosterListByEntitySeasonRosterResponse")


@_attrs_define
class SeasonsRosterListByEntitySeasonRosterResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = SeasonRosterModel.from_dict(data_item_data)

            data.append(data_item)

        seasons_roster_list_by_entity_season_roster_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        seasons_roster_list_by_entity_season_roster_response.additional_properties = d
        return seasons_roster_list_by_entity_season_roster_response
