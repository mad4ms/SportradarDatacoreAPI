...
if TYPE_CHECKING:
    from ..models.change_log_model import ChangeLogModel
...
T = TypeVar("T", bound="ChangeLogListChangeLogResponse")


@_attrs_define
class ChangeLogListChangeLogResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = ChangeLogModel.from_dict(data_item_data)

            data.append(data_item)

        change_log_list_change_log_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        change_log_list_change_log_response.additional_properties = d
        return change_log_list_change_log_response
