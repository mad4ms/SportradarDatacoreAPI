...
T = TypeVar("T", bound="CompetitionPersonStatisticsModelStatistics")


@_attrs_define
class CompetitionPersonStatisticsModelStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_person_statistics_model_statistics = cls(
        ...
        return competition_person_statistics_model_statistics
