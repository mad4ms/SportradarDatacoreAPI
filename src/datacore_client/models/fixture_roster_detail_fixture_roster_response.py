...
T = TypeVar("T", bound="FixtureRosterDetailFixtureRosterResponse")


@_attrs_define
class FixtureRosterDetailFixtureRosterResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fixture_roster_detail_fixture_roster_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_roster_detail_fixture_roster_response.additional_properties = d
        return fixture_roster_detail_fixture_roster_response
