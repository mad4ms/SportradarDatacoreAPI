...
T = TypeVar("T", bound="AwardsListNonFixturesResponseDefault")


@_attrs_define
class AwardsListNonFixturesResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        awards_list_non_fixtures_response_default = cls(
            meta=meta,
            error=error,
        )

        awards_list_non_fixtures_response_default.additional_properties = d
        return awards_list_non_fixtures_response_default
