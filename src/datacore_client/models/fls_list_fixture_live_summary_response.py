...
if TYPE_CHECKING:
    from ..models.fixture_live_summary_model import FixtureLiveSummaryModel
...
T = TypeVar("T", bound="FlsListFixtureLiveSummaryResponse")


@_attrs_define
class FlsListFixtureLiveSummaryResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = FixtureLiveSummaryModel.from_dict(data_item_data)

            data.append(data_item)

        fls_list_fixture_live_summary_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fls_list_fixture_live_summary_response.additional_properties = d
        return fls_list_fixture_live_summary_response
