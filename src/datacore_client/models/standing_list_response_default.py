...
T = TypeVar("T", bound="StandingListResponseDefault")


@_attrs_define
class StandingListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        standing_list_response_default = cls(
            meta=meta,
            error=error,
        )

        standing_list_response_default.additional_properties = d
        return standing_list_response_default
