...
T = TypeVar("T", bound="CompetitionDetailResponseDefault")


@_attrs_define
class CompetitionDetailResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_detail_response_default = cls(
            meta=meta,
            error=error,
        )

        competition_detail_response_default.additional_properties = d
        return competition_detail_response_default
