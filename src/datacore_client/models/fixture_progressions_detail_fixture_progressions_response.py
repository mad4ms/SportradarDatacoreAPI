...
if TYPE_CHECKING:
    from ..models.fixture_progression_model import FixtureProgressionModel
...
T = TypeVar("T", bound="FixtureProgressionsDetailFixtureProgressionsResponse")


@_attrs_define
class FixtureProgressionsDetailFixtureProgressionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = FixtureProgressionModel.from_dict(data_item_data)

            data.append(data_item)

        fixture_progressions_detail_fixture_progressions_response = cls(
            meta=meta,
            links=links,
            included=included,
            data=data,
        ...
        fixture_progressions_detail_fixture_progressions_response.additional_properties = d
        return fixture_progressions_detail_fixture_progressions_response
