...
T = TypeVar("T", bound="UniformsBySeasonListResponseDefault")


@_attrs_define
class UniformsBySeasonListResponseDefault:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        uniforms_by_season_list_response_default = cls(
            meta=meta,
            error=error,
        )

        uniforms_by_season_list_response_default.additional_properties = d
        return uniforms_by_season_list_response_default
