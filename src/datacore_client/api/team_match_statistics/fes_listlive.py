...
from ...models.fes_listlive_fixture_entity_statistics_response import FesListliveFixtureEntityStatisticsResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/statistics/for/entity/in/fixtures/{fixture_id}/live",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = FesListliveFixtureEntityStatisticsResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Team total statistics - live
        ...
        added together) for the match. This call will return records of matches still in-progress if
    available.
...
def sync(
    ...
    *,
    ...
    offset: Union[Unset, int] = UNSET,
    updated: Union[Unset, datetime.datetime] = UNSET,
) -> Optional[Union[FesListliveFixtureEntityStatisticsResponse, FesListliveResponseDefault]]:
    """Team total statistics - live
