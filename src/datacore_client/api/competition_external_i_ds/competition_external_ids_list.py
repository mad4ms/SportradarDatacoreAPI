...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CompetitionExternalIdsListCompetitionExternalIdsResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        competition_id (Union[Unset, str]):  Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
