...
from ...models.organization_fixture_list_competitor_type import OrganizationFixtureListCompetitorType
from ...models.organization_fixture_list_discipline import OrganizationFixtureListDiscipline
from ...models.organization_fixture_list_fixture_type import OrganizationFixtureListFixtureType
from ...models.organization_fixture_list_fixtures_response import OrganizationFixtureListFixturesResponse
from ...models.organization_fixture_list_response_default import OrganizationFixtureListResponseDefault
from ...models.organization_fixture_list_status import OrganizationFixtureListStatus
from ...models.organization_fixture_list_status_not import OrganizationFixtureListStatusNot
...
def _get_kwargs(
    ...
    *,
    ...
    competitor_type: Union[Unset, OrganizationFixtureListCompetitorType] = UNSET,
    discipline: Union[Unset, OrganizationFixtureListDiscipline] = UNSET,
    external: Union[Unset, str] = UNSET,
    feature_match: Union[Unset, bool] = UNSET,
    fields: Union[Unset, str] = UNSET,
    fixture_ids: Union[Unset, UUID] = UNSET,
    fixture_type: Union[Unset, OrganizationFixtureListFixtureType] = UNSET,
    ...
    status: Union[Unset, OrganizationFixtureListStatus] = UNSET,
    status_not: Union[Unset, OrganizationFixtureListStatusNot] = UNSET,
    ...
    json_fixture_ids: Union[Unset, str] = UNSET
    if not isinstance(fixture_ids, Unset):
        json_fixture_ids = str(fixture_ids)
    params["fixtureIds"] = json_fixture_ids
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/fixtures",
        "params": params,
    }
...
) -> Union[OrganizationFixtureListFixturesResponse, OrganizationFixtureListResponseDefault]:
    if response.status_code == 200:
        response_200 = OrganizationFixtureListFixturesResponse.from_dict(response.json())

        return response_200

    response_default = OrganizationFixtureListResponseDefault.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OrganizationFixtureListFixturesResponse, OrganizationFixtureListResponseDefault]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        competitor_type (Union[Unset, OrganizationFixtureListCompetitorType]):  Example: PERSON.
        discipline (Union[Unset, OrganizationFixtureListDiscipline]):  Example: INDOOR.
        external (Union[Unset, str]):  Example: entityId,personId.
        feature_match (Union[Unset, bool]):  Example: True.
        fields (Union[Unset, str]):  Example: dob,firstName,organization(id),organizations[name],
            teams[name,details/metrics/*,tags(id)].
        fixture_ids (Union[Unset, UUID]):  Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc,de83c6a8-3b29-11eb-bdb7-0242ac130005.
        fixture_type (Union[Unset, OrganizationFixtureListFixtureType]):  Example: REGULAR.
        ...
        status (Union[Unset, OrganizationFixtureListStatus]):  Example: SCHEDULED.
        status_not (Union[Unset, OrganizationFixtureListStatusNot]):  Example: SCHEDULED.
...
def sync(
    ...
    *,
    ...
    updated: Union[Unset, datetime.datetime] = UNSET,
    venue_id: Union[Unset, UUID] = UNSET,
) -> Optional[Union[OrganizationFixtureListFixturesResponse, OrganizationFixtureListResponseDefault]]:
    """Get a list of matches for the organization
