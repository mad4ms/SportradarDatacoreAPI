...
from ...models.fixture_roster_detail_fixture_roster_response import FixtureRosterDetailFixtureRosterResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/fixtures/{fixture_id}/persons/{person_id}/roster",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = FixtureRosterDetailFixtureRosterResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    limit: Union[Unset, int] = 10,
    offset: Union[Unset, int] = UNSET,
) -> Optional[Union[FixtureRosterDetailFixtureRosterResponse, FixtureRosterDetailResponseDefault]]:
    """Get the roster information for a person in a match
