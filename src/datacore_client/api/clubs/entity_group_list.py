...
from ...models.entity_group_list_entity_groups_response import EntityGroupListEntityGroupsResponse
...
def sync(
    ...
    *,
    ...
    status: Union[Unset, EntityGroupListStatus] = UNSET,
    updated: Union[Unset, datetime.datetime] = UNSET,
) -> Optional[Union[EntityGroupListEntityGroupsResponse, EntityGroupListResponseDefault]]:
    """Get a list of clubs
