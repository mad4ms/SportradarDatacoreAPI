...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = FixtureExternalIdsDetailFixtureExternalIdsResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    limit: Union[Unset, int] = 10,
    offset: Union[Unset, int] = UNSET,
) -> Optional[Union[FixtureExternalIdsDetailFixtureExternalIdsResponse, FixtureExternalIdsDetailResponseDefault]]:
    """Get a match external identifier details
