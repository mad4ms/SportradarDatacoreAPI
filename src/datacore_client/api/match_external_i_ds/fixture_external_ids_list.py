...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = FixtureExternalIdsListFixtureExternalIdsResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    source_type: Union[Unset, str] = UNSET,
    updated: Union[Unset, datetime.datetime] = UNSET,
) -> Optional[Union[FixtureExternalIdsListFixtureExternalIdsResponse, FixtureExternalIdsListResponseDefault]]:
    """Get a list of a match external ids
