...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = EntityExternalIdsDetailEntityExternalIdsResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    limit: Union[Unset, int] = 10,
    offset: Union[Unset, int] = UNSET,
) -> Optional[Union[EntityExternalIdsDetailEntityExternalIdsResponse, EntityExternalIdsDetailResponseDefault]]:
    """Get a team external identifier details
