...
from ...models.uniforms_by_season_list_base_type import UniformsBySeasonListBaseType
from ...models.uniforms_by_season_list_response_default import UniformsBySeasonListResponseDefault
from ...models.uniforms_by_season_list_uniforms_response import UniformsBySeasonListUniformsResponse
...
def _get_kwargs(
    ...
    *,
    ...
    base_ids: Union[Unset, UUID] = UNSET,
    base_type: Union[Unset, UniformsBySeasonListBaseType] = UNSET,
    ...
    json_base_id: Union[Unset, str] = UNSET
    if not isinstance(base_id, Unset):
        json_base_id = str(base_id)
    params["baseId"] = json_base_id

    json_base_ids: Union[Unset, str] = UNSET
    if not isinstance(base_ids, Unset):
        json_base_ids = str(base_ids)
    params["baseIds"] = json_base_ids
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/handball/o/{organization_id}/seasons/{season_id}/uniforms",
        "params": params,
    }
...
) -> Union[UniformsBySeasonListResponseDefault, UniformsBySeasonListUniformsResponse]:
    if response.status_code == 200:
        response_200 = UniformsBySeasonListUniformsResponse.from_dict(response.json())

        return response_200

    response_default = UniformsBySeasonListResponseDefault.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[UniformsBySeasonListResponseDefault, UniformsBySeasonListUniformsResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        base_id (Union[Unset, UUID]):  Example: 009e9276-5c80-11e8-9c2d-fa7ae01bbebc.
        base_ids (Union[Unset, UUID]):  Example:
            009e9276-5c80-11e8-9c2d-fa7ae01bbebc,de83c6a8-3b29-11eb-bdb7-0242ac130005.
        base_type (Union[Unset, UniformsBySeasonListBaseType]):  Example: PERSON.
...
def sync(
    ...
    *,
    ...
    sort_by: Union[Unset, str] = UNSET,
    updated: Union[Unset, datetime.datetime] = UNSET,
) -> Optional[Union[UniformsBySeasonListResponseDefault, UniformsBySeasonListUniformsResponse]]:
    """Get a list of Uniforms for a season
